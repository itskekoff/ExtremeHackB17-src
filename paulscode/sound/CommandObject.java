...
public class CommandObject {
    ...
    public CommandObject(int cmd, int i2) {
        this.Command = cmd;
        this.intArgs = new int[1];
        this.intArgs[0] = i2;
    }

    public CommandObject(int cmd, Class c2) {
        this.Command = cmd;
        this.classArgs = new Class[1];
        this.classArgs[0] = c2;
    }

    public CommandObject(int cmd, float f2) {
        this.Command = cmd;
        this.floatArgs = new float[1];
        this.floatArgs[0] = f2;
    }

    public CommandObject(int cmd, String s2) {
        this.Command = cmd;
        this.stringArgs = new String[1];
        this.stringArgs[0] = s2;
    }

    public CommandObject(int cmd, Object o2) {
        this.Command = cmd;
        this.objectArgs = new Object[1];
        this.objectArgs[0] = o2;
    }

    public CommandObject(int cmd, String s2, Object o2) {
        this.Command = cmd;
        this.stringArgs = new String[1];
        this.stringArgs[0] = s2;
        this.objectArgs = new Object[1];
    ...
    public CommandObject(int cmd, String s2, byte[] buff) {
        this.Command = cmd;
        this.stringArgs = new String[1];
        this.stringArgs[0] = s2;
        this.buffer = buff;
    ...
    public CommandObject(int cmd, String s2, Object o2, long l2) {
        this.Command = cmd;
        this.stringArgs = new String[1];
        this.stringArgs[0] = s2;
        this.objectArgs = new Object[1];
    ...
    public CommandObject(int cmd, String s2, Object o2, long l1, long l2) {
        this.Command = cmd;
        this.stringArgs = new String[1];
        this.stringArgs[0] = s2;
        this.objectArgs = new Object[1];
    ...
    public CommandObject(int cmd, String s2, int i2) {
        this.Command = cmd;
        this.intArgs = new int[1];
        this.stringArgs = new String[1];
        this.intArgs[0] = i2;
    ...
    public CommandObject(int cmd, String s2, float f2) {
        this.Command = cmd;
        this.floatArgs = new float[1];
        this.stringArgs = new String[1];
        this.floatArgs[0] = f2;
    ...
    public CommandObject(int cmd, String s2, boolean b2) {
        this.Command = cmd;
    ...
    public CommandObject(int cmd, String s2, float f1, float f2, float f3) {
        this.Command = cmd;
        this.floatArgs = new float[3];
        this.stringArgs = new String[1];
        this.floatArgs[0] = f1;
    ...
    public CommandObject(int cmd, boolean b1, boolean b2, boolean b3, String s2, Object o2, float f1, float f2, float f3, int i2, float f4) {
        this.Command = cmd;
        this.intArgs = new int[1];
    ...
    public CommandObject(int cmd, boolean b1, boolean b2, boolean b3, String s2, Object o2, float f1, float f2, float f3, int i2, float f4, boolean b4) {
        this.Command = cmd;
        this.intArgs = new int[1];
        this.floatArgs = new float[4];
    ...
    public CommandObject(int cmd, Object o2, boolean b2, String s2, float f1, float f2, float f3, int i2, float f4) {
        this.Command = cmd;
        this.intArgs = new int[1];
        this.floatArgs = new float[4];
        this.boolArgs = new boolean[1];
