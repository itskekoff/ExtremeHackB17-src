...
public class SoundSystemConfig {
    ...
    public static boolean libraryCompatible(Class libraryClass) {
        ...
        Object o2 = SoundSystemConfig.runMethod(libraryClass, "libraryCompatible", new Class[0], new Object[0]);
        if (o2 == null) {
    ...
    public static String getLibraryTitle(Class libraryClass) {
        ...
        Object o2 = SoundSystemConfig.runMethod(libraryClass, "getTitle", new Class[0], new Object[0]);
        if (o2 == null) {
    ...
    public static String getLibraryDescription(Class libraryClass) {
        ...
        Object o2 = SoundSystemConfig.runMethod(libraryClass, "getDescription", new Class[0], new Object[0]);
        if (o2 == null) {
    ...
    public static boolean reverseByteOrder(Class libraryClass) {
        ...
        Object o2 = SoundSystemConfig.runMethod(libraryClass, "reversByteOrder", new Class[0], new Object[0]);
        if (o2 == null) {
    ...
    public static void setLogger(SoundSystemLogger l2) {
        logger = l2;
    }
    ...
    public static synchronized void setCodec(String extension, Class iCodecClass) throws SoundSystemException {
        ...
        ListIterator i2 = codecs.listIterator();
        while (i2.hasNext()) {
            Codec codec = (Codec)i2.next();
        ...
        new Thread(){
            ...
            public void run() {
                ...
                synchronized (object) {
                    ...
                    ListIterator i2 = streamListeners.listIterator();
                    while (i2.hasNext()) {
                        IStreamListener streamListener = (IStreamListener)i2.next();
    ...
    private static Object runMethod(Class c2, String method, Class[] paramTypes, Object[] params) {
        Method m2 = null;
        try {
            m2 = c2.getMethod(method, paramTypes);
        }
    ...
    private static class Codec {
        ...
        public Codec(String extension, Class iCodecClass) {
            if (extension != null && extension.length() > 0) {
                this.extensionRegX = ".*";
                for (int x2 = 0; x2 < extension.length(); ++x2) {
                    String c2 = extension.substring(x2, x2 + 1);
                    this.extensionRegX = this.extensionRegX + "[" + c2.toLowerCase(Locale.ENGLISH) + c2.toUpperCase(Locale.ENGLISH) + "]";
                }
        ...
        public ICodec getInstance() {
            ...
            Object o2 = null;
            try {
                o2 = this.iCodecClass.newInstance();
            }
