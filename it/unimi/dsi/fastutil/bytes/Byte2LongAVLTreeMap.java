...
Cloneable {
    ...
    public Byte2LongAVLTreeMap(Comparator<? super Byte> c2) {
        this();
        this.storedComparator = c2;
        this.setActualComparator();
    }

    public Byte2LongAVLTreeMap(Map<? extends Byte, ? extends Long> m2) {
        this();
        this.putAll(m2);
    }

    public Byte2LongAVLTreeMap(SortedMap<Byte, Long> m2) {
        this(m2.comparator());
        this.putAll((Map<? extends Byte, ? extends Long>)m2);
    }

    public Byte2LongAVLTreeMap(Byte2LongMap m2) {
        this();
        this.putAll(m2);
    }

    public Byte2LongAVLTreeMap(Byte2LongSortedMap m2) {
        this(m2.comparator());
        this.putAll(m2);
    }

    public Byte2LongAVLTreeMap(byte[] k2, long[] v2, Comparator<? super Byte> c2) {
        this(c2);
    ...
    public Byte2LongAVLTreeMap(byte[] k2, long[] v2) {
        this(k2, v2, null);
    }
    ...
    public Long put(Byte ok2, Long ov) {
        long oldValue = this.put((byte)ok2, (long)ov);
    ...
    public Long remove(Object ok2) {
        long oldValue = this.remove((Byte)ok2);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>(){
                final Comparator<? super Byte2LongMap.Entry> comparator = new Comparator<Byte2LongMap.Entry>(){
                    ...
                    @Override
                    public int compare(Byte2LongMap.Entry x2, Byte2LongMap.Entry y2) {
                        return Byte2LongAVLTreeMap.this.actualComparator.compare(x2.getByteKey(), y2.getByteKey());
                    }
                };
                ...
                public boolean contains(Object o2) {
                    ...
                    Entry f2 = Byte2LongAVLTreeMap.this.findKey((Byte)e2.getKey());
                    return e2.equals(f2);
                }
                ...
                public boolean remove(Object o2) {
                    ...
                    Entry f2 = Byte2LongAVLTreeMap.this.findKey((Byte)e2.getKey());
                    if (f2 != null) {
                        Byte2LongAVLTreeMap.this.remove(f2.key);
                    }
                    return f2 != null;
                }
                ...
                @Override
                public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry from, Byte2LongMap.Entry to2) {
                    return Byte2LongAVLTreeMap.this.subMap(from.getByteKey(), to2.getByteKey()).byte2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry to2) {
                    return Byte2LongAVLTreeMap.this.headMap(to2.getByteKey()).byte2LongEntrySet();
                }
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public boolean contains(long k2) {
                    return Byte2LongAVLTreeMap.this.containsValue(k2);
                }
    ...
    public Byte2LongAVLTreeMap clone() {
        Byte2LongAVLTreeMap c2;
        try {
            c2 = (Byte2LongAVLTreeMap)super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s2, int n2, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n2 == 1) {
            Entry top = new Entry(s2.readByte(), s2.readLong());
            top.pred(pred);
            top.succ(succ);
            return top;
        }
        if (n2 == 2) {
            Entry top = new Entry(s2.readByte(), s2.readLong());
            top.right(new Entry(s2.readByte(), s2.readLong()));
            top.right.pred(top);
            top.balance(1);
            top.pred(pred);
            top.right.succ(succ);
    ...
    implements Serializable {
        ...
        public Submap(byte from, boolean bottom, byte to2, boolean top) {
            if (!bottom && !top && Byte2LongAVLTreeMap.this.compare(from, to2) > 0) {
        ...
        final boolean in(byte k2) {
            return !(!this.bottom && Byte2LongAVLTreeMap.this.compare(k2, this.from) < 0 || !this.top && Byte2LongAVLTreeMap.this.compare(k2, this.to) >= 0);
        }
        ...
        public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>(){
                    ...
                    @Override
                    public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry from, Byte2LongMap.Entry to2) {
                        return Submap.this.subMap(from.getByteKey(), to2.getByteKey()).byte2LongEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry to2) {
                        return Submap.this.headMap(to2.getByteKey()).byte2LongEntrySet();
                    }
        ...
        @Override
        public boolean containsKey(byte k2) {
            return this.in(k2) && Byte2LongAVLTreeMap.this.containsKey(k2);
        }
        ...
        public long get(byte k2) {
            Entry e2;
            byte kk2 = k2;
            return this.in(kk2) && (e2 = Byte2LongAVLTreeMap.this.findKey(kk2)) != null ? e2.value : this.defRetValue;
        }
        ...
        public long put(byte k2, long v2) {
            ...
            long oldValue = Byte2LongAVLTreeMap.this.put(k2, v2);
        ...
        public long remove(byte k2) {
            ...
            long oldValue = Byte2LongAVLTreeMap.this.remove(k2);
        ...
        public Byte2LongSortedMap headMap(byte to2) {
            ...
            return Byte2LongAVLTreeMap.this.compare(to2, this.to) < 0 ? new Submap(this.from, this.bottom, to2, false) : this;
        }
        ...
        public Byte2LongSortedMap subMap(byte from, byte to2) {
            ...
            if (!this.top) {
                byte by2 = to2 = Byte2LongAVLTreeMap.this.compare(to2, this.to) < 0 ? to2 : this.to;
            }
            if (!this.bottom) {
                byte by3 = from = Byte2LongAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e2 = Byte2LongAVLTreeMap.this.firstEntry;
            } else {
                e2 = Byte2LongAVLTreeMap.this.locateKey(this.from);
                if (Byte2LongAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                    e2 = e2.next();
                }
            }
            if (e2 == null || !this.top && Byte2LongAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                return null;
            }
            return e2;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e2 = Byte2LongAVLTreeMap.this.lastEntry;
            } else {
                e2 = Byte2LongAVLTreeMap.this.locateKey(this.to);
                if (Byte2LongAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                    e2 = e2.prev();
                }
            }
            if (e2 == null || !this.bottom && Byte2LongAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                return null;
            }
            return e2;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k2) {
                ...
                if (!submap.bottom && submap.Byte2LongAVLTreeMap.this.compare(k2, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2LongAVLTreeMap.this.compare(k2, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2LongAVLTreeMap.this.locateKey(k2);
                if (submap.Byte2LongAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(byte k2) {
            this.next = Byte2LongAVLTreeMap.this.locateKey(k2);
            if (this.next != null) {
                if (Byte2LongAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
