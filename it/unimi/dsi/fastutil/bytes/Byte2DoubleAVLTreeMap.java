...
Cloneable {
    ...
    public Byte2DoubleAVLTreeMap(Comparator<? super Byte> c2) {
        this();
        this.storedComparator = c2;
        this.setActualComparator();
    }

    public Byte2DoubleAVLTreeMap(Map<? extends Byte, ? extends Double> m2) {
        this();
        this.putAll(m2);
    }

    public Byte2DoubleAVLTreeMap(SortedMap<Byte, Double> m2) {
        this(m2.comparator());
        this.putAll((Map<? extends Byte, ? extends Double>)m2);
    }

    public Byte2DoubleAVLTreeMap(Byte2DoubleMap m2) {
        this();
        this.putAll(m2);
    }

    public Byte2DoubleAVLTreeMap(Byte2DoubleSortedMap m2) {
        this(m2.comparator());
        this.putAll(m2);
    }

    public Byte2DoubleAVLTreeMap(byte[] k2, double[] v2, Comparator<? super Byte> c2) {
        this(c2);
    ...
    public Byte2DoubleAVLTreeMap(byte[] k2, double[] v2) {
        this(k2, v2, null);
    }
    ...
    public double addTo(byte k2, double incr) {
    ...
    public Double put(Byte ok2, Double ov) {
        double oldValue = this.put((byte)ok2, (double)ov);
    ...
    public Double remove(Object ok2) {
        double oldValue = this.remove((Byte)ok2);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>(){
                final Comparator<? super Byte2DoubleMap.Entry> comparator = new Comparator<Byte2DoubleMap.Entry>(){
                    ...
                    @Override
                    public int compare(Byte2DoubleMap.Entry x2, Byte2DoubleMap.Entry y2) {
                        return Byte2DoubleAVLTreeMap.this.actualComparator.compare(x2.getByteKey(), y2.getByteKey());
                    }
                };
                ...
                public boolean contains(Object o2) {
                    ...
                    Entry f2 = Byte2DoubleAVLTreeMap.this.findKey((Byte)e2.getKey());
                    return e2.equals(f2);
                }
                ...
                public boolean remove(Object o2) {
                    ...
                    Entry f2 = Byte2DoubleAVLTreeMap.this.findKey((Byte)e2.getKey());
                    if (f2 != null) {
                        Byte2DoubleAVLTreeMap.this.remove(f2.key);
                    }
                    return f2 != null;
                }
                ...
                @Override
                public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry from, Byte2DoubleMap.Entry to2) {
                    return Byte2DoubleAVLTreeMap.this.subMap(from.getByteKey(), to2.getByteKey()).byte2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry to2) {
                    return Byte2DoubleAVLTreeMap.this.headMap(to2.getByteKey()).byte2DoubleEntrySet();
                }
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public boolean contains(double k2) {
                    return Byte2DoubleAVLTreeMap.this.containsValue(k2);
                }
    ...
    public Byte2DoubleAVLTreeMap clone() {
        Byte2DoubleAVLTreeMap c2;
        try {
            c2 = (Byte2DoubleAVLTreeMap)super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s2, int n2, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n2 == 1) {
            Entry top = new Entry(s2.readByte(), s2.readDouble());
            top.pred(pred);
            top.succ(succ);
            return top;
        }
        if (n2 == 2) {
            Entry top = new Entry(s2.readByte(), s2.readDouble());
            top.right(new Entry(s2.readByte(), s2.readDouble()));
            top.right.pred(top);
            top.balance(1);
            top.pred(pred);
            top.right.succ(succ);
    ...
    implements Serializable {
        ...
        public Submap(byte from, boolean bottom, byte to2, boolean top) {
            if (!bottom && !top && Byte2DoubleAVLTreeMap.this.compare(from, to2) > 0) {
        ...
        final boolean in(byte k2) {
            return !(!this.bottom && Byte2DoubleAVLTreeMap.this.compare(k2, this.from) < 0 || !this.top && Byte2DoubleAVLTreeMap.this.compare(k2, this.to) >= 0);
        }
        ...
        public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>(){
                    ...
                    @Override
                    public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry from, Byte2DoubleMap.Entry to2) {
                        return Submap.this.subMap(from.getByteKey(), to2.getByteKey()).byte2DoubleEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry to2) {
                        return Submap.this.headMap(to2.getByteKey()).byte2DoubleEntrySet();
                    }
        ...
        @Override
        public boolean containsKey(byte k2) {
            return this.in(k2) && Byte2DoubleAVLTreeMap.this.containsKey(k2);
        }
        ...
        public double get(byte k2) {
            Entry e2;
            byte kk2 = k2;
            return this.in(kk2) && (e2 = Byte2DoubleAVLTreeMap.this.findKey(kk2)) != null ? e2.value : this.defRetValue;
        }
        ...
        public double put(byte k2, double v2) {
            ...
            double oldValue = Byte2DoubleAVLTreeMap.this.put(k2, v2);
        ...
        public double remove(byte k2) {
            ...
            double oldValue = Byte2DoubleAVLTreeMap.this.remove(k2);
        ...
        public Byte2DoubleSortedMap headMap(byte to2) {
            ...
            return Byte2DoubleAVLTreeMap.this.compare(to2, this.to) < 0 ? new Submap(this.from, this.bottom, to2, false) : this;
        }
        ...
        public Byte2DoubleSortedMap subMap(byte from, byte to2) {
            ...
            if (!this.top) {
                byte by2 = to2 = Byte2DoubleAVLTreeMap.this.compare(to2, this.to) < 0 ? to2 : this.to;
            }
            if (!this.bottom) {
                byte by3 = from = Byte2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e2 = Byte2DoubleAVLTreeMap.this.firstEntry;
            } else {
                e2 = Byte2DoubleAVLTreeMap.this.locateKey(this.from);
                if (Byte2DoubleAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                    e2 = e2.next();
                }
            }
            if (e2 == null || !this.top && Byte2DoubleAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                return null;
            }
            return e2;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e2 = Byte2DoubleAVLTreeMap.this.lastEntry;
            } else {
                e2 = Byte2DoubleAVLTreeMap.this.locateKey(this.to);
                if (Byte2DoubleAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                    e2 = e2.prev();
                }
            }
            if (e2 == null || !this.bottom && Byte2DoubleAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                return null;
            }
            return e2;
        }
        ...
        implements ObjectListIterator<Byte2DoubleMap.Entry> {
            ...
            @Override
            public void set(Byte2DoubleMap.Entry ok2) {
                throw new UnsupportedOperationException();
            }

            @Override
            public void add(Byte2DoubleMap.Entry ok2) {
                throw new UnsupportedOperationException();
            }
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k2) {
                ...
                if (!submap.bottom && submap.Byte2DoubleAVLTreeMap.this.compare(k2, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2DoubleAVLTreeMap.this.compare(k2, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2DoubleAVLTreeMap.this.locateKey(k2);
                if (submap.Byte2DoubleAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(byte k2) {
            this.next = Byte2DoubleAVLTreeMap.this.locateKey(k2);
            if (this.next != null) {
                if (Byte2DoubleAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
