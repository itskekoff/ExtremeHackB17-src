...
Cloneable {
    ...
    public Byte2FloatRBTreeMap(Comparator<? super Byte> c2) {
        this();
        this.storedComparator = c2;
        this.setActualComparator();
    }

    public Byte2FloatRBTreeMap(Map<? extends Byte, ? extends Float> m2) {
        this();
        this.putAll(m2);
    }

    public Byte2FloatRBTreeMap(SortedMap<Byte, Float> m2) {
        this(m2.comparator());
        this.putAll((Map<? extends Byte, ? extends Float>)m2);
    }

    public Byte2FloatRBTreeMap(Byte2FloatMap m2) {
        this();
        this.putAll(m2);
    }

    public Byte2FloatRBTreeMap(Byte2FloatSortedMap m2) {
        this(m2.comparator());
        this.putAll(m2);
    }

    public Byte2FloatRBTreeMap(byte[] k2, float[] v2, Comparator<? super Byte> c2) {
        this(c2);
    ...
    public Byte2FloatRBTreeMap(byte[] k2, float[] v2) {
        this(k2, v2, null);
    }
...
lbl160:
            ...
            this.entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>(){
                final Comparator<? super Byte2FloatMap.Entry> comparator = new Comparator<Byte2FloatMap.Entry>(){
                    ...
                    public int compare(Byte2FloatMap.Entry x2, Byte2FloatMap.Entry y2) {
                        return Byte2FloatRBTreeMap.this.actualComparator.compare(x2.getByteKey(), y2.getByteKey());
                    }
                };
                ...
                public boolean contains(Object o2) {
                    ...
                    Entry f2 = Byte2FloatRBTreeMap.this.findKey((Byte)e2.getKey());
                    return e2.equals(f2);
                }
                ...
                public boolean remove(Object o2) {
                    ...
                    Entry f2 = Byte2FloatRBTreeMap.this.findKey((Byte)e2.getKey());
                    if (f2 != null) {
                        Byte2FloatRBTreeMap.this.remove(f2.key);
                    }
                    return f2 != null;
                }
                ...
                public ObjectSortedSet<Byte2FloatMap.Entry> subSet(Byte2FloatMap.Entry from, Byte2FloatMap.Entry to2) {
                    return Byte2FloatRBTreeMap.this.subMap(from.getByteKey(), to2.getByteKey()).byte2FloatEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2FloatMap.Entry> headSet(Byte2FloatMap.Entry to2) {
                    return Byte2FloatRBTreeMap.this.headMap(to2.getByteKey()).byte2FloatEntrySet();
                }
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public boolean contains(float k2) {
                    return Byte2FloatRBTreeMap.this.containsValue(k2);
                }
    ...
    public Byte2FloatRBTreeMap clone() {
        Byte2FloatRBTreeMap c2;
        try {
            c2 = (Byte2FloatRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Submap(byte from, boolean bottom, byte to2, boolean top) {
            if (!bottom && !top && Byte2FloatRBTreeMap.this.compare(from, to2) > 0) {
        ...
        final boolean in(byte k2) {
            return !(!this.bottom && Byte2FloatRBTreeMap.this.compare(k2, this.from) < 0 || !this.top && Byte2FloatRBTreeMap.this.compare(k2, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(byte k2) {
            return this.in(k2) && Byte2FloatRBTreeMap.this.containsKey(k2);
        }
        ...
        public float get(byte k2) {
            Entry e2;
            byte kk2 = k2;
            return this.in(kk2) && (e2 = Byte2FloatRBTreeMap.this.findKey(kk2)) != null ? e2.value : this.defRetValue;
        }
        ...
        public float put(byte k2, float v2) {
            ...
            float oldValue = Byte2FloatRBTreeMap.this.put(k2, v2);
        ...
        public float remove(byte k2) {
            ...
            float oldValue = Byte2FloatRBTreeMap.this.remove(k2);
        ...
        public Byte2FloatSortedMap headMap(byte to2) {
            ...
            return Byte2FloatRBTreeMap.this.compare(to2, this.to) < 0 ? new Submap(this.from, this.bottom, to2, false) : this;
        }
        ...
        public Byte2FloatSortedMap subMap(byte from, byte to2) {
            ...
            if (!this.top) {
                byte by2 = to2 = Byte2FloatRBTreeMap.this.compare(to2, this.to) < 0 ? to2 : this.to;
            }
            if (!this.bottom) {
                byte by3 = from = Byte2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e2 = Byte2FloatRBTreeMap.this.firstEntry;
            } else {
                e2 = Byte2FloatRBTreeMap.this.locateKey(this.from);
                if (Byte2FloatRBTreeMap.this.compare(e2.key, this.from) < 0) {
                    e2 = e2.next();
                }
            }
            if (e2 == null || !this.top && Byte2FloatRBTreeMap.this.compare(e2.key, this.to) >= 0) {
                return null;
            }
            return e2;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e2 = Byte2FloatRBTreeMap.this.lastEntry;
            } else {
                e2 = Byte2FloatRBTreeMap.this.locateKey(this.to);
                if (Byte2FloatRBTreeMap.this.compare(e2.key, this.to) >= 0) {
                    e2 = e2.prev();
                }
            }
            if (e2 == null || !this.bottom && Byte2FloatRBTreeMap.this.compare(e2.key, this.from) < 0) {
                return null;
            }
            return e2;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k2) {
                ...
                if (!submap.bottom && submap.Byte2FloatRBTreeMap.this.compare(k2, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2FloatRBTreeMap.this.compare(k2, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2FloatRBTreeMap.this.locateKey(k2);
                if (submap.Byte2FloatRBTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(byte k2) {
            this.next = Byte2FloatRBTreeMap.this.locateKey(k2);
            if (this.next != null) {
                if (Byte2FloatRBTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
