...
public class Byte2FloatMaps {
    ...
    public static Byte2FloatMap synchronize(Byte2FloatMap m2) {
        return new SynchronizedMap(m2);
    }

    public static Byte2FloatMap synchronize(Byte2FloatMap m2, Object sync) {
        return new SynchronizedMap(m2, sync);
    }

    public static Byte2FloatMap unmodifiable(Byte2FloatMap m2) {
    ...
    Serializable {
        ...
        protected UnmodifiableMap(Byte2FloatMap m2) {
            super(m2);
            this.map = m2;
        }
    ...
    Serializable {
        ...
        protected SynchronizedMap(Byte2FloatMap m2, Object sync) {
            super(m2, sync);
            this.map = m2;
        }

        protected SynchronizedMap(Byte2FloatMap m2) {
            super(m2);
            this.map = m2;
        }
    ...
    Cloneable {
        ...
        Map.Entry<Byte, Float> {
            ...
            public boolean equals(Object o2) {
                ...
                return Singleton.this.key == (Byte)e2.getKey() && Singleton.this.value == ((Float)e2.getValue()).floatValue();
            }
