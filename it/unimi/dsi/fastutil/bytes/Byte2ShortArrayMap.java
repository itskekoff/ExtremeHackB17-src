...
Cloneable {
    ...
    public Byte2ShortArrayMap(Byte2ShortMap m2) {
        this(m2.size());
        this.putAll(m2);
    }

    public Byte2ShortArrayMap(Map<? extends Byte, ? extends Short> m2) {
        this(m2.size());
        this.putAll(m2);
    }
    ...
    public Byte2ShortArrayMap clone() {
        Byte2ShortArrayMap c2;
        try {
            c2 = (Byte2ShortArrayMap)super.clone();
        }
    ...
    implements Byte2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            return Byte2ShortArrayMap.this.containsKey(k2) && Byte2ShortArrayMap.this.get(k2) == ((Short)e2.getValue()).shortValue();
        }
        ...
        public boolean remove(Object o2) {
            ...
            int oldPos = Byte2ShortArrayMap.this.findKey(k2);
            if (oldPos == -1 || v2 != Byte2ShortArrayMap.this.value[oldPos]) {
                return false;
            }
