...
public class Byte2ByteMaps {
    ...
    public static Byte2ByteMap synchronize(Byte2ByteMap m2) {
        return new SynchronizedMap(m2);
    }

    public static Byte2ByteMap synchronize(Byte2ByteMap m2, Object sync) {
        return new SynchronizedMap(m2, sync);
    }

    public static Byte2ByteMap unmodifiable(Byte2ByteMap m2) {
    ...
    Serializable {
        ...
        protected UnmodifiableMap(Byte2ByteMap m2) {
            super(m2);
            this.map = m2;
        }
    ...
    Serializable {
        ...
        protected SynchronizedMap(Byte2ByteMap m2, Object sync) {
            super(m2, sync);
            this.map = m2;
        }

        protected SynchronizedMap(Byte2ByteMap m2) {
            super(m2);
            this.map = m2;
        }
    ...
    Cloneable {
        ...
        Map.Entry<Byte, Byte> {
            ...
            public boolean equals(Object o2) {
                ...
                return Singleton.this.key == (Byte)e2.getKey() && Singleton.this.value == (Byte)e2.getValue();
            }
