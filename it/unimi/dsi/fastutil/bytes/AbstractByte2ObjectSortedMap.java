...
implements Byte2ObjectSortedMap<V> {
    ...
    extends AbstractObjectCollection<V> {
        ...
        public boolean contains(Object k2) {
            return AbstractByte2ObjectSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractByteSortedSet {
        ...
        public boolean contains(byte k2) {
            return AbstractByte2ObjectSortedMap.this.containsKey(k2);
        }
        ...
        public ByteSortedSet headSet(byte to2) {
            return AbstractByte2ObjectSortedMap.this.headMap(to2).keySet();
        }
        ...
        public ByteSortedSet subSet(byte from, byte to2) {
            return AbstractByte2ObjectSortedMap.this.subMap(from, to2).keySet();
        }
