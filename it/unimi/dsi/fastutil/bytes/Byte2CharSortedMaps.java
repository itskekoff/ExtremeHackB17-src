...
public class Byte2CharSortedMaps {
    ...
    public static Byte2CharSortedMap synchronize(Byte2CharSortedMap m2) {
        return new SynchronizedSortedMap(m2);
    }

    public static Byte2CharSortedMap synchronize(Byte2CharSortedMap m2, Object sync) {
        return new SynchronizedSortedMap(m2, sync);
    }

    public static Byte2CharSortedMap unmodifiable(Byte2CharSortedMap m2) {
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Byte2CharSortedMap m2) {
            super(m2);
            this.sortedMap = m2;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Byte2CharSortedMap m2, Object sync) {
            super(m2, sync);
            this.sortedMap = m2;
        }

        protected SynchronizedSortedMap(Byte2CharSortedMap m2) {
            super(m2);
            this.sortedMap = m2;
        }
