...
implements Byte2CharSortedMap {
    ...
    extends AbstractCharIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Character>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharCollection {
        ...
        public boolean contains(char k2) {
            return AbstractByte2CharSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractByteBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Character>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractByteSortedSet {
        ...
        public boolean contains(byte k2) {
            return AbstractByte2CharSortedMap.this.containsKey(k2);
        }
        ...
        public ByteSortedSet headSet(byte to2) {
            return AbstractByte2CharSortedMap.this.headMap(to2).keySet();
        }
        ...
        public ByteSortedSet subSet(byte from, byte to2) {
            return AbstractByte2CharSortedMap.this.subMap(from, to2).keySet();
        }
