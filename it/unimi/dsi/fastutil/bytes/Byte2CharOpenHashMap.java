...
Hash {
    ...
    public Byte2CharOpenHashMap(int expected, float f2) {
        if (f2 <= 0.0f || f2 > 1.0f) {
    ...
    public Byte2CharOpenHashMap(Map<? extends Byte, ? extends Character> m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Byte2CharOpenHashMap(Map<? extends Byte, ? extends Character> m2) {
        this(m2, 0.75f);
    }

    public Byte2CharOpenHashMap(Byte2CharMap m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Byte2CharOpenHashMap(Byte2CharMap m2) {
        this(m2, 0.75f);
    }

    public Byte2CharOpenHashMap(byte[] k2, char[] v2, float f2) {
        this(k2.length, f2);
    ...
    public Byte2CharOpenHashMap(byte[] k2, char[] v2) {
        this(k2, v2, 0.75f);
    }
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public boolean contains(char v2) {
                    return Byte2CharOpenHashMap.this.containsValue(v2);
                }
    ...
    public Byte2CharOpenHashMap clone() {
        Byte2CharOpenHashMap c2;
        try {
            c2 = (Byte2CharOpenHashMap)super.clone();
        }
    ...
    extends AbstractByteSet {
        ...
        public boolean contains(byte k2) {
            return Byte2CharOpenHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(byte k2) {
            int oldSize = Byte2CharOpenHashMap.this.size;
            Byte2CharOpenHashMap.this.remove(k2);
    ...
    implements Byte2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (k2 == 0) {
                return Byte2CharOpenHashMap.this.containsNullKey && Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n] == v2;
            }
            byte[] key = Byte2CharOpenHashMap.this.key;
            int pos = HashCommon.mix(k2) & Byte2CharOpenHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            if (k2 == curr) {
                return Byte2CharOpenHashMap.this.value[pos] == v2;
            }
            do {
        ...
        public boolean rem(Object o2) {
            ...
            char v2 = ((Character)e2.getValue()).charValue();
            if (k2 == 0) {
                if (Byte2CharOpenHashMap.this.containsNullKey && Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.n] == v2) {
            ...
            if (curr == k2) {
                if (Byte2CharOpenHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2CharOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k2 || Byte2CharOpenHashMap.this.value[pos] != v2);
            Byte2CharOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(k2) & Byte2CharOpenHashMap.this.mask;
                while (k2 != key[p2]) {
                    p2 = p2 + 1 & Byte2CharOpenHashMap.this.mask;
                }
                return p2;
    ...
    Map.Entry<Byte, Character> {
        ...
        public char setValue(char v2) {
            ...
            Byte2CharOpenHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Byte2CharOpenHashMap.this.key[this.index] == (Byte)e2.getKey() && Byte2CharOpenHashMap.this.value[this.index] == ((Character)e2.getValue()).charValue();
        }
