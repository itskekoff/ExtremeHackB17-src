...
implements Byte2ReferenceSortedMap<V> {
    ...
    extends AbstractObjectIterator<V> {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Byte, V>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractReferenceCollection<V> {
        ...
        public boolean contains(Object k2) {
            return AbstractByte2ReferenceSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractByteBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Byte, V>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractByteSortedSet {
        ...
        public boolean contains(byte k2) {
            return AbstractByte2ReferenceSortedMap.this.containsKey(k2);
        }
        ...
        public ByteSortedSet headSet(byte to2) {
            return AbstractByte2ReferenceSortedMap.this.headMap(to2).keySet();
        }
        ...
        public ByteSortedSet subSet(byte from, byte to2) {
            return AbstractByte2ReferenceSortedMap.this.subMap(from, to2).keySet();
        }
