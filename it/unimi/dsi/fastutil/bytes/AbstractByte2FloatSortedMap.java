...
implements Byte2FloatSortedMap {
    ...
    extends AbstractFloatIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Float>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractFloatCollection {
        ...
        public boolean contains(float k2) {
            return AbstractByte2FloatSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractByteBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Float>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractByteSortedSet {
        ...
        public boolean contains(byte k2) {
            return AbstractByte2FloatSortedMap.this.containsKey(k2);
        }
        ...
        public ByteSortedSet headSet(byte to2) {
            return AbstractByte2FloatSortedMap.this.headMap(to2).keySet();
        }
        ...
        public ByteSortedSet subSet(byte from, byte to2) {
            return AbstractByte2FloatSortedMap.this.subMap(from, to2).keySet();
        }
