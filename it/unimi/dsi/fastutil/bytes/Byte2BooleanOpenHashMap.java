...
Hash {
    ...
    public Byte2BooleanOpenHashMap(int expected, float f2) {
        if (f2 <= 0.0f || f2 > 1.0f) {
    ...
    public Byte2BooleanOpenHashMap(Map<? extends Byte, ? extends Boolean> m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Byte2BooleanOpenHashMap(Map<? extends Byte, ? extends Boolean> m2) {
        this(m2, 0.75f);
    }

    public Byte2BooleanOpenHashMap(Byte2BooleanMap m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Byte2BooleanOpenHashMap(Byte2BooleanMap m2) {
        this(m2, 0.75f);
    }

    public Byte2BooleanOpenHashMap(byte[] k2, boolean[] v2, float f2) {
        this(k2.length, f2);
    ...
    public Byte2BooleanOpenHashMap(byte[] k2, boolean[] v2) {
        this(k2, v2, 0.75f);
    }
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public boolean contains(boolean v2) {
                    return Byte2BooleanOpenHashMap.this.containsValue(v2);
                }
    ...
    public Byte2BooleanOpenHashMap clone() {
        Byte2BooleanOpenHashMap c2;
        try {
            c2 = (Byte2BooleanOpenHashMap)super.clone();
        }
    ...
    extends AbstractByteSet {
        ...
        public boolean contains(byte k2) {
            return Byte2BooleanOpenHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(byte k2) {
            int oldSize = Byte2BooleanOpenHashMap.this.size;
            Byte2BooleanOpenHashMap.this.remove(k2);
    ...
    implements Byte2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (k2 == 0) {
                return Byte2BooleanOpenHashMap.this.containsNullKey && Byte2BooleanOpenHashMap.this.value[Byte2BooleanOpenHashMap.this.n] == v2;
            }
            byte[] key = Byte2BooleanOpenHashMap.this.key;
            int pos = HashCommon.mix(k2) & Byte2BooleanOpenHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            if (k2 == curr) {
                return Byte2BooleanOpenHashMap.this.value[pos] == v2;
            }
            do {
        ...
        public boolean rem(Object o2) {
            ...
            boolean v2 = (Boolean)e2.getValue();
            if (k2 == 0) {
                if (Byte2BooleanOpenHashMap.this.containsNullKey && Byte2BooleanOpenHashMap.this.value[Byte2BooleanOpenHashMap.this.n] == v2) {
            ...
            if (curr == k2) {
                if (Byte2BooleanOpenHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2BooleanOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k2 || Byte2BooleanOpenHashMap.this.value[pos] != v2);
            Byte2BooleanOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(k2) & Byte2BooleanOpenHashMap.this.mask;
                while (k2 != key[p2]) {
                    p2 = p2 + 1 & Byte2BooleanOpenHashMap.this.mask;
                }
                return p2;
    ...
    Map.Entry<Byte, Boolean> {
        ...
        public boolean setValue(boolean v2) {
            ...
            Byte2BooleanOpenHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Byte2BooleanOpenHashMap.this.key[this.index] == (Byte)e2.getKey() && Byte2BooleanOpenHashMap.this.value[this.index] == (Boolean)e2.getValue();
        }
