...
Hash {
    ...
    public Byte2ReferenceOpenCustomHashMap(int expected, float f2, ByteHash.Strategy strategy) {
    ...
    public Byte2ReferenceOpenCustomHashMap(Map<? extends Byte, ? extends V> m2, float f2, ByteHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Byte2ReferenceOpenCustomHashMap(Map<? extends Byte, ? extends V> m2, ByteHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Byte2ReferenceOpenCustomHashMap(Byte2ReferenceMap<V> m2, float f2, ByteHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Byte2ReferenceOpenCustomHashMap(Byte2ReferenceMap<V> m2, ByteHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Byte2ReferenceOpenCustomHashMap(byte[] k2, V[] v2, float f2, ByteHash.Strategy strategy) {
    ...
    public Byte2ReferenceOpenCustomHashMap(byte[] k2, V[] v2, ByteHash.Strategy strategy) {
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(){
                ...
                public boolean contains(Object v2) {
                    return Byte2ReferenceOpenCustomHashMap.this.containsValue(v2);
                }
    ...
    public Byte2ReferenceOpenCustomHashMap<V> clone() {
        Byte2ReferenceOpenCustomHashMap c2;
        try {
            c2 = (Byte2ReferenceOpenCustomHashMap)super.clone();
        }
    ...
    public int hashCode() {
        ...
        while (j2-- != 0) {
            ...
            if (this != this.value[i2]) {
                t2 ^= this.value[i2] == null ? 0 : System.identityHashCode(this.value[i2]);
            }
            h2 += t2;
            ++i2;
        }
        if (this.containsNullKey) {
            h2 += this.value[this.n] == null ? 0 : System.identityHashCode(this.value[this.n]);
        }
        return h2;
    }
    ...
    extends AbstractByteSet {
        ...
        public boolean contains(byte k2) {
            return Byte2ReferenceOpenCustomHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(byte k2) {
            int oldSize = Byte2ReferenceOpenCustomHashMap.this.size;
            Byte2ReferenceOpenCustomHashMap.this.remove(k2);
    ...
    implements Byte2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o2) {
            ...
            if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k2, (byte)0)) {
                return Byte2ReferenceOpenCustomHashMap.this.containsNullKey && Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n] == v2;
            }
            byte[] key = Byte2ReferenceOpenCustomHashMap.this.key;
            int pos = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(k2)) & Byte2ReferenceOpenCustomHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k2, curr)) {
                return Byte2ReferenceOpenCustomHashMap.this.value[pos] == v2;
            }
            do {
                if ((curr = key[pos = pos + 1 & Byte2ReferenceOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k2, curr));
            return Byte2ReferenceOpenCustomHashMap.this.value[pos] == v2;
        }
        ...
        public boolean rem(Object o2) {
            ...
            Object v2 = e2.getValue();
            if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k2, (byte)0)) {
                if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey && Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n] == v2) {
            ...
            if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k2)) {
                if (Byte2ReferenceOpenCustomHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2ReferenceOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k2) || Byte2ReferenceOpenCustomHashMap.this.value[pos] != v2);
            Byte2ReferenceOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(k2)) & Byte2ReferenceOpenCustomHashMap.this.mask;
                while (!Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k2, key[p2])) {
                    p2 = p2 + 1 & Byte2ReferenceOpenCustomHashMap.this.mask;
                }
                return p2;
    ...
    Map.Entry<Byte, V> {
        ...
        public V setValue(V v2) {
            ...
            Byte2ReferenceOpenCustomHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Byte2ReferenceOpenCustomHashMap.this.strategy.equals(Byte2ReferenceOpenCustomHashMap.this.key[this.index], (Byte)e2.getKey()) && Byte2ReferenceOpenCustomHashMap.this.value[this.index] == e2.getValue();
        }
