...
implements Byte2DoubleSortedMap {
    ...
    extends AbstractDoubleIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Double>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractDoubleCollection {
        ...
        public boolean contains(double k2) {
            return AbstractByte2DoubleSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractByteBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Double>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractByteSortedSet {
        ...
        public boolean contains(byte k2) {
            return AbstractByte2DoubleSortedMap.this.containsKey(k2);
        }
        ...
        public ByteSortedSet headSet(byte to2) {
            return AbstractByte2DoubleSortedMap.this.headMap(to2).keySet();
        }
        ...
        public ByteSortedSet subSet(byte from, byte to2) {
            return AbstractByte2DoubleSortedMap.this.subMap(from, to2).keySet();
        }
