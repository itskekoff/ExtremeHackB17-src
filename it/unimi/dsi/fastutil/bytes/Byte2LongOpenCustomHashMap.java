...
Hash {
    ...
    public Byte2LongOpenCustomHashMap(int expected, float f2, ByteHash.Strategy strategy) {
    ...
    public Byte2LongOpenCustomHashMap(Map<? extends Byte, ? extends Long> m2, float f2, ByteHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Byte2LongOpenCustomHashMap(Map<? extends Byte, ? extends Long> m2, ByteHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Byte2LongOpenCustomHashMap(Byte2LongMap m2, float f2, ByteHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Byte2LongOpenCustomHashMap(Byte2LongMap m2, ByteHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Byte2LongOpenCustomHashMap(byte[] k2, long[] v2, float f2, ByteHash.Strategy strategy) {
    ...
    public Byte2LongOpenCustomHashMap(byte[] k2, long[] v2, ByteHash.Strategy strategy) {
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection(){
                ...
                public boolean contains(long v2) {
                    return Byte2LongOpenCustomHashMap.this.containsValue(v2);
                }
    ...
    public Byte2LongOpenCustomHashMap clone() {
        Byte2LongOpenCustomHashMap c2;
        try {
            c2 = (Byte2LongOpenCustomHashMap)super.clone();
        }
    ...
    extends AbstractByteSet {
        ...
        public boolean contains(byte k2) {
            return Byte2LongOpenCustomHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(byte k2) {
            int oldSize = Byte2LongOpenCustomHashMap.this.size;
            Byte2LongOpenCustomHashMap.this.remove(k2);
    ...
    implements Byte2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (Byte2LongOpenCustomHashMap.this.strategy.equals(k2, (byte)0)) {
                return Byte2LongOpenCustomHashMap.this.containsNullKey && Byte2LongOpenCustomHashMap.this.value[Byte2LongOpenCustomHashMap.this.n] == v2;
            }
            byte[] key = Byte2LongOpenCustomHashMap.this.key;
            int pos = HashCommon.mix(Byte2LongOpenCustomHashMap.this.strategy.hashCode(k2)) & Byte2LongOpenCustomHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            if (Byte2LongOpenCustomHashMap.this.strategy.equals(k2, curr)) {
                return Byte2LongOpenCustomHashMap.this.value[pos] == v2;
            }
            do {
                if ((curr = key[pos = pos + 1 & Byte2LongOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2LongOpenCustomHashMap.this.strategy.equals(k2, curr));
            return Byte2LongOpenCustomHashMap.this.value[pos] == v2;
        }
        ...
        public boolean rem(Object o2) {
            ...
            long v2 = (Long)e2.getValue();
            if (Byte2LongOpenCustomHashMap.this.strategy.equals(k2, (byte)0)) {
                if (Byte2LongOpenCustomHashMap.this.containsNullKey && Byte2LongOpenCustomHashMap.this.value[Byte2LongOpenCustomHashMap.this.n] == v2) {
            ...
            if (Byte2LongOpenCustomHashMap.this.strategy.equals(curr, k2)) {
                if (Byte2LongOpenCustomHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2LongOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2LongOpenCustomHashMap.this.strategy.equals(curr, k2) || Byte2LongOpenCustomHashMap.this.value[pos] != v2);
            Byte2LongOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(Byte2LongOpenCustomHashMap.this.strategy.hashCode(k2)) & Byte2LongOpenCustomHashMap.this.mask;
                while (!Byte2LongOpenCustomHashMap.this.strategy.equals(k2, key[p2])) {
                    p2 = p2 + 1 & Byte2LongOpenCustomHashMap.this.mask;
                }
                return p2;
    ...
    Map.Entry<Byte, Long> {
        ...
        public long setValue(long v2) {
            ...
            Byte2LongOpenCustomHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Byte2LongOpenCustomHashMap.this.strategy.equals(Byte2LongOpenCustomHashMap.this.key[this.index], (Byte)e2.getKey()) && Byte2LongOpenCustomHashMap.this.value[this.index] == (Long)e2.getValue();
        }
