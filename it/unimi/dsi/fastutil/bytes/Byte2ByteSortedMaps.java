...
public class Byte2ByteSortedMaps {
    ...
    public static Byte2ByteSortedMap synchronize(Byte2ByteSortedMap m2) {
        return new SynchronizedSortedMap(m2);
    }

    public static Byte2ByteSortedMap synchronize(Byte2ByteSortedMap m2, Object sync) {
        return new SynchronizedSortedMap(m2, sync);
    }

    public static Byte2ByteSortedMap unmodifiable(Byte2ByteSortedMap m2) {
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Byte2ByteSortedMap m2) {
            super(m2);
            this.sortedMap = m2;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Byte2ByteSortedMap m2, Object sync) {
            super(m2, sync);
            this.sortedMap = m2;
        }

        protected SynchronizedSortedMap(Byte2ByteSortedMap m2) {
            super(m2);
            this.sortedMap = m2;
        }
