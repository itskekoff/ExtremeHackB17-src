...
Cloneable {
    ...
    public Byte2ShortRBTreeMap(Comparator<? super Byte> c2) {
        this();
        this.storedComparator = c2;
        this.setActualComparator();
    }

    public Byte2ShortRBTreeMap(Map<? extends Byte, ? extends Short> m2) {
        this();
        this.putAll(m2);
    }

    public Byte2ShortRBTreeMap(SortedMap<Byte, Short> m2) {
        this(m2.comparator());
        this.putAll((Map<? extends Byte, ? extends Short>)m2);
    }

    public Byte2ShortRBTreeMap(Byte2ShortMap m2) {
        this();
        this.putAll(m2);
    }

    public Byte2ShortRBTreeMap(Byte2ShortSortedMap m2) {
        this(m2.comparator());
        this.putAll(m2);
    }

    public Byte2ShortRBTreeMap(byte[] k2, short[] v2, Comparator<? super Byte> c2) {
        this(c2);
    ...
    public Byte2ShortRBTreeMap(byte[] k2, short[] v2) {
        this(k2, v2, null);
    }
...
lbl160:
            ...
            this.entries = new AbstractObjectSortedSet<Byte2ShortMap.Entry>(){
                final Comparator<? super Byte2ShortMap.Entry> comparator = new Comparator<Byte2ShortMap.Entry>(){
                    ...
                    public int compare(Byte2ShortMap.Entry x2, Byte2ShortMap.Entry y2) {
                        return Byte2ShortRBTreeMap.this.actualComparator.compare(x2.getByteKey(), y2.getByteKey());
                    }
                };
                ...
                public boolean contains(Object o2) {
                    ...
                    Entry f2 = Byte2ShortRBTreeMap.this.findKey((Byte)e2.getKey());
                    return e2.equals(f2);
                }
                ...
                public boolean remove(Object o2) {
                    ...
                    Entry f2 = Byte2ShortRBTreeMap.this.findKey((Byte)e2.getKey());
                    if (f2 != null) {
                        Byte2ShortRBTreeMap.this.remove(f2.key);
                    }
                    return f2 != null;
                }
                ...
                public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry to2) {
                    return Byte2ShortRBTreeMap.this.subMap(from.getByteKey(), to2.getByteKey()).byte2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry to2) {
                    return Byte2ShortRBTreeMap.this.headMap(to2.getByteKey()).byte2ShortEntrySet();
                }
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection(){
                ...
                public boolean contains(short k2) {
                    return Byte2ShortRBTreeMap.this.containsValue(k2);
                }
    ...
    public Byte2ShortRBTreeMap clone() {
        Byte2ShortRBTreeMap c2;
        try {
            c2 = (Byte2ShortRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Submap(byte from, boolean bottom, byte to2, boolean top) {
            if (!bottom && !top && Byte2ShortRBTreeMap.this.compare(from, to2) > 0) {
        ...
        final boolean in(byte k2) {
            return !(!this.bottom && Byte2ShortRBTreeMap.this.compare(k2, this.from) < 0 || !this.top && Byte2ShortRBTreeMap.this.compare(k2, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(byte k2) {
            return this.in(k2) && Byte2ShortRBTreeMap.this.containsKey(k2);
        }
        ...
        public short get(byte k2) {
            Entry e2;
            byte kk2 = k2;
            return this.in(kk2) && (e2 = Byte2ShortRBTreeMap.this.findKey(kk2)) != null ? e2.value : this.defRetValue;
        }
        ...
        public short put(byte k2, short v2) {
            ...
            short oldValue = Byte2ShortRBTreeMap.this.put(k2, v2);
        ...
        public short remove(byte k2) {
            ...
            short oldValue = Byte2ShortRBTreeMap.this.remove(k2);
        ...
        public Byte2ShortSortedMap headMap(byte to2) {
            ...
            return Byte2ShortRBTreeMap.this.compare(to2, this.to) < 0 ? new Submap(this.from, this.bottom, to2, false) : this;
        }
        ...
        public Byte2ShortSortedMap subMap(byte from, byte to2) {
            ...
            if (!this.top) {
                byte by2 = to2 = Byte2ShortRBTreeMap.this.compare(to2, this.to) < 0 ? to2 : this.to;
            }
            if (!this.bottom) {
                byte by3 = from = Byte2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e2 = Byte2ShortRBTreeMap.this.firstEntry;
            } else {
                e2 = Byte2ShortRBTreeMap.this.locateKey(this.from);
                if (Byte2ShortRBTreeMap.this.compare(e2.key, this.from) < 0) {
                    e2 = e2.next();
                }
            }
            if (e2 == null || !this.top && Byte2ShortRBTreeMap.this.compare(e2.key, this.to) >= 0) {
                return null;
            }
            return e2;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e2 = Byte2ShortRBTreeMap.this.lastEntry;
            } else {
                e2 = Byte2ShortRBTreeMap.this.locateKey(this.to);
                if (Byte2ShortRBTreeMap.this.compare(e2.key, this.to) >= 0) {
                    e2 = e2.prev();
                }
            }
            if (e2 == null || !this.bottom && Byte2ShortRBTreeMap.this.compare(e2.key, this.from) < 0) {
                return null;
            }
            return e2;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k2) {
                ...
                if (!submap.bottom && submap.Byte2ShortRBTreeMap.this.compare(k2, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2ShortRBTreeMap.this.compare(k2, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2ShortRBTreeMap.this.locateKey(k2);
                if (submap.Byte2ShortRBTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(byte k2) {
            this.next = Byte2ShortRBTreeMap.this.locateKey(k2);
            if (this.next != null) {
                if (Byte2ShortRBTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
