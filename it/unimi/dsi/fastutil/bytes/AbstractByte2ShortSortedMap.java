...
implements Byte2ShortSortedMap {
    ...
    extends AbstractShortIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Short>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractShortCollection {
        ...
        public boolean contains(short k2) {
            return AbstractByte2ShortSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractByteBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Short>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractByteSortedSet {
        ...
        public boolean contains(byte k2) {
            return AbstractByte2ShortSortedMap.this.containsKey(k2);
        }
        ...
        public ByteSortedSet headSet(byte to2) {
            return AbstractByte2ShortSortedMap.this.headMap(to2).keySet();
        }
        ...
        public ByteSortedSet subSet(byte from, byte to2) {
            return AbstractByte2ShortSortedMap.this.subMap(from, to2).keySet();
        }
