...
Hash {
    ...
    public Byte2ByteOpenHashMap(int expected, float f2) {
        if (f2 <= 0.0f || f2 > 1.0f) {
    ...
    public Byte2ByteOpenHashMap(Map<? extends Byte, ? extends Byte> m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Byte2ByteOpenHashMap(Map<? extends Byte, ? extends Byte> m2) {
        this(m2, 0.75f);
    }

    public Byte2ByteOpenHashMap(Byte2ByteMap m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Byte2ByteOpenHashMap(Byte2ByteMap m2) {
        this(m2, 0.75f);
    }

    public Byte2ByteOpenHashMap(byte[] k2, byte[] v2, float f2) {
        this(k2.length, f2);
    ...
    public Byte2ByteOpenHashMap(byte[] k2, byte[] v2) {
        this(k2, v2, 0.75f);
    }
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public boolean contains(byte v2) {
                    return Byte2ByteOpenHashMap.this.containsValue(v2);
                }
    ...
    public Byte2ByteOpenHashMap clone() {
        Byte2ByteOpenHashMap c2;
        try {
            c2 = (Byte2ByteOpenHashMap)super.clone();
        }
    ...
    extends AbstractByteSet {
        ...
        public boolean contains(byte k2) {
            return Byte2ByteOpenHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(byte k2) {
            int oldSize = Byte2ByteOpenHashMap.this.size;
            Byte2ByteOpenHashMap.this.remove(k2);
    ...
    implements Byte2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (k2 == 0) {
                return Byte2ByteOpenHashMap.this.containsNullKey && Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n] == v2;
            }
            byte[] key = Byte2ByteOpenHashMap.this.key;
            int pos = HashCommon.mix(k2) & Byte2ByteOpenHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            if (k2 == curr) {
                return Byte2ByteOpenHashMap.this.value[pos] == v2;
            }
            do {
        ...
        public boolean rem(Object o2) {
            ...
            byte v2 = (Byte)e2.getValue();
            if (k2 == 0) {
                if (Byte2ByteOpenHashMap.this.containsNullKey && Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n] == v2) {
            ...
            if (curr == k2) {
                if (Byte2ByteOpenHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2ByteOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k2 || Byte2ByteOpenHashMap.this.value[pos] != v2);
            Byte2ByteOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(k2) & Byte2ByteOpenHashMap.this.mask;
                while (k2 != key[p2]) {
                    p2 = p2 + 1 & Byte2ByteOpenHashMap.this.mask;
                }
                return p2;
    ...
    Map.Entry<Byte, Byte> {
        ...
        public byte setValue(byte v2) {
            ...
            Byte2ByteOpenHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Byte2ByteOpenHashMap.this.key[this.index] == (Byte)e2.getKey() && Byte2ByteOpenHashMap.this.value[this.index] == (Byte)e2.getValue();
        }
