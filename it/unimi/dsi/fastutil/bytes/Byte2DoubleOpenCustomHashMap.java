...
Hash {
    ...
    public Byte2DoubleOpenCustomHashMap(int expected, float f2, ByteHash.Strategy strategy) {
    ...
    public Byte2DoubleOpenCustomHashMap(Map<? extends Byte, ? extends Double> m2, float f2, ByteHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Byte2DoubleOpenCustomHashMap(Map<? extends Byte, ? extends Double> m2, ByteHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Byte2DoubleOpenCustomHashMap(Byte2DoubleMap m2, float f2, ByteHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Byte2DoubleOpenCustomHashMap(Byte2DoubleMap m2, ByteHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Byte2DoubleOpenCustomHashMap(byte[] k2, double[] v2, float f2, ByteHash.Strategy strategy) {
    ...
    public Byte2DoubleOpenCustomHashMap(byte[] k2, double[] v2, ByteHash.Strategy strategy) {
    ...
    private int insert(byte k2, double v2) {
        int pos;
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public boolean contains(double v2) {
                    return Byte2DoubleOpenCustomHashMap.this.containsValue(v2);
                }
    ...
    public Byte2DoubleOpenCustomHashMap clone() {
        Byte2DoubleOpenCustomHashMap c2;
        try {
            c2 = (Byte2DoubleOpenCustomHashMap)super.clone();
        }
    ...
    extends AbstractByteSet {
        ...
        public boolean contains(byte k2) {
            return Byte2DoubleOpenCustomHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(byte k2) {
            int oldSize = Byte2DoubleOpenCustomHashMap.this.size;
            Byte2DoubleOpenCustomHashMap.this.remove(k2);
    ...
    implements Byte2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k2, (byte)0)) {
                return Byte2DoubleOpenCustomHashMap.this.containsNullKey && Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n] == v2;
            }
            byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
            int pos = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k2)) & Byte2DoubleOpenCustomHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k2, curr)) {
                return Byte2DoubleOpenCustomHashMap.this.value[pos] == v2;
            }
            do {
                if ((curr = key[pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2DoubleOpenCustomHashMap.this.strategy.equals(k2, curr));
            return Byte2DoubleOpenCustomHashMap.this.value[pos] == v2;
        }
        ...
        public boolean rem(Object o2) {
            ...
            double v2 = (Double)e2.getValue();
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k2, (byte)0)) {
                if (Byte2DoubleOpenCustomHashMap.this.containsNullKey && Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n] == v2) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k2)) {
                if (Byte2DoubleOpenCustomHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k2) || Byte2DoubleOpenCustomHashMap.this.value[pos] != v2);
            Byte2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k2)) & Byte2DoubleOpenCustomHashMap.this.mask;
                while (!Byte2DoubleOpenCustomHashMap.this.strategy.equals(k2, key[p2])) {
                    p2 = p2 + 1 & Byte2DoubleOpenCustomHashMap.this.mask;
                }
                return p2;
    ...
    Map.Entry<Byte, Double> {
        ...
        public double setValue(double v2) {
            ...
            Byte2DoubleOpenCustomHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[this.index], (Byte)e2.getKey()) && Byte2DoubleOpenCustomHashMap.this.value[this.index] == (Double)e2.getValue();
        }
