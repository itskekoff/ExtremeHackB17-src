...
public class Byte2ObjectSortedMaps {
    ...
    public static <V> Byte2ObjectSortedMap<V> synchronize(Byte2ObjectSortedMap<V> m2) {
        return new SynchronizedSortedMap<V>(m2);
    }

    public static <V> Byte2ObjectSortedMap<V> synchronize(Byte2ObjectSortedMap<V> m2, Object sync) {
        return new SynchronizedSortedMap<V>(m2, sync);
    }

    public static <V> Byte2ObjectSortedMap<V> unmodifiable(Byte2ObjectSortedMap<V> m2) {
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Byte2ObjectSortedMap<V> m2) {
            super(m2);
            this.sortedMap = m2;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Byte2ObjectSortedMap<V> m2, Object sync) {
            super(m2, sync);
            this.sortedMap = m2;
        }

        protected SynchronizedSortedMap(Byte2ObjectSortedMap<V> m2) {
            super(m2);
            this.sortedMap = m2;
        }
