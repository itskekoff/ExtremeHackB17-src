...
public class Byte2ReferenceSortedMaps {
    ...
    public static <V> Byte2ReferenceSortedMap<V> synchronize(Byte2ReferenceSortedMap<V> m2) {
        return new SynchronizedSortedMap<V>(m2);
    }

    public static <V> Byte2ReferenceSortedMap<V> synchronize(Byte2ReferenceSortedMap<V> m2, Object sync) {
        return new SynchronizedSortedMap<V>(m2, sync);
    }

    public static <V> Byte2ReferenceSortedMap<V> unmodifiable(Byte2ReferenceSortedMap<V> m2) {
        return new UnmodifiableSortedMap<V>(m2);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Byte2ReferenceSortedMap<V> m2) {
            super(m2);
            this.sortedMap = m2;
        }
        ...
        public Byte2ReferenceSortedMap<V> subMap(byte from, byte to2) {
            return new UnmodifiableSortedMap<V>(this.sortedMap.subMap(from, to2));
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Byte2ReferenceSortedMap<V> m2, Object sync) {
            super(m2, sync);
            this.sortedMap = m2;
        }

        protected SynchronizedSortedMap(Byte2ReferenceSortedMap<V> m2) {
            super(m2);
            this.sortedMap = m2;
        }
        ...
        @Override
        public Byte2ReferenceSortedMap<V> subMap(byte from, byte to2) {
            return new SynchronizedSortedMap<V>(this.sortedMap.subMap(from, to2), this.sync);
        }
