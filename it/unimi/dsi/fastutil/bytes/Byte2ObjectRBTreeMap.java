...
Cloneable {
    ...
    public Byte2ObjectRBTreeMap(Comparator<? super Byte> c2) {
        this();
        this.storedComparator = c2;
    }

    public Byte2ObjectRBTreeMap(Map<? extends Byte, ? extends V> m2) {
        this();
        this.putAll((Map<Byte, ? extends V>)m2);
    }

    public Byte2ObjectRBTreeMap(SortedMap<Byte, V> m2) {
        this(m2.comparator());
        this.putAll((Map<Byte, V>)m2);
    }

    public Byte2ObjectRBTreeMap(Byte2ObjectMap<? extends V> m2) {
        this();
        this.putAll(m2);
    }

    public Byte2ObjectRBTreeMap(Byte2ObjectSortedMap<V> m2) {
        this(m2.comparator());
        this.putAll(m2);
    }

    public Byte2ObjectRBTreeMap(byte[] k2, V[] v2, Comparator<? super Byte> c2) {
        this(c2);
    ...
    public Byte2ObjectRBTreeMap(byte[] k2, V[] v2) {
        this(k2, v2, null);
    }
...
lbl161:
            ...
            this.entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>(){
                final Comparator<? super Byte2ObjectMap.Entry<V>> comparator = new Comparator<Byte2ObjectMap.Entry<V>>(){
                    ...
                    public int compare(Byte2ObjectMap.Entry<V> x2, Byte2ObjectMap.Entry<V> y2) {
                        return Byte2ObjectRBTreeMap.this.actualComparator.compare(x2.getByteKey(), y2.getByteKey());
                    }
                };
                ...
                public boolean contains(Object o2) {
                    ...
                    Entry f2 = Byte2ObjectRBTreeMap.this.findKey((Byte)e2.getKey());
                    return e2.equals(f2);
                }
                ...
                public boolean remove(Object o2) {
                    ...
                    Entry f2 = Byte2ObjectRBTreeMap.this.findKey((Byte)e2.getKey());
                    if (f2 != null) {
                        Byte2ObjectRBTreeMap.this.remove(f2.key);
                    }
                    return f2 != null;
                }
                ...
                public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from, Byte2ObjectMap.Entry<V> to2) {
                    return Byte2ObjectRBTreeMap.this.subMap(from.getByteKey(), to2.getByteKey()).byte2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> to2) {
                    return Byte2ObjectRBTreeMap.this.headMap(to2.getByteKey()).byte2ObjectEntrySet();
                }
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public boolean contains(Object k2) {
                    return Byte2ObjectRBTreeMap.this.containsValue(k2);
                }
    ...
    public Byte2ObjectRBTreeMap<V> clone() {
        Byte2ObjectRBTreeMap c2;
        try {
            c2 = (Byte2ObjectRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Submap(byte from, boolean bottom, byte to2, boolean top) {
            if (!bottom && !top && Byte2ObjectRBTreeMap.this.compare(from, to2) > 0) {
        ...
        final boolean in(byte k2) {
            return !(!this.bottom && Byte2ObjectRBTreeMap.this.compare(k2, this.from) < 0 || !this.top && Byte2ObjectRBTreeMap.this.compare(k2, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(byte k2) {
            return this.in(k2) && Byte2ObjectRBTreeMap.this.containsKey(k2);
        }
        ...
        public V get(byte k2) {
            Entry e2;
            byte kk2 = k2;
            return this.in(kk2) && (e2 = Byte2ObjectRBTreeMap.this.findKey(kk2)) != null ? e2.value : this.defRetValue;
        }
        ...
        public V put(byte k2, V v2) {
            ...
            Object oldValue = Byte2ObjectRBTreeMap.this.put(k2, v2);
        ...
        public V remove(byte k2) {
            ...
            Object oldValue = Byte2ObjectRBTreeMap.this.remove(k2);
        ...
        public Byte2ObjectSortedMap<V> headMap(byte to2) {
            ...
            return Byte2ObjectRBTreeMap.this.compare(to2, this.to) < 0 ? new Submap(this.from, this.bottom, to2, false) : this;
        }
        ...
        public Byte2ObjectSortedMap<V> subMap(byte from, byte to2) {
            ...
            if (!this.top) {
                byte by2 = to2 = Byte2ObjectRBTreeMap.this.compare(to2, this.to) < 0 ? to2 : this.to;
            }
            if (!this.bottom) {
                byte by3 = from = Byte2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.bottom) {
                e2 = Byte2ObjectRBTreeMap.this.firstEntry;
            } else {
                e2 = Byte2ObjectRBTreeMap.this.locateKey(this.from);
                if (Byte2ObjectRBTreeMap.this.compare(e2.key, this.from) < 0) {
                    e2 = e2.next();
                }
            }
            if (e2 == null || !this.top && Byte2ObjectRBTreeMap.this.compare(e2.key, this.to) >= 0) {
                return null;
            }
            return e2;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                e2 = Byte2ObjectRBTreeMap.this.lastEntry;
            } else {
                e2 = Byte2ObjectRBTreeMap.this.locateKey(this.to);
                if (Byte2ObjectRBTreeMap.this.compare(e2.key, this.to) >= 0) {
                    e2 = e2.prev();
                }
            }
            if (e2 == null || !this.bottom && Byte2ObjectRBTreeMap.this.compare(e2.key, this.from) < 0) {
                return null;
            }
            return e2;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k2) {
                ...
                if (!submap.bottom && submap.Byte2ObjectRBTreeMap.this.compare(k2, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2ObjectRBTreeMap.this.compare(k2, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2ObjectRBTreeMap.this.locateKey(k2);
                if (submap.Byte2ObjectRBTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(byte k2) {
            this.next = Byte2ObjectRBTreeMap.this.locateKey(k2);
            if (this.next != null) {
                if (Byte2ObjectRBTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
