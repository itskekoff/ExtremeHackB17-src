...
implements Byte2ByteSortedMap {
    ...
    extends AbstractByteIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Byte>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractByteCollection {
        ...
        public boolean contains(byte k2) {
            return AbstractByte2ByteSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractByteBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Byte>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractByteSortedSet {
        ...
        @Override
        public boolean contains(byte k2) {
            return AbstractByte2ByteSortedMap.this.containsKey(k2);
        }
        ...
        public ByteSortedSet headSet(byte to2) {
            return AbstractByte2ByteSortedMap.this.headMap(to2).keySet();
        }
        ...
        public ByteSortedSet subSet(byte from, byte to2) {
            return AbstractByte2ByteSortedMap.this.subMap(from, to2).keySet();
        }
