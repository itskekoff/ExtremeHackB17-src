...
Cloneable {
    ...
    public Byte2IntAVLTreeMap(Comparator<? super Byte> c2) {
        this();
        this.storedComparator = c2;
        this.setActualComparator();
    }

    public Byte2IntAVLTreeMap(Map<? extends Byte, ? extends Integer> m2) {
        this();
        this.putAll(m2);
    }

    public Byte2IntAVLTreeMap(SortedMap<Byte, Integer> m2) {
        this(m2.comparator());
        this.putAll((Map<? extends Byte, ? extends Integer>)m2);
    }

    public Byte2IntAVLTreeMap(Byte2IntMap m2) {
        this();
        this.putAll(m2);
    }

    public Byte2IntAVLTreeMap(Byte2IntSortedMap m2) {
        this(m2.comparator());
        this.putAll(m2);
    }

    public Byte2IntAVLTreeMap(byte[] k2, int[] v2, Comparator<? super Byte> c2) {
        this(c2);
    ...
    public Byte2IntAVLTreeMap(byte[] k2, int[] v2) {
        this(k2, v2, null);
    }
    ...
    public Integer put(Byte ok2, Integer ov) {
        int oldValue = this.put((byte)ok2, (int)ov);
    ...
    public Integer remove(Object ok2) {
        int oldValue = this.remove((Byte)ok2);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>(){
                final Comparator<? super Byte2IntMap.Entry> comparator = new Comparator<Byte2IntMap.Entry>(){
                    ...
                    @Override
                    public int compare(Byte2IntMap.Entry x2, Byte2IntMap.Entry y2) {
                        return Byte2IntAVLTreeMap.this.actualComparator.compare(x2.getByteKey(), y2.getByteKey());
                    }
                };
                ...
                public boolean contains(Object o2) {
                    ...
                    Entry f2 = Byte2IntAVLTreeMap.this.findKey((Byte)e2.getKey());
                    return e2.equals(f2);
                }
                ...
                public boolean remove(Object o2) {
                    ...
                    Entry f2 = Byte2IntAVLTreeMap.this.findKey((Byte)e2.getKey());
                    if (f2 != null) {
                        Byte2IntAVLTreeMap.this.remove(f2.key);
                    }
                    return f2 != null;
                }
                ...
                @Override
                public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry from, Byte2IntMap.Entry to2) {
                    return Byte2IntAVLTreeMap.this.subMap(from.getByteKey(), to2.getByteKey()).byte2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry to2) {
                    return Byte2IntAVLTreeMap.this.headMap(to2.getByteKey()).byte2IntEntrySet();
                }
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public boolean contains(int k2) {
                    return Byte2IntAVLTreeMap.this.containsValue(k2);
                }
    ...
    public Byte2IntAVLTreeMap clone() {
        Byte2IntAVLTreeMap c2;
        try {
            c2 = (Byte2IntAVLTreeMap)super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s2, int n2, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        ...
        if (n2 == 2) {
            Entry top = new Entry(s2.readByte(), s2.readInt());
            top.right(new Entry(s2.readByte(), s2.readInt()));
            top.right.pred(top);
            top.balance(1);
            top.pred(pred);
            top.right.succ(succ);
    ...
    implements Serializable {
        ...
        public Submap(byte from, boolean bottom, byte to2, boolean top) {
            if (!bottom && !top && Byte2IntAVLTreeMap.this.compare(from, to2) > 0) {
        ...
        final boolean in(byte k2) {
            return !(!this.bottom && Byte2IntAVLTreeMap.this.compare(k2, this.from) < 0 || !this.top && Byte2IntAVLTreeMap.this.compare(k2, this.to) >= 0);
        }
        ...
        public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>(){
                    ...
                    @Override
                    public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry from, Byte2IntMap.Entry to2) {
                        return Submap.this.subMap(from.getByteKey(), to2.getByteKey()).byte2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry to2) {
                        return Submap.this.headMap(to2.getByteKey()).byte2IntEntrySet();
                    }
        ...
        @Override
        public boolean containsKey(byte k2) {
            return this.in(k2) && Byte2IntAVLTreeMap.this.containsKey(k2);
        }
        ...
        public int get(byte k2) {
            Entry e2;
            byte kk2 = k2;
            return this.in(kk2) && (e2 = Byte2IntAVLTreeMap.this.findKey(kk2)) != null ? e2.value : this.defRetValue;
        }
        ...
        public int put(byte k2, int v2) {
            ...
            int oldValue = Byte2IntAVLTreeMap.this.put(k2, v2);
        ...
        public int remove(byte k2) {
            ...
            int oldValue = Byte2IntAVLTreeMap.this.remove(k2);
        ...
        public Byte2IntSortedMap headMap(byte to2) {
            ...
            return Byte2IntAVLTreeMap.this.compare(to2, this.to) < 0 ? new Submap(this.from, this.bottom, to2, false) : this;
        }
        ...
        public Byte2IntSortedMap subMap(byte from, byte to2) {
            ...
            if (!this.top) {
                byte by2 = to2 = Byte2IntAVLTreeMap.this.compare(to2, this.to) < 0 ? to2 : this.to;
            }
            if (!this.bottom) {
                byte by3 = from = Byte2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e2 = Byte2IntAVLTreeMap.this.firstEntry;
            } else {
                e2 = Byte2IntAVLTreeMap.this.locateKey(this.from);
                if (Byte2IntAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                    e2 = e2.next();
                }
            }
            if (e2 == null || !this.top && Byte2IntAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                return null;
            }
            return e2;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e2 = Byte2IntAVLTreeMap.this.lastEntry;
            } else {
                e2 = Byte2IntAVLTreeMap.this.locateKey(this.to);
                if (Byte2IntAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                    e2 = e2.prev();
                }
            }
            if (e2 == null || !this.bottom && Byte2IntAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                return null;
            }
            return e2;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k2) {
                ...
                if (!submap.bottom && submap.Byte2IntAVLTreeMap.this.compare(k2, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2IntAVLTreeMap.this.compare(k2, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2IntAVLTreeMap.this.locateKey(k2);
                if (submap.Byte2IntAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(byte k2) {
            this.next = Byte2IntAVLTreeMap.this.locateKey(k2);
            if (this.next != null) {
                if (Byte2IntAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
