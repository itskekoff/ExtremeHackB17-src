...
public class Byte2ObjectFunctions {
    ...
    public static <V> Byte2ObjectFunction<V> synchronize(Byte2ObjectFunction<V> f2) {
        return new SynchronizedFunction<V>(f2);
    }

    public static <V> Byte2ObjectFunction<V> synchronize(Byte2ObjectFunction<V> f2, Object sync) {
        return new SynchronizedFunction<V>(f2, sync);
    }

    public static <V> Byte2ObjectFunction<V> unmodifiable(Byte2ObjectFunction<V> f2) {
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Byte2ObjectFunction<V> f2) {
            if (f2 == null) {
    ...
    implements Serializable {
        ...
        protected SynchronizedFunction(Byte2ObjectFunction<V> f2, Object sync) {
            if (f2 == null) {
                throw new NullPointerException();
            }
            this.function = f2;
        ...
        protected SynchronizedFunction(Byte2ObjectFunction<V> f2) {
            if (f2 == null) {
                throw new NullPointerException();
            }
            this.function = f2;
