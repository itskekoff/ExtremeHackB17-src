...
Hash {
    ...
    public Byte2DoubleOpenHashMap(int expected, float f2) {
        if (f2 <= 0.0f || f2 > 1.0f) {
    ...
    public Byte2DoubleOpenHashMap(Map<? extends Byte, ? extends Double> m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Byte2DoubleOpenHashMap(Map<? extends Byte, ? extends Double> m2) {
        this(m2, 0.75f);
    }

    public Byte2DoubleOpenHashMap(Byte2DoubleMap m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Byte2DoubleOpenHashMap(Byte2DoubleMap m2) {
        this(m2, 0.75f);
    }

    public Byte2DoubleOpenHashMap(byte[] k2, double[] v2, float f2) {
        this(k2.length, f2);
    ...
    public Byte2DoubleOpenHashMap(byte[] k2, double[] v2) {
        this(k2, v2, 0.75f);
    }
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(){
                ...
                public boolean contains(double v2) {
                    return Byte2DoubleOpenHashMap.this.containsValue(v2);
                }
    ...
    public Byte2DoubleOpenHashMap clone() {
        Byte2DoubleOpenHashMap c2;
        try {
            c2 = (Byte2DoubleOpenHashMap)super.clone();
        }
    ...
    extends AbstractByteSet {
        ...
        public boolean contains(byte k2) {
            return Byte2DoubleOpenHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(byte k2) {
            int oldSize = Byte2DoubleOpenHashMap.this.size;
            Byte2DoubleOpenHashMap.this.remove(k2);
    ...
    implements Byte2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (k2 == 0) {
                return Byte2DoubleOpenHashMap.this.containsNullKey && Byte2DoubleOpenHashMap.this.value[Byte2DoubleOpenHashMap.this.n] == v2;
            }
            byte[] key = Byte2DoubleOpenHashMap.this.key;
            int pos = HashCommon.mix(k2) & Byte2DoubleOpenHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            if (k2 == curr) {
                return Byte2DoubleOpenHashMap.this.value[pos] == v2;
            }
            do {
        ...
        public boolean rem(Object o2) {
            ...
            double v2 = (Double)e2.getValue();
            if (k2 == 0) {
                if (Byte2DoubleOpenHashMap.this.containsNullKey && Byte2DoubleOpenHashMap.this.value[Byte2DoubleOpenHashMap.this.n] == v2) {
            ...
            if (curr == k2) {
                if (Byte2DoubleOpenHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2DoubleOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k2 || Byte2DoubleOpenHashMap.this.value[pos] != v2);
            Byte2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(k2) & Byte2DoubleOpenHashMap.this.mask;
                while (k2 != key[p2]) {
                    p2 = p2 + 1 & Byte2DoubleOpenHashMap.this.mask;
                }
                return p2;
    ...
    Map.Entry<Byte, Double> {
        ...
        public double setValue(double v2) {
            ...
            Byte2DoubleOpenHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Byte2DoubleOpenHashMap.this.key[this.index] == (Byte)e2.getKey() && Byte2DoubleOpenHashMap.this.value[this.index] == (Double)e2.getValue();
        }
