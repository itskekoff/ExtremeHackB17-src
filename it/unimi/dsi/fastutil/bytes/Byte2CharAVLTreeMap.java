...
Cloneable {
    ...
    public Byte2CharAVLTreeMap(Comparator<? super Byte> c2) {
        this();
        this.storedComparator = c2;
        this.setActualComparator();
    }

    public Byte2CharAVLTreeMap(Map<? extends Byte, ? extends Character> m2) {
        this();
        this.putAll(m2);
    }

    public Byte2CharAVLTreeMap(SortedMap<Byte, Character> m2) {
        this(m2.comparator());
        this.putAll((Map<? extends Byte, ? extends Character>)m2);
    }

    public Byte2CharAVLTreeMap(Byte2CharMap m2) {
        this();
        this.putAll(m2);
    }

    public Byte2CharAVLTreeMap(Byte2CharSortedMap m2) {
        this(m2.comparator());
        this.putAll(m2);
    }

    public Byte2CharAVLTreeMap(byte[] k2, char[] v2, Comparator<? super Byte> c2) {
        this(c2);
    ...
    public Byte2CharAVLTreeMap(byte[] k2, char[] v2) {
        this(k2, v2, null);
    }
            ...
            this.entries = new AbstractObjectSortedSet<Byte2CharMap.Entry>(){
                final Comparator<? super Byte2CharMap.Entry> comparator = new Comparator<Byte2CharMap.Entry>(){
                    ...
                    public int compare(Byte2CharMap.Entry x2, Byte2CharMap.Entry y2) {
                        return Byte2CharAVLTreeMap.this.actualComparator.compare(x2.getByteKey(), y2.getByteKey());
                    }
                };
                ...
                public boolean contains(Object o2) {
                    ...
                    Entry f2 = Byte2CharAVLTreeMap.this.findKey((Byte)e2.getKey());
                    return e2.equals(f2);
                }
                ...
                public boolean remove(Object o2) {
                    ...
                    Entry f2 = Byte2CharAVLTreeMap.this.findKey((Byte)e2.getKey());
                    if (f2 != null) {
                        Byte2CharAVLTreeMap.this.remove(f2.key);
                    }
                    return f2 != null;
                }
                ...
                public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry to2) {
                    return Byte2CharAVLTreeMap.this.subMap(from.getByteKey(), to2.getByteKey()).byte2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry to2) {
                    return Byte2CharAVLTreeMap.this.headMap(to2.getByteKey()).byte2CharEntrySet();
                }
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public boolean contains(char k2) {
                    return Byte2CharAVLTreeMap.this.containsValue(k2);
                }
    ...
    public Byte2CharAVLTreeMap clone() {
        Byte2CharAVLTreeMap c2;
        try {
            c2 = (Byte2CharAVLTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Submap(byte from, boolean bottom, byte to2, boolean top) {
            if (!bottom && !top && Byte2CharAVLTreeMap.this.compare(from, to2) > 0) {
        ...
        final boolean in(byte k2) {
            return !(!this.bottom && Byte2CharAVLTreeMap.this.compare(k2, this.from) < 0 || !this.top && Byte2CharAVLTreeMap.this.compare(k2, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(byte k2) {
            return this.in(k2) && Byte2CharAVLTreeMap.this.containsKey(k2);
        }
        ...
        public char get(byte k2) {
            Entry e2;
            byte kk2 = k2;
            return this.in(kk2) && (e2 = Byte2CharAVLTreeMap.this.findKey(kk2)) != null ? e2.value : this.defRetValue;
        }
        ...
        public char put(byte k2, char v2) {
            ...
            char oldValue = Byte2CharAVLTreeMap.this.put(k2, v2);
        ...
        public char remove(byte k2) {
            ...
            char oldValue = Byte2CharAVLTreeMap.this.remove(k2);
        ...
        public Byte2CharSortedMap headMap(byte to2) {
            ...
            return Byte2CharAVLTreeMap.this.compare(to2, this.to) < 0 ? new Submap(this.from, this.bottom, to2, false) : this;
        }
        ...
        public Byte2CharSortedMap subMap(byte from, byte to2) {
            ...
            if (!this.top) {
                byte by2 = to2 = Byte2CharAVLTreeMap.this.compare(to2, this.to) < 0 ? to2 : this.to;
            }
            if (!this.bottom) {
                byte by3 = from = Byte2CharAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e2 = Byte2CharAVLTreeMap.this.firstEntry;
            } else {
                e2 = Byte2CharAVLTreeMap.this.locateKey(this.from);
                if (Byte2CharAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                    e2 = e2.next();
                }
            }
            if (e2 == null || !this.top && Byte2CharAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                return null;
            }
            return e2;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e2 = Byte2CharAVLTreeMap.this.lastEntry;
            } else {
                e2 = Byte2CharAVLTreeMap.this.locateKey(this.to);
                if (Byte2CharAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                    e2 = e2.prev();
                }
            }
            if (e2 == null || !this.bottom && Byte2CharAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                return null;
            }
            return e2;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(byte k2) {
                ...
                if (!submap.bottom && submap.Byte2CharAVLTreeMap.this.compare(k2, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Byte2CharAVLTreeMap.this.compare(k2, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Byte2CharAVLTreeMap.this.locateKey(k2);
                if (submap.Byte2CharAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(byte k2) {
            this.next = Byte2CharAVLTreeMap.this.locateKey(k2);
            if (this.next != null) {
                if (Byte2CharAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
