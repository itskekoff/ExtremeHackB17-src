...
Hash {
    ...
    public Byte2IntOpenCustomHashMap(int expected, float f2, ByteHash.Strategy strategy) {
    ...
    public Byte2IntOpenCustomHashMap(Map<? extends Byte, ? extends Integer> m2, float f2, ByteHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Byte2IntOpenCustomHashMap(Map<? extends Byte, ? extends Integer> m2, ByteHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Byte2IntOpenCustomHashMap(Byte2IntMap m2, float f2, ByteHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Byte2IntOpenCustomHashMap(Byte2IntMap m2, ByteHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Byte2IntOpenCustomHashMap(byte[] k2, int[] v2, float f2, ByteHash.Strategy strategy) {
    ...
    public Byte2IntOpenCustomHashMap(byte[] k2, int[] v2, ByteHash.Strategy strategy) {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection(){
                ...
                public boolean contains(int v2) {
                    return Byte2IntOpenCustomHashMap.this.containsValue(v2);
                }
    ...
    public Byte2IntOpenCustomHashMap clone() {
        Byte2IntOpenCustomHashMap c2;
        try {
            c2 = (Byte2IntOpenCustomHashMap)super.clone();
        }
    ...
    extends AbstractByteSet {
        ...
        public boolean contains(byte k2) {
            return Byte2IntOpenCustomHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(byte k2) {
            int oldSize = Byte2IntOpenCustomHashMap.this.size;
            Byte2IntOpenCustomHashMap.this.remove(k2);
    ...
    implements Byte2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (Byte2IntOpenCustomHashMap.this.strategy.equals(k2, (byte)0)) {
                return Byte2IntOpenCustomHashMap.this.containsNullKey && Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.n] == v2;
            }
            byte[] key = Byte2IntOpenCustomHashMap.this.key;
            int pos = HashCommon.mix(Byte2IntOpenCustomHashMap.this.strategy.hashCode(k2)) & Byte2IntOpenCustomHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            if (Byte2IntOpenCustomHashMap.this.strategy.equals(k2, curr)) {
                return Byte2IntOpenCustomHashMap.this.value[pos] == v2;
            }
            do {
                if ((curr = key[pos = pos + 1 & Byte2IntOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2IntOpenCustomHashMap.this.strategy.equals(k2, curr));
            return Byte2IntOpenCustomHashMap.this.value[pos] == v2;
        }
        ...
        public boolean rem(Object o2) {
            ...
            int v2 = (Integer)e2.getValue();
            if (Byte2IntOpenCustomHashMap.this.strategy.equals(k2, (byte)0)) {
                if (Byte2IntOpenCustomHashMap.this.containsNullKey && Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.n] == v2) {
            ...
            if (Byte2IntOpenCustomHashMap.this.strategy.equals(curr, k2)) {
                if (Byte2IntOpenCustomHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2IntOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2IntOpenCustomHashMap.this.strategy.equals(curr, k2) || Byte2IntOpenCustomHashMap.this.value[pos] != v2);
            Byte2IntOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(Byte2IntOpenCustomHashMap.this.strategy.hashCode(k2)) & Byte2IntOpenCustomHashMap.this.mask;
                while (!Byte2IntOpenCustomHashMap.this.strategy.equals(k2, key[p2])) {
                    p2 = p2 + 1 & Byte2IntOpenCustomHashMap.this.mask;
                }
                return p2;
    ...
    Map.Entry<Byte, Integer> {
        ...
        public int setValue(int v2) {
            ...
            Byte2IntOpenCustomHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Byte2IntOpenCustomHashMap.this.strategy.equals(Byte2IntOpenCustomHashMap.this.key[this.index], (Byte)e2.getKey()) && Byte2IntOpenCustomHashMap.this.value[this.index] == (Integer)e2.getValue();
        }
