...
implements Byte2IntSortedMap {
    ...
    extends AbstractIntIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Integer>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractIntCollection {
        ...
        public boolean contains(int k2) {
            return AbstractByte2IntSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractByteBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Byte, Integer>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractByteSortedSet {
        ...
        public boolean contains(byte k2) {
            return AbstractByte2IntSortedMap.this.containsKey(k2);
        }
        ...
        public ByteSortedSet headSet(byte to2) {
            return AbstractByte2IntSortedMap.this.headMap(to2).keySet();
        }
        ...
        public ByteSortedSet subSet(byte from, byte to2) {
            return AbstractByte2IntSortedMap.this.subMap(from, to2).keySet();
        }
