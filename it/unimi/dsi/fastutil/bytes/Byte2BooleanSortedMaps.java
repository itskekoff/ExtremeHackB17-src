...
public class Byte2BooleanSortedMaps {
    ...
    public static Byte2BooleanSortedMap synchronize(Byte2BooleanSortedMap m2) {
        return new SynchronizedSortedMap(m2);
    }

    public static Byte2BooleanSortedMap synchronize(Byte2BooleanSortedMap m2, Object sync) {
        return new SynchronizedSortedMap(m2, sync);
    }

    public static Byte2BooleanSortedMap unmodifiable(Byte2BooleanSortedMap m2) {
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Byte2BooleanSortedMap m2) {
            super(m2);
            this.sortedMap = m2;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Byte2BooleanSortedMap m2, Object sync) {
            super(m2, sync);
            this.sortedMap = m2;
        }

        protected SynchronizedSortedMap(Byte2BooleanSortedMap m2) {
            super(m2);
            this.sortedMap = m2;
        }
