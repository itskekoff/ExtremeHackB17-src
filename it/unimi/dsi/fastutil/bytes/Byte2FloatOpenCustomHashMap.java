...
Hash {
    ...
    public Byte2FloatOpenCustomHashMap(int expected, float f2, ByteHash.Strategy strategy) {
    ...
    public Byte2FloatOpenCustomHashMap(Map<? extends Byte, ? extends Float> m2, float f2, ByteHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Byte2FloatOpenCustomHashMap(Map<? extends Byte, ? extends Float> m2, ByteHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Byte2FloatOpenCustomHashMap(Byte2FloatMap m2, float f2, ByteHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Byte2FloatOpenCustomHashMap(Byte2FloatMap m2, ByteHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Byte2FloatOpenCustomHashMap(byte[] k2, float[] v2, float f2, ByteHash.Strategy strategy) {
    ...
    public Byte2FloatOpenCustomHashMap(byte[] k2, float[] v2, ByteHash.Strategy strategy) {
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection(){
                ...
                public boolean contains(float v2) {
                    return Byte2FloatOpenCustomHashMap.this.containsValue(v2);
                }
    ...
    public Byte2FloatOpenCustomHashMap clone() {
        Byte2FloatOpenCustomHashMap c2;
        try {
            c2 = (Byte2FloatOpenCustomHashMap)super.clone();
        }
    ...
    extends AbstractByteSet {
        ...
        public boolean contains(byte k2) {
            return Byte2FloatOpenCustomHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(byte k2) {
            int oldSize = Byte2FloatOpenCustomHashMap.this.size;
            Byte2FloatOpenCustomHashMap.this.remove(k2);
    ...
    implements Byte2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k2, (byte)0)) {
                return Byte2FloatOpenCustomHashMap.this.containsNullKey && Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n] == v2;
            }
            byte[] key = Byte2FloatOpenCustomHashMap.this.key;
            int pos = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(k2)) & Byte2FloatOpenCustomHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k2, curr)) {
                return Byte2FloatOpenCustomHashMap.this.value[pos] == v2;
            }
            do {
                if ((curr = key[pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2FloatOpenCustomHashMap.this.strategy.equals(k2, curr));
            return Byte2FloatOpenCustomHashMap.this.value[pos] == v2;
        }
        ...
        public boolean rem(Object o2) {
            ...
            float v2 = ((Float)e2.getValue()).floatValue();
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k2, (byte)0)) {
                if (Byte2FloatOpenCustomHashMap.this.containsNullKey && Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n] == v2) {
            ...
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(curr, k2)) {
                if (Byte2FloatOpenCustomHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2FloatOpenCustomHashMap.this.strategy.equals(curr, k2) || Byte2FloatOpenCustomHashMap.this.value[pos] != v2);
            Byte2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(k2)) & Byte2FloatOpenCustomHashMap.this.mask;
                while (!Byte2FloatOpenCustomHashMap.this.strategy.equals(k2, key[p2])) {
                    p2 = p2 + 1 & Byte2FloatOpenCustomHashMap.this.mask;
                }
                return p2;
    ...
    Map.Entry<Byte, Float> {
        ...
        public float setValue(float v2) {
            ...
            Byte2FloatOpenCustomHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[this.index], (Byte)e2.getKey()) && Byte2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e2.getValue()).floatValue();
        }
