...
Hash {
    ...
    public Byte2ObjectOpenHashMap(int expected, float f2) {
        if (f2 <= 0.0f || f2 > 1.0f) {
    ...
    public Byte2ObjectOpenHashMap(Map<? extends Byte, ? extends V> m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Byte2ObjectOpenHashMap(Map<? extends Byte, ? extends V> m2) {
        this(m2, 0.75f);
    }

    public Byte2ObjectOpenHashMap(Byte2ObjectMap<V> m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Byte2ObjectOpenHashMap(Byte2ObjectMap<V> m2) {
        this(m2, 0.75f);
    }

    public Byte2ObjectOpenHashMap(byte[] k2, V[] v2, float f2) {
        this(k2.length, f2);
    ...
    public Byte2ObjectOpenHashMap(byte[] k2, V[] v2) {
        this(k2, v2, 0.75f);
    }
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(){
                ...
                public boolean contains(Object v2) {
                    return Byte2ObjectOpenHashMap.this.containsValue(v2);
                }
    ...
    public Byte2ObjectOpenHashMap<V> clone() {
        Byte2ObjectOpenHashMap c2;
        try {
            c2 = (Byte2ObjectOpenHashMap)super.clone();
        }
    ...
    extends AbstractByteSet {
        ...
        public boolean contains(byte k2) {
            return Byte2ObjectOpenHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(byte k2) {
            int oldSize = Byte2ObjectOpenHashMap.this.size;
            Byte2ObjectOpenHashMap.this.remove(k2);
    ...
    implements Byte2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o2) {
            ...
            if (k2 == 0) {
                return Byte2ObjectOpenHashMap.this.containsNullKey && (Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n] == null ? v2 == null : Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n].equals(v2));
            }
            byte[] key = Byte2ObjectOpenHashMap.this.key;
            int pos = HashCommon.mix(k2) & Byte2ObjectOpenHashMap.this.mask;
            byte curr = key[pos];
            if (curr == 0) {
                return false;
            }
            if (k2 == curr) {
                return Byte2ObjectOpenHashMap.this.value[pos] == null ? v2 == null : Byte2ObjectOpenHashMap.this.value[pos].equals(v2);
            }
            do {
        ...
        public boolean rem(Object o2) {
            ...
            Object v2 = e2.getValue();
            if (k2 == 0) {
                if (Byte2ObjectOpenHashMap.this.containsNullKey && (Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n] == null ? v2 == null : Byte2ObjectOpenHashMap.this.value[Byte2ObjectOpenHashMap.this.n].equals(v2))) {
            ...
            if (curr == k2) {
                if (Byte2ObjectOpenHashMap.this.value[pos] == null ? v2 == null : Byte2ObjectOpenHashMap.this.value[pos].equals(v2)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k2 || !(Byte2ObjectOpenHashMap.this.value[pos] == null ? v2 == null : Byte2ObjectOpenHashMap.this.value[pos].equals(v2)));
            Byte2ObjectOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(k2) & Byte2ObjectOpenHashMap.this.mask;
                while (k2 != key[p2]) {
                    p2 = p2 + 1 & Byte2ObjectOpenHashMap.this.mask;
                }
                return p2;
    ...
    Map.Entry<Byte, V> {
        ...
        public V setValue(V v2) {
            ...
            Byte2ObjectOpenHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Byte2ObjectOpenHashMap.this.key[this.index] == (Byte)e2.getKey() && (Byte2ObjectOpenHashMap.this.value[this.index] == null ? e2.getValue() == null : Byte2ObjectOpenHashMap.this.value[this.index].equals(e2.getValue()));
        }
