...
Hash {
    ...
    public Char2ByteOpenHashMap(int expected, float f2) {
        if (f2 <= 0.0f || f2 > 1.0f) {
    ...
    public Char2ByteOpenHashMap(Map<? extends Character, ? extends Byte> m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Char2ByteOpenHashMap(Map<? extends Character, ? extends Byte> m2) {
        this(m2, 0.75f);
    }

    public Char2ByteOpenHashMap(Char2ByteMap m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Char2ByteOpenHashMap(Char2ByteMap m2) {
        this(m2, 0.75f);
    }

    public Char2ByteOpenHashMap(char[] k2, byte[] v2, float f2) {
        this(k2.length, f2);
    ...
    public Char2ByteOpenHashMap(char[] k2, byte[] v2) {
        this(k2, v2, 0.75f);
    }
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public boolean contains(byte v2) {
                    return Char2ByteOpenHashMap.this.containsValue(v2);
                }
    ...
    public Char2ByteOpenHashMap clone() {
        Char2ByteOpenHashMap c2;
        try {
            c2 = (Char2ByteOpenHashMap)super.clone();
        }
    ...
    extends AbstractCharSet {
        ...
        public boolean contains(char k2) {
            return Char2ByteOpenHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(char k2) {
            int oldSize = Char2ByteOpenHashMap.this.size;
            Char2ByteOpenHashMap.this.remove(k2);
    ...
    implements Char2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (k2 == '\u0000') {
                return Char2ByteOpenHashMap.this.containsNullKey && Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n] == v2;
            }
            char[] key = Char2ByteOpenHashMap.this.key;
            int pos = HashCommon.mix(k2) & Char2ByteOpenHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
            if (k2 == curr) {
                return Char2ByteOpenHashMap.this.value[pos] == v2;
            }
            do {
        ...
        public boolean rem(Object o2) {
            ...
            byte v2 = (Byte)e2.getValue();
            if (k2 == '\u0000') {
                if (Char2ByteOpenHashMap.this.containsNullKey && Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.n] == v2) {
            ...
            if (curr == k2) {
                if (Char2ByteOpenHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2ByteOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k2 || Char2ByteOpenHashMap.this.value[pos] != v2);
            Char2ByteOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(k2) & Char2ByteOpenHashMap.this.mask;
                while (k2 != key[p2]) {
                    p2 = p2 + 1 & Char2ByteOpenHashMap.this.mask;
                }
                return p2;
            } while (key[this.pos] == '\u0000');
            this.last = this.pos;
    ...
    Map.Entry<Character, Byte> {
        ...
        public byte setValue(byte v2) {
            ...
            Char2ByteOpenHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Char2ByteOpenHashMap.this.key[this.index] == ((Character)e2.getKey()).charValue() && Char2ByteOpenHashMap.this.value[this.index] == (Byte)e2.getValue();
        }
