...
implements Char2CharSortedMap {
    ...
    extends AbstractCharIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Character, Character>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharCollection {
        ...
        public boolean contains(char k2) {
            return AbstractChar2CharSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractCharBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Character, Character>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharSortedSet {
        ...
        @Override
        public boolean contains(char k2) {
            return AbstractChar2CharSortedMap.this.containsKey(k2);
        }
        ...
        public CharSortedSet headSet(char to2) {
            return AbstractChar2CharSortedMap.this.headMap(to2).keySet();
        }
        ...
        public CharSortedSet subSet(char from, char to2) {
            return AbstractChar2CharSortedMap.this.subMap(from, to2).keySet();
        }
