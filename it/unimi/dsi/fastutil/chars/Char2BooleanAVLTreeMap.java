...
Cloneable {
    ...
    public Char2BooleanAVLTreeMap(Comparator<? super Character> c2) {
        this();
        this.storedComparator = c2;
        this.setActualComparator();
    }

    public Char2BooleanAVLTreeMap(Map<? extends Character, ? extends Boolean> m2) {
        this();
        this.putAll(m2);
    }

    public Char2BooleanAVLTreeMap(SortedMap<Character, Boolean> m2) {
        this(m2.comparator());
        this.putAll((Map<? extends Character, ? extends Boolean>)m2);
    }

    public Char2BooleanAVLTreeMap(Char2BooleanMap m2) {
        this();
        this.putAll(m2);
    }

    public Char2BooleanAVLTreeMap(Char2BooleanSortedMap m2) {
        this(m2.comparator());
        this.putAll(m2);
    }

    public Char2BooleanAVLTreeMap(char[] k2, boolean[] v2, Comparator<? super Character> c2) {
        this(c2);
    ...
    public Char2BooleanAVLTreeMap(char[] k2, boolean[] v2) {
        this(k2, v2, null);
    }
            ...
            this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>(){
                final Comparator<? super Char2BooleanMap.Entry> comparator = new Comparator<Char2BooleanMap.Entry>(){
                    ...
                    public int compare(Char2BooleanMap.Entry x2, Char2BooleanMap.Entry y2) {
                        return Char2BooleanAVLTreeMap.this.actualComparator.compare(x2.getCharKey(), y2.getCharKey());
                    }
                };
                ...
                public boolean contains(Object o2) {
                    ...
                    Entry f2 = Char2BooleanAVLTreeMap.this.findKey(((Character)e2.getKey()).charValue());
                    return e2.equals(f2);
                }
                ...
                public boolean remove(Object o2) {
                    ...
                    Entry f2 = Char2BooleanAVLTreeMap.this.findKey(((Character)e2.getKey()).charValue());
                    if (f2 != null) {
                        Char2BooleanAVLTreeMap.this.remove(f2.key);
                    }
                    return f2 != null;
                }
                ...
                public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to2) {
                    return Char2BooleanAVLTreeMap.this.subMap(from.getCharKey(), to2.getCharKey()).char2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to2) {
                    return Char2BooleanAVLTreeMap.this.headMap(to2.getCharKey()).char2BooleanEntrySet();
                }
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public boolean contains(boolean k2) {
                    return Char2BooleanAVLTreeMap.this.containsValue(k2);
                }
    ...
    public Char2BooleanAVLTreeMap clone() {
        Char2BooleanAVLTreeMap c2;
        try {
            c2 = (Char2BooleanAVLTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Submap(char from, boolean bottom, char to2, boolean top) {
            if (!bottom && !top && Char2BooleanAVLTreeMap.this.compare(from, to2) > 0) {
        ...
        final boolean in(char k2) {
            return !(!this.bottom && Char2BooleanAVLTreeMap.this.compare(k2, this.from) < 0 || !this.top && Char2BooleanAVLTreeMap.this.compare(k2, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(char k2) {
            return this.in(k2) && Char2BooleanAVLTreeMap.this.containsKey(k2);
        }
        ...
        public boolean get(char k2) {
            Entry e2;
            char kk2 = k2;
            return this.in(kk2) && (e2 = Char2BooleanAVLTreeMap.this.findKey(kk2)) != null ? e2.value : this.defRetValue;
        }
        ...
        public boolean put(char k2, boolean v2) {
            ...
            boolean oldValue = Char2BooleanAVLTreeMap.this.put(k2, v2);
        ...
        public boolean remove(char k2) {
            ...
            boolean oldValue = Char2BooleanAVLTreeMap.this.remove(k2);
        ...
        public Char2BooleanSortedMap headMap(char to2) {
            ...
            return Char2BooleanAVLTreeMap.this.compare(to2, this.to) < 0 ? new Submap(this.from, this.bottom, to2, false) : this;
        }
        ...
        public Char2BooleanSortedMap subMap(char from, char to2) {
            ...
            if (!this.top) {
                char c2 = to2 = Char2BooleanAVLTreeMap.this.compare(to2, this.to) < 0 ? to2 : this.to;
            }
            if (!this.bottom) {
                char c3 = from = Char2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e2 = Char2BooleanAVLTreeMap.this.firstEntry;
            } else {
                e2 = Char2BooleanAVLTreeMap.this.locateKey(this.from);
                if (Char2BooleanAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                    e2 = e2.next();
                }
            }
            if (e2 == null || !this.top && Char2BooleanAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                return null;
            }
            return e2;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e2 = Char2BooleanAVLTreeMap.this.lastEntry;
            } else {
                e2 = Char2BooleanAVLTreeMap.this.locateKey(this.to);
                if (Char2BooleanAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                    e2 = e2.prev();
                }
            }
            if (e2 == null || !this.bottom && Char2BooleanAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                return null;
            }
            return e2;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k2) {
                ...
                if (!submap.bottom && submap.Char2BooleanAVLTreeMap.this.compare(k2, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2BooleanAVLTreeMap.this.compare(k2, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2BooleanAVLTreeMap.this.locateKey(k2);
                if (submap.Char2BooleanAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(char k2) {
            this.next = Char2BooleanAVLTreeMap.this.locateKey(k2);
            if (this.next != null) {
                if (Char2BooleanAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
