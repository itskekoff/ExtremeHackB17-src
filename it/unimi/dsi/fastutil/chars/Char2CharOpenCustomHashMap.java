...
Hash {
    ...
    public Char2CharOpenCustomHashMap(int expected, float f2, CharHash.Strategy strategy) {
    ...
    public Char2CharOpenCustomHashMap(Map<? extends Character, ? extends Character> m2, float f2, CharHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Char2CharOpenCustomHashMap(Map<? extends Character, ? extends Character> m2, CharHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Char2CharOpenCustomHashMap(Char2CharMap m2, float f2, CharHash.Strategy strategy) {
        this(m2.size(), f2, strategy);
        this.putAll(m2);
    }

    public Char2CharOpenCustomHashMap(Char2CharMap m2, CharHash.Strategy strategy) {
        this(m2, 0.75f, strategy);
    }

    public Char2CharOpenCustomHashMap(char[] k2, char[] v2, float f2, CharHash.Strategy strategy) {
    ...
    public Char2CharOpenCustomHashMap(char[] k2, char[] v2, CharHash.Strategy strategy) {
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public boolean contains(char v2) {
                    return Char2CharOpenCustomHashMap.this.containsValue(v2);
                }
    ...
    public Char2CharOpenCustomHashMap clone() {
        Char2CharOpenCustomHashMap c2;
        try {
            c2 = (Char2CharOpenCustomHashMap)super.clone();
        }
    ...
    extends AbstractCharSet {
        ...
        public boolean contains(char k2) {
            return Char2CharOpenCustomHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(char k2) {
            int oldSize = Char2CharOpenCustomHashMap.this.size;
            Char2CharOpenCustomHashMap.this.remove(k2);
    ...
    implements Char2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (Char2CharOpenCustomHashMap.this.strategy.equals(k2, '\u0000')) {
                return Char2CharOpenCustomHashMap.this.containsNullKey && Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.n] == v2;
            }
            char[] key = Char2CharOpenCustomHashMap.this.key;
            int pos = HashCommon.mix(Char2CharOpenCustomHashMap.this.strategy.hashCode(k2)) & Char2CharOpenCustomHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
            if (Char2CharOpenCustomHashMap.this.strategy.equals(k2, curr)) {
                return Char2CharOpenCustomHashMap.this.value[pos] == v2;
            }
            do {
                if ((curr = key[pos = pos + 1 & Char2CharOpenCustomHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (!Char2CharOpenCustomHashMap.this.strategy.equals(k2, curr));
            return Char2CharOpenCustomHashMap.this.value[pos] == v2;
        }
        ...
        public boolean rem(Object o2) {
            ...
            char v2 = ((Character)e2.getValue()).charValue();
            if (Char2CharOpenCustomHashMap.this.strategy.equals(k2, '\u0000')) {
                if (Char2CharOpenCustomHashMap.this.containsNullKey && Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.n] == v2) {
            ...
            if (Char2CharOpenCustomHashMap.this.strategy.equals(curr, k2)) {
                if (Char2CharOpenCustomHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2CharOpenCustomHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (!Char2CharOpenCustomHashMap.this.strategy.equals(curr, k2) || Char2CharOpenCustomHashMap.this.value[pos] != v2);
            Char2CharOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(Char2CharOpenCustomHashMap.this.strategy.hashCode(k2)) & Char2CharOpenCustomHashMap.this.mask;
                while (!Char2CharOpenCustomHashMap.this.strategy.equals(k2, key[p2])) {
                    p2 = p2 + 1 & Char2CharOpenCustomHashMap.this.mask;
                }
                return p2;
            } while (key[this.pos] == '\u0000');
            this.last = this.pos;
    ...
    Map.Entry<Character, Character> {
        ...
        public char setValue(char v2) {
            ...
            Char2CharOpenCustomHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Char2CharOpenCustomHashMap.this.strategy.equals(Char2CharOpenCustomHashMap.this.key[this.index], ((Character)e2.getKey()).charValue()) && Char2CharOpenCustomHashMap.this.value[this.index] == ((Character)e2.getValue()).charValue();
        }
