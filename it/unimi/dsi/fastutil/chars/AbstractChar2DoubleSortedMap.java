...
implements Char2DoubleSortedMap {
    ...
    @Override
    @Deprecated
    public Char2DoubleSortedMap headMap(Character to2) {
    ...
    @Override
    @Deprecated
    public Char2DoubleSortedMap subMap(Character from, Character to2) {
    ...
    extends AbstractDoubleIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Character, Double>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractDoubleCollection {
        ...
        public boolean contains(double k2) {
            return AbstractChar2DoubleSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractCharBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Character, Double>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public boolean contains(char k2) {
            return AbstractChar2DoubleSortedMap.this.containsKey(k2);
        }
        ...
        public CharSortedSet headSet(char to2) {
            return AbstractChar2DoubleSortedMap.this.headMap(to2).keySet();
        }
        ...
        public CharSortedSet subSet(char from, char to2) {
            return AbstractChar2DoubleSortedMap.this.subMap(from, to2).keySet();
        }
