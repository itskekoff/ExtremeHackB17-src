...
implements Char2FloatSortedMap {
    ...
    @Override
    @Deprecated
    public Char2FloatSortedMap headMap(Character to2) {
    ...
    @Override
    @Deprecated
    public Char2FloatSortedMap subMap(Character from, Character to2) {
    ...
    extends AbstractFloatIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Character, Float>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractFloatCollection {
        ...
        public boolean contains(float k2) {
            return AbstractChar2FloatSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractCharBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Character, Float>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public boolean contains(char k2) {
            return AbstractChar2FloatSortedMap.this.containsKey(k2);
        }
        ...
        public CharSortedSet headSet(char to2) {
            return AbstractChar2FloatSortedMap.this.headMap(to2).keySet();
        }
        ...
        public CharSortedSet subSet(char from, char to2) {
            return AbstractChar2FloatSortedMap.this.subMap(from, to2).keySet();
        }
