...
Cloneable {
    ...
    public Char2ByteAVLTreeMap(Comparator<? super Character> c2) {
        this();
        this.storedComparator = c2;
        this.setActualComparator();
    }

    public Char2ByteAVLTreeMap(Map<? extends Character, ? extends Byte> m2) {
        this();
        this.putAll(m2);
    }

    public Char2ByteAVLTreeMap(SortedMap<Character, Byte> m2) {
        this(m2.comparator());
        this.putAll((Map<? extends Character, ? extends Byte>)m2);
    }

    public Char2ByteAVLTreeMap(Char2ByteMap m2) {
        this();
        this.putAll(m2);
    }

    public Char2ByteAVLTreeMap(Char2ByteSortedMap m2) {
        this(m2.comparator());
        this.putAll(m2);
    }

    public Char2ByteAVLTreeMap(char[] k2, byte[] v2, Comparator<? super Character> c2) {
        this(c2);
    ...
    public Char2ByteAVLTreeMap(char[] k2, byte[] v2) {
        this(k2, v2, null);
    }
    ...
    public Byte put(Character ok2, Byte ov) {
        byte oldValue = this.put(ok2.charValue(), (byte)ov);
    ...
    public Byte remove(Object ok2) {
        byte oldValue = this.remove(((Character)ok2).charValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>(){
                final Comparator<? super Char2ByteMap.Entry> comparator = new Comparator<Char2ByteMap.Entry>(){
                    ...
                    @Override
                    public int compare(Char2ByteMap.Entry x2, Char2ByteMap.Entry y2) {
                        return Char2ByteAVLTreeMap.this.actualComparator.compare(x2.getCharKey(), y2.getCharKey());
                    }
                };
                ...
                public boolean contains(Object o2) {
                    ...
                    Entry f2 = Char2ByteAVLTreeMap.this.findKey(((Character)e2.getKey()).charValue());
                    return e2.equals(f2);
                }
                ...
                public boolean remove(Object o2) {
                    ...
                    Entry f2 = Char2ByteAVLTreeMap.this.findKey(((Character)e2.getKey()).charValue());
                    if (f2 != null) {
                        Char2ByteAVLTreeMap.this.remove(f2.key);
                    }
                    return f2 != null;
                }
                ...
                @Override
                public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry to2) {
                    return Char2ByteAVLTreeMap.this.subMap(from.getCharKey(), to2.getCharKey()).char2ByteEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry to2) {
                    return Char2ByteAVLTreeMap.this.headMap(to2.getCharKey()).char2ByteEntrySet();
                }
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection(){
                ...
                public boolean contains(byte k2) {
                    return Char2ByteAVLTreeMap.this.containsValue(k2);
                }
    ...
    public Char2ByteAVLTreeMap clone() {
        Char2ByteAVLTreeMap c2;
        try {
            c2 = (Char2ByteAVLTreeMap)super.clone();
        }
    ...
    private Entry readTree(ObjectInputStream s2, int n2, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n2 == 1) {
            Entry top = new Entry(s2.readChar(), s2.readByte());
            top.pred(pred);
            top.succ(succ);
            return top;
        }
        if (n2 == 2) {
            Entry top = new Entry(s2.readChar(), s2.readByte());
            top.right(new Entry(s2.readChar(), s2.readByte()));
            top.right.pred(top);
            top.balance(1);
            top.pred(pred);
            top.right.succ(succ);
    ...
    implements Serializable {
        ...
        public Submap(char from, boolean bottom, char to2, boolean top) {
            if (!bottom && !top && Char2ByteAVLTreeMap.this.compare(from, to2) > 0) {
        ...
        final boolean in(char k2) {
            return !(!this.bottom && Char2ByteAVLTreeMap.this.compare(k2, this.from) < 0 || !this.top && Char2ByteAVLTreeMap.this.compare(k2, this.to) >= 0);
        }
        ...
        public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>(){
                    ...
                    @Override
                    public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry to2) {
                        return Submap.this.subMap(from.getCharKey(), to2.getCharKey()).char2ByteEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry to2) {
                        return Submap.this.headMap(to2.getCharKey()).char2ByteEntrySet();
                    }
        ...
        @Override
        public boolean containsKey(char k2) {
            return this.in(k2) && Char2ByteAVLTreeMap.this.containsKey(k2);
        }
        ...
        public byte get(char k2) {
            Entry e2;
            char kk2 = k2;
            return this.in(kk2) && (e2 = Char2ByteAVLTreeMap.this.findKey(kk2)) != null ? e2.value : this.defRetValue;
        }
        ...
        public byte put(char k2, byte v2) {
            ...
            byte oldValue = Char2ByteAVLTreeMap.this.put(k2, v2);
        ...
        public byte remove(char k2) {
            ...
            byte oldValue = Char2ByteAVLTreeMap.this.remove(k2);
        ...
        public Char2ByteSortedMap headMap(char to2) {
            ...
            return Char2ByteAVLTreeMap.this.compare(to2, this.to) < 0 ? new Submap(this.from, this.bottom, to2, false) : this;
        }
        ...
        public Char2ByteSortedMap subMap(char from, char to2) {
            ...
            if (!this.top) {
                char c2 = to2 = Char2ByteAVLTreeMap.this.compare(to2, this.to) < 0 ? to2 : this.to;
            }
            if (!this.bottom) {
                char c3 = from = Char2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e2 = Char2ByteAVLTreeMap.this.firstEntry;
            } else {
                e2 = Char2ByteAVLTreeMap.this.locateKey(this.from);
                if (Char2ByteAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                    e2 = e2.next();
                }
            }
            if (e2 == null || !this.top && Char2ByteAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                return null;
            }
            return e2;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e2 = Char2ByteAVLTreeMap.this.lastEntry;
            } else {
                e2 = Char2ByteAVLTreeMap.this.locateKey(this.to);
                if (Char2ByteAVLTreeMap.this.compare(e2.key, this.to) >= 0) {
                    e2 = e2.prev();
                }
            }
            if (e2 == null || !this.bottom && Char2ByteAVLTreeMap.this.compare(e2.key, this.from) < 0) {
                return null;
            }
            return e2;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k2) {
                ...
                if (!submap.bottom && submap.Char2ByteAVLTreeMap.this.compare(k2, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2ByteAVLTreeMap.this.compare(k2, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2ByteAVLTreeMap.this.locateKey(k2);
                if (submap.Char2ByteAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(char k2) {
            this.next = Char2ByteAVLTreeMap.this.locateKey(k2);
            if (this.next != null) {
                if (Char2ByteAVLTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
