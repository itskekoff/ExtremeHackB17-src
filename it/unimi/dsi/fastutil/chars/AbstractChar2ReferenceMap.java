...
Serializable {
    ...
    public void putAll(Map<? extends Character, ? extends V> m2) {
        ...
        if (m2 instanceof Char2ReferenceMap) {
            while (n2-- != 0) {
                Char2ReferenceMap.Entry e2 = (Char2ReferenceMap.Entry)i2.next();
    ...
    public CharSet keySet() {
        return new AbstractCharSet(){
            ...
            public boolean contains(char k2) {
                return AbstractChar2ReferenceMap.this.containsKey(k2);
            }
    ...
    public ReferenceCollection<V> values() {
        return new AbstractReferenceCollection<V>(){
            ...
            public boolean contains(Object k2) {
                return AbstractChar2ReferenceMap.this.containsValue(k2);
            }
    ...
    implements Char2ReferenceMap.Entry<V> {
        ...
        public boolean equals(Object o2) {
            ...
            return this.key == ((Character)e2.getKey()).charValue() && this.value == e2.getValue();
        }
