...
implements Char2ByteSortedMap {
    ...
    extends AbstractByteIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Character, Byte>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractByteCollection {
        ...
        public boolean contains(byte k2) {
            return AbstractChar2ByteSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractCharBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Character, Byte>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public boolean contains(char k2) {
            return AbstractChar2ByteSortedMap.this.containsKey(k2);
        }
        ...
        public CharSortedSet headSet(char to2) {
            return AbstractChar2ByteSortedMap.this.headMap(to2).keySet();
        }
        ...
        public CharSortedSet subSet(char from, char to2) {
            return AbstractChar2ByteSortedMap.this.subMap(from, to2).keySet();
        }
