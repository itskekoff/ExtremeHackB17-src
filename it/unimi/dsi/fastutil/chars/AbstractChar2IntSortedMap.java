...
implements Char2IntSortedMap {
    ...
    @Override
    @Deprecated
    public Char2IntSortedMap headMap(Character to2) {
    ...
    @Override
    @Deprecated
    public Char2IntSortedMap subMap(Character from, Character to2) {
    ...
    extends AbstractIntIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Character, Integer>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractIntCollection {
        ...
        public boolean contains(int k2) {
            return AbstractChar2IntSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractCharBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Character, Integer>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public boolean contains(char k2) {
            return AbstractChar2IntSortedMap.this.containsKey(k2);
        }
        ...
        public CharSortedSet headSet(char to2) {
            return AbstractChar2IntSortedMap.this.headMap(to2).keySet();
        }
        ...
        public CharSortedSet subSet(char from, char to2) {
            return AbstractChar2IntSortedMap.this.subMap(from, to2).keySet();
        }
