...
public class Char2CharMaps {
    ...
    public static Char2CharMap synchronize(Char2CharMap m2) {
        return new SynchronizedMap(m2);
    }

    public static Char2CharMap synchronize(Char2CharMap m2, Object sync) {
        return new SynchronizedMap(m2, sync);
    }

    public static Char2CharMap unmodifiable(Char2CharMap m2) {
    ...
    Serializable {
        ...
        protected UnmodifiableMap(Char2CharMap m2) {
            super(m2);
            this.map = m2;
        }
    ...
    Serializable {
        ...
        protected SynchronizedMap(Char2CharMap m2, Object sync) {
            super(m2, sync);
            this.map = m2;
        }

        protected SynchronizedMap(Char2CharMap m2) {
            super(m2);
            this.map = m2;
        }
    ...
    Cloneable {
        ...
        Map.Entry<Character, Character> {
            ...
            public boolean equals(Object o2) {
                ...
                return Singleton.this.key == ((Character)e2.getKey()).charValue() && Singleton.this.value == ((Character)e2.getValue()).charValue();
            }
