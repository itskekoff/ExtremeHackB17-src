...
implements Char2BooleanSortedMap {
    ...
    extends AbstractBooleanIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Character, Boolean>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractBooleanCollection {
        ...
        public boolean contains(boolean k2) {
            return AbstractChar2BooleanSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractCharBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Character, Boolean>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public boolean contains(char k2) {
            return AbstractChar2BooleanSortedMap.this.containsKey(k2);
        }
        ...
        public CharSortedSet headSet(char to2) {
            return AbstractChar2BooleanSortedMap.this.headMap(to2).keySet();
        }
        ...
        public CharSortedSet subSet(char from, char to2) {
            return AbstractChar2BooleanSortedMap.this.subMap(from, to2).keySet();
        }
