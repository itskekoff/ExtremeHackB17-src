...
implements Char2ShortSortedMap {
    ...
    @Override
    @Deprecated
    public Char2ShortSortedMap headMap(Character to2) {
    ...
    @Override
    @Deprecated
    public Char2ShortSortedMap subMap(Character from, Character to2) {
    ...
    extends AbstractShortIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Character, Short>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractShortCollection {
        ...
        public boolean contains(short k2) {
            return AbstractChar2ShortSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractCharBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Character, Short>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public boolean contains(char k2) {
            return AbstractChar2ShortSortedMap.this.containsKey(k2);
        }
        ...
        public CharSortedSet headSet(char to2) {
            return AbstractChar2ShortSortedMap.this.headMap(to2).keySet();
        }
        ...
        public CharSortedSet subSet(char from, char to2) {
            return AbstractChar2ShortSortedMap.this.subMap(from, to2).keySet();
        }
