...
implements Char2ObjectSortedMap<V> {
    ...
    @Override
    @Deprecated
    public Char2ObjectSortedMap<V> subMap(Character from, Character to2) {
    ...
    extends AbstractObjectCollection<V> {
        ...
        public boolean contains(Object k2) {
            return AbstractChar2ObjectSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public boolean contains(char k2) {
            return AbstractChar2ObjectSortedMap.this.containsKey(k2);
        }
        ...
        public CharSortedSet headSet(char to2) {
            return AbstractChar2ObjectSortedMap.this.headMap(to2).keySet();
        }
        ...
        public CharSortedSet subSet(char from, char to2) {
            return AbstractChar2ObjectSortedMap.this.subMap(from, to2).keySet();
        }
