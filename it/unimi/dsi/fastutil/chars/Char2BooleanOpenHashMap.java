...
Hash {
    ...
    public Char2BooleanOpenHashMap(int expected, float f2) {
        if (f2 <= 0.0f || f2 > 1.0f) {
    ...
    public Char2BooleanOpenHashMap(Map<? extends Character, ? extends Boolean> m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Char2BooleanOpenHashMap(Map<? extends Character, ? extends Boolean> m2) {
        this(m2, 0.75f);
    }

    public Char2BooleanOpenHashMap(Char2BooleanMap m2, float f2) {
        this(m2.size(), f2);
        this.putAll(m2);
    }

    public Char2BooleanOpenHashMap(Char2BooleanMap m2) {
        this(m2, 0.75f);
    }

    public Char2BooleanOpenHashMap(char[] k2, boolean[] v2, float f2) {
        this(k2.length, f2);
    ...
    public Char2BooleanOpenHashMap(char[] k2, boolean[] v2) {
        this(k2, v2, 0.75f);
    }
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(){
                ...
                public boolean contains(boolean v2) {
                    return Char2BooleanOpenHashMap.this.containsValue(v2);
                }
    ...
    public Char2BooleanOpenHashMap clone() {
        Char2BooleanOpenHashMap c2;
        try {
            c2 = (Char2BooleanOpenHashMap)super.clone();
        }
    ...
    extends AbstractCharSet {
        ...
        public boolean contains(char k2) {
            return Char2BooleanOpenHashMap.this.containsKey(k2);
        }

        @Override
        public boolean rem(char k2) {
            int oldSize = Char2BooleanOpenHashMap.this.size;
            Char2BooleanOpenHashMap.this.remove(k2);
    ...
    implements Char2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o2) {
            ...
            if (k2 == '\u0000') {
                return Char2BooleanOpenHashMap.this.containsNullKey && Char2BooleanOpenHashMap.this.value[Char2BooleanOpenHashMap.this.n] == v2;
            }
            char[] key = Char2BooleanOpenHashMap.this.key;
            int pos = HashCommon.mix(k2) & Char2BooleanOpenHashMap.this.mask;
            char curr = key[pos];
            if (curr == '\u0000') {
                return false;
            }
            if (k2 == curr) {
                return Char2BooleanOpenHashMap.this.value[pos] == v2;
            }
            do {
        ...
        public boolean rem(Object o2) {
            ...
            boolean v2 = (Boolean)e2.getValue();
            if (k2 == '\u0000') {
                if (Char2BooleanOpenHashMap.this.containsNullKey && Char2BooleanOpenHashMap.this.value[Char2BooleanOpenHashMap.this.n] == v2) {
            ...
            if (curr == k2) {
                if (Char2BooleanOpenHashMap.this.value[pos] == v2) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2BooleanOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k2 || Char2BooleanOpenHashMap.this.value[pos] != v2);
            Char2BooleanOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                int p2 = HashCommon.mix(k2) & Char2BooleanOpenHashMap.this.mask;
                while (k2 != key[p2]) {
                    p2 = p2 + 1 & Char2BooleanOpenHashMap.this.mask;
                }
                return p2;
            } while (key[this.pos] == '\u0000');
            this.last = this.pos;
    ...
    Map.Entry<Character, Boolean> {
        ...
        public boolean setValue(boolean v2) {
            ...
            Char2BooleanOpenHashMap.this.value[this.index] = v2;
            return oldValue;
        }
        ...
        public boolean equals(Object o2) {
            ...
            Map.Entry e2 = (Map.Entry)o2;
            return Char2BooleanOpenHashMap.this.key[this.index] == ((Character)e2.getKey()).charValue() && Char2BooleanOpenHashMap.this.value[this.index] == (Boolean)e2.getValue();
        }
