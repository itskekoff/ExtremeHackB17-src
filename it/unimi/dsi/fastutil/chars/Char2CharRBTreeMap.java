...
Cloneable {
    ...
    public Char2CharRBTreeMap(Comparator<? super Character> c2) {
        this();
        this.storedComparator = c2;
        this.setActualComparator();
    }

    public Char2CharRBTreeMap(Map<? extends Character, ? extends Character> m2) {
        this();
        this.putAll(m2);
    }

    public Char2CharRBTreeMap(SortedMap<Character, Character> m2) {
        this(m2.comparator());
        this.putAll((Map<? extends Character, ? extends Character>)m2);
    }

    public Char2CharRBTreeMap(Char2CharMap m2) {
        this();
        this.putAll(m2);
    }

    public Char2CharRBTreeMap(Char2CharSortedMap m2) {
        this(m2.comparator());
        this.putAll(m2);
    }

    public Char2CharRBTreeMap(char[] k2, char[] v2, Comparator<? super Character> c2) {
        this(c2);
    ...
    public Char2CharRBTreeMap(char[] k2, char[] v2) {
        this(k2, v2, null);
    }
...
lbl160:
            ...
            this.entries = new AbstractObjectSortedSet<Char2CharMap.Entry>(){
                final Comparator<? super Char2CharMap.Entry> comparator = new Comparator<Char2CharMap.Entry>(){
                    ...
                    public int compare(Char2CharMap.Entry x2, Char2CharMap.Entry y2) {
                        return Char2CharRBTreeMap.this.actualComparator.compare(x2.getCharKey(), y2.getCharKey());
                    }
                };
                ...
                public boolean contains(Object o2) {
                    ...
                    Entry f2 = Char2CharRBTreeMap.this.findKey(((Character)e2.getKey()).charValue());
                    return e2.equals(f2);
                }
                ...
                public boolean remove(Object o2) {
                    ...
                    Entry f2 = Char2CharRBTreeMap.this.findKey(((Character)e2.getKey()).charValue());
                    if (f2 != null) {
                        Char2CharRBTreeMap.this.remove(f2.key);
                    }
                    return f2 != null;
                }
                ...
                public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry from, Char2CharMap.Entry to2) {
                    return Char2CharRBTreeMap.this.subMap(from.getCharKey(), to2.getCharKey()).char2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry to2) {
                    return Char2CharRBTreeMap.this.headMap(to2.getCharKey()).char2CharEntrySet();
                }
        ...
        if (this.values == null) {
            this.values = new AbstractCharCollection(){
                ...
                public boolean contains(char k2) {
                    return Char2CharRBTreeMap.this.containsValue(k2);
                }
    ...
    public Char2CharRBTreeMap clone() {
        Char2CharRBTreeMap c2;
        try {
            c2 = (Char2CharRBTreeMap)super.clone();
        }
    ...
    implements Serializable {
        ...
        public Submap(char from, boolean bottom, char to2, boolean top) {
            if (!bottom && !top && Char2CharRBTreeMap.this.compare(from, to2) > 0) {
        ...
        final boolean in(char k2) {
            return !(!this.bottom && Char2CharRBTreeMap.this.compare(k2, this.from) < 0 || !this.top && Char2CharRBTreeMap.this.compare(k2, this.to) >= 0);
        }
        ...
        @Override
        public boolean containsKey(char k2) {
            return this.in(k2) && Char2CharRBTreeMap.this.containsKey(k2);
        }
        ...
        public char get(char k2) {
            Entry e2;
            char kk2 = k2;
            return this.in(kk2) && (e2 = Char2CharRBTreeMap.this.findKey(kk2)) != null ? e2.value : this.defRetValue;
        }
        ...
        public char put(char k2, char v2) {
            ...
            char oldValue = Char2CharRBTreeMap.this.put(k2, v2);
        ...
        public char remove(char k2) {
            ...
            char oldValue = Char2CharRBTreeMap.this.remove(k2);
        ...
        public Char2CharSortedMap headMap(char to2) {
            ...
            return Char2CharRBTreeMap.this.compare(to2, this.to) < 0 ? new Submap(this.from, this.bottom, to2, false) : this;
        }
        ...
        public Char2CharSortedMap subMap(char from, char to2) {
            ...
            if (!this.top) {
                char c2 = to2 = Char2CharRBTreeMap.this.compare(to2, this.to) < 0 ? to2 : this.to;
            }
            if (!this.bottom) {
                char c3 = from = Char2CharRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.bottom) {
                e2 = Char2CharRBTreeMap.this.firstEntry;
            } else {
                e2 = Char2CharRBTreeMap.this.locateKey(this.from);
                if (Char2CharRBTreeMap.this.compare(e2.key, this.from) < 0) {
                    e2 = e2.next();
                }
            }
            if (e2 == null || !this.top && Char2CharRBTreeMap.this.compare(e2.key, this.to) >= 0) {
                return null;
            }
            return e2;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                e2 = Char2CharRBTreeMap.this.lastEntry;
            } else {
                e2 = Char2CharRBTreeMap.this.locateKey(this.to);
                if (Char2CharRBTreeMap.this.compare(e2.key, this.to) >= 0) {
                    e2 = e2.prev();
                }
            }
            if (e2 == null || !this.bottom && Char2CharRBTreeMap.this.compare(e2.key, this.from) < 0) {
                return null;
            }
            return e2;
        }
        ...
        extends TreeIterator {
            ...
            SubmapIterator(char k2) {
                ...
                if (!submap.bottom && submap.Char2CharRBTreeMap.this.compare(k2, this.next.key) < 0) {
                    this.prev = null;
                    return;
                }
                if (!submap.top) {
                    this.prev = submap.lastEntry();
                    if (submap.Char2CharRBTreeMap.this.compare(k2, this.prev.key) >= 0) {
                        this.next = null;
                        return;
                    }
                }
                this.next = submap.Char2CharRBTreeMap.this.locateKey(k2);
                if (submap.Char2CharRBTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
    ...
    private class TreeIterator {
        ...
        TreeIterator(char k2) {
            this.next = Char2CharRBTreeMap.this.locateKey(k2);
            if (this.next != null) {
                if (Char2CharRBTreeMap.this.compare(this.next.key, k2) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
