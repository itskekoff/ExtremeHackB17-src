...
implements Char2ReferenceSortedMap<V> {
    ...
    @Override
    @Deprecated
    public Char2ReferenceSortedMap<V> headMap(Character to2) {
        return this.headMap(to2.charValue());
    }
    ...
    @Override
    @Deprecated
    public Char2ReferenceSortedMap<V> subMap(Character from, Character to2) {
        return this.subMap(from.charValue(), to2.charValue());
    }
    ...
    extends AbstractObjectIterator<V> {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Character, V>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractReferenceCollection<V> {
        ...
        public boolean contains(Object k2) {
            return AbstractChar2ReferenceSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractCharBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Character, V>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public boolean contains(char k2) {
            return AbstractChar2ReferenceSortedMap.this.containsKey(k2);
        }
        ...
        @Override
        public CharSortedSet headSet(char to2) {
            return AbstractChar2ReferenceSortedMap.this.headMap(to2).keySet();
        }
        ...
        @Override
        public CharSortedSet subSet(char from, char to2) {
            return AbstractChar2ReferenceSortedMap.this.subMap(from, to2).keySet();
        }
