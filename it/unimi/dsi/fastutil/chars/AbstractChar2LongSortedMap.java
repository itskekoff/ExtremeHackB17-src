...
implements Char2LongSortedMap {
    ...
    @Override
    @Deprecated
    public Char2LongSortedMap headMap(Character to2) {
    ...
    @Override
    @Deprecated
    public Char2LongSortedMap subMap(Character from, Character to2) {
    ...
    extends AbstractLongIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Character, Long>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractLongCollection {
        ...
        public boolean contains(long k2) {
            return AbstractChar2LongSortedMap.this.containsValue(k2);
        }
    ...
    extends AbstractCharBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Character, Long>> i2) {
            this.i = i2;
        }
    ...
    extends AbstractCharSortedSet {
        ...
        public boolean contains(char k2) {
            return AbstractChar2LongSortedMap.this.containsKey(k2);
        }
        ...
        public CharSortedSet headSet(char to2) {
            return AbstractChar2LongSortedMap.this.headMap(to2).keySet();
        }
        ...
        public CharSortedSet subSet(char from, char to2) {
            return AbstractChar2LongSortedMap.this.subMap(from, to2).keySet();
        }
