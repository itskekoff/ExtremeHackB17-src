...
public class BetterGrass {
    ...
    private static void loadProperties(TextureMap p_loadProperties_0_) {
        ...
        spritesLoaded = true;
        String s2 = "optifine/bettergrass.properties";
        try {
            ...
            if (flag) {
                Config.dbg("BetterGrass: Parsing default configuration " + s2);
            } else {
                Config.dbg("BetterGrass: Parsing configuration " + s2);
            }
            ...
            Config.warn("Error reading: " + s2 + ", " + ioexception.getClass().getName() + ": " + ioexception.getMessage());
        }
    }
    ...
    private static TextureAtlasSprite registerSprite(Properties p_registerSprite_0_, String p_registerSprite_1_, String p_registerSprite_2_, TextureMap p_registerSprite_3_) {
        ...
        String s2 = p_registerSprite_0_.getProperty(p_registerSprite_1_);
        if (s2 == null) {
            s2 = p_registerSprite_2_;
        }
        if (!Config.hasResource(resourcelocation = new ResourceLocation("textures/" + s2 + ".png"))) {
    ...
    private static List getFaceQuadsMycelium(IBlockAccess p_getFaceQuadsMycelium_0_, IBlockState p_getFaceQuadsMycelium_1_, BlockPos p_getFaceQuadsMycelium_2_, EnumFacing p_getFaceQuadsMycelium_3_, List p_getFaceQuadsMycelium_4_) {
        ...
        boolean bl2 = flag = block == Blocks.SNOW || block == Blocks.SNOW_LAYER;
    ...
    private static boolean getBoolean(Properties p_getBoolean_0_, String p_getBoolean_1_, boolean p_getBoolean_2_) {
        String s2 = p_getBoolean_0_.getProperty(p_getBoolean_1_);
        return s2 == null ? p_getBoolean_2_ : Boolean.parseBoolean(s2);
    }
}
