...
public enum BlockDir {
    ...
    public int getOffsetX() {
        int i2 = this.facing1.getFrontOffsetX();
        if (this.facing2 != null) {
            i2 += this.facing2.getFrontOffsetX();
        }
        return i2;
    }

    public int getOffsetY() {
        int i2 = this.facing1.getFrontOffsetY();
        if (this.facing2 != null) {
            i2 += this.facing2.getFrontOffsetY();
        }
        return i2;
    }

    public int getOffsetZ() {
        int i2 = this.facing1.getFrontOffsetZ();
        if (this.facing2 != null) {
            i2 += this.facing2.getFrontOffsetZ();
        }
        return i2;
    }
