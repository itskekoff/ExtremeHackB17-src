...
public class ConnectedProperties {
    ...
    private int[] parseCtmTileIndexes(Properties p_parseCtmTileIndexes_1_) {
        ...
        for (Object object : p_parseCtmTileIndexes_1_.keySet()) {
            ...
            String s3 = p_parseCtmTileIndexes_1_.getProperty(s2);
            if (s3 == null) continue;
    ...
    private int[] detectMatchBlockIds() {
        ...
        for (j2 = i2 = "block".length(); j2 < this.name.length(); ++j2) {
    ...
    private static TextureAtlasSprite[] registerIcons(String[] p_registerIcons_0_, TextureMap p_registerIcons_1_) {
        ...
        for (int i2 = 0; i2 < p_registerIcons_0_.length; ++i2) {
            ...
            if (!(flag = Config.hasResource(resourcelocation1 = new ResourceLocation(s1, s3 = String.valueOf(s22) + ".png")))) {
