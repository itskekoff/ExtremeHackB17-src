...
public class PlayerItemParser {
    ...
    public static ModelRenderer parseModelRenderer(JsonObject p_parseModelRenderer_0_, ModelBase p_parseModelRenderer_1_, int[] p_parseModelRenderer_2_, String p_parseModelRenderer_3_) {
        ...
        String s2 = Json.getString(p_parseModelRenderer_0_, MODEL_ID);
        modelrenderer.setId(s2);
        modelrenderer.scaleX = f2 = Json.getFloat(p_parseModelRenderer_0_, MODEL_SCALE, 1.0f);
        ...
        String s22 = Json.getString(p_parseModelRenderer_0_, MODEL_INVERT_AXIS, "").toLowerCase();
