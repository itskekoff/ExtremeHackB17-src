...
public class PlayerConfigurations {
    ...
    public static synchronized PlayerConfiguration getPlayerConfiguration(AbstractClientPlayer p_getPlayerConfiguration_0_) {
        ...
        if (playerconfiguration == null) {
            ...
            String s2 = String.valueOf(HttpUtils.getPlayerItemsUrl()) + "/users/" + s1 + ".cfg";
            FileDownloadThread filedownloadthread = new FileDownloadThread(s2, playerconfigurationreceiver);
