...
public class ConnectedTexturesCompact {
    ...
    public static BakedQuad[] getConnectedTextureCtmCompact(int p_getConnectedTextureCtmCompact_0_, ConnectedProperties p_getConnectedTextureCtmCompact_1_, int p_getConnectedTextureCtmCompact_2_, BakedQuad p_getConnectedTextureCtmCompact_3_, RenderEnv p_getConnectedTextureCtmCompact_4_) {
        int i2;
        if (p_getConnectedTextureCtmCompact_1_.ctmTileIndexes != null && p_getConnectedTextureCtmCompact_0_ >= 0 && p_getConnectedTextureCtmCompact_0_ < p_getConnectedTextureCtmCompact_1_.ctmTileIndexes.length && (i2 = p_getConnectedTextureCtmCompact_1_.ctmTileIndexes[p_getConnectedTextureCtmCompact_0_]) >= 0 && i2 <= p_getConnectedTextureCtmCompact_1_.tileIcons.length) {
            return ConnectedTexturesCompact.getQuadsCompact(i2, p_getConnectedTextureCtmCompact_1_.tileIcons, p_getConnectedTextureCtmCompact_3_, p_getConnectedTextureCtmCompact_4_);
        }
    ...
    private static BakedQuad getQuadCompact(TextureAtlasSprite p_getQuadCompact_0_, Dir p_getQuadCompact_1_, int p_getQuadCompact_2_, int p_getQuadCompact_3_, int p_getQuadCompact_4_, int p_getQuadCompact_5_, int p_getQuadCompact_6_, BakedQuad p_getQuadCompact_7_, RenderEnv p_getQuadCompact_8_) {
        ...
        int i2 = p_getQuadCompact_0_.getIndexInMap();
        if (i2 >= 0 && i2 < amap.length) {
            BakedQuad bakedquad;
    ...
    private static BakedQuad makeSpriteQuadCompact(BakedQuad p_makeSpriteQuadCompact_0_, TextureAtlasSprite p_makeSpriteQuadCompact_1_, int p_makeSpriteQuadCompact_2_, int p_makeSpriteQuadCompact_3_, int p_makeSpriteQuadCompact_4_, int p_makeSpriteQuadCompact_5_, int p_makeSpriteQuadCompact_6_) {
        ...
        for (int i2 = 0; i2 < 4; ++i2) {
            ConnectedTexturesCompact.fixVertexCompact(aint, i2, textureatlassprite, p_makeSpriteQuadCompact_1_, p_makeSpriteQuadCompact_2_, p_makeSpriteQuadCompact_3_, p_makeSpriteQuadCompact_4_, p_makeSpriteQuadCompact_5_, p_makeSpriteQuadCompact_6_);
        }
    ...
    private static void fixVertexCompact(int[] p_fixVertexCompact_0_, int p_fixVertexCompact_1_, TextureAtlasSprite p_fixVertexCompact_2_, TextureAtlasSprite p_fixVertexCompact_3_, int p_fixVertexCompact_4_, int p_fixVertexCompact_5_, int p_fixVertexCompact_6_, int p_fixVertexCompact_7_, int p_fixVertexCompact_8_) {
        float f6;
        float f5;
        int i2 = p_fixVertexCompact_0_.length / 4;
        int j2 = i2 * p_fixVertexCompact_1_;
        float f2 = Float.intBitsToFloat(p_fixVertexCompact_0_[j2 + 4]);
        float f1 = Float.intBitsToFloat(p_fixVertexCompact_0_[j2 + 4 + 1]);
        double d0 = p_fixVertexCompact_2_.getSpriteU16(f2);
        double d1 = p_fixVertexCompact_2_.getSpriteV16(f1);
        float f22 = Float.intBitsToFloat(p_fixVertexCompact_0_[j2 + 0]);
        float f3 = Float.intBitsToFloat(p_fixVertexCompact_0_[j2 + 1]);
        float f4 = Float.intBitsToFloat(p_fixVertexCompact_0_[j2 + 2]);
        ...
        p_fixVertexCompact_0_[j2 + 4] = Float.floatToRawIntBits(p_fixVertexCompact_3_.getInterpolatedU(d0));
        p_fixVertexCompact_0_[j2 + 4 + 1] = Float.floatToRawIntBits(p_fixVertexCompact_3_.getInterpolatedV(d1));
        p_fixVertexCompact_0_[j2 + 0] = Float.floatToRawIntBits(f22);
        p_fixVertexCompact_0_[j2 + 1] = Float.floatToRawIntBits(f3);
        p_fixVertexCompact_0_[j2 + 2] = Float.floatToRawIntBits(f4);
    }
