...
extends EntityDamageSource {
    ...
    public ITextComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
        ...
        String s2 = "death.attack." + this.damageType;
        String s1 = String.valueOf(s2) + ".item";
        return !itemstack.func_190926_b() && itemstack.hasDisplayName() && I18n.canTranslate(s1) ? new TextComponentTranslation(s1, entityLivingBaseIn.getDisplayName(), itextcomponent, itemstack.getTextComponent()) : new TextComponentTranslation(s2, entityLivingBaseIn.getDisplayName(), itextcomponent);
    }
}
