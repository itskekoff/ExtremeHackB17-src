...
public class Vec3d {
    ...
    public Vec3d subtract(double x2, double y2, double z2) {
    ...
    public Vec3d addVector(double x2, double y2, double z2) {
        return new Vec3d(this.xCoord + x2, this.yCoord + y2, this.zCoord + z2);
    }
    ...
    @Nullable
    public Vec3d getIntermediateWithXValue(Vec3d vec, double x2) {
        double d0 = vec.xCoord - this.xCoord;
        double d1 = vec.yCoord - this.yCoord;
        double d2 = vec.zCoord - this.zCoord;
    ...
    @Nullable
    public Vec3d getIntermediateWithZValue(Vec3d vec, double z2) {
        double d0 = vec.xCoord - this.xCoord;
        double d1 = vec.yCoord - this.yCoord;
        double d2 = vec.zCoord - this.zCoord;
    ...
    public int hashCode() {
        long j2 = Double.doubleToLongBits(this.xCoord);
        int i2 = (int)(j2 ^ j2 >>> 32);
        j2 = Double.doubleToLongBits(this.yCoord);
        i2 = 31 * i2 + (int)(j2 ^ j2 >>> 32);
        j2 = Double.doubleToLongBits(this.zCoord);
        i2 = 31 * i2 + (int)(j2 ^ j2 >>> 32);
        return i2;
    }
    ...
    public static Vec3d fromPitchYaw(float p_189986_0_, float p_189986_1_) {
        ...
        float f22 = -MathHelper.cos(-p_189986_0_ * ((float)Math.PI / 180));
