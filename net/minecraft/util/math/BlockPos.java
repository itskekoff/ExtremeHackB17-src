...
extends Vec3i {
    ...
    public static Iterable<BlockPos> getAllInBox(BlockPos from, BlockPos to2) {
        return BlockPos.func_191532_a(Math.min(from.getX(), to2.getX()), Math.min(from.getY(), to2.getY()), Math.min(from.getZ(), to2.getZ()), Math.max(from.getX(), to2.getX()), Math.max(from.getY(), to2.getY()), Math.max(from.getZ(), to2.getZ()));
    }
    ...
    public static Iterable<MutableBlockPos> getAllInBoxMutable(BlockPos from, BlockPos to2) {
        return BlockPos.func_191531_b(Math.min(from.getX(), to2.getX()), Math.min(from.getY(), to2.getY()), Math.min(from.getZ(), to2.getZ()), Math.max(from.getX(), to2.getX()), Math.max(from.getY(), to2.getY()), Math.max(from.getZ(), to2.getZ()));
    }
    ...
    extends BlockPos {
        ...
        @Override
        public BlockPos add(double x2, double y2, double z2) {
            return super.add(x2, y2, z2).toImmutable();
        }
        ...
        @Override
        public BlockPos offset(EnumFacing facing, int n2) {
            return super.offset(facing, n2).toImmutable();
        }
