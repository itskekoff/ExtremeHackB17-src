...
public class AxisAlignedBB {
    ...
    public int hashCode() {
        long i2 = Double.doubleToLongBits(this.minX);
        int j2 = (int)(i2 ^ i2 >>> 32);
        i2 = Double.doubleToLongBits(this.minY);
        j2 = 31 * j2 + (int)(i2 ^ i2 >>> 32);
        i2 = Double.doubleToLongBits(this.minZ);
        j2 = 31 * j2 + (int)(i2 ^ i2 >>> 32);
        i2 = Double.doubleToLongBits(this.maxX);
        j2 = 31 * j2 + (int)(i2 ^ i2 >>> 32);
        i2 = Double.doubleToLongBits(this.maxY);
        j2 = 31 * j2 + (int)(i2 ^ i2 >>> 32);
        i2 = Double.doubleToLongBits(this.maxZ);
        j2 = 31 * j2 + (int)(i2 ^ i2 >>> 32);
        return j2;
    }
