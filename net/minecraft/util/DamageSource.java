...
public class DamageSource {
    ...
    public ITextComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
        ...
        String s1 = String.valueOf(s2) + ".player";
        return entitylivingbase != null && I18n.canTranslate(s1) ? new TextComponentTranslation(s1, entityLivingBaseIn.getDisplayName(), entitylivingbase.getDisplayName()) : new TextComponentTranslation(s2, entityLivingBaseIn.getDisplayName());
    }
