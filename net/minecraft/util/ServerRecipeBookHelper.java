...
public class ServerRecipeBookHelper {
    ...
    private void func_194326_a() {
        ...
        for (int i2 = 0; i2 < this.field_194336_g.getSizeInventory(); ++i2) {
            ItemStack itemstack = this.field_194336_g.getStackInSlot(i2);
            if (itemstack.func_190926_b()) continue;
            while (itemstack.func_190916_E() > 0) {
                int j2 = inventoryplayer.storeItemStack(itemstack);
                if (j2 == -1) {
                    j2 = inventoryplayer.getFirstEmptyStack();
                }
                ItemStack itemstack1 = itemstack.copy();
                itemstack1.func_190920_e(1);
                inventoryplayer.func_191971_c(j2, itemstack1);
                this.field_194336_g.decrStackSize(i2, 1);
            }
        }
    ...
    private void func_194329_b() {
        ...
        int i2 = this.field_194331_b.func_194114_b(this.field_194333_d, null);
        if (flag) {
            boolean flag1 = true;
            for (int j2 = 0; j2 < this.field_194336_g.getSizeInventory(); ++j2) {
                ItemStack itemstack = this.field_194336_g.getStackInSlot(j2);
                if (itemstack.func_190926_b() || Math.min(i2, itemstack.getMaxStackSize()) <= itemstack.func_190916_E()) continue;
                flag1 = false;
            }
            if (flag1) {
                return;
        ...
        if (this.field_194331_b.func_194118_a(this.field_194333_d, intlist = new IntArrayList(), i1 = this.func_194324_a(i2, flag))) {
            int j1 = i1;
            IntListIterator intlistiterator = intlist.iterator();
            while (intlistiterator.hasNext()) {
                int k2 = (Integer)intlistiterator.next();
                int l2 = RecipeItemHelper.func_194115_b(k2).getMaxStackSize();
                if (l2 >= j1) continue;
                j1 = l2;
            }
    ...
    private int func_194324_a(int p_194324_1_, boolean p_194324_2_) {
        ...
        if (this.field_194334_e) {
            ...
            for (int j2 = 0; j2 < this.field_194336_g.getSizeInventory(); ++j2) {
                ItemStack itemstack = this.field_194336_g.getStackInSlot(j2);
                if (itemstack.func_190926_b() || i2 <= itemstack.func_190916_E()) continue;
    ...
    private void func_194323_a(int p_194323_1_, IntList p_194323_2_) {
        int i2 = this.field_194336_g.getWidth();
        int j2 = this.field_194336_g.getHeight();
        if (this.field_194333_d instanceof ShapedRecipes) {
            ShapedRecipes shapedrecipes = (ShapedRecipes)this.field_194333_d;
            i2 = shapedrecipes.func_192403_f();
            j2 = shapedrecipes.func_192404_g();
        }
        int j1 = 1;
        IntListIterator iterator = p_194323_2_.iterator();
        for (int k2 = 0; k2 < this.field_194336_g.getWidth() && j2 != k2; ++k2) {
            for (int l2 = 0; l2 < this.field_194336_g.getHeight(); ++l2) {
                if (i2 == l2 || !iterator.hasNext()) {
                    j1 += this.field_194336_g.getWidth() - l2;
                    break;
                }
    ...
    private void func_194325_a(Slot p_194325_1_, ItemStack p_194325_2_) {
        ItemStack itemstack;
        InventoryPlayer inventoryplayer = this.field_194332_c.inventory;
        int i2 = inventoryplayer.func_194014_c(p_194325_2_);
        if (i2 != -1 && !(itemstack = inventoryplayer.getStackInSlot(i2).copy()).func_190926_b()) {
            if (itemstack.func_190916_E() > 1) {
                inventoryplayer.decrStackSize(i2, 1);
            } else {
                inventoryplayer.removeStackFromSlot(i2);
            }
