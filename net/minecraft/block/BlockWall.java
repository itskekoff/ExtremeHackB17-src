...
extends Block {
    ...
    public void addCollisionBoxToList(IBlockState state, World worldIn, BlockPos pos, AxisAlignedBB entityBox, List<AxisAlignedBB> collidingBoxes, @Nullable Entity entityIn, boolean p_185477_7_) {
        ...
        this.addCollisionBoxToList(pos, entityBox, collidingBoxes, CLIP_AABB_BY_INDEX[BlockWall.getAABBIndex(state)]);
    }
    ...
    private boolean canConnectTo(IBlockAccess worldIn, BlockPos pos, EnumFacing p_176253_3_) {
        ...
        boolean bl2 = flag = blockfaceshape == BlockFaceShape.MIDDLE_POLE_THICK || blockfaceshape == BlockFaceShape.MIDDLE_POLE && block instanceof BlockFenceGate;
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        static {
            ...
            int n2 = arrenumType.length;
            for (int i2 = 0; i2 < n2; ++i2) {
                EnumType blockwall$enumtype;
                EnumType.META_LOOKUP[blockwall$enumtype.getMetadata()] = blockwall$enumtype = arrenumType[i2];
            }
        }
