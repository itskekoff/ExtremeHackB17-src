...
extends Block {
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        ...
        int j2 = 2;
        int k2 = pos.getX();
        if (worldIn.isAreaLoaded(new BlockPos(k2 - 2, (l2 = pos.getY()) - 2, (i1 = pos.getZ()) - 2), new BlockPos(k2 + 2, l2 + 2, i1 + 2))) {
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (!worldIn.isRemote && state.getValue(CHECK_DECAY).booleanValue() && state.getValue(DECAYABLE).booleanValue()) {
            ...
            if (worldIn.isAreaLoaded(new BlockPos(k2 - 5, l3 - 5, i1 - 5), new BlockPos(k2 + 5, l3 + 5, i1 + 5))) {
                BlockPos.MutableBlockPos blockpos$mutableblockpos = new BlockPos.MutableBlockPos();
                for (int i22 = -4; i22 <= 4; ++i22) {
                    for (int j22 = -4; j22 <= 4; ++j22) {
                        for (int k22 = -4; k22 <= 4; ++k22) {
                            IBlockState iblockstate = worldIn.getBlockState(blockpos$mutableblockpos.setPos(k2 + i22, l3 + j22, i1 + k22));
                            Block block = iblockstate.getBlock();
                            if (block != Blocks.LOG && block != Blocks.LOG2) {
                                if (iblockstate.getMaterial() == Material.LEAVES) {
                                    this.surroundings[(i22 + 16) * 1024 + (j22 + 16) * 32 + k22 + 16] = -2;
                                    continue;
                                }
                                this.surroundings[(i22 + 16) * 1024 + (j22 + 16) * 32 + k22 + 16] = -1;
                                continue;
                            }
                            this.surroundings[(i22 + 16) * 1024 + (j22 + 16) * 32 + k22 + 16] = 0;
                        }
                    }
                }
                for (int i3 = 1; i3 <= 4; ++i3) {
                    for (int j3 = -4; j3 <= 4; ++j3) {
                        for (int k3 = -4; k3 <= 4; ++k3) {
                            for (int l32 = -4; l32 <= 4; ++l32) {
                                if (this.surroundings[(j3 + 16) * 1024 + (k3 + 16) * 32 + l32 + 16] != i3 - 1) continue;
                                if (this.surroundings[(j3 + 16 - 1) * 1024 + (k3 + 16) * 32 + l32 + 16] == -2) {
                                    this.surroundings[(j3 + 16 - 1) * 1024 + (k3 + 16) * 32 + l32 + 16] = i3;
                                }
                                if (this.surroundings[(j3 + 16 + 1) * 1024 + (k3 + 16) * 32 + l32 + 16] == -2) {
                                    this.surroundings[(j3 + 16 + 1) * 1024 + (k3 + 16) * 32 + l32 + 16] = i3;
                                }
                                if (this.surroundings[(j3 + 16) * 1024 + (k3 + 16 - 1) * 32 + l32 + 16] == -2) {
                                    this.surroundings[(j3 + 16) * 1024 + (k3 + 16 - 1) * 32 + l32 + 16] = i3;
                                }
                                if (this.surroundings[(j3 + 16) * 1024 + (k3 + 16 + 1) * 32 + l32 + 16] == -2) {
                                    this.surroundings[(j3 + 16) * 1024 + (k3 + 16 + 1) * 32 + l32 + 16] = i3;
                                }
                                if (this.surroundings[(j3 + 16) * 1024 + (k3 + 16) * 32 + (l32 + 16 - 1)] == -2) {
                                    this.surroundings[(j3 + 16) * 1024 + (k3 + 16) * 32 + (l32 + 16 - 1)] = i3;
                                }
                                if (this.surroundings[(j3 + 16) * 1024 + (k3 + 16) * 32 + l32 + 16 + 1] != -2) continue;
                                this.surroundings[(j3 + 16) * 1024 + (k3 + 16) * 32 + l32 + 16 + 1] = i3;
                            }
                        }
                    }
