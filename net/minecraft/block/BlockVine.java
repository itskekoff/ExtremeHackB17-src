...
extends Block {
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        ...
        return i2 == 1 ? axisalignedbb : FULL_BLOCK_AABB;
    }
        ...
        if (!worldIn.isRemote && worldIn.rand.nextInt(4) == 0) {
            ...
            if (enumfacing1 == EnumFacing.UP && pos.getY() < 255 && worldIn.isAirBlock(blockpos2)) {
                ...
                for (EnumFacing enumfacing2 : EnumFacing.Plane.HORIZONTAL) {
                    iblockstate2 = rand.nextBoolean() && this.func_193395_a(worldIn, blockpos2, enumfacing2.getOpposite()) ? iblockstate2.withProperty(BlockVine.getPropertyFor(enumfacing2), true) : iblockstate2.withProperty(BlockVine.getPropertyFor(enumfacing2), false);
                }
    ...
    public static int getNumGrownFaces(IBlockState state) {
        int i2 = 0;
        PropertyBool[] arrpropertyBool = ALL_FACES;
        int n2 = ALL_FACES.length;
        for (int i3 = 0; i3 < n2; ++i3) {
            PropertyBool propertybool = arrpropertyBool[i3];
