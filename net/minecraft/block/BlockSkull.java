...
extends BlockContainer {
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (tileentity instanceof TileEntitySkull) {
            i2 = ((TileEntitySkull)tileentity).getSkullType();
        }
        return new ItemStack(Items.SKULL, 1, i2);
    }
    ...
    public void checkWitherSpawn(World worldIn, BlockPos pos, TileEntitySkull te2) {
        BlockPattern blockpattern;
        BlockPattern.PatternHelper blockpattern$patternhelper;
        if (te2.getSkullType() == 1 && pos.getY() >= 2 && worldIn.getDifficulty() != EnumDifficulty.PEACEFUL && !worldIn.isRemote && (blockpattern$patternhelper = (blockpattern = this.getWitherPattern()).match(worldIn, pos)) != null) {
