...
implements IGrowable {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        switch (state.getValue(TYPE)) {
            case SPRUCE: {
                block7: for (i2 = 0; i2 >= -1; --i2) {
                    for (j2 = 0; j2 >= -1; --j2) {
                        if (!this.isTwoByTwoOfType(worldIn, pos, i2, j2, BlockPlanks.EnumType.SPRUCE)) continue;
            ...
            case JUNGLE: {
                ...
                block9: for (i2 = 0; i2 >= -1; --i2) {
                    for (j2 = 0; j2 >= -1; --j2) {
                        if (!this.isTwoByTwoOfType(worldIn, pos, i2, j2, BlockPlanks.EnumType.JUNGLE)) continue;
            ...
            case DARK_OAK: {
                block11: for (i2 = 0; i2 >= -1; --i2) {
                    for (j2 = 0; j2 >= -1; --j2) {
                        if (!this.isTwoByTwoOfType(worldIn, pos, i2, j2, BlockPlanks.EnumType.DARK_OAK)) continue;
