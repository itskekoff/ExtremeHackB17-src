        ...
        block11: {
            ...
            block10: {
                ...
                for (int i2 = 0; i2 < this.getSnowmanPattern().getThumbLength(); ++i2) {
                    BlockWorldState blockworldstate = blockpattern$patternhelper.translateOffset(0, i2, 0);
            ...
            for (int j2 = 0; j2 < this.getGolemPattern().getPalmLength(); ++j2) {
                for (int k2 = 0; k2 < this.getGolemPattern().getThumbLength(); ++k2) {
                    worldIn.setBlockState(blockpattern$patternhelper.translateOffset(j2, k2, 0).getPos(), Blocks.AIR.getDefaultState(), 2);
                }
            }
