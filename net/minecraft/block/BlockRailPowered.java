...
extends BlockRailBase {
    ...
    protected boolean findPoweredRailSignal(World worldIn, BlockPos pos, IBlockState state, boolean p_176566_4_, int p_176566_5_) {
        ...
        if (this.isSameRailWithPower(worldIn, new BlockPos(i2, j2, k2), p_176566_4_, p_176566_5_, blockrailbase$enumraildirection)) {
            return true;
        }
        return flag && this.isSameRailWithPower(worldIn, new BlockPos(i2, j2 - 1, k2), p_176566_4_, p_176566_5_, blockrailbase$enumraildirection);
    }
    ...
    protected void updateState(IBlockState p_189541_1_, World p_189541_2_, BlockPos p_189541_3_, Block p_189541_4_) {
        ...
        boolean bl2 = flag1 = p_189541_2_.isBlockPowered(p_189541_3_) || this.findPoweredRailSignal(p_189541_2_, p_189541_3_, p_189541_1_, true, 0) || this.findPoweredRailSignal(p_189541_2_, p_189541_3_, p_189541_1_, false, 0);
        if (flag1 != flag) {
