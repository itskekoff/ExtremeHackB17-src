...
extends Block {
    ...
    private boolean canPlaceOn(World worldIn, BlockPos pos) {
        ...
        boolean bl2 = flag = block == Blocks.END_GATEWAY || block == Blocks.LIT_PUMPKIN;
        if (worldIn.getBlockState(pos).isFullyOpaque()) {
            return !flag;
        }
        boolean bl3 = flag1 = block instanceof BlockFence || block == Blocks.GLASS || block == Blocks.COBBLESTONE_WALL || block == Blocks.STAINED_GLASS;
        return flag1 && !flag;
    }
