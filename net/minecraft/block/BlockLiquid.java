...
extends Block {
    ...
    protected int getRenderedDepth(IBlockState p_189545_1_) {
        int i2 = this.getDepth(p_189545_1_);
        return i2 >= 8 ? 0 : i2;
    }
    ...
    private boolean isBlockSolid(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        ...
        boolean bl2 = flag = BlockLiquid.func_193382_c(block) || block instanceof BlockStairs;
    ...
    protected Vec3d getFlow(IBlockAccess p_189543_1_, BlockPos p_189543_2_, IBlockState p_189543_3_) {
        ...
        double d1 = 0.0;
        double d2 = 0.0;
        int i2 = this.getRenderedDepth(p_189543_3_);
        BlockPos.PooledMutableBlockPos blockpos$pooledmutableblockpos = BlockPos.PooledMutableBlockPos.retain();
        for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
            blockpos$pooledmutableblockpos.setPos(p_189543_2_).move(enumfacing);
            int j2 = this.getRenderedDepth(p_189543_1_.getBlockState(blockpos$pooledmutableblockpos));
            if (j2 < 0) {
                if (p_189543_1_.getBlockState(blockpos$pooledmutableblockpos).getMaterial().blocksMovement() || (j2 = this.getRenderedDepth(p_189543_1_.getBlockState(blockpos$pooledmutableblockpos.down()))) < 0) continue;
                int k2 = j2 - (i2 - 8);
                d0 += (double)(enumfacing.getFrontOffsetX() * k2);
                d1 += (double)(enumfacing.getFrontOffsetY() * k2);
                d2 += (double)(enumfacing.getFrontOffsetZ() * k2);
                continue;
            }
            if (j2 < 0) continue;
            int l2 = j2 - i2;
            d0 += (double)(enumfacing.getFrontOffsetX() * l2);
            d1 += (double)(enumfacing.getFrontOffsetY() * l2);
            d2 += (double)(enumfacing.getFrontOffsetZ() * l2);
        }
    ...
    public int getPackedLightmapCoords(IBlockState state, IBlockAccess source, BlockPos pos) {
        int i2 = source.getCombinedLight(pos, 0);
        int j2 = source.getCombinedLight(pos.up(), 0);
        int k2 = i2 & 0xFF;
        int l2 = j2 & 0xFF;
        int i1 = i2 >> 16 & 0xFF;
        int j1 = j2 >> 16 & 0xFF;
    ...
    public static float func_190973_f(IBlockState p_190973_0_, IBlockAccess p_190973_1_, BlockPos p_190973_2_) {
        int i2 = p_190973_0_.getValue(LEVEL);
        return (i2 & 7) == 0 && p_190973_1_.getBlockState(p_190973_2_.up()).getMaterial() == Material.WATER ? 1.0f : 1.0f - BlockLiquid.getLiquidHeightPercent(i2);
    }
