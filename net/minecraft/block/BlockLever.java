...
extends Block {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing heldItem, float side, float hitX, float hitY) {
        ...
        float f2 = state.getValue(POWERED) != false ? 0.6f : 0.5f;
        worldIn.playSound(null, pos, SoundEvents.BLOCK_LEVER_CLICK, SoundCategory.BLOCKS, 0.3f, f2);
    ...
    public static enum EnumOrientation implements IStringSerializable
    {
        ...
        static {
            ...
            int n2 = arrenumOrientation.length;
            for (int i2 = 0; i2 < n2; ++i2) {
                EnumOrientation blocklever$enumorientation;
                EnumOrientation.META_LOOKUP[blocklever$enumorientation.getMetadata()] = blocklever$enumorientation = arrenumOrientation[i2];
            }
        }
