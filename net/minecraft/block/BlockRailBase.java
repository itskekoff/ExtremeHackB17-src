...
extends Block {
    ...
    public static enum EnumRailDirection implements IStringSerializable
    {
        ...
        static {
            ...
            int n2 = arrenumRailDirection.length;
            for (int i2 = 0; i2 < n2; ++i2) {
                EnumRailDirection blockrailbase$enumraildirection;
                EnumRailDirection.META_LOOKUP[blockrailbase$enumraildirection.getMetadata()] = blockrailbase$enumraildirection = arrenumRailDirection[i2];
            }
        }
    ...
    public class Rail {
        ...
        private void removeSoftConnections() {
            for (int i2 = 0; i2 < this.connectedRails.size(); ++i2) {
                Rail blockrailbase$rail = this.findRailAt(this.connectedRails.get(i2));
                if (blockrailbase$rail != null && blockrailbase$rail.isConnectedToRail(this)) {
                    this.connectedRails.set(i2, blockrailbase$rail.pos);
                    continue;
                }
        ...
        private boolean isConnectedTo(BlockPos posIn) {
            for (int i2 = 0; i2 < this.connectedRails.size(); ++i2) {
                BlockPos blockpos = this.connectedRails.get(i2);
