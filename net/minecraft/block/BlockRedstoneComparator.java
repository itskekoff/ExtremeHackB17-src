...
implements ITileEntityProvider {
    ...
    protected int calculateInputStrength(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (iblockstate.hasComparatorInputOverride()) {
            i2 = iblockstate.getComparatorInputOverride(worldIn, blockpos);
        } else if (i2 < 15 && iblockstate.isNormalCube()) {
            ...
            if (iblockstate.hasComparatorInputOverride()) {
                ...
                i2 = entityitemframe.getAnalogOutput();
            }
        }
        return i2;
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing heldItem, float side, float hitX, float hitY) {
        ...
        float f2 = (state = state.cycleProperty(MODE)).getValue(MODE) == Mode.SUBTRACT ? 0.55f : 0.5f;
        worldIn.playSound(playerIn, pos, SoundEvents.BLOCK_COMPARATOR_CLICK, SoundCategory.BLOCKS, 0.3f, f2);
    ...
    public boolean eventReceived(IBlockState state, World worldIn, BlockPos pos, int id2, int param) {
        super.eventReceived(state, worldIn, pos, id2, param);
        TileEntity tileentity = worldIn.getTileEntity(pos);
        return tileentity == null ? false : tileentity.receiveClientEvent(id2, param);
    }
