...
implements ITileEntityProvider {
    ...
    public static BlockPos getSafeExitLocation(World worldIn, BlockPos pos, int tries) {
        ...
        for (int l2 = 0; l2 <= 1; ++l2) {
            ...
            int k1 = i1 + 2;
            int l1 = j1 + 2;
            for (int i22 = i1; i22 <= k1; ++i22) {
                for (int j22 = j1; j22 <= l1; ++j22) {
    ...
    @Override
    public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, TileEntity te2, ItemStack stack) {
        if (state.getValue(PART) == EnumPartType.HEAD && te2 instanceof TileEntityBed) {
            TileEntityBed tileentitybed = (TileEntityBed)te2;
