...
implements ITileEntityProvider {
    ...
    public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, @Nullable TileEntity te2, ItemStack stack) {
        if (te2 instanceof IWorldNameable && ((IWorldNameable)((Object)te2)).hasCustomName()) {
            ...
            Item item = this.getItemDropped(state, worldIn.rand, i2);
            if (item == Items.field_190931_a) {
                return;
            }
            ItemStack itemstack = new ItemStack(item, this.quantityDropped(worldIn.rand));
            itemstack.setStackDisplayName(((IWorldNameable)((Object)te2)).getName());
