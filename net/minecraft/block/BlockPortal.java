...
extends BlockBreakable {
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        if (worldIn.provider.isSurfaceWorld() && worldIn.getGameRules().getBoolean("doMobSpawning") && rand.nextInt(2000) < worldIn.getDifficulty().getDifficultyId()) {
            ...
            if (i2 > 0 && !worldIn.getBlockState(blockpos.up()).isNormalCube() && (entity = ItemMonsterPlacer.spawnCreature(worldIn, EntityList.func_191306_a(EntityPigZombie.class), (double)blockpos.getX() + 0.5, (double)blockpos.getY() + 1.1, (double)blockpos.getZ() + 0.5)) != null) {
    ...
    public BlockPattern.PatternHelper createPatternHelper(World worldIn, BlockPos p_181089_2_) {
        ...
        EnumFacing.AxisDirection[] arraxisDirection = EnumFacing.AxisDirection.values();
        int n2 = arraxisDirection.length;
        for (int i2 = 0; i2 < n2; ++i2) {
            EnumFacing.AxisDirection enumfacing$axisdirection = arraxisDirection[i2];
            BlockPattern.PatternHelper blockpattern$patternhelper = new BlockPattern.PatternHelper(enumfacing.getAxisDirection() == enumfacing$axisdirection ? blockpos : blockpos.offset(blockportal$size.rightDir, blockportal$size.getWidth() - 1), EnumFacing.getFacingFromAxis(enumfacing$axisdirection, enumfacing$axis), EnumFacing.UP, loadingcache, blockportal$size.getWidth(), blockportal$size.getHeight(), 1);
            for (int i3 = 0; i3 < blockportal$size.getWidth(); ++i3) {
                for (int j2 = 0; j2 < blockportal$size.getHeight(); ++j2) {
                    BlockWorldState blockworldstate = blockpattern$patternhelper.translateOffset(i3, j2, 1);
    ...
    public static class Size {
        ...
        public Size(World worldIn, BlockPos p_i45694_2_, EnumFacing.Axis p_i45694_3_) {
            ...
            int i2 = this.getDistanceUntilEdge(p_i45694_2_, this.leftDir) - 1;
            if (i2 >= 0) {
                this.bottomLeft = p_i45694_2_.offset(this.leftDir, i2);
        ...
        protected int calculatePortalHeight() {
            ...
            block0: while (this.height < 21) {
                for (int i2 = 0; i2 < this.width; ++i2) {
                    BlockPos blockpos = this.bottomLeft.offset(this.rightDir, i2).up(this.height);
                    Block block = this.world.getBlockState(blockpos).getBlock();
                    if (!this.isEmptyBlock(block)) break block0;
                    if (block == Blocks.PORTAL) {
                        ++this.portalBlockCount;
                    }
                    if (i2 == 0 ? (block = this.world.getBlockState(blockpos.offset(this.leftDir)).getBlock()) != Blocks.OBSIDIAN : i2 == this.width - 1 && (block = this.world.getBlockState(blockpos.offset(this.rightDir)).getBlock()) != Blocks.OBSIDIAN) break block0;
                }
                ++this.height;
            }
            for (int j2 = 0; j2 < this.width; ++j2) {
                if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j2).up(this.height)).getBlock() == Blocks.OBSIDIAN) continue;
                this.height = 0;
                break;
            }
        ...
        public void placePortalBlocks() {
            for (int i2 = 0; i2 < this.width; ++i2) {
                BlockPos blockpos = this.bottomLeft.offset(this.rightDir, i2);
