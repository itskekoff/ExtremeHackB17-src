...
extends BlockContainer {
    ...
    private static void func_193386_c(World p_193386_0_, BlockPos p_193386_1_, EnumFacing p_193386_2_) {
        ...
        int i2 = gamerules.getInt("maxCommandChainLength");
        while (i2-- > 0) {
        ...
        if (i2 <= 0) {
            int j2 = Math.max(gamerules.getInt("maxCommandChainLength"), 0);
            field_193388_c.warn("Commandblock chain tried to execure more than " + j2 + " steps!");
        }
    }
}
