...
extends BlockIce {
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos p_189540_5_) {
        int i2;
        if (blockIn == this && (i2 = this.countNeighbors(worldIn, pos)) < 2) {
    ...
    private int countNeighbors(World p_185680_1_, BlockPos p_185680_2_) {
        ...
        for (EnumFacing enumfacing : EnumFacing.values()) {
            if (p_185680_1_.getBlockState(p_185680_2_.offset(enumfacing)).getBlock() != this || ++i2 < 4) continue;
            return i2;
        }
        return i2;
    }
    ...
    protected void slightlyMelt(World p_185681_1_, BlockPos p_185681_2_, IBlockState p_185681_3_, Random p_185681_4_, boolean p_185681_5_) {
        int i2 = p_185681_3_.getValue(AGE);
        if (i2 < 3) {
            p_185681_1_.setBlockState(p_185681_2_, p_185681_3_.withProperty(AGE, i2 + 1), 2);
