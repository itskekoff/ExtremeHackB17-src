...
implements IInventory {
    ...
    public ItemStack addItem(ItemStack stack) {
        ...
        for (int i2 = 0; i2 < this.slotsCount; ++i2) {
            ...
            int j2 = Math.min(this.getInventoryStackLimit(), itemstack1.getMaxStackSize());
            int k2 = Math.min(itemstack.func_190916_E(), j2 - itemstack1.func_190916_E());
            if (k2 <= 0) continue;
            itemstack1.func_190917_f(k2);
    ...
    public void markDirty() {
        if (this.changeListeners != null) {
            for (int i2 = 0; i2 < this.changeListeners.size(); ++i2) {
                this.changeListeners.get(i2).onInventoryChanged(this);
            }
        }
    }
