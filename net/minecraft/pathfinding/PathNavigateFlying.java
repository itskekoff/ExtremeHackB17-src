...
extends PathNavigate {
    ...
    protected boolean isDirectPathBetweenPoints(Vec3d posVec31, Vec3d posVec32, int sizeX, int sizeY, int sizeZ) {
        ...
        int j2 = MathHelper.floor(posVec31.yCoord);
        int k2 = MathHelper.floor(posVec31.zCoord);
        ...
        double d8 = (double)i2 - posVec31.xCoord;
        double d9 = (double)j2 - posVec31.yCoord;
        double d10 = (double)k2 - posVec31.zCoord;
        if (d0 >= 0.0) {
            d8 += 1.0;
        }
        if (d1 >= 0.0) {
        ...
        int i22 = MathHelper.floor(posVec32.zCoord);
        int j22 = k1 - i2;
        int k22 = l1 - j2;
        int l22 = i22 - k2;
        while (j22 * l2 > 0 || k22 * i1 > 0 || l22 * j1 > 0) {
            if (d8 < d10 && d8 <= d9) {
                d8 += d5;
                j22 = k1 - (i2 += l2);
                continue;
