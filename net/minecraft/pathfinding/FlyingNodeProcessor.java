...
extends WalkNodeProcessor {
    ...
    public PathPoint getStart() {
        ...
        PathNodeType pathnodetype1 = this.func_192558_a(this.entity, blockpos1.getX(), i2, blockpos1.getZ());
        ...
        return super.openPoint(blockpos1.getX(), i2, blockpos1.getZ());
    }

    @Override
    public PathPoint getPathPointToCoords(double x2, double y2, double z2) {
        return super.openPoint(MathHelper.floor(x2), MathHelper.floor(y2), MathHelper.floor(z2));
    }
    ...
    public int findPathOptions(PathPoint[] pathOptions, PathPoint currentPoint, PathPoint targetPoint, float maxDistance) {
        ...
        boolean bl2 = flag5 = pathpoint5 == null || pathpoint5.costMalus != 0.0f;
    ...
    protected PathPoint openPoint(int x2, int y2, int z2) {
        ...
        PathNodeType pathnodetype = this.func_192558_a(this.entity, x2, y2, z2);
        float f2 = this.entity.getPathPriority(pathnodetype);
        if (f2 >= 0.0f) {
            pathpoint = super.openPoint(x2, y2, z2);
