...
public class Enchantments {
    ...
    @Nullable
    private static Enchantment getRegisteredEnchantment(String id2) {
        Enchantment enchantment = Enchantment.REGISTRY.getObject(new ResourceLocation(id2));
        if (enchantment == null) {
            throw new IllegalStateException("Invalid Enchantment requested: " + id2);
        }
        return enchantment;
    }
}
