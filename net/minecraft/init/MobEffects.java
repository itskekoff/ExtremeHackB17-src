...
public class MobEffects {
    ...
    @Nullable
    private static Potion getRegisteredMobEffect(String id2) {
        Potion potion = Potion.REGISTRY.getObject(new ResourceLocation(id2));
        if (potion == null) {
            throw new IllegalStateException("Invalid MobEffect requested: " + id2);
        }
        return potion;
    }
}
