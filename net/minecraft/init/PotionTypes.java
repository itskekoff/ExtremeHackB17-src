...
public class PotionTypes {
    ...
    private static PotionType getRegisteredPotionType(String id2) {
        PotionType potiontype = PotionType.REGISTRY.getObject(new ResourceLocation(id2));
        if (!CACHE.add(potiontype)) {
            throw new IllegalStateException("Invalid Potion requested: " + id2);
        }
        return potiontype;
    }
}
