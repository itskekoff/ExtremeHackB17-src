...
public abstract class Biomes {
    ...
    private static Biome getRegisteredBiome(String id2) {
        Biome biome = Biome.REGISTRY.getObject(new ResourceLocation(id2));
        if (biome == null) {
            throw new IllegalStateException("Invalid Biome requested: " + id2);
        }
        return biome;
    }
}
