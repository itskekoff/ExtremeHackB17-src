        ...
        this.targetEntity = this.taskOwner.world.getNearestAttackablePlayer(this.taskOwner.posX, this.taskOwner.posY + (double)this.taskOwner.getEyeHeight(), this.taskOwner.posZ, this.getTargetDistance(), this.getTargetDistance(), new Function<EntityPlayer, Double>(){
            ...
            public Double apply(@Nullable EntityPlayer p_apply_1_) {
                ...
                if (itemstack.getItem() == Items.SKULL) {
                    ...
                    boolean flag = EntityAINearestAttackableTarget.this.taskOwner instanceof EntitySkeleton && i2 == 0;
                    boolean flag1 = EntityAINearestAttackableTarget.this.taskOwner instanceof EntityZombie && i2 == 2;
                    boolean bl2 = flag2 = EntityAINearestAttackableTarget.this.taskOwner instanceof EntityCreeper && i2 == 4;
                    if (flag || flag1 || flag2) {
                        return 0.5;
                    }
                }
