...
extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        if (entitylivingbase != null) {
            ...
            boolean bl2 = flag1 = this.seeTime > 0;
            if (flag != flag1) {
                this.seeTime = 0;
            }
            ...
            if (((EntityLivingBase)this.entity).isHandActive()) {
                ...
                if (!flag && this.seeTime < -60) {
                    ((EntityLivingBase)this.entity).resetActiveHand();
                } else if (flag && (i2 = ((EntityLivingBase)this.entity).getItemInUseMaxCount()) >= 20) {
                    ((EntityLivingBase)this.entity).resetActiveHand();
                    ((IRangedAttackMob)this.entity).attackEntityWithRangedAttack(entitylivingbase, ItemBow.getArrowVelocity(i2));
