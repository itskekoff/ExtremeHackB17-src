...
extends EntityAITarget {
    ...
    public boolean shouldExecute() {
        ...
        int i2 = entitylivingbase.getLastAttackerTime();
        return i2 != this.timestamp && this.isSuitableTarget(this.theTarget, false) && this.theEntityTameable.shouldAttackEntity(this.theTarget, entitylivingbase);
    }
