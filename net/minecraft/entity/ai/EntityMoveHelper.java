...
public class EntityMoveHelper {
    ...
    public void onUpdateMoveHelper() {
        if (this.action == Action.STRAFE) {
            ...
            float f2 = (float)this.entity.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getAttributeValue();
            float f1 = (float)this.speed * f2;
            float f22 = this.moveForward;
            float f3 = this.moveStrafe;
            float f4 = MathHelper.sqrt(f22 * f22 + f3 * f3);
            if (f4 < 1.0f) {
                f4 = 1.0f;
            }
            f4 = f1 / f4;
            ...
            float f7 = (f22 *= f4) * f6 - (f3 *= f4) * f5;
            float f8 = f3 * f6 + f22 * f5;
    ...
    protected float limitAngle(float p_75639_1_, float p_75639_2_, float p_75639_3_) {
        float f1;
        float f2 = MathHelper.wrapDegrees(p_75639_2_ - p_75639_1_);
        if (f2 > p_75639_3_) {
            f2 = p_75639_3_;
        }
        if (f2 < -p_75639_3_) {
