...
extends EntityAIBase {
    ...
    protected boolean isSuitableTarget(@Nullable EntityLivingBase target, boolean includeInvincibles) {
        ...
        if (this.nearbyOnly) {
            ...
            if (this.targetSearchStatus == 0) {
                int n2 = this.targetSearchStatus = this.canEasilyReach(target) ? 1 : 2;
            }
    ...
    private boolean canEasilyReach(EntityLivingBase target) {
        ...
        int i2 = pathpoint.xCoord - MathHelper.floor(target.posX);
        return (double)(i2 * i2 + (j2 = pathpoint.zCoord - MathHelper.floor(target.posZ)) * j2) <= 2.25;
    }
