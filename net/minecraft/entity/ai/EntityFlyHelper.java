...
extends EntityMoveHelper {
    ...
    public void onUpdateMoveHelper() {
        if (this.action == EntityMoveHelper.Action.MOVE_TO) {
            ...
            this.entity.rotationYaw = this.limitAngle(this.entity.rotationYaw, f2, 10.0f);
            ...
            float f22 = (float)(-(MathHelper.atan2(d1, d4) * 57.29577951308232));
            this.entity.rotationPitch = this.limitAngle(this.entity.rotationPitch, f22, 10.0f);
