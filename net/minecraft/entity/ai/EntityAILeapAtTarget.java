...
extends EntityAIBase {
    ...
    public void startExecuting() {
        ...
        if ((double)f2 >= 1.0E-4) {
            this.leaper.motionX += d0 / (double)f2 * 0.5 * (double)0.8f + this.leaper.motionX * (double)0.2f;
            this.leaper.motionZ += d1 / (double)f2 * 0.5 * (double)0.8f + this.leaper.motionZ * (double)0.2f;
        }
