...
public class SharedMonsterAttributes {
    ...
    public static void setAttributeModifiers(AbstractAttributeMap map, NBTTagList list) {
        for (int i2 = 0; i2 < list.tagCount(); ++i2) {
            NBTTagCompound nbttagcompound = list.getCompoundTagAt(i2);
    ...
    private static void applyModifiersToAttributeInstance(IAttributeInstance instance, NBTTagCompound compound) {
        ...
        if (compound.hasKey("Modifiers", 9)) {
            ...
            for (int i2 = 0; i2 < nbttaglist.tagCount(); ++i2) {
                AttributeModifier attributemodifier = SharedMonsterAttributes.readAttributeModifierFromNBT(nbttaglist.getCompoundTagAt(i2));
