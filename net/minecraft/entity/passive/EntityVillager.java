...
IMerchant {
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand) {
        ...
        boolean bl2 = flag = itemstack.getItem() == Items.NAME_TAG;
        if (flag) {
            ...
            public NBTTagCompound process(IDataFixer fixer, NBTTagCompound compound, int versionIn) {
                ...
                if (EntityList.func_191306_a(EntityVillager.class).equals(new ResourceLocation(compound.getString("id"))) && compound.hasKey("Offers", 10) && (nbttagcompound = compound.getCompoundTag("Offers")).hasKey("Recipes", 9)) {
                    ...
                    for (int i2 = 0; i2 < nbttaglist.tagCount(); ++i2) {
                        ...
                        nbttaglist.set(i2, nbttagcompound1);
                    }
                }
                return compound;
            }
    ...
    public void readEntityFromNBT(NBTTagCompound compound) {
        ...
        for (int i2 = 0; i2 < nbttaglist.tagCount(); ++i2) {
            ItemStack itemstack = new ItemStack(nbttaglist.getCompoundTagAt(i2));
            if (itemstack.func_190926_b()) continue;
    ...
    public void setRevengeTarget(@Nullable EntityLivingBase livingBase) {
        ...
        if (this.villageObj != null && livingBase != null) {
            ...
            if (livingBase instanceof EntityPlayer) {
                ...
                this.villageObj.modifyPlayerReputation(livingBase.getName(), i2);
    ...
    public void useRecipe(MerchantRecipe recipe) {
        ...
        if (recipe.getRewardsExp()) {
            this.world.spawnEntityInWorld(new EntityXPOrb(this.world, this.posX, this.posY + 0.5, this.posZ, i2));
        }
    ...
    private void populateBuyingList() {
        ...
        if (i2 >= 0 && i2 < aentityvillager$itradelist.length) {
            ...
            if (j2 >= 0 && j2 < aentityvillager$itradelist1.length) {
                ...
                ITradeList[] arriTradeList = aentityvillager$itradelist2 = aentityvillager$itradelist1[j2];
                int n2 = aentityvillager$itradelist2.length;
                for (int i3 = 0; i3 < n2; ++i3) {
                    ITradeList entityvillager$itradelist = arriTradeList[i3];
    ...
    public ITextComponent getDisplayName() {
        ...
        if (s2 != null && !s2.isEmpty()) {
            TextComponentString textcomponentstring = new TextComponentString(ScorePlayerTeam.formatPlayerName(team, s2));
    ...
    public boolean wantsMoreFood() {
        boolean flag;
        boolean bl2 = flag = this.getProfession() == 0;
        if (flag) {
    ...
    implements ITradeList {
        ...
        public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
            int i2 = 1;
            if (this.price != null) {
                i2 = this.price.getPrice(p_190888_3_);
            }
            p_190888_2_.add(new MerchantRecipe(new ItemStack(this.buyingItem, i2, 0), Items.EMERALD));
        }
    }
    ...
    implements ITradeList {
        ...
        @Override
        public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
            int i2 = this.buyingPriceInfo.getPrice(p_190888_3_);
            int j2 = this.sellingPriceInfo.getPrice(p_190888_3_);
            p_190888_2_.add(new MerchantRecipe(new ItemStack(this.buyingItemStack.getItem(), i2, this.buyingItemStack.getMetadata()), new ItemStack(Items.EMERALD), new ItemStack(this.sellingItemstack.getItem(), j2, this.sellingItemstack.getMetadata())));
        }
    }
    ...
    implements ITradeList {
        ...
        public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
            ...
            int i2 = MathHelper.getInt(p_190888_3_, enchantment.getMinLevel(), enchantment.getMaxLevel());
            ItemStack itemstack = ItemEnchantedBook.getEnchantedItemStack(new EnchantmentData(enchantment, i2));
            int j2 = 2 + p_190888_3_.nextInt(5 + i2 * 10) + 3 * i2;
            ...
            p_190888_2_.add(new MerchantRecipe(new ItemStack(Items.BOOK), new ItemStack(Items.EMERALD, j2), itemstack));
        }
    }
    ...
    implements ITradeList {
        ...
        public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
            ...
            if (this.priceInfo != null) {
                i2 = this.priceInfo.getPrice(p_190888_3_);
            }
    ...
    implements ITradeList {
        ...
        public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
            ...
            if (i2 < 0) {
                ...
                itemstack1 = new ItemStack(this.itemToBuy.getItem(), -i2, this.itemToBuy.getMetadata());
            } else {
    ...
    implements ITradeList {
        ...
        @Override
        public void func_190888_a(IMerchant p_190888_1_, MerchantRecipeList p_190888_2_, Random p_190888_3_) {
            int i2 = this.field_190889_a.getPrice(p_190888_3_);
            ...
            if (blockpos != null) {
                ...
                p_190888_2_.add(new MerchantRecipe(new ItemStack(Items.EMERALD, i2), new ItemStack(Items.COMPASS), itemstack));
            }
        }
    }
}
