...
extends EntityAnimal {
    ...
    private void calculateRotationYaw(double x2, double z2) {
        this.rotationYaw = (float)(MathHelper.atan2(z2 - this.posZ, x2 - this.posX) * 57.29577951308232) - 90.0f;
    }
    ...
    public EntityRabbit createChild(EntityAgeable ageable) {
        ...
        int i2 = this.getRandomRabbitType();
        if (this.rand.nextInt(20) != 0) {
            i2 = ageable instanceof EntityRabbit && this.rand.nextBoolean() ? ((EntityRabbit)ageable).getRabbitType() : this.getRabbitType();
        }
        entityrabbit.setRabbitType(i2);
        return entityrabbit;
    }
    ...
    extends EntityMoveHelper {
        ...
        public void setMoveTo(double x2, double y2, double z2, double speedIn) {
            ...
            super.setMoveTo(x2, y2, z2, speedIn);
            if (speedIn > 0.0) {
