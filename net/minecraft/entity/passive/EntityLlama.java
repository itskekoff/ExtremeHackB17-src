...
implements IRangedAttackMob {
    ...
    private void func_190705_dT() {
        int i2 = this.rand.nextFloat() < 0.04f ? 5 : 3;
        this.func_190706_p(1 + this.rand.nextInt(i2));
    }
    ...
    public void updatePassenger(Entity passenger) {
        if (this.isPassenger(passenger)) {
            ...
            float f22 = 0.3f;
            passenger.setPosition(this.posX + (double)(0.3f * f1), this.posY + this.getMountedYOffset() + passenger.getYOffset(), this.posZ - (double)(0.3f * f2));
        }
    }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
        ...
        if (livingdata instanceof GroupData) {
            i2 = ((GroupData)livingdata).field_190886_a;
        } else {
            i2 = this.rand.nextInt(4);
            livingdata = new GroupData(i2);
        }
        this.func_190710_o(i2);
        return livingdata;
    }
    ...
    public EnumDyeColor func_190704_dO() {
        int i2 = this.dataManager.get(field_190721_bH);
        return i2 == -1 ? null : EnumDyeColor.byMetadata(i2);
    }
    ...
    public EntityLlama createChild(EntityAgeable ageable) {
        ...
        int i2 = this.rand.nextInt(Math.max(this.func_190707_dL(), entityllama1.func_190707_dL())) + 1;
        if (this.rand.nextFloat() < 0.03f) {
            ++i2;
        }
        entityllama.func_190706_p(i2);
    ...
    private void func_190713_e(EntityLivingBase p_190713_1_) {
        ...
        float f2 = MathHelper.sqrt(d0 * d0 + d2 * d2) * 0.2f;
        entityllamaspit.setThrowableHeading(d0, d1 + (double)f2, d2, 1.5f, 10.0f);
    ...
    public void fall(float distance, float damageMultiplier) {
        int i2 = MathHelper.ceil((distance * 0.5f - 3.0f) * damageMultiplier);
        if (i2 > 0) {
            if (distance >= 6.0f) {
