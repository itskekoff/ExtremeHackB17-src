...
extends EntityTameable {
        ...
        if (this.isWet()) {
            ...
            if (this.timeWolfIsShaking > 0.4f) {
                ...
                for (int j2 = 0; j2 < i2; ++j2) {
                    ...
                    this.world.spawnParticle(EnumParticleTypes.WATER_SPLASH, this.posX + (double)f1, (double)(f2 + 0.8f), this.posZ + (double)f22, this.motionX, this.motionY, this.motionZ, new int[0]);
                }
            }
        }
    }
    ...
    public void setBegging(boolean beg2) {
        this.dataManager.set(BEGGING, beg2);
    }
