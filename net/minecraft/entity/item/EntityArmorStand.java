...
extends EntityLivingBase {
    ...
    protected final void setSize(float width, float height) {
        ...
        super.setSize(width * f2, height * f2);
    ...
    public void readEntityFromNBT(NBTTagCompound compound) {
        ...
        if (compound.hasKey("ArmorItems", 9)) {
            ...
            for (int i2 = 0; i2 < this.armorItems.size(); ++i2) {
                this.armorItems.set(i2, new ItemStack(nbttaglist.getCompoundTagAt(i2)));
            }
        }
        if (compound.hasKey("HandItems", 9)) {
            NBTTagList nbttaglist1 = compound.getTagList("HandItems", 10);
            for (int j2 = 0; j2 < this.handItems.size(); ++j2) {
                this.handItems.set(j2, new ItemStack(nbttaglist1.getCompoundTagAt(j2)));
            }
        }
    ...
    protected EntityEquipmentSlot func_190772_a(Vec3d p_190772_1_) {
        ...
        if (d0 >= 0.1) {
            ...
            if (d0 < 0.1 + d2 && this.func_190630_a(entityequipmentslot1)) {
        ...
        if (d0 >= 0.9 + d3) {
            ...
            if (d0 < 0.9 + d4 && this.func_190630_a(EntityEquipmentSlot.CHEST)) {
                return EntityEquipmentSlot.CHEST;
            }
        }
        if (d0 >= 0.4) {
            double d5 = flag ? 1.0 : 0.8;
            if (d0 < 0.4 + d5 && this.func_190630_a(EntityEquipmentSlot.LEGS)) {
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (!this.world.isRemote && !this.isDead) {
            ...
            if (!(this.isEntityInvulnerable(source) || this.canInteract || this.hasMarker())) {
                ...
                if (i2 - this.punchCooldown > 5L && !flag) {
                    this.world.setEntityState(this, (byte)32);
                    this.punchCooldown = i2;
                } else {
                    this.dropBlock();
                    this.playParticles();
                    this.setDead();
    ...
    private void dropContents() {
        ...
        for (int i2 = 0; i2 < this.handItems.size(); ++i2) {
            ItemStack itemstack = this.handItems.get(i2);
            if (itemstack.func_190926_b()) continue;
            Block.spawnAsEntity(this.world, new BlockPos(this).up(), itemstack);
            this.handItems.set(i2, ItemStack.field_190927_a);
        }
        for (int j2 = 0; j2 < this.armorItems.size(); ++j2) {
            ItemStack itemstack1 = this.armorItems.get(j2);
            if (itemstack1.func_190926_b()) continue;
            Block.spawnAsEntity(this.world, new BlockPos(this).up(), itemstack1);
            this.armorItems.set(j2, ItemStack.field_190927_a);
        }
    }
