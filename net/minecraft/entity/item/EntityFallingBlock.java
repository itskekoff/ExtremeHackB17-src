...
extends Entity {
    ...
    public EntityFallingBlock(World worldIn, double x2, double y2, double z2, IBlockState fallingBlockState) {
        ...
        this.setPosition(x2, y2 + (double)((1.0f - this.height) / 2.0f), z2);
        this.motionX = 0.0;
        this.motionY = 0.0;
        this.motionZ = 0.0;
        this.prevPosX = x2;
                            ...
                            if (this.world.func_190527_a(block, blockpos1, true, EnumFacing.UP, null) && (flag1 || !BlockFalling.canFallThrough(this.world.getBlockState(blockpos1.down()))) && this.world.setBlockState(blockpos1, this.fallTile, 3)) {
                                ...
                                if (this.tileEntityData != null && block instanceof ITileEntityProvider && (tileentity = this.world.getTileEntity(blockpos1)) != null) {
                                    ...
                                    for (String s2 : this.tileEntityData.getKeySet()) {
                                        ...
                                        if ("x".equals(s2) || "y".equals(s2) || "z".equals(s2)) continue;
    ...
    public void fall(float distance, float damageMultiplier) {
        int i2;
        Block block = this.fallTile.getBlock();
        if (this.hurtEntities && (i2 = MathHelper.ceil(distance - 1.0f)) > 0) {
            ...
            for (Entity entity : list) {
                entity.attackEntityFrom(damagesource, Math.min(MathHelper.floor((float)i2 * this.fallHurtAmount), this.fallHurtMax));
            }
    ...
    protected void readEntityFromNBT(NBTTagCompound compound) {
        int i2 = compound.getByte("Data") & 0xFF;
        this.fallTile = compound.hasKey("Block", 8) ? Block.getBlockFromName(compound.getString("Block")).getStateFromMeta(i2) : (compound.hasKey("TileID", 99) ? Block.getBlockById(compound.getInteger("TileID")).getStateFromMeta(i2) : Block.getBlockById(compound.getByte("Tile") & 0xFF).getStateFromMeta(i2));
