...
extends EntityMinecart {
    private final MobSpawnerBaseLogic mobSpawnerLogic = new MobSpawnerBaseLogic(){
        ...
        @Override
        public void broadcastEvent(int id2) {
            EntityMinecartMobSpawner.this.world.setEntityState(EntityMinecartMobSpawner.this, (byte)id2);
        }
    ...
    public EntityMinecartMobSpawner(World worldIn, double x2, double y2, double z2) {
    ...
    public static void registerFixesMinecartMobSpawner(DataFixer fixer) {
        ...
        fixer.registerWalker(FixTypes.ENTITY, new IDataWalker(){
            ...
            public NBTTagCompound process(IDataFixer fixer, NBTTagCompound compound, int versionIn) {
                ...
                if (EntityList.func_191306_a(EntityMinecartMobSpawner.class).equals(new ResourceLocation(s2))) {
    ...
    public void handleStatusUpdate(byte id2) {
        this.mobSpawnerLogic.setDelayToMin(id2);
    }
