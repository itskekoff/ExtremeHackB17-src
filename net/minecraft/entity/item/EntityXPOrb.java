...
extends Entity {
    ...
    public int getBrightnessForRender() {
        ...
        int i2 = super.getBrightnessForRender();
        int j2 = i2 & 0xFF;
        int k2 = i2 >> 16 & 0xFF;
    ...
    public void onUpdate() {
        ...
        float f2 = 0.98f;
        if (this.onGround) {
            f2 = this.world.getBlockState((BlockPos)new BlockPos((int)MathHelper.floor((double)this.posX), (int)(MathHelper.floor((double)this.getEntityBoundingBox().minY) - 1), (int)MathHelper.floor((double)this.posZ))).getBlock().slipperiness * 0.98f;
        }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn) {
        if (!this.world.isRemote && this.delayBeforeCanPickup == 0 && entityIn.xpCooldown == 0) {
            ...
            if (!itemstack.func_190926_b() && itemstack.isItemDamaged()) {
                int i2 = Math.min(this.xpToDurability(this.xpValue), itemstack.getItemDamage());
                this.xpValue -= this.durabilityToXp(i2);
                itemstack.setItemDamage(itemstack.getItemDamage() - i2);
            }
            if (this.xpValue > 0) {
    ...
    private int xpToDurability(int xp2) {
        return xp2 * 2;
    }
