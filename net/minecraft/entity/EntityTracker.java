...
public class EntityTracker {
    ...
    public static void updateServerPosition(Entity entityIn, double x2, double y2, double z2) {
        entityIn.serverPosX = EntityTracker.getPositionLong(x2);
        entityIn.serverPosY = EntityTracker.getPositionLong(y2);
        entityIn.serverPosZ = EntityTracker.getPositionLong(z2);
    }
        ...
        try {
            ...
            crashreportcategory.setDetail("Update interval", new ICrashReportDetail<String>(){
                ...
                public String call() throws Exception {
                    String s2 = "Once per " + updateFrequency + " ticks";
