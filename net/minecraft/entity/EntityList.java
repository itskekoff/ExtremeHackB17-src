...
public class EntityList {
    ...
    public static String getEntityString(Entity entityIn) {
        int i2 = field_191308_b.getIDForObject(entityIn.getClass());
        return i2 == -1 ? null : field_191311_g.get(i2);
    }

    @Nullable
    public static String func_191302_a(@Nullable ResourceLocation p_191302_0_) {
        int i2 = field_191308_b.getIDForObject(field_191308_b.getObject(p_191302_0_));
        return i2 == -1 ? null : field_191311_g.get(i2);
    }
