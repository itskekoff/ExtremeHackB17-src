...
extends PhaseBase {
    ...
    public void doLocalUpdate() {
        if (this.attackTarget == null) {
            ...
            double d2 = d12 = this.targetLocation == null ? 0.0 : this.targetLocation.squareDistanceTo(this.dragon.posX, this.dragon.posY, this.dragon.posZ);
    ...
    private void findNewTarget() {
        if (this.currentPath == null || this.currentPath.isFinished()) {
            int i2;
            int j2 = i2 = this.dragon.initPathPoints();
            if (this.dragon.getRNG().nextInt(8) == 0) {
                this.holdingPatternClockwise = !this.holdingPatternClockwise;
                j2 = i2 + 6;
            }
            j2 = this.holdingPatternClockwise ? ++j2 : --j2;
            ...
            this.currentPath = this.dragon.findPath(i2, j2, null);
            if (this.currentPath != null) {
                this.currentPath.incrementPathIndex();
            }
        }
    ...
    public void setTarget(EntityLivingBase p_188686_1_) {
        ...
        int i2 = this.dragon.initPathPoints();
        int j2 = this.dragon.getNearestPpIdx(this.attackTarget.posX, this.attackTarget.posY, this.attackTarget.posZ);
        int k2 = MathHelper.floor(this.attackTarget.posX);
        int l2 = MathHelper.floor(this.attackTarget.posZ);
        double d0 = (double)k2 - this.dragon.posX;
        double d1 = (double)l2 - this.dragon.posZ;
        ...
        PathPoint pathpoint = new PathPoint(k2, i1, l2);
        this.currentPath = this.dragon.findPath(i2, j2, pathpoint);
        if (this.currentPath != null) {
            this.currentPath.incrementPathIndex();
            this.navigateToNextPathNode();
        }
