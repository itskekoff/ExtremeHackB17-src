...
extends PhaseBase {
    ...
    public void doClientRenderEffects() {
        if (this.time++ % 10 == 0) {
            ...
            float f22 = (this.dragon.getRNG().nextFloat() - 0.5f) * 8.0f;
            this.dragon.world.spawnParticle(EnumParticleTypes.EXPLOSION_HUGE, this.dragon.posX + (double)f2, this.dragon.posY + 2.0 + (double)f1, this.dragon.posZ + (double)f22, 0.0, 0.0, 0.0, new int[0]);
        }
    }
