...
extends PhaseBase {
    ...
    public void doLocalUpdate() {
        double d0;
        double d2 = d0 = this.targetLocation == null ? 0.0 : this.targetLocation.squareDistanceTo(this.dragon.posX, this.dragon.posY, this.dragon.posZ);
    ...
    private void findNewTarget() {
        if (this.currentPath != null && this.currentPath.isFinished()) {
            ...
            int n2 = i2 = this.dragon.getFightManager() == null ? 0 : this.dragon.getFightManager().getNumAliveCrystals();
            if (this.dragon.getRNG().nextInt(i2 + 3) == 0) {
            ...
            if (entityplayer != null && (this.dragon.getRNG().nextInt(MathHelper.abs((int)d0) + 2) == 0 || this.dragon.getRNG().nextInt(i2 + 2) == 0)) {
        ...
        if (this.currentPath == null || this.currentPath.isFinished()) {
            int j2;
            int k2 = j2 = this.dragon.initPathPoints();
            if (this.dragon.getRNG().nextInt(8) == 0) {
                this.clockwise = !this.clockwise;
                k2 = j2 + 6;
            }
            k2 = this.clockwise ? ++k2 : --k2;
            ...
            this.currentPath = this.dragon.findPath(j2, k2, null);
