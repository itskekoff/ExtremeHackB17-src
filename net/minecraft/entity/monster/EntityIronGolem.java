...
extends EntityGolem {
    ...
    public void onLivingUpdate() {
        ...
        if (this.motionX * this.motionX + this.motionZ * this.motionZ > 2.500000277905201E-7 && this.rand.nextInt(5) == 0 && (iblockstate = this.world.getBlockState(new BlockPos(i2 = MathHelper.floor(this.posX), j2 = MathHelper.floor(this.posY - (double)0.2f), k2 = MathHelper.floor(this.posZ)))).getMaterial() != Material.AIR) {
