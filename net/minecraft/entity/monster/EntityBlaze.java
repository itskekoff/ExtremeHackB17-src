        ...
        public void updateTask() {
            ...
            if (d0 < 4.0) {
                ...
                if (this.attackTime <= 0) {
                    ...
                    if (this.attackStep > 1) {
                        float f2 = MathHelper.sqrt(MathHelper.sqrt(d0)) * 0.5f;
                        this.blaze.world.playEvent(null, 1018, new BlockPos((int)this.blaze.posX, (int)this.blaze.posY, (int)this.blaze.posZ), 0);
                        for (int i2 = 0; i2 < 1; ++i2) {
                            EntitySmallFireball entitysmallfireball = new EntitySmallFireball(this.blaze.world, this.blaze, d1 + this.blaze.getRNG().nextGaussian() * (double)f2, d2, d3 + this.blaze.getRNG().nextGaussian() * (double)f2);
