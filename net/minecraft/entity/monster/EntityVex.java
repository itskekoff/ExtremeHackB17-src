...
extends EntityMob {
    ...
    private boolean func_190656_b(int p_190656_1_) {
        byte i2 = this.dataManager.get(field_190664_a);
        return (i2 & p_190656_1_) != 0;
    }

    private void func_190660_a(int p_190660_1_, boolean p_190660_2_) {
        int i2 = this.dataManager.get(field_190664_a).byteValue();
        i2 = p_190660_2_ ? (i2 |= p_190660_1_) : (i2 &= ~p_190660_1_);
        this.dataManager.set(field_190664_a, (byte)(i2 & 0xFF));
    }
