...
implements IMob {
    ...
    public boolean attackEntityAsMob(Entity entityIn) {
        ...
        if (entityIn instanceof EntityLivingBase) {
            f2 += EnchantmentHelper.getModifierForCreature(this.getHeldItemMainhand(), ((EntityLivingBase)entityIn).getCreatureAttribute());
            i2 += EnchantmentHelper.getKnockbackModifier(this);
        }
        if (flag = entityIn.attackEntityFrom(DamageSource.causeMobDamage(this), f2)) {
            int j2;
            if (i2 > 0 && entityIn instanceof EntityLivingBase) {
                ((EntityLivingBase)entityIn).knockBack(this, (float)i2 * 0.5f, MathHelper.sin(this.rotationYaw * ((float)Math.PI / 180)), -MathHelper.cos(this.rotationYaw * ((float)Math.PI / 180)));
                this.motionX *= 0.6;
                this.motionZ *= 0.6;
            }
    ...
    protected boolean isValidLightLevel() {
        ...
        int i2 = this.world.getLightFromNeighbors(blockpos);
        if (this.world.isThundering()) {
            int j2 = this.world.getSkylightSubtracted();
            this.world.setSkylightSubtracted(10);
            i2 = this.world.getLightFromNeighbors(blockpos);
            this.world.setSkylightSubtracted(j2);
        }
