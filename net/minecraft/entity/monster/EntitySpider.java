...
extends EntityMob {
    ...
    extends EntityAIAttackMelee {
        ...
        public boolean continueExecuting() {
            float f2 = this.attacker.getBrightness();
            if (f2 >= 0.5f && this.attacker.getRNG().nextInt(100) == 0) {
    ...
    extends EntityAINearestAttackableTarget<T> {
        ...
        public boolean shouldExecute() {
            float f2 = this.taskOwner.getBrightness();
            return f2 >= 0.5f ? false : super.shouldExecute();
        }
    }
