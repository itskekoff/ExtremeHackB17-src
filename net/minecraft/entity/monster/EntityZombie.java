...
extends EntityMob {
    ...
    public void onLivingUpdate() {
        float f2;
        if (this.world.isDaytime() && !this.world.isRemote && !this.isChild() && this.func_190730_o() && (f2 = this.getBrightness()) > 0.5f && this.rand.nextFloat() * 30.0f < (f2 - 0.4f) * 2.0f && this.world.canSeeSky(new BlockPos(this.posX, this.posY + (double)this.getEyeHeight(), this.posZ))) {
            boolean flag = true;
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (super.attackEntityFrom(source, amount)) {
            ...
            if (entitylivingbase != null && this.world.getDifficulty() == EnumDifficulty.HARD && (double)this.rand.nextFloat() < this.getEntityAttribute(SPAWN_REINFORCEMENTS_CHANCE).getAttributeValue() && this.world.getGameRules().getBoolean("doMobSpawning")) {
                ...
                int j2 = MathHelper.floor(this.posY);
                int k2 = MathHelper.floor(this.posZ);
                EntityZombie entityzombie = new EntityZombie(this.world);
                for (int l2 = 0; l2 < 50; ++l2) {
                    int k1;
                    int j1;
                    int i1 = i2 + MathHelper.getInt(this.rand, 7, 40) * MathHelper.getInt(this.rand, -1, 1);
                    if (!this.world.getBlockState(new BlockPos(i1, (j1 = j2 + MathHelper.getInt(this.rand, 7, 40) * MathHelper.getInt(this.rand, -1, 1)) - 1, k1 = k2 + MathHelper.getInt(this.rand, 7, 40) * MathHelper.getInt(this.rand, -1, 1))).isFullyOpaque() || this.world.getLightFromNeighbors(new BlockPos(i1, j1, k1)) >= 10) continue;
    ...
    public boolean attackEntityAsMob(Entity entityIn) {
        ...
        if (flag) {
            float f2 = this.world.getDifficultyForLocation(new BlockPos(this)).getAdditionalDifficulty();
            if (this.getHeldItemMainhand().func_190926_b() && this.isBurning() && this.rand.nextFloat() < f2 * 0.3f) {
                entityIn.setFire(2 * (int)f2);
            }
        }
        return flag;
    }
    ...
    protected void setEquipmentBasedOnDifficulty(DifficultyInstance difficulty) {
        ...
        float f3 = this.world.getDifficulty() == EnumDifficulty.HARD ? 0.05f : 0.01f;
        if (f2 < f3) {
