...
extends EntityMob {
    ...
    protected boolean func_193078_a(int p_193078_1_) {
        byte i2 = this.dataManager.get(field_193080_a);
        return (i2 & p_193078_1_) != 0;
    }

    protected void func_193079_a(int p_193079_1_, boolean p_193079_2_) {
        int i2 = this.dataManager.get(field_193080_a).byteValue();
        i2 = p_193079_2_ ? (i2 |= p_193079_1_) : (i2 &= ~p_193079_1_);
        this.dataManager.set(field_193080_a, (byte)(i2 & 0xFF));
    }
