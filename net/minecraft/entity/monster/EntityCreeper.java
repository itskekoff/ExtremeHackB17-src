...
extends EntityMob {
    ...
    public void onUpdate() {
        if (this.isEntityAlive()) {
            ...
            if ((i2 = this.getCreeperState()) > 0 && this.timeSinceIgnited == 0) {
    ...
    public void onDeath(DamageSource cause) {
        ...
        if (this.world.getGameRules().getBoolean("doMobLoot")) {
            if (cause.getEntity() instanceof EntitySkeleton) {
                int i2 = Item.getIdFromItem(Items.RECORD_13);
                int j2 = Item.getIdFromItem(Items.RECORD_WAIT);
                int k2 = i2 + this.rand.nextInt(j2 - i2 + 1);
                this.dropItem(Item.getItemById(k2), 1);
    ...
    private void explode() {
        if (!this.world.isRemote) {
            ...
            float f2 = this.getPowered() ? 2.0f : 1.0f;
            this.dead = true;
            this.world.createExplosion(this, this.posX, this.posY, this.posZ, (float)this.explosionRadius * f2, flag);
            this.setDead();
            this.func_190741_do();
        }
    }
