...
implements IMob {
    ...
    extends EntityMoveHelper {
        ...
        private boolean isNotColliding(double x2, double y2, double z2, double p_179926_7_) {
            double d0 = (x2 - this.parentEntity.posX) / p_179926_7_;
            double d1 = (y2 - this.parentEntity.posY) / p_179926_7_;
            double d2 = (z2 - this.parentEntity.posZ) / p_179926_7_;
            AxisAlignedBB axisalignedbb = this.parentEntity.getEntityBoundingBox();
            int i2 = 1;
            while ((double)i2 < p_179926_7_) {
