...
implements IRangedAttackMob {
    ...
    public void onLivingUpdate() {
        ...
        if (!this.world.isRemote) {
            ...
            for (int l2 = 0; l2 < 4; ++l2) {
                i2 = MathHelper.floor(this.posX + (double)((float)(l2 % 2 * 2 - 1) * 0.25f));
                BlockPos blockpos = new BlockPos(i2, j2 = MathHelper.floor(this.posY), k2 = MathHelper.floor(this.posZ + (double)((float)(l2 / 2 % 2 * 2 - 1) * 0.25f)));
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase target, float distanceFactor) {
        ...
        float f2 = MathHelper.sqrt(d1 * d1 + d3 * d3) * 0.2f;
