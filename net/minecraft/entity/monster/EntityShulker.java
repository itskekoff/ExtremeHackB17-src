...
implements IMob {
    ...
    public void readEntityFromNBT(NBTTagCompound compound) {
        ...
        if (compound.hasKey("APX")) {
            int i2 = compound.getInteger("APX");
            int j2 = compound.getInteger("APY");
            int k2 = compound.getInteger("APZ");
            this.dataManager.set(ATTACHED_BLOCK_POS, Optional.of(new BlockPos(i2, j2, k2)));
        } else {
    ...
    public void onUpdate() {
        ...
        if (this.isRiding()) {
            float f2;
            blockpos = null;
            this.rotationYaw = f2 = this.getRidingEntity().rotationYaw;
    ...
    public void setPosition(double x2, double y2, double z2) {
        ...
        if (this.dataManager != null && this.ticksExisted != 0) {
            ...
            Optional<BlockPos> optional1 = Optional.of(new BlockPos(x2, y2, z2));
