...
implements IRangedAttackMob {
    ...
    public EntityIllusionIllager(World p_i47507_1_) {
        ...
        for (int i2 = 0; i2 < 4; ++i2) {
            this.field_193100_bx[0][i2] = new Vec3d(0.0, 0.0, 0.0);
            this.field_193100_bx[1][i2] = new Vec3d(0.0, 0.0, 0.0);
        }
    }
            ...
            if (this.hurtTime != 1 && this.ticksExisted % 1200 != 0) {
                if (this.hurtTime == this.maxHurtTime - 1) {
                    ...
                    for (int k2 = 0; k2 < 4; ++k2) {
                        this.field_193100_bx[0][k2] = this.field_193100_bx[1][k2];
                        this.field_193100_bx[1][k2] = new Vec3d(0.0, 0.0, 0.0);
                    }
                }
            } else {
                this.field_193099_c = 3;
                ...
                for (int j2 = 0; j2 < 4; ++j2) {
                    this.field_193100_bx[0][j2] = this.field_193100_bx[1][j2];
                    this.field_193100_bx[1][j2] = new Vec3d((double)(-6.0f + (float)this.rand.nextInt(13)) * 0.5, Math.max(0, this.rand.nextInt(6) - 4), (double)(-6.0f + (float)this.rand.nextInt(13)) * 0.5);
                }
    ...
    public Vec3d[] func_193098_a(float p_193098_1_) {
        ...
        for (int i2 = 0; i2 < 4; ++i2) {
            avec3d[i2] = this.field_193100_bx[1][i2].scale(1.0 - d0).add(this.field_193100_bx[0][i2].scale(d0));
        }
        return avec3d;
    }
