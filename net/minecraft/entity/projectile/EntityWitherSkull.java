...
extends EntityFireball {
    ...
    public EntityWitherSkull(World worldIn, double x2, double y2, double z2, double accelX, double accelY, double accelZ) {
        super(worldIn, x2, y2, z2, accelX, accelY, accelZ);
        this.setSize(0.3125f, 0.3125f);
    }
    ...
    public float getExplosionResistance(Explosion explosionIn, World worldIn, BlockPos pos, IBlockState blockStateIn) {
        float f2 = super.getExplosionResistance(explosionIn, worldIn, pos, blockStateIn);
        ...
        if (!this.world.isRemote) {
            if (result.entityHit != null) {
                ...
                if (result.entityHit instanceof EntityLivingBase) {
                    ...
                    if (i2 > 0) {
                        ((EntityLivingBase)result.entityHit).addPotionEffect(new PotionEffect(MobEffects.WITHER, 20 * i2, 1));
                    }
                }
            }
