...
extends Entity {
    ...
    private void func_190620_n() {
        float f2 = this.angler.prevRotationPitch + (this.angler.rotationPitch - this.angler.prevRotationPitch);
        ...
        double d2 = this.angler.prevPosZ + (this.angler.posZ - this.angler.prevPosZ) - (double)f22 * 0.3;
        this.setLocationAndAngles(d0, d1, d2, f1, f2);
        this.motionX = -f3;
    ...
    public void notifyDataManagerChange(DataParameter<?> key) {
        if (DATA_HOOKED_ENTITY.equals(key)) {
            int i2 = this.getDataManager().get(DATA_HOOKED_ENTITY);
            this.caughtEntity = i2 > 0 ? this.world.getEntityByID(i2 - 1) : null;
        }
    ...
    public void onUpdate() {
        ...
        if (this.angler == null) {
            ...
            if (iblockstate.getMaterial() == Material.WATER) {
                f2 = BlockLiquid.func_190973_f(iblockstate, this.world, blockpos);
            }
            if (this.field_190627_av == State.FLYING) {
                ...
                if (this.field_190627_av == State.BOBBING) {
                    this.motionX *= 0.9;
                    this.motionZ *= 0.9;
                    double d0 = this.posY + this.motionY - (double)blockpos.getY() - (double)f2;
                    if (Math.abs(d0) < 0.01) {
                        d0 += Math.signum(d0) * 0.1;
                    }
                    this.motionY -= d0 * (double)this.rand.nextFloat() * 0.2;
                    if (!this.world.isRemote && f2 > 0.0f) {
    ...
    private boolean func_190625_o() {
        ...
        boolean bl2 = flag1 = itemstack1.getItem() == Items.FISHING_ROD;
    ...
    private void func_190621_a(BlockPos p_190621_1_) {
        ...
        if (this.ticksCatchable > 0) {
            ...
            if (this.ticksCatchableDelay > 0) {
                ...
                Block block = worldserver.getBlockState(new BlockPos(d0, d1 - 1.0, d2 = this.posZ + (double)(f22 * (float)this.ticksCatchableDelay * 0.1f))).getBlock();
                if (block == Blocks.WATER || block == Blocks.FLOWING_WATER) {
                    if (this.rand.nextFloat() < 0.15f) {
                        worldserver.spawnParticle(EnumParticleTypes.WATER_BUBBLE, d0, d1 - (double)0.1f, d2, 1, (double)f1, 0.1, (double)f22, 0.0, new int[0]);
                    }
                    float f3 = f1 * 0.04f;
                    float f4 = f22 * 0.04f;
    ...
    public int handleHookRetraction() {
        if (!this.world.isRemote && this.angler != null) {
            ...
            if (this.caughtEntity != null) {
                ...
                i2 = this.caughtEntity instanceof EntityItem ? 3 : 5;
    ...
    public void handleStatusUpdate(byte id2) {
        if (id2 == 31 && this.world.isRemote && this.caughtEntity instanceof EntityPlayer && ((EntityPlayer)this.caughtEntity).isUser()) {
            this.bringInHookedEntity();
        }
