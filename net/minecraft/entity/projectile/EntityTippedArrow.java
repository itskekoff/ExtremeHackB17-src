...
extends EntityArrow {
    ...
    public EntityTippedArrow(World worldIn, double x2, double y2, double z2) {
    ...
    public void setPotionEffect(ItemStack stack) {
        if (stack.getItem() == Items.TIPPED_ARROW) {
            ...
            if ((i2 = EntityTippedArrow.func_191508_b(stack)) == -1) {
                this.func_190548_o();
            } else {
                this.func_191507_d(i2);
            }
