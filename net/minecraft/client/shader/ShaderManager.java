...
public class ShaderManager {
                ...
                if (jsonarray != null) {
                    ...
                    for (JsonElement jsonelement : jsonarray) {
                        try {
                            ...
                            jsonexception1.prependJsonKey("samplers[" + i2 + "]");
                ...
                if ((jsonarray1 = JsonUtils.getJsonArray(jsonobject, "attributes", null)) != null) {
                    ...
                    for (JsonElement jsonelement1 : jsonarray1) {
                        try {
                            ...
                            jsonexception2.prependJsonKey("attributes[" + j2 + "]");
                ...
                if (jsonarray2 != null) {
                    ...
                    for (JsonElement jsonelement2 : jsonarray2) {
                        try {
                            ...
                            jsonexception3.prependJsonKey("uniforms[" + k2 + "]");
    ...
    private void setupUniforms() {
        ...
        while (i2 < this.samplerNames.size()) {
            ...
            if (k2 == -1) {
                LOGGER.warn("Shader {}could not find sampler named {} in the specified shader program.", (Object)this.programFilename, (Object)s2);
    ...
    private void parseUniform(JsonElement element) throws JsonException {
        ...
        for (JsonElement jsonelement : jsonarray) {
            try {
                ...
                jsonexception.prependJsonKey("values[" + k2 + "]");
                throw jsonexception;
            }
            ++k2;
        }
