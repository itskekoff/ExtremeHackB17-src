...
implements IMultipassModel {
    ...
    protected void renderPaddle(EntityBoat boat, int paddle, float scale, float limbSwing) {
        float f2 = boat.getRowingTime(paddle, limbSwing);
        ...
        modelrenderer.rotateAngleY = (float)MathHelper.clampedLerp(-0.7853981633974483, 0.7853981633974483, (MathHelper.sin(-f2 + 1.0f) + 1.0f) / 2.0f);
        if (paddle == 1) {
