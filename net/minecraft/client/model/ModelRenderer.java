...
public class ModelRenderer {
    ...
    public void render(float scale) {
        if (!this.isHidden && this.showModel) {
            ...
            if (this.textureLocation != null && !this.renderGlobal.renderOverlayDamaged) {
                ...
                i2 = GlStateManager.getBoundTexture();
            ...
            if (this.rotateAngleX == 0.0f && this.rotateAngleY == 0.0f && this.rotateAngleZ == 0.0f) {
                if (this.rotationPointX == 0.0f && this.rotationPointY == 0.0f && this.rotationPointZ == 0.0f) {
                    ...
                    if (this.childModels != null) {
                        for (int l2 = 0; l2 < this.childModels.size(); ++l2) {
                            this.childModels.get(l2).render(scale);
                        }
                    }
                    if (flag) {
                    ...
                    if (this.childModels != null) {
                        for (int k2 = 0; k2 < this.childModels.size(); ++k2) {
                            this.childModels.get(k2).render(scale);
                        }
                    }
                    if (flag) {
                        GlStateManager.scale(1.0f / this.scaleX, 1.0f / this.scaleY, 1.0f / this.scaleZ);
                ...
                if (this.childModels != null) {
                    for (int j2 = 0; j2 < this.childModels.size(); ++j2) {
                        this.childModels.get(j2).render(scale);
                    }
                }
    ...
    private void compileDisplayList(float scale) {
        ...
        for (int i2 = 0; i2 < this.cubeList.size(); ++i2) {
            this.cubeList.get(i2).render(bufferbuilder, scale);
        }
    ...
    public ModelRenderer getChild(String p_getChild_1_) {
        ...
        if (this.childModels != null) {
            for (int i2 = 0; i2 < this.childModels.size(); ++i2) {
                ModelRenderer modelrenderer = this.childModels.get(i2);
    ...
    public ModelRenderer getChildDeep(String p_getChildDeep_1_) {
        ...
        if (this.childModels != null) {
            for (int i2 = 0; i2 < this.childModels.size(); ++i2) {
                ModelRenderer modelrenderer1 = this.childModels.get(i2);
