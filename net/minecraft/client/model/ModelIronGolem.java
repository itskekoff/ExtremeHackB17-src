...
extends ModelBase {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
        ...
        int i2 = entityirongolem.getAttackTimer();
        if (i2 > 0) {
            this.ironGolemRightArm.rotateAngleX = -2.0f + 1.5f * this.triangleWave((float)i2 - partialTickTime, 10.0f);
            this.ironGolemLeftArm.rotateAngleX = -2.0f + 1.5f * this.triangleWave((float)i2 - partialTickTime, 10.0f);
        } else {
            int j2 = entityirongolem.getHoldRoseTick();
            if (j2 > 0) {
                this.ironGolemRightArm.rotateAngleX = -0.8f + 0.025f * this.triangleWave(j2, 70.0f);
