    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if (abstractillager$illagerarmpose == AbstractIllager.IllagerArmPose.ATTACKING) {
            ...
            if (((EntityLivingBase)entityIn).getPrimaryHand() == EnumHandSide.RIGHT) {
                ...
                this.field_191223_g.rotateAngleX += f2 * 2.2f - f1 * 0.4f;
                this.field_191224_h.rotateAngleX += f2 * 1.2f - f1 * 0.4f;
            } else {
                ...
                this.field_191223_g.rotateAngleX += f2 * 1.2f - f1 * 0.4f;
                this.field_191224_h.rotateAngleX += f2 * 2.2f - f1 * 0.4f;
            }
