...
extends ModelQuadruped {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        float f2 = ageInTicks - (float)entityIn.ticksExisted;
        float f1 = ((EntityPolarBear)entityIn).getStandingAnimationScale(f2);
        f1 *= f1;
        float f22 = 1.0f - f1;
        this.body.rotateAngleX = 1.5707964f - f1 * (float)Math.PI * 0.35f;
        this.body.rotationPointY = 9.0f * f22 + 11.0f * f1;
        this.leg3.rotationPointY = 14.0f * f22 + -6.0f * f1;
        this.leg3.rotationPointZ = -8.0f * f22 + -4.0f * f1;
        ...
        this.head.rotationPointY = 10.0f * f22 + -12.0f * f1;
        this.head.rotationPointZ = -16.0f * f22 + -3.0f * f1;
