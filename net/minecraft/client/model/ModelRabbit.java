...
extends ModelBase {
    ...
    private void setRotationOffset(ModelRenderer renderer, float x2, float y2, float z2) {
        renderer.rotateAngleX = x2;
        renderer.rotateAngleY = y2;
        renderer.rotateAngleZ = z2;
    }
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        this.jumpRotation = MathHelper.sin(entityrabbit.setJumpCompletion(f2) * (float)Math.PI);
