...
public class CreativeSettings {
    ...
    public CreativeSettings(Minecraft p_i47395_1_, File p_i47395_2_) {
        ...
        for (int i2 = 0; i2 < 9; ++i2) {
            this.field_192568_d[i2] = new HotbarSnapshot();
        }
        this.func_192562_a();
    }
    ...
    public void func_192562_a() {
        try {
            ...
            for (int i2 = 0; i2 < 9; ++i2) {
                this.field_192568_d[i2].func_192833_a(nbttagcompound.getTagList(String.valueOf(i2), 10));
            }
        }
    ...
    public void func_192564_b() {
        try {
            ...
            for (int i2 = 0; i2 < 9; ++i2) {
                nbttagcompound.setTag(String.valueOf(i2), this.field_192568_d[i2].func_192834_a());
            }
