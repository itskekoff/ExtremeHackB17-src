...
public class GameSettings {
    ...
    public static boolean isKeyDown(KeyBinding key) {
        int i2 = key.getKeyCode();
        if (i2 != 0 && i2 < 256) {
            return i2 < 0 ? Mouse.isButtonDown(i2 + 100) : Keyboard.isKeyDown(i2);
        }
        return false;
    }
    ...
    public void setOptionValue(Options settingsOption, int value) {
        ...
        if (settingsOption == Options.CHAT_COLOR) {
            boolean bl5 = this.chatColours = !this.chatColours;
        }
        if (settingsOption == Options.CHAT_LINKS) {
            boolean bl6 = this.chatLinks = !this.chatLinks;
        }
        if (settingsOption == Options.CHAT_LINKS_PROMPT) {
            boolean bl7 = this.chatLinksPrompt = !this.chatLinksPrompt;
        }
        if (settingsOption == Options.SNOOPER_ENABLED) {
            boolean bl8 = this.snooperEnabled = !this.snooperEnabled;
        }
        if (settingsOption == Options.TOUCHSCREEN) {
            boolean bl9 = this.touchscreen = !this.touchscreen;
        }
        if (settingsOption == Options.USE_FULLSCREEN) {
            boolean bl10 = this.fullScreen = !this.fullScreen;
        ...
        if (settingsOption == Options.REDUCED_DEBUG_INFO) {
            boolean bl11 = this.reducedDebugInfo = !this.reducedDebugInfo;
        }
        if (settingsOption == Options.ENTITY_SHADOWS) {
            boolean bl12 = this.entityShadows = !this.entityShadows;
        }
        ...
        if (settingsOption == Options.SHOW_SUBTITLES) {
            boolean bl13 = this.showSubtitles = !this.showSubtitles;
        }
        if (settingsOption == Options.REALMS_NOTIFICATIONS) {
            boolean bl14 = this.realmsNotifications = !this.realmsNotifications;
        }
        if (settingsOption == Options.AUTO_JUMP) {
            boolean bl15 = this.autoJump = !this.autoJump;
        }
    ...
    public String getKeyBinding(Options settingOption) {
        ...
        if (settingOption.getEnumFloat()) {
            ...
            if (settingOption == Options.SENSITIVITY) {
                ...
                return f2 == 1.0f ? String.valueOf(s1) + I18n.format("options.sensitivity.max", new Object[0]) : String.valueOf(s1) + (int)(f2 * 200.0f) + "%";
            }
            if (settingOption == Options.FOV) {
                if (f1 == 70.0f) {
            ...
            if (settingOption == Options.GAMMA) {
                ...
                return f2 == 1.0f ? String.valueOf(s1) + I18n.format("options.gamma.max", new Object[0]) : String.valueOf(s1) + "+" + (int)(f2 * 100.0f) + "%";
            }
            if (settingOption == Options.SATURATION) {
                return String.valueOf(s1) + (int)(f2 * 400.0f) + "%";
            }
            if (settingOption == Options.CHAT_OPACITY) {
                return String.valueOf(s1) + (int)(f2 * 90.0f + 10.0f) + "%";
            }
            if (settingOption == Options.CHAT_HEIGHT_UNFOCUSED) {
                return String.valueOf(s1) + GuiNewChat.calculateChatboxHeight(f2) + "px";
            }
            if (settingOption == Options.CHAT_HEIGHT_FOCUSED) {
                return String.valueOf(s1) + GuiNewChat.calculateChatboxHeight(f2) + "px";
            }
            if (settingOption == Options.CHAT_WIDTH) {
                return String.valueOf(s1) + GuiNewChat.calculateChatboxWidth(f2) + "px";
            }
            ...
            return f2 == 0.0f ? String.valueOf(s1) + I18n.format("options.off", new Object[0]) : String.valueOf(s1) + (int)(f2 * 100.0f) + "%";
        }
    ...
    public void loadOptions() {
        try {
            ...
            for (String s2 : list) {
                try {
                    Iterator<String> iterator = COLON_SPLITTER.omitEmptyStrings().limit(2).split(s2).iterator();
                    nbttagcompound.setString(iterator.next(), iterator.next());
                }
                catch (Exception var12) {
                    LOGGER.warn("Skipping bad option: {}", (Object)s2);
                }
            }
            ...
            for (String s1 : nbttagcompound.getKeySet()) {
                ...
                try {
                    ...
                    KeyBinding[] arrkeyBinding = this.keyBindings;
                    int n2 = this.keyBindings.length;
                    for (int i2 = 0; i2 < n2; ++i2) {
                        KeyBinding keyBinding = arrkeyBinding[i2];
    ...
    private NBTTagCompound dataFix(NBTTagCompound p_189988_1_) {
        int i2 = 0;
        try {
            i2 = Integer.parseInt(p_189988_1_.getString("version"));
        }
        catch (RuntimeException runtimeException) {
            // empty catch block
        }
        return this.mc.getDataFixer().process(FixTypes.OPTIONS, p_189988_1_, i2);
    }
        ...
        block15: {
            ...
            try {
                try {
                    ...
                    KeyBinding[] arrobject = this.keyBindings;
                    int n2 = this.keyBindings.length;
                    for (int i2 = 0; i2 < n2; ++i2) {
                        KeyBinding keyBinding = arrobject[i2];
                        if (Reflector.ForgeKeyBinding_getKeyModifier.exists()) {
                            Object object2;
                            String s2 = "key_" + keyBinding.getKeyDescription() + ":" + keyBinding.getKeyCode();
                            Object object1 = Reflector.call(keyBinding, Reflector.ForgeKeyBinding_getKeyModifier, new Object[0]);
                            printwriter.println(object1 != (object2 = Reflector.getFieldValue(Reflector.KeyModifier_NONE)) ? String.valueOf(s2) + ":" + object1 : s2);
                            continue;
                        }
    ...
    public void sendSettingsToServer() {
        if (this.mc.player != null) {
            ...
            this.mc.player.connection.sendPacket(new CPacketClientSettings(this.language, this.renderDistanceChunks, this.chatVisibility, this.chatColours, i2, this.mainHand));
        }
    }
    ...
    private void setOptionValueOF(Options p_setOptionValueOF_1_, int p_setOptionValueOF_2_) {
        ...
        if (p_setOptionValueOF_1_ == Options.HELD_ITEM_TOOLTIPS) {
            boolean bl29 = this.heldItemTooltips = !this.heldItemTooltips;
        }
    ...
    private String getKeyBindingOF(Options p_getKeyBindingOF_1_) {
        ...
        if (p_getKeyBindingOF_1_ == Options.RENDER_DISTANCE) {
            int l2 = (int)this.getOptionFloatValue(p_getKeyBindingOF_1_);
            ...
            return String.valueOf(s2) + l2 + " " + s22;
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.AUTOSAVE_TICKS) {
            if (this.ofAutoSaveTicks <= 40) {
                return String.valueOf(s2) + Lang.get("of.options.save.default");
            }
            if (this.ofAutoSaveTicks <= 400) {
                return String.valueOf(s2) + Lang.get("of.options.save.20s");
            }
            return this.ofAutoSaveTicks <= 4000 ? String.valueOf(s2) + Lang.get("of.options.save.3min") : String.valueOf(s2) + Lang.get("of.options.save.30min");
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.TIME) {
            if (this.ofTime == 1) {
                return String.valueOf(s2) + Lang.get("of.options.time.dayOnly");
            }
            return this.ofTime == 2 ? String.valueOf(s2) + Lang.get("of.options.time.nightOnly") : String.valueOf(s2) + Lang.getDefault();
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.RANDOM_MOBS) {
            return this.ofRandomMobs ? String.valueOf(s2) + Lang.getOn() : String.valueOf(s2) + Lang.getOff();
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.TRANSLUCENT_BLOCKS) {
            ...
            return this.ofTranslucentBlocks == 2 ? String.valueOf(s2) + Lang.getFancy() : String.valueOf(s2) + Lang.getDefault();
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.FRAMERATE_LIMIT) {
            ...
            if (f2 == 0.0f) {
                return String.valueOf(s2) + Lang.get("of.options.framerateLimit.vsync");
            }
            return f2 == p_getKeyBindingOF_1_.valueMax ? String.valueOf(s2) + I18n.format("options.framerateLimit.max", new Object[0]) : String.valueOf(s2) + (int)f2 + " fps";
        }
        return null;
    }
    ...
    private static int indexOf(int p_indexOf_0_, int[] p_indexOf_1_) {
        for (int i2 = 0; i2 < p_indexOf_1_.length; ++i2) {
            if (p_indexOf_1_[i2] != p_indexOf_0_) continue;
            return i2;
        }
        return -1;
    }
