    ...
    public void setLoadingProgress(int progress) {
        if (!this.mc.running) {
            ...
            if (i2 - this.systemTime >= 100L) {
                ...
                bufferbuilder.pos(0.0, l2, 0.0).tex(0.0, (float)l2 / 32.0f).color(64, 64, 64, 255).endVertex();
                bufferbuilder.pos(k2, l2, 0.0).tex((float)k2 / 32.0f, (float)l2 / 32.0f).color(64, 64, 64, 255).endVertex();
                bufferbuilder.pos(k2, 0.0, 0.0).tex((float)k2 / 32.0f, 0.0).color(64, 64, 64, 255).endVertex();
