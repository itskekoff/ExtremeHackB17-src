...
public class TextureUtil {
    ...
    static {
        ...
        for (int l2 = 0; l2 < 16; ++l2) {
            System.arraycopy(l2 < k2 ? aint : aint1, 0, MISSING_TEXTURE_DATA, 16 * l2, k2);
            System.arraycopy(l2 < k2 ? aint1 : aint, 0, MISSING_TEXTURE_DATA, 16 * l2 + k2, k2);
        }
    ...
    private static int blendColorComponent(int p_147944_0_, int p_147944_1_, int p_147944_2_, int p_147944_3_, int p_147944_4_) {
        float f2 = TextureUtil.getColorGamma(p_147944_0_ >> p_147944_4_);
        float f1 = TextureUtil.getColorGamma(p_147944_1_ >> p_147944_4_);
        float f22 = TextureUtil.getColorGamma(p_147944_2_ >> p_147944_4_);
    ...
    private static void uploadTextureSub(int p_147947_0_, int[] p_147947_1_, int p_147947_2_, int p_147947_3_, int p_147947_4_, int p_147947_5_, boolean p_147947_6_, boolean p_147947_7_, boolean p_147947_8_) {
        ...
        for (int k2 = 0; k2 < p_147947_2_ * p_147947_3_; k2 += p_147947_2_ * j2) {
            ...
            GlStateManager.glTexSubImage2D(3553, p_147947_0_, p_147947_4_, p_147947_5_ + l2, p_147947_2_, j2, 32993, 33639, DATA_BUFFER);
        }
    }
    ...
    public static void allocateTextureImpl(int glTextureId, int mipmapLevels, int width, int height) {
        ...
        for (int i2 = 0; i2 <= mipmapLevels; ++i2) {
            GlStateManager.glTexImage2D(3553, i2, 6408, width >> i2, height >> i2, 0, 32993, 33639, null);
        }
    }
    ...
    private static void uploadTextureImageSubImpl(BufferedImage p_110993_0_, int p_110993_1_, int p_110993_2_, boolean p_110993_3_, boolean p_110993_4_) {
        ...
        for (int l2 = 0; l2 < i2 * j2; l2 += i2 * k2) {
            ...
            GlStateManager.glTexSubImage2D(3553, 0, p_110993_1_, p_110993_2_ + i1, i2, j1, 32993, 33639, DATA_BUFFER);
        }
    }
    ...
    public static void setTextureBlurMipmap(boolean p_147954_0_, boolean p_147954_1_) {
        if (p_147954_0_) {
            ...
            GlStateManager.glTexParameteri(3553, 10241, p_147954_1_ ? i2 : 9728);
