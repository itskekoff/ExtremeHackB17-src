...
extends RenderLiving<EntityGuardian> {
    ...
    public void doRender(EntityGuardian entity, double x2, double y2, double z2, float entityYaw, float partialTicks) {
        ...
        if (entitylivingbase != null) {
            float f2 = entity.getAttackAnimationScale(partialTicks);
            ...
            float f22 = (float)entity.world.getTotalWorldTime() + partialTicks;
            ...
            boolean i2 = true;
            double d1 = (double)f22 * 0.05 * -1.5;
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            float f7 = f2 * f2;
            int j2 = 64 + (int)(f7 * 191.0f);
            int k2 = 32 + (int)(f7 * 191.0f);
            ...
            bufferbuilder.pos(d12, d0, d13).tex(0.4999, d23).color(j2, k2, l2, 255).endVertex();
            bufferbuilder.pos(d12, 0.0, d13).tex(0.4999, d22).color(j2, k2, l2, 255).endVertex();
            bufferbuilder.pos(d14, 0.0, d15).tex(0.0, d22).color(j2, k2, l2, 255).endVertex();
            bufferbuilder.pos(d14, d0, d15).tex(0.0, d23).color(j2, k2, l2, 255).endVertex();
            bufferbuilder.pos(d16, d0, d17).tex(0.4999, d23).color(j2, k2, l2, 255).endVertex();
            bufferbuilder.pos(d16, 0.0, d17).tex(0.4999, d22).color(j2, k2, l2, 255).endVertex();
            bufferbuilder.pos(d18, 0.0, d19).tex(0.0, d22).color(j2, k2, l2, 255).endVertex();
            bufferbuilder.pos(d18, d0, d19).tex(0.0, d23).color(j2, k2, l2, 255).endVertex();
            double d24 = 0.0;
            if (entity.ticksExisted % 2 == 0) {
                d24 = 0.5;
            }
            bufferbuilder.pos(d4, d0, d5).tex(0.5, d24 + 0.5).color(j2, k2, l2, 255).endVertex();
            bufferbuilder.pos(d6, d0, d7).tex(1.0, d24 + 0.5).color(j2, k2, l2, 255).endVertex();
            bufferbuilder.pos(d10, d0, d11).tex(1.0, d24).color(j2, k2, l2, 255).endVertex();
            bufferbuilder.pos(d8, d0, d9).tex(0.5, d24).color(j2, k2, l2, 255).endVertex();
            tessellator.draw();
