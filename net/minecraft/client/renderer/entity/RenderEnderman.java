...
extends RenderLiving<EntityEnderman> {
    ...
    @Override
    public void doRender(EntityEnderman entity, double x2, double y2, double z2, float entityYaw, float partialTicks) {
        ...
        if (entity.isScreaming()) {
            double d0 = 0.02;
            x2 += this.rnd.nextGaussian() * 0.02;
            z2 += this.rnd.nextGaussian() * 0.02;
        }
