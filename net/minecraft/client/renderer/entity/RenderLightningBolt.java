            ...
            for (int j2 = 0; j2 < 3; ++j2) {
                ...
                for (int i1 = k2; i1 >= l2; --i1) {
                    ...
                    for (int j1 = 0; j1 < 5; ++j1) {
                        ...
                        bufferbuilder.pos(d10 + d2, y2 + (double)(i1 * 16), d11 + d3).color(0.45f, 0.45f, 0.5f, 0.3f).endVertex();
                        bufferbuilder.pos(d8 + d4, y2 + (double)((i1 + 1) * 16), d9 + d5).color(0.45f, 0.45f, 0.5f, 0.3f).endVertex();
                    }
                    tessellator.draw();
                }
            }
