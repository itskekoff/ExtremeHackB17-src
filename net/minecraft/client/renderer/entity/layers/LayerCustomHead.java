...
implements LayerRenderer<EntityLivingBase> {
    ...
    public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        if (!itemstack.func_190926_b()) {
            ...
            boolean bl2 = flag = entitylivingbaseIn instanceof EntityVillager || entitylivingbaseIn instanceof EntityZombieVillager;
            ...
            if (item == Items.SKULL) {
                ...
                if (itemstack.hasTagCompound()) {
                    ...
                    } else if (nbttagcompound.hasKey("SkullOwner", 8) && !StringUtils.isBlank(s2 = nbttagcompound.getString("SkullOwner"))) {
