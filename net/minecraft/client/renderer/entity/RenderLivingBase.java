...
extends Render<T> {
    ...
    public void doRender(T entity, double x2, double y2, double z2, float entityYaw, float partialTicks) {
        block22: {
            block21: {
                ...
                if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, Float.valueOf(partialTicks), x2, y2, z2)) break block22;
            }
            ...
            try {
                ...
                if (this.mainModel.isRiding && ((Entity)entity).getRidingEntity() instanceof EntityLivingBase) {
                    ...
                    f22 = f1 - f2;
                    float f3 = MathHelper.wrapDegrees(f22);
                    if (f3 < -85.0f) {
                        f3 = -85.0f;
                    }
                    if (f3 >= 85.0f) {
                ...
                this.mainModel.setRotationAngles(f6, f5, f8, f22, f7, f4, (Entity)entity);
                ...
                if (this.renderOutlines) {
                    ...
                    if (!(entity instanceof EntityPlayer) || !((EntityPlayer)entity).isSpectator()) {
                        this.renderLayers(entity, f6, f5, partialTicks, f8, f22, f7, f4);
                    }
            ...
            if (Reflector.RenderLivingEvent_Post_Constructor.exists()) {
                Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Post_Constructor, entity, this, Float.valueOf(partialTicks), x2, y2, z2);
            }
        }
    }
    ...
    protected void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        boolean bl2 = flag1 = !flag && !((Entity)entitylivingbaseIn).isInvisibleToPlayer(Minecraft.getMinecraft().player);
        if (flag || flag1) {
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        boolean flag1;
        float f2 = ((Entity)entitylivingbaseIn).getBrightness();
    ...
    protected void rotateCorpse(T entityLiving, float p_77043_2_, float p_77043_3_, float partialTicks) {
        ...
        if (((EntityLivingBase)entityLiving).deathTime > 0) {
            ...
            String s2 = TextFormatting.getTextWithoutFormattingCodes(((Entity)entityLiving).getName());
            if (s2 != null && ("Dinnerbone".equals(s2) || "Grumm".equals(s2)) && (!(entityLiving instanceof EntityPlayer) || ((EntityPlayer)entityLiving).isWearing(EnumPlayerModelParts.CAPE))) {
    ...
    public void renderName(T entity, double x2, double y2, double z2) {
        block7: {
            block6: {
                ...
                if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, entity, this, x2, y2, z2)) break block7;
            }
            if (this.canRenderName(entity)) {
                ...
                if (d0 < (double)(f2 * f2)) {
                    ...
                    this.renderEntityName(entity, x2, y2, z2, s2, d0);
                }
            }
    ...
    protected boolean canRenderName(T entity) {
        ...
        boolean bl2 = flag = !((Entity)entity).isInvisibleToPlayer(entityplayersp);
