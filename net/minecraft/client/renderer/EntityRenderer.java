...
implements IResourceManagerReloadListener {
    ...
    private float getFOVModifier(float partialTicks, boolean useFOVSetting) {
        ...
        return Reflector.ForgeHooksClient_getFOVModifier.exists() ? Reflector.callFloat(Reflector.ForgeHooksClient_getFOVModifier, this, entity, iblockstate, Float.valueOf(partialTicks), Float.valueOf(f2)) : f2;
    }
    ...
    private void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                double d4 = (double)(-MathHelper.sin(f1 * ((float)Math.PI / 180)) * MathHelper.cos(f22 * ((float)Math.PI / 180))) * d3;
                double d5 = (double)(MathHelper.cos(f1 * ((float)Math.PI / 180)) * MathHelper.cos(f22 * ((float)Math.PI / 180))) * d3;
                double d6 = (double)(-MathHelper.sin(f22 * ((float)Math.PI / 180))) * d3;
            ...
            if (world != null) {
                ...
                for (int i2 = 0; i2 < 256; ++i2) {
                    ...
                    if (Reflector.ForgeWorldProvider_getLightmapColors.exists()) {
                        ...
                        Reflector.call(world.provider, Reflector.ForgeWorldProvider_getLightmapColors, Float.valueOf(partialTicks), Float.valueOf(f2), Float.valueOf(f22), Float.valueOf(f3), afloat);
                        f8 = afloat[0];
                        f9 = afloat[1];
                        f10 = afloat[2];
                    }
                    ...
                    this.lightmapColors[i2] = 0xFF000000 | k2 << 16 | l2 << 8 | i1;
                }
                this.lightmapTexture.updateDynamicTexture();
                this.lightmapUpdateNeeded = false;
                this.mc.mcProfiler.endSection();
    ...
    public float getNightVisionBrightness(EntityLivingBase entitylivingbaseIn, float partialTicks) {
        int i2 = entitylivingbaseIn.getActivePotionEffect(MobEffects.NIGHT_VISION).getDuration();
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (this.mc.inGameHasFocus && flag) {
            ...
            if (this.mc.gameSettings.smoothCamera) {
                ...
                this.mc.player.setAngles(f22, f3 * (float)i2);
            } else {
                this.smoothCamYaw = 0.0f;
                this.smoothCamPitch = 0.0f;
                this.mc.player.setAngles(f22, f3 * (float)i2);
    ...
    private void createWorldIcon() {
        if (this.mc.renderGlobal.getRenderedChunks() > 10 && this.mc.renderGlobal.hasNoChunkUpdates() && !this.mc.getIntegratedServer().isWorldIconSet()) {
            ...
            try {
                ...
                graphics.drawImage(bufferedimage, 0, 0, 64, 64, k2, l2, k2 + i2, l2 + i2, null);
                graphics.dispose();
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Event3DRender ev2 = new Event3DRender(partialTicks);
        EventManager.call(ev2);
    ...
    private void addRainParticles() {
        float f2 = this.mc.world.getRainStrength(1.0f);
    ...
    protected void renderRainSnow(float partialTicks) {
        ...
        if (f5 > 0.0f) {
            ...
            Entity entity = this.mc.getRenderViewEntity();
            WorldClient world = this.mc.world;
            int i2 = MathHelper.floor(entity.posX);
            int j2 = MathHelper.floor(entity.posY);
            ...
            for (int k1 = k2 - i1; k1 <= k2 + i1; ++k1) {
                for (int l1 = i2 - i1; l1 <= i2 + i1; ++l1) {
                    ...
                    blockpos$mutableblockpos.setPos(l1, k22, k1);
                    float f1 = biome.getFloatTemperature(blockpos$mutableblockpos);
                    if (world.getBiomeProvider().getTemperatureAtHeight(f1, j22) >= 0.15f) {
                        if (j1 != 0) {
                            if (j1 >= 0) {
                                tessellator.draw();
                            }
                        ...
                        float f22 = MathHelper.sqrt(d6 * d6 + d7 * d7) / (float)i1;
                        float f3 = ((1.0f - f22 * f22) * 0.5f + 0.5f) * f5;
                        blockpos$mutableblockpos.setPos(l1, i3, k1);
                        int j3 = ((World)world).getCombinedLight(blockpos$mutableblockpos, 0);
                        int k3 = j3 >> 16 & 0xFFFF;
                        int l3 = j3 & 0xFFFF;
                        bufferbuilder.pos((double)l1 - d3 + 0.5, l22, (double)k1 - d4 + 0.5).tex(0.0, (double)k22 * 0.25 + d5).color(1.0f, 1.0f, 1.0f, f3).lightmap(k3, l3).endVertex();
                        bufferbuilder.pos((double)l1 + d3 + 0.5, l22, (double)k1 + d4 + 0.5).tex(1.0, (double)k22 * 0.25 + d5).color(1.0f, 1.0f, 1.0f, f3).lightmap(k3, l3).endVertex();
                        bufferbuilder.pos((double)l1 + d3 + 0.5, k22, (double)k1 + d4 + 0.5).tex(1.0, (double)l22 * 0.25 + d5).color(1.0f, 1.0f, 1.0f, f3).lightmap(k3, l3).endVertex();
                        bufferbuilder.pos((double)l1 - d3 + 0.5, k22, (double)k1 - d4 + 0.5).tex(0.0, (double)l22 * 0.25 + d5).color(1.0f, 1.0f, 1.0f, f3).lightmap(k3, l3).endVertex();
                        continue;
                    }
                    if (j1 != 1) {
                        if (j1 >= 0) {
                    ...
                    int j4 = i4 >> 16 & 0xFFFF;
                    int k4 = i4 & 0xFFFF;
                    bufferbuilder.pos((double)l1 - d3 + 0.5, l22, (double)k1 - d4 + 0.5).tex(0.0 + d9, (double)k22 * 0.25 + d8 + d10).color(1.0f, 1.0f, 1.0f, f4).lightmap(j4, k4).endVertex();
                    bufferbuilder.pos((double)l1 + d3 + 0.5, l22, (double)k1 + d4 + 0.5).tex(1.0 + d9, (double)k22 * 0.25 + d8 + d10).color(1.0f, 1.0f, 1.0f, f4).lightmap(j4, k4).endVertex();
                    bufferbuilder.pos((double)l1 + d3 + 0.5, k22, (double)k1 + d4 + 0.5).tex(1.0 + d9, (double)l22 * 0.25 + d8 + d10).color(1.0f, 1.0f, 1.0f, f4).lightmap(j4, k4).endVertex();
                    bufferbuilder.pos((double)l1 - d3 + 0.5, k22, (double)k1 - d4 + 0.5).tex(0.0 + d9, (double)l22 * 0.25 + d8 + d10).color(1.0f, 1.0f, 1.0f, f4).lightmap(j4, k4).endVertex();
                }
            }
            if (j1 >= 0) {
                tessellator.draw();
    ...
    private void updateFogColor(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPotionActive(MobEffects.BLINDNESS)) {
            int i2 = ((EntityLivingBase)entity).getActivePotionEffect(MobEffects.BLINDNESS).getDuration();
    ...
    private void setupFog(int startCoords, float partialTicks) {
        ...
        if (Reflector.ForgeHooksClient_getFogDensity.exists()) {
            f2 = Reflector.callFloat(Reflector.ForgeHooksClient_getFogDensity, this, entity, iblockstate, Float.valueOf(partialTicks), Float.valueOf(0.1f));
        }
        if (f2 >= 0.0f) {
            ...
            int i2 = ((EntityLivingBase)entity).getActivePotionEffect(MobEffects.BLINDNESS).getDuration();
            if (i2 < 20) {
                f22 = 5.0f + (this.farPlaneDistance - 5.0f) * (1.0f - (float)i2 / 20.0f);
            }
            if (Config.isShaders()) {
            ...
            if (startCoords == -1) {
                ...
                GlStateManager.setFogEnd(f22 * 0.8f);
            } else {
                GlStateManager.setFogStart(f22 * 0.25f);
                GlStateManager.setFogEnd(f22);
            }
    ...
    private void frameFinish() {
        long i2;
        if (this.mc.world != null && (i2 = System.currentTimeMillis()) > this.lastErrorCheckTimeMs + 10000L) {
            this.lastErrorCheckTimeMs = i2;
            int j2 = GlStateManager.glGetError();
            if (j2 != 0) {
                String s2 = GLU.gluErrorString(j2);
                TextComponentString textcomponentstring = new TextComponentString(I18n.format("of.message.openglError", j2, s2));
                this.mc.ingameGUI.getChatGUI().printChatMessage(textcomponentstring);
            }
        }
    }
    ...
    private void checkLoadVisibleChunks(Entity p_checkLoadVisibleChunks_1_, float p_checkLoadVisibleChunks_2_, ICamera p_checkLoadVisibleChunks_3_, boolean p_checkLoadVisibleChunks_4_) {
        ...
        if (Keyboard.isKeyDown(61) && Keyboard.isKeyDown(38)) {
            ...
            this.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(textcomponentstring, i2);
    ...
    private void loadAllVisibleChunks(Entity p_loadAllVisibleChunks_1_, double p_loadAllVisibleChunks_2_, ICamera p_loadAllVisibleChunks_4_, boolean p_loadAllVisibleChunks_5_) {
        ...
        int i2 = renderglobal.getCountLoadedChunks();
        long j2 = System.currentTimeMillis();
        Config.dbg("Loading visible chunks");
        long k2 = System.currentTimeMillis() + 5000L;
        int l2 = 0;
        boolean flag = false;
        do {
            flag = false;
            for (int i1 = 0; i1 < 100; ++i1) {
                ...
                l2 += renderglobal.getCountChunksToUpdate();
                renderglobal.updateChunks(System.nanoTime() + 1000000000L);
                l2 -= renderglobal.getCountChunksToUpdate();
            }
            if (renderglobal.getCountLoadedChunks() != i2) {
                flag = true;
                i2 = renderglobal.getCountLoadedChunks();
            }
            if (System.currentTimeMillis() <= k2) continue;
            Config.log("Chunks loaded: " + l2);
            k2 = System.currentTimeMillis() + 5000L;
        } while (flag);
        Config.log("Chunks loaded: " + l2);
    ...
    public static void drawNameplate(FontRenderer fontRendererIn, String str, float x2, float y2, float z2, int verticalShift, float viewerYaw, float viewerPitch, boolean isThirdPersonFrontal, boolean isSneaking) {
        GlStateManager.pushMatrix();
        ...
        GlStateManager.enableBlend();
        GlStateManager.tryBlendFuncSeparate(GlStateManager.SourceFactor.SRC_ALPHA, GlStateManager.DestFactor.ONE_MINUS_SRC_ALPHA, GlStateManager.SourceFactor.ONE, GlStateManager.DestFactor.ZERO);
        int i2 = fontRendererIn.getStringWidth(str) / 2;
        GlStateManager.disableTexture2D();
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_COLOR);
        bufferbuilder.pos(-i2 - 1, -1 + verticalShift, 0.0).color(0.0f, 0.0f, 0.0f, 0.25f).endVertex();
        bufferbuilder.pos(-i2 - 1, 8 + verticalShift, 0.0).color(0.0f, 0.0f, 0.0f, 0.25f).endVertex();
        bufferbuilder.pos(i2 + 1, 8 + verticalShift, 0.0).color(0.0f, 0.0f, 0.0f, 0.25f).endVertex();
        bufferbuilder.pos(i2 + 1, -1 + verticalShift, 0.0).color(0.0f, 0.0f, 0.0f, 0.25f).endVertex();
        tessellator.draw();
        GlStateManager.enableTexture2D();
    ...
    private void func_190563_a(int p_190563_1_, int p_190563_2_, float p_190563_3_) {
        if (this.field_190566_ab != null && this.field_190567_ac > 0) {
            ...
            float f2 = ((float)i2 + p_190563_3_) / 40.0f;
            float f1 = f2 * f2;
            float f22 = f2 * f1;
            ...
            GlStateManager.rotate(6.0f * MathHelper.cos(f2 * 8.0f), 1.0f, 0.0f, 0.0f);
            GlStateManager.rotate(6.0f * MathHelper.cos(f2 * 8.0f), 0.0f, 0.0f, 1.0f);
