...
public class ChunkRenderDispatcher {
    ...
    public ChunkRenderDispatcher(int p_i7_1_) {
        int i2 = Math.max(1, (int)((double)Runtime.getRuntime().maxMemory() * 0.3) / 0xA00000);
        int j2 = Math.max(1, MathHelper.clamp(Runtime.getRuntime().availableProcessors(), 1, i2 / 5));
        this.countRenderBuilders = p_i7_1_ < 0 ? MathHelper.clamp(j2, 1, i2) : p_i7_1_;
        if (j2 > 1) {
        ...
        for (int l2 = 0; l2 < this.countRenderBuilders; ++l2) {
    ...
    public boolean updateTransparencyLater(RenderChunk chunkRenderer) {
        ...
        try {
            ...
            if (chunkcompiletaskgenerator != null) {
                ...
                boolean bl2 = flag2 = this.queueChunkUpdates.offer(chunkcompiletaskgenerator);
                return bl2;
            }
            flag1 = flag = true;
        }
