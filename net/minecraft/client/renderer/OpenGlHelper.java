...
public class OpenGlHelper {
    ...
    public static void initializeTextures() {
        ...
        boolean bl2 = arbTextureEnvCombine = contextcapabilities.GL_ARB_texture_env_combine && !contextcapabilities.OpenGL13;
        if (arbMultitexture) {
        ...
        boolean bl3 = framebufferSupported = openGL14 && (contextcapabilities.GL_ARB_framebuffer_object || contextcapabilities.GL_EXT_framebuffer_object || contextcapabilities.OpenGL30);
        ...
        String s2 = GL11.glGetString(7936).toLowerCase(Locale.ROOT);
    ...
    public static void setLightmapTextureCoords(int target, float p_77475_1_, float t2) {
        if (arbMultitexture) {
            ARBMultitexture.glMultiTexCoord2fARB(target, p_77475_1_, t2);
        } else {
            GL13.glMultiTexCoord2f(target, p_77475_1_, t2);
        }
