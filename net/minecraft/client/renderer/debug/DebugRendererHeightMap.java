...
implements DebugRenderer.IDebugRenderer {
    ...
    public void render(float p_190060_1_, long p_190060_2_) {
        ...
        for (BlockPos blockpos1 : iterable) {
            int i2;
            if (world.getBlockState(blockpos1.add(0, i2 = world.getHeight(blockpos1.getX(), blockpos1.getZ()), 0).down()) == Blocks.AIR.getDefaultState()) {
                RenderGlobal.addChainedFilledBoxVertices(bufferbuilder, (double)((float)blockpos1.getX() + 0.25f) - d0, (double)i2 - d1, (double)((float)blockpos1.getZ() + 0.25f) - d2, (double)((float)blockpos1.getX() + 0.75f) - d0, (double)i2 + 0.09375 - d1, (double)((float)blockpos1.getZ() + 0.75f) - d2, 0.0f, 0.0f, 1.0f, 0.5f);
                continue;
            }
            RenderGlobal.addChainedFilledBoxVertices(bufferbuilder, (double)((float)blockpos1.getX() + 0.25f) - d0, (double)i2 - d1, (double)((float)blockpos1.getZ() + 0.25f) - d2, (double)((float)blockpos1.getX() + 0.75f) - d0, (double)i2 + 0.09375 - d1, (double)((float)blockpos1.getZ() + 0.75f) - d2, 0.0f, 1.0f, 0.0f, 0.5f);
        }
        tessellator.draw();
