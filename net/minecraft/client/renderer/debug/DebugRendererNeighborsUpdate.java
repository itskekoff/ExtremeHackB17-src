...
implements DebugRenderer.IDebugRenderer {
    ...
    public void render(float p_190060_1_, long p_190060_2_) {
        long i2 = this.field_191554_a.world.getTotalWorldTime();
        ...
        while (iterator.hasNext()) {
            ...
            for (Map.Entry<BlockPos, Integer> entry1 : map1.entrySet()) {
                ...
                RenderGlobal.drawSelectionBoundingBox(new AxisAlignedBB(BlockPos.ORIGIN).expandXyz(0.002).contract(0.0025 * (double)k2).offset(blockpos.getX(), blockpos.getY(), blockpos.getZ()).offset(-d0, -d1, -d2), 1.0f, 1.0f, 1.0f, 1.0f);
