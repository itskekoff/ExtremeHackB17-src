...
public class DebugRenderer {
    ...
    public static void renderDebugText(String str, double x2, double y2, double z2, float partialTicks, int color) {
        ...
        if (minecraft.player != null && minecraft.getRenderManager() != null && minecraft.getRenderManager().options != null) {
            ...
            GlStateManager.translate((float)(x2 - d0), (float)(y2 - d1) + 0.07f, (float)(z2 - d2));
