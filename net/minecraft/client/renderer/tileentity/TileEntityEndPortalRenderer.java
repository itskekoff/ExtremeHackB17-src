    ...
    public void func_192841_a(TileEntityEndPortal p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_) {
        if (!Config.isShaders() || !ShadersRender.renderEndPortal(p_192841_1_, p_192841_2_, p_192841_4_, p_192841_6_, p_192841_8_, p_192841_9_, this.func_191287_c())) {
            ...
            for (int j2 = 0; j2 < i2; ++j2) {
                ...
                float f22 = j2 + 1;
                GlStateManager.translate(17.0f / f22, (2.0f + f22 / 1.5f) * ((float)Minecraft.getSystemTime() % 800000.0f / 800000.0f), 0.0f);
                GlStateManager.rotate((f22 * f22 * 4321.0f + f22 * 9.0f) * 2.0f, 0.0f, 0.0f, 1.0f);
                GlStateManager.scale(4.5f - f22 / 4.0f, 4.5f - f22 / 4.0f, 1.0f);
                ...
                if (p_192841_1_.shouldRenderFace(EnumFacing.UP)) {
                    bufferbuilder.pos(p_192841_2_, p_192841_4_ + (double)f2, p_192841_6_ + 1.0).color(f3, f4, f5, 1.0f).endVertex();
                    bufferbuilder.pos(p_192841_2_ + 1.0, p_192841_4_ + (double)f2, p_192841_6_ + 1.0).color(f3, f4, f5, 1.0f).endVertex();
                    bufferbuilder.pos(p_192841_2_ + 1.0, p_192841_4_ + (double)f2, p_192841_6_).color(f3, f4, f5, 1.0f).endVertex();
                    bufferbuilder.pos(p_192841_2_, p_192841_4_ + (double)f2, p_192841_6_).color(f3, f4, f5, 1.0f).endVertex();
                }
                tessellator.draw();
                GlStateManager.popMatrix();
