...
public class TileEntityRendererDispatcher {
    ...
    public void renderTileEntity(TileEntity tileentityIn, float partialTicks, int destroyStage) {
        if (tileentityIn.getDistanceSq(this.entityX, this.entityY, this.entityZ) < tileentityIn.getMaxRenderDistanceSquared()) {
            ...
            if (Reflector.ForgeTileEntity_hasFastRenderer.exists()) {
                boolean bl2 = flag = !this.drawingBatch || !Reflector.callBoolean(tileentityIn, Reflector.ForgeTileEntity_hasFastRenderer, new Object[0]);
            }
            if (flag) {
                int i2 = this.worldObj.getCombinedLight(tileentityIn.getPos(), 0);
                int j2 = i2 % 65536;
                int k2 = i2 / 65536;
    ...
    public void renderTileEntityAt(TileEntity tileEntityIn, double x2, double y2, double z2, float partialTicks) {
        this.func_192855_a(tileEntityIn, x2, y2, z2, partialTicks, 1.0f);
    }
