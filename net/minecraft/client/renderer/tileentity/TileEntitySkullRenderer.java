...
extends TileEntitySpecialRenderer<TileEntitySkull> {
    ...
    public void func_192841_a(TileEntitySkull p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_) {
        ...
        float f2 = p_192841_1_.getAnimationProgress(p_192841_8_);
        this.renderSkull((float)p_192841_2_, (float)p_192841_4_, (float)p_192841_6_, enumfacing, (float)(p_192841_1_.getSkullRotation() * 360) / 16.0f, p_192841_1_.getSkullType(), p_192841_1_.getPlayerProfile(), p_192841_9_, f2);
    }
    ...
    public void renderSkull(float x2, float y2, float z2, EnumFacing facing, float p_188190_5_, int skullType, @Nullable GameProfile profile, int destroyStage, float animateTicks) {
        ...
        if (facing == EnumFacing.UP) {
            GlStateManager.translate(x2 + 0.5f, y2, z2 + 0.5f);
        } else {
            switch (facing) {
                case NORTH: {
                    GlStateManager.translate(x2 + 0.5f, y2 + 0.25f, z2 + 0.74f);
                    break;
                }
                case SOUTH: {
                    GlStateManager.translate(x2 + 0.5f, y2 + 0.25f, z2 + 0.26f);
                    p_188190_5_ = 180.0f;
                    break;
                }
                case WEST: {
                    GlStateManager.translate(x2 + 0.74f, y2 + 0.25f, z2 + 0.5f);
                    p_188190_5_ = 270.0f;
                    break;
                }
                default: {
                    GlStateManager.translate(x2 + 0.26f, y2 + 0.25f, z2 + 0.5f);
                    p_188190_5_ = 90.0f;
                }
            }
        }
