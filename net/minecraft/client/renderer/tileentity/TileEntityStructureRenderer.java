...
extends TileEntitySpecialRenderer<TileEntityStructure> {
    ...
    private void renderInvisibleBlocks(TileEntityStructure p_190054_1_, double p_190054_2_, double p_190054_4_, double p_190054_6_, BlockPos p_190054_8_, Tessellator p_190054_9_, BufferBuilder p_190054_10_, boolean p_190054_11_) {
        ...
        for (BlockPos blockpos2 : BlockPos.getAllInBox(blockpos1, blockpos1.add(p_190054_1_.getStructureSize()).add(-1, -1, -1))) {
            ...
            boolean bl2 = flag1 = iblockstate == Blocks.STRUCTURE_VOID.getDefaultState();
            if (!flag && !flag1) continue;
            float f2 = flag ? 0.05f : 0.0f;
            double d0 = (double)((float)(blockpos2.getX() - blockpos.getX()) + 0.45f) + p_190054_2_ - (double)f2;
            double d1 = (double)((float)(blockpos2.getY() - blockpos.getY()) + 0.45f) + p_190054_4_ - (double)f2;
            double d2 = (double)((float)(blockpos2.getZ() - blockpos.getZ()) + 0.45f) + p_190054_6_ - (double)f2;
            double d3 = (double)((float)(blockpos2.getX() - blockpos.getX()) + 0.55f) + p_190054_2_ + (double)f2;
            double d4 = (double)((float)(blockpos2.getY() - blockpos.getY()) + 0.55f) + p_190054_4_ + (double)f2;
            double d5 = (double)((float)(blockpos2.getZ() - blockpos.getZ()) + 0.55f) + p_190054_6_ + (double)f2;
            if (p_190054_11_) {
    ...
    @Override
    public boolean isGlobalRenderer(TileEntityStructure te2) {
        return true;
    }
}
