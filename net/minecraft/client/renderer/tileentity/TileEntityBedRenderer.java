...
extends TileEntitySpecialRenderer<TileEntityBed> {
    ...
    static {
        ...
        EnumDyeColor[] arrenumDyeColor = aenumdyecolor;
        int n2 = aenumdyecolor.length;
        for (int i2 = 0; i2 < n2; ++i2) {
            EnumDyeColor enumdyecolor = arrenumDyeColor[i2];
    ...
    public void func_192841_a(TileEntityBed p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_) {
        ...
        int n2 = i2 = flag ? p_192841_1_.getBlockMetadata() & 3 : 0;
        if (p_192841_9_ >= 0) {
        ...
        if (flag) {
            this.func_193847_a(flag1, p_192841_2_, p_192841_4_, p_192841_6_, i2, p_192841_10_);
        } else {
            GlStateManager.pushMatrix();
            this.func_193847_a(true, p_192841_2_, p_192841_4_, p_192841_6_, i2, p_192841_10_);
            this.func_193847_a(false, p_192841_2_, p_192841_4_, p_192841_6_ - 1.0, i2, p_192841_10_);
    ...
    private void func_193847_a(boolean p_193847_1_, double p_193847_2_, double p_193847_4_, double p_193847_6_, int p_193847_8_, float p_193847_9_) {
        ...
        GlStateManager.translate((float)p_193847_2_ + f1, (float)p_193847_4_ + 0.5625f, (float)p_193847_6_ + f22);
