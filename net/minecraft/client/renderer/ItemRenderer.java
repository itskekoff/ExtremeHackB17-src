...
public class ItemRenderer {
    ...
    public void renderItemSide(EntityLivingBase entitylivingbaseIn, ItemStack heldStack, ItemCameraTransforms.TransformType transform, boolean leftHanded) {
        if (!heldStack.func_190926_b()) {
            ...
            boolean bl2 = flag = this.itemRenderer.shouldRenderItemIn3D(heldStack) && block.getBlockLayer() == BlockRenderLayer.TRANSLUCENT;
    ...
    private void setLightmap() {
        ...
        int i2 = this.mc.world.getCombinedLight(new BlockPos(abstractclientplayer.posX, abstractclientplayer.posY + (double)abstractclientplayer.getEyeHeight(), abstractclientplayer.posZ), 0);
    ...
    private void rotateArm(float p_187458_1_) {
        ...
        float f2 = entityplayersp.prevRenderArmPitch + (entityplayersp.renderArmPitch - entityplayersp.prevRenderArmPitch) * p_187458_1_;
    ...
    private void renderArm(EnumHandSide p_187455_1_) {
        ...
        GlStateManager.pushMatrix();
        float f2 = p_187455_1_ == EnumHandSide.RIGHT ? 1.0f : -1.0f;
    ...
    private void renderMapFirstPersonSide(float p_187465_1_, EnumHandSide p_187465_2_, float p_187465_3_, ItemStack p_187465_4_) {
        float f2 = p_187465_2_ == EnumHandSide.RIGHT ? 1.0f : -1.0f;
        GlStateManager.translate(f2 * 0.125f, -0.125f, 0.0f);
        if (!this.mc.player.isInvisible()) {
            GlStateManager.pushMatrix();
        ...
        GlStateManager.pushMatrix();
        GlStateManager.translate(f2 * 0.51f, -0.08f + p_187465_1_ * -1.2f, -0.75f);
        float f1 = MathHelper.sqrt(p_187465_3_);
        float f22 = MathHelper.sin(f1 * (float)Math.PI);
        float f3 = -0.5f * f22;
        float f4 = 0.4f * MathHelper.sin(f1 * ((float)Math.PI * 2));
        float f5 = -0.3f * MathHelper.sin(p_187465_3_ * (float)Math.PI);
        GlStateManager.translate(f2 * f3, f4 - 0.3f * f22, f5);
        GlStateManager.rotate(f22 * -45.0f, 1.0f, 0.0f, 0.0f);
        GlStateManager.rotate(f2 * f22 * -30.0f, 0.0f, 1.0f, 0.0f);
    ...
    private void renderMapFirstPerson(float p_187463_1_, float p_187463_2_, float p_187463_3_) {
        float f2 = MathHelper.sqrt(p_187463_3_);
        float f1 = -0.2f * MathHelper.sin(p_187463_3_ * (float)Math.PI);
        float f22 = -0.4f * MathHelper.sin(f2 * (float)Math.PI);
        GlStateManager.translate(0.0f, -f1 / 2.0f, f22);
        ...
        this.renderArms();
        float f4 = MathHelper.sin(f2 * (float)Math.PI);
    ...
    private void renderArmFirstPerson(float p_187456_1_, float p_187456_2_, EnumHandSide p_187456_3_) {
        ...
        float f22 = -0.3f * MathHelper.sin(f1 * (float)Math.PI);
        float f3 = 0.4f * MathHelper.sin(f1 * ((float)Math.PI * 2));
        float f4 = -0.4f * MathHelper.sin(p_187456_2_ * (float)Math.PI);
        GlStateManager.translate(f2 * (f22 + 0.64000005f), f3 + -0.6f + p_187456_1_ * -0.6f, f4 + -0.71999997f);
        GlStateManager.rotate(f2 * 45.0f, 0.0f, 1.0f, 0.0f);
        float f5 = MathHelper.sin(p_187456_2_ * p_187456_2_ * (float)Math.PI);
        float f6 = MathHelper.sin(f1 * (float)Math.PI);
        GlStateManager.rotate(f2 * f6 * 70.0f, 0.0f, 1.0f, 0.0f);
        GlStateManager.rotate(f2 * f5 * -20.0f, 0.0f, 0.0f, 1.0f);
        EntityPlayerSP abstractclientplayer = this.mc.player;
        this.mc.getTextureManager().bindTexture(abstractclientplayer.getLocationSkin());
        GlStateManager.translate(f2 * -1.0f, 3.6f, 3.5f);
        GlStateManager.rotate(f2 * 120.0f, 0.0f, 0.0f, 1.0f);
        GlStateManager.rotate(200.0f, 1.0f, 0.0f, 0.0f);
        GlStateManager.rotate(f2 * -135.0f, 0.0f, 1.0f, 0.0f);
        GlStateManager.translate(f2 * 5.6f, 0.0f, 0.0f);
    ...
    private void transformEatFirstPerson(float p_187454_1_, EnumHandSide p_187454_2_, ItemStack p_187454_3_) {
        float f2 = (float)this.mc.player.getItemInUseCount() - p_187454_1_ + 1.0f;
        float f1 = f2 / (float)p_187454_3_.getMaxItemUseDuration();
        if (f1 < 0.8f) {
        ...
        int i2 = p_187454_2_ == EnumHandSide.RIGHT ? 1 : -1;
        GlStateManager.translate(f3 * 0.6f * (float)i2, f3 * -0.5f, f3 * 0.0f);
        GlStateManager.rotate((float)i2 * f3 * 90.0f, 0.0f, 1.0f, 0.0f);
        GlStateManager.rotate(f3 * 10.0f, 1.0f, 0.0f, 0.0f);
        GlStateManager.rotate((float)i2 * f3 * 30.0f, 0.0f, 0.0f, 1.0f);
    }

    private void transformFirstPerson(EnumHandSide p_187453_1_, float p_187453_2_) {
        int i2 = p_187453_1_ == EnumHandSide.RIGHT ? 1 : -1;
        float f2 = MathHelper.sin(p_187453_2_ * p_187453_2_ * (float)Math.PI);
        GlStateManager.rotate((float)i2 * (45.0f + f2 * -20.0f), 0.0f, 1.0f, 0.0f);
        float f1 = MathHelper.sin(MathHelper.sqrt(p_187453_2_) * (float)Math.PI);
        GlStateManager.rotate((float)i2 * f1 * -20.0f, 0.0f, 0.0f, 1.0f);
        GlStateManager.rotate(f1 * -80.0f, 1.0f, 0.0f, 0.0f);
        GlStateManager.rotate((float)i2 * -45.0f, 0.0f, 1.0f, 0.0f);
    }

    private void transformSideFirstPerson(EnumHandSide p_187459_1_, float p_187459_2_) {
        int i2 = p_187459_1_ == EnumHandSide.RIGHT ? 1 : -1;
        GlStateManager.translate((float)i2 * 0.56f, -0.52f + p_187459_2_ * -0.6f, -0.72f);
    }
            ...
            block10: {
                ...
                block7: {
                    ...
                    block8: {
                        ...
                        f2 = abstractclientplayer.getSwingProgress(partialTicks);
                        ...
                        float f22 = abstractclientplayer.prevRotationYaw + (abstractclientplayer.rotationYaw - abstractclientplayer.prevRotationYaw) * partialTicks;
                        boolean flag = true;
                        flag1 = true;
                        ...
                        this.rotateArroundXAndY(f1, f22);
                        this.setLightmap();
                        this.rotateArm(partialTicks);
                        GlStateManager.enableRescaleNormal();
                        if (!flag) break block7;
                        f3 = enumhand == EnumHand.MAIN_HAND ? f2 : 0.0f;
                ...
                f4 = enumhand == EnumHand.OFF_HAND ? f2 : 0.0f;
    ...
    public void renderItemInFirstPerson(AbstractClientPlayer p_187457_1_, float p_187457_2_, float p_187457_3_, EnumHand p_187457_4_, float p_187457_5_, ItemStack p_187457_6_, float p_187457_7_) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.func_190926_b()) {
                ...
                boolean flag1;
                boolean bl2 = flag1 = enumhandside == EnumHandSide.RIGHT;
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                    ...
                    switch (p_187457_6_.getItemUseAction()) {
                        ...
                        case BOW: {
                            this.transformSideFirstPerson(enumhandside, p_187457_7_);
                            GlStateManager.translate((float)j2 * -0.2785682f, 0.18344387f, 0.15731531f);
                            GlStateManager.rotate(-13.935f, 1.0f, 0.0f, 0.0f);
                            GlStateManager.rotate((float)j2 * 35.3f, 0.0f, 1.0f, 0.0f);
                            GlStateManager.rotate((float)j2 * -9.785f, 0.0f, 0.0f, 1.0f);
                            ...
                            GlStateManager.rotate((float)j2 * 45.0f, 0.0f, -1.0f, 0.0f);
                        }
                    }
                } else {
                    float f2 = -0.4f * MathHelper.sin(MathHelper.sqrt(p_187457_5_) * (float)Math.PI);
                    float f1 = 0.2f * MathHelper.sin(MathHelper.sqrt(p_187457_5_) * ((float)Math.PI * 2));
                    float f22 = -0.2f * MathHelper.sin(p_187457_5_ * (float)Math.PI);
                    int i2 = flag1 ? 1 : -1;
                    GlStateManager.translate((float)i2 * f2, f1, f22);
                    this.transformSideFirstPerson(enumhandside, p_187457_7_);
    ...
    private void renderWaterOverlayTexture(float partialTicks) {
        if (!Config.isShaders() || Shaders.isUnderwaterOverlay()) {
            ...
            Tessellator tessellator = Tessellator.getInstance();
            BufferBuilder bufferbuilder = tessellator.getBuffer();
            float f2 = this.mc.player.getBrightness();
    ...
    private void renderFireInFirstPerson() {
        ...
        for (int i2 = 0; i2 < 2; ++i2) {
            ...
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX);
            bufferbuilder.pos(-0.5, -0.5, -0.5).tex(f22, f4).endVertex();
            bufferbuilder.pos(0.5, -0.5, -0.5).tex(f1, f4).endVertex();
            bufferbuilder.pos(0.5, 0.5, -0.5).tex(f1, f3).endVertex();
            bufferbuilder.pos(-0.5, 0.5, -0.5).tex(f22, f3).endVertex();
            tessellator.draw();
            GlStateManager.popMatrix();
        }
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
    ...
    public void updateEquippedItem() {
        ...
        if (entityplayersp.isRowingBoat()) {
            ...
            if (Reflector.ForgeHooksClient_shouldCauseReequipAnimation.exists()) {
                ...
                this.equippedProgressMainHand += MathHelper.clamp((!flag ? f2 * f2 * f2 : 0.0f) - this.equippedProgressMainHand, -0.4f, 0.4f);
                this.equippedProgressOffHand += MathHelper.clamp((float)(!flag1 ? 1 : 0) - this.equippedProgressOffHand, -0.4f, 0.4f);
            } else {
                this.equippedProgressMainHand += MathHelper.clamp((Objects.equals(this.itemStackMainHand, itemstack) ? f2 * f2 * f2 : 0.0f) - this.equippedProgressMainHand, -0.4f, 0.4f);
