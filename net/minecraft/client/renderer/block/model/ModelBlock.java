...
public class ModelBlock {
    ...
    private String resolveTextureName(String textureName, Bookkeep p_178302_2_) {
        if (this.startsWithHash(textureName)) {
            ...
            String s2 = this.textures.get(textureName.substring(1));
            if (s2 == null && this.hasParent()) {
                s2 = this.parent.resolveTextureName(textureName, p_178302_2_);
            }
            p_178302_2_.modelExt = this;
            if (s2 != null && this.startsWithHash(s2)) {
                s2 = p_178302_2_.model.resolveTextureName(s2, p_178302_2_);
            }
            return s2 != null && !this.startsWithHash(s2) ? s2 : "missingno";
        }
        return textureName;
    }
    ...
    implements JsonDeserializer<ModelBlock> {
        ...
        public ModelBlock deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            String s2 = this.getParent(jsonobject);
            ...
            ResourceLocation resourcelocation = s2.isEmpty() ? null : new ResourceLocation(s2);
