...
public class BlockPartFace {
    ...
    implements JsonDeserializer<BlockPartFace> {
        ...
        public BlockPartFace deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            int i2 = this.parseTintIndex(jsonobject);
            String s2 = this.parseTexture(jsonobject);
            BlockFaceUV blockfaceuv = (BlockFaceUV)p_deserialize_3_.deserialize(jsonobject, (Type)((Object)BlockFaceUV.class));
            return new BlockPartFace(enumfacing, i2, s2, blockfaceuv);
        }
        ...
        private EnumFacing parseCullFace(JsonObject object) {
            String s2 = JsonUtils.getString(object, "cullface", "");
            return EnumFacing.byName(s2);
        }
    }
}
