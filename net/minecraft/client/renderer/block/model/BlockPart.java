...
public class BlockPart {
    ...
    implements JsonDeserializer<BlockPart> {
        ...
        private float parseAngle(JsonObject object) {
            float f2 = JsonUtils.getFloat(object, "angle");
        ...
        private EnumFacing.Axis parseAxis(JsonObject object) {
            String s2 = JsonUtils.getString(object, "axis");
            EnumFacing.Axis enumfacing$axis = EnumFacing.Axis.byName(s2.toLowerCase(Locale.ROOT));
        ...
        private Vector3f parsePosition(JsonObject object, String memberName) {
            ...
            for (int i2 = 0; i2 < afloat.length; ++i2) {
                afloat[i2] = JsonUtils.getFloat(jsonarray.get(i2), String.valueOf(memberName) + "[" + i2 + "]");
            }
