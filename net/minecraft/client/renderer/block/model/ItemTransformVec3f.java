...
public class ItemTransformVec3f {
    ...
    public int hashCode() {
        int i2 = this.rotation.hashCode();
        i2 = 31 * i2 + this.translation.hashCode();
        i2 = 31 * i2 + this.scale.hashCode();
        return i2;
    }
    ...
    implements JsonDeserializer<ItemTransformVec3f> {
        ...
        private Vector3f parseVector3f(JsonObject jsonObject, String key, Vector3f defaultValue) {
            ...
            for (int i2 = 0; i2 < afloat.length; ++i2) {
                afloat[i2] = JsonUtils.getFloat(jsonarray.get(i2), String.valueOf(key) + "[" + i2 + "]");
            }
