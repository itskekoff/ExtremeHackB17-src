...
extends Particle {
    ...
    public ParticleSimpleAnimated(World worldIn, double x2, double y2, double z2, int textureIdxIn, int numFrames, float yAccelIn) {
    ...
    public void setColor(int p_187146_1_) {
        float f2 = (float)((p_187146_1_ & 0xFF0000) >> 16) / 255.0f;
        float f1 = (float)((p_187146_1_ & 0xFF00) >> 8) / 255.0f;
        float f22 = (float)((p_187146_1_ & 0xFF) >> 0) / 255.0f;
        float f3 = 1.0f;
        this.setRBGColorF(f2 * 1.0f, f1 * 1.0f, f22 * 1.0f);
    }
