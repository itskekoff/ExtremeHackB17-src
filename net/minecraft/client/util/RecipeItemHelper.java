...
public class RecipeItemHelper {
    ...
    public void func_194112_a(ItemStack p_194112_1_) {
        if (!(p_194112_1_.func_190926_b() || p_194112_1_.isItemDamaged() || p_194112_1_.isItemEnchanted() || p_194112_1_.hasDisplayName())) {
            int i2 = RecipeItemHelper.func_194113_b(p_194112_1_);
            int j2 = p_194112_1_.func_190916_E();
            this.func_194117_b(i2, j2);
        }
    }

    public static int func_194113_b(ItemStack p_194113_0_) {
        Item item = p_194113_0_.getItem();
        int i2 = item.getHasSubtypes() ? p_194113_0_.getMetadata() : 0;
        return Item.REGISTRY.getIDForObject(item) << 16 | i2 & 0xFFFF;
    }
    ...
    public int func_194122_a(int p_194122_1_, int p_194122_2_) {
        int i2 = this.field_194124_a.get(p_194122_1_);
        if (i2 >= p_194122_2_) {
            this.field_194124_a.put(p_194122_1_, i2 - p_194122_2_);
            return p_194122_1_;
        }
        return 0;
    }
    ...
    class RecipePicker {
        ...
        public RecipePicker(IRecipe p_i47608_2_) {
            ...
            for (int i2 = 0; i2 < this.field_194106_c.size(); ++i2) {
                IntList intlist = this.field_194106_c.get(i2).func_194139_b();
                for (int j2 = 0; j2 < this.field_194109_f; ++j2) {
                    if (!intlist.contains(this.field_194108_e[j2])) continue;
                    this.field_194110_g.set(this.func_194095_d(true, j2, i2));
                }
            }
        }
        ...
        public boolean func_194092_a(int p_194092_1_, @Nullable IntList p_194092_2_) {
            ...
            while (this.func_194098_a(p_194092_1_)) {
                ...
                int l2 = this.field_194111_h.size() - 1;
                this.func_194096_c(this.field_194111_h.getInt(l2));
            ...
            boolean flag = k2 == this.field_194107_d;
            boolean bl2 = flag1 = flag && p_194092_2_ != null;
            if (flag1) {
                p_194092_2_.clear();
            }
        ...
        private boolean func_194098_a(int p_194098_1_) {
            int k2 = this.field_194109_f;
            for (int l2 = 0; l2 < k2; ++l2) {
                if (RecipeItemHelper.this.field_194124_a.get(this.field_194108_e[l2]) < p_194098_1_) continue;
                this.func_194088_a(false, l2);
                while (!this.field_194111_h.isEmpty()) {
                    ...
                    int k1 = flag ? this.field_194107_d : k2;
        ...
        private int func_194095_d(boolean p_194095_1_, int p_194095_2_, int p_194095_3_) {
            int k2 = p_194095_1_ ? p_194095_2_ * this.field_194107_d + p_194095_3_ : p_194095_3_ * this.field_194107_d + p_194095_2_;
            return this.field_194107_d + this.field_194109_f + this.field_194107_d + 2 * k2;
        }
        ...
        public int func_194102_b(int p_194102_1_, @Nullable IntList p_194102_2_) {
            int k2 = 0;
            int l2 = Math.min(p_194102_1_, this.func_194090_b()) + 1;
            while (true) {
                int i1;
                if (this.func_194092_a(i1 = (k2 + l2) / 2, null)) {
                    if (l2 - k2 <= 1) {
                        if (i1 > 0) {
        ...
        private int func_194090_b() {
            ...
            for (Ingredient ingredient : this.field_194106_c) {
                ...
                while (intlistiterator.hasNext()) {
                    ...
                    l2 = Math.max(l2, RecipeItemHelper.this.field_194124_a.get(i1));
                }
                if (k2 <= 0) continue;
                k2 = Math.min(k2, l2);
            }
