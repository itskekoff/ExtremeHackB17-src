...
implements ISearchTree<T> {
    ...
    public void func_194040_a() {
        ...
        for (T t2 : this.field_194048_e) {
            this.func_194042_b(t2);
        }
    ...
    extends AbstractIterator<T> {
        ...
        protected T computeNext() {
            ...
            int i2 = this.field_194036_d == this.field_194037_e ? 0 : (this.field_194036_d == null ? 1 : (this.field_194037_e == null ? -1 : Integer.compare(this.field_194035_c.getInt(this.field_194036_d), this.field_194035_c.getInt(this.field_194037_e))));
            T t3 = t2 = i2 <= 0 ? this.field_194036_d : this.field_194037_e;
            if (i2 <= 0) {
