...
public class SuffixArray<T> {
    ...
    public void func_194057_a(T p_194057_1_, String p_194057_2_) {
        ...
        int i2 = this.field_194061_a.size();
        this.field_194061_a.add(p_194057_1_);
        this.field_194066_f.add(this.field_194065_e.size());
        for (int j2 = 0; j2 < p_194057_2_.length(); ++j2) {
            this.field_194067_g.add(i2);
            this.field_194068_h.add(j2);
            this.field_194065_e.add(p_194057_2_.charAt(j2));
        }
        this.field_194067_g.add(i2);
    ...
    public void func_194058_a() {
        int i2 = this.field_194065_e.size();
        int[] aint = new int[i2];
        final int[] aint1 = new int[i2];
        final int[] aint2 = new int[i2];
        int[] aint3 = new int[i2];
        ...
        Swapper swapper = (p_194054_3_, p_194054_4_) -> {
            if (p_194054_3_ != p_194054_4_) {
                ...
                arrn[p_194054_3_] = aint1[p_194054_4_];
                arrn[p_194054_4_] = i2;
                i2 = aint2[p_194054_3_];
                arrn2[p_194054_3_] = aint2[p_194054_4_];
                arrn2[p_194054_4_] = i2;
                i2 = aint3[p_194054_3_];
                arrn3[p_194054_3_] = aint3[p_194054_4_];
                arrn3[p_194054_4_] = i2;
            }
        };
        for (int j2 = 0; j2 < i2; ++j2) {
            aint[j2] = this.field_194065_e.getInt(j2);
        }
        int k1 = 1;
        int k2 = Math.min(i2, this.field_194069_i);
        while (k1 * 2 < k2) {
            int l2 = 0;
            while (l2 < i2) {
                aint1[l2] = aint[l2];
                aint2[l2] = l2 + k1 < i2 ? aint[l2 + k1] : -2;
                aint3[l2] = l2++;
            }
