...
implements GuiListExtended.IGuiListEntry {
    ...
    public void func_192634_a(int p_192634_1_, int p_192634_2_, int p_192634_3_, int p_192634_4_, int p_192634_5_, int p_192634_6_, int p_192634_7_, boolean p_192634_8_, float p_192634_9_) {
        String s2 = this.worldSummary.getDisplayName();
        ...
        if (StringUtils.isEmpty(s2)) {
            s2 = String.valueOf(I18n.format("selectWorld.world", new Object[0])) + " " + (p_192634_1_ + 1);
        }
        if (this.worldSummary.requiresConversion()) {
            s22 = String.valueOf(I18n.format("selectWorld.conversion", new Object[0])) + " " + s22;
        } else {
            s22 = I18n.format("gameMode." + this.worldSummary.getEnumGameType().getName(), new Object[0]);
            if (this.worldSummary.isHardcoreModeEnabled()) {
                s22 = (Object)((Object)TextFormatting.DARK_RED) + I18n.format("gameMode.hardcore", new Object[0]) + (Object)((Object)TextFormatting.RESET);
            }
            ...
            s22 = this.worldSummary.markVersionInList() ? (this.worldSummary.askToOpenWorld() ? String.valueOf(s22) + ", " + I18n.format("selectWorld.version", new Object[0]) + " " + (Object)((Object)TextFormatting.RED) + s3 + (Object)((Object)TextFormatting.RESET) : String.valueOf(s22) + ", " + I18n.format("selectWorld.version", new Object[0]) + " " + (Object)((Object)TextFormatting.ITALIC) + s3 + (Object)((Object)TextFormatting.RESET)) : String.valueOf(s22) + ", " + I18n.format("selectWorld.version", new Object[0]) + " " + s3;
        }
        this.client.fontRendererObj.drawString(s2, p_192634_2_ + 32 + 3, p_192634_3_ + 1, 0xFFFFFF);
        ...
        this.client.fontRendererObj.drawString(s22, p_192634_2_ + 32 + 3, p_192634_3_ + this.client.fontRendererObj.FONT_HEIGHT + this.client.fontRendererObj.FONT_HEIGHT + 3, 0x808080);
        ...
        if (this.client.gameSettings.touchscreen || p_192634_8_) {
            ...
            if (this.worldSummary.markVersionInList()) {
                Gui.drawModalRectWithCustomSizedTexture(p_192634_2_, p_192634_3_, 32.0f, i2, 32, 32, 256.0f, 256.0f);
                if (this.worldSummary.askToOpenWorld()) {
                    Gui.drawModalRectWithCustomSizedTexture(p_192634_2_, p_192634_3_, 96.0f, i2, 32, 32, 256.0f, 256.0f);
                    if (j2 < 32) {
                    ...
                    Gui.drawModalRectWithCustomSizedTexture(p_192634_2_, p_192634_3_, 64.0f, i2, 32, 32, 256.0f, 256.0f);
                    if (j2 < 32) {
                ...
                Gui.drawModalRectWithCustomSizedTexture(p_192634_2_, p_192634_3_, 0.0f, i2, 32, 32, 256.0f, 256.0f);
            }
        }
    }
    ...
    private void loadServerIcon() {
        boolean flag;
        boolean bl2 = flag = this.iconFile != null && this.iconFile.isFile();
        if (flag) {
