...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        GuiScreenCustomizePresets.drawDefaultBackground();
    ...
    extends GuiSlot {
        ...
        private void blitIcon(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_) {
            ...
            bufferbuilder.pos(i2 + 0, p_178051_2_ + 32, 0.0).tex(0.0, 1.0).endVertex();
            bufferbuilder.pos(i2 + 32, p_178051_2_ + 32, 0.0).tex(1.0, 1.0).endVertex();
            bufferbuilder.pos(i2 + 32, p_178051_2_ + 0, 0.0).tex(1.0, 0.0).endVertex();
            bufferbuilder.pos(i2 + 0, p_178051_2_ + 0, 0.0).tex(0.0, 0.0).endVertex();
            tessellator.draw();
        }
