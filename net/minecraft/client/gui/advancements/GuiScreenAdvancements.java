...
implements ClientAdvancementManager.IListener {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (mouseButton == 0) {
            ...
            for (GuiAdvancementTab guiadvancementtab : this.field_191947_i.values()) {
                if (!guiadvancementtab.func_191793_c(i2, j2, mouseX, mouseY)) continue;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiScreenAdvancements.drawDefaultBackground();
        this.func_191936_c(mouseX, mouseY, i2, j2);
        this.func_191934_b(i2, j2);
        this.func_191937_d(mouseX, mouseY, i2, j2);
    }
    ...
    private void func_191936_c(int p_191936_1_, int p_191936_2_, int p_191936_3_, int p_191936_4_) {
        ...
        if (guiadvancementtab == null) {
            ...
            String s2 = I18n.format("advancements.empty", new Object[0]);
            int i2 = this.fontRendererObj.getStringWidth(s2);
            this.fontRendererObj.drawString(s2, p_191936_3_ + 9 + 117 - i2 / 2, p_191936_4_ + 18 + 56 - this.fontRendererObj.FONT_HEIGHT / 2, -1);
