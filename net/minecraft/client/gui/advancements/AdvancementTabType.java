...
enum AdvancementTabType {
    ...
    static {
        ...
        for (AdvancementTabType advancementtabtype : AdvancementTabType.values()) {
            i2 += advancementtabtype.field_192664_j;
        }
        field_192659_e = i2;
    }
    ...
    public void func_192651_a(Gui p_192651_1_, int p_192651_2_, int p_192651_3_, boolean p_192651_4_, int p_192651_5_) {
        int i2 = this.field_192660_f;
        if (p_192651_5_ > 0) {
            i2 += this.field_192662_h;
        }
        if (p_192651_5_ == this.field_192664_j - 1) {
            i2 += this.field_192662_h;
        }
        int j2 = p_192651_4_ ? this.field_192661_g + this.field_192663_i : this.field_192661_g;
        p_192651_1_.drawTexturedModalRect(p_192651_2_ + this.func_192648_a(p_192651_5_), p_192651_3_ + this.func_192653_b(p_192651_5_), i2, j2, this.field_192662_h, this.field_192663_i);
    }

    public void func_192652_a(int p_192652_1_, int p_192652_2_, int p_192652_3_, RenderItem p_192652_4_, ItemStack p_192652_5_) {
        int i2 = p_192652_1_ + this.func_192648_a(p_192652_3_);
        int j2 = p_192652_2_ + this.func_192653_b(p_192652_3_);
        switch (this) {
            case ABOVE: {
                i2 += 6;
                j2 += 9;
        ...
        p_192652_4_.renderItemAndEffectIntoGUI(null, p_192652_5_, i2, j2);
    }
    ...
    public boolean func_192654_a(int p_192654_1_, int p_192654_2_, int p_192654_3_, int p_192654_4_, int p_192654_5_) {
        int i2 = p_192654_1_ + this.func_192648_a(p_192654_3_);
        int j2 = p_192654_2_ + this.func_192653_b(p_192654_3_);
        return p_192654_4_ > i2 && p_192654_4_ < i2 + this.field_192662_h && p_192654_5_ > j2 && p_192654_5_ < j2 + this.field_192663_i;
    }
}
