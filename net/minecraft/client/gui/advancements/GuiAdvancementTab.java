...
extends Gui {
    ...
    public void func_191799_a() {
        ...
        int i2 = this.field_191811_n % 16;
        int j2 = this.field_191812_o % 16;
        for (int k2 = -1; k2 <= 15; ++k2) {
            for (int l2 = -1; l2 <= 8; ++l2) {
                GuiAdvancementTab.drawModalRectWithCustomSizedTexture(i2 + 16 * k2, j2 + 16 * l2, 0.0f, 0.0f, 16, 16, 16.0f, 16.0f);
            }
        }
    ...
    private void func_193937_a(GuiAdvancement p_193937_1_, Advancement p_193937_2_) {
        ...
        int i2 = p_193937_1_.func_191823_d();
        int j2 = i2 + 28;
        int k2 = p_193937_1_.func_191820_c();
        int l2 = k2 + 27;
        this.field_193939_q = Math.min(this.field_193939_q, i2);
        this.field_191813_p = Math.max(this.field_191813_p, j2);
        this.field_193940_r = Math.min(this.field_193940_r, k2);
        this.field_191814_q = Math.max(this.field_191814_q, l2);
        for (GuiAdvancement guiadvancement : this.field_191810_m.values()) {
