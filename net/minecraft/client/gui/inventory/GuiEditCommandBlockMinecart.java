...
implements ITabCompleter {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        boolean bl2 = this.doneButton.enabled = !this.commandField.getText().trim().isEmpty();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (!this.previousEdit.getText().isEmpty()) {
            i2 = i2 + j2 * this.fontRendererObj.FONT_HEIGHT + 20;
            this.drawString(this.fontRendererObj, I18n.format("advMode.previousOutput", new Object[0]), width / 2 - 150, i2, 0xA0A0A0);
