...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (this.mc.world.getWorldInfo().isHardcoreModeEnabled()) {
            this.buttonList.add(new GuiButton(0, width / 2 - 100, height / 4 + 72, I18n.format("deathScreen.spectate", new Object[0])));
            this.buttonList.add(new GuiButton(1, width / 2 - 100, height / 4 + 96, I18n.format("deathScreen." + (this.mc.isIntegratedServerRunning() ? "deleteWorld" : "leaveServer"), new Object[0])));
        } else {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiGameOver.drawGradientRect(0, 0, width, height, 0x60500000, -1602211792);
        ...
        this.drawCenteredString(this.fontRendererObj, String.valueOf(I18n.format("deathScreen.score", new Object[0])) + ": " + (Object)((Object)TextFormatting.YELLOW) + this.mc.player.getScore(), width / 2, 100, 0xFFFFFF);
    ...
    public ITextComponent getClickedComponentAt(int p_184870_1_) {
        ...
        int i2 = this.mc.fontRendererObj.getStringWidth(this.causeOfDeath.getFormattedText());
        int j2 = width / 2 - i2 / 2;
        int k2 = width / 2 + i2 / 2;
        int l2 = j2;
        if (p_184870_1_ >= j2 && p_184870_1_ <= k2) {
            for (ITextComponent itextcomponent : this.causeOfDeath) {
                if ((l2 += this.mc.fontRendererObj.getStringWidth(GuiUtilRenderComponents.removeTextColorsIfConfigured(itextcomponent.getUnformattedComponentText(), false))) <= p_184870_1_) continue;
