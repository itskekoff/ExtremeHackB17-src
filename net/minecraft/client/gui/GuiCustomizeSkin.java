...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        for (EnumPlayerModelParts enumplayermodelparts : EnumPlayerModelParts.values()) {
            this.buttonList.add(new ButtonPart(enumplayermodelparts.getPartId(), width / 2 - 155 + i2 % 2 * 160, height / 6 + 24 * (i2 >> 1), 150, 20, enumplayermodelparts));
            ++i2;
        }
        this.buttonList.add(new GuiOptionButton(199, width / 2 - 155 + i2 % 2 * 160, height / 6 + 24 * (i2 >> 1), GameSettings.Options.MAIN_HAND, this.mc.gameSettings.getKeyBinding(GameSettings.Options.MAIN_HAND)));
        if (++i2 % 2 == 1) {
            ++i2;
        }
        this.buttonList.add(new GuiButton(200, width / 2 - 100, height / 6 + 24 * (i2 >> 1), I18n.format("gui.done", new Object[0])));
    }
    ...
    private String getMessage(EnumPlayerModelParts playerModelParts) {
        ...
        return String.valueOf(playerModelParts.getName().getFormattedText()) + ": " + s2;
    }
