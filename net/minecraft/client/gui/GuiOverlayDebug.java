...
extends Gui {
    ...
    protected void renderDebugInfoLeft() {
        ...
        for (int i2 = 0; i2 < list.size(); ++i2) {
            ...
            int l2 = 2;
            int i1 = 2 + j2 * i2;
            GuiOverlayDebug.drawRect(1.0, i1 - 1, 2 + k2 + 1, i1 + j2 - 1, -1873784752);
    ...
    protected <T extends Comparable<T>> List<String> getDebugInfoRight() {
        ...
        if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == RayTraceResult.Type.BLOCK && this.mc.objectMouseOver.getBlockPos() != null) {
            ...
            for (Map.Entry entry : iblockstate.getProperties().entrySet()) {
                ...
                Comparable t2 = (Comparable)entry.getValue();
                String s2 = iproperty.getName(t2);
                if (Boolean.TRUE.equals(t2)) {
                    s2 = (Object)((Object)TextFormatting.GREEN) + s2;
                } else if (Boolean.FALSE.equals(t2)) {
                    s2 = (Object)((Object)TextFormatting.RED) + s2;
                }
                list.add(String.valueOf(iproperty.getName()) + ": " + s2);
            }
        }
        return list;
    }
    ...
    private int blendColors(int p_181553_1_, int p_181553_2_, float p_181553_3_) {
        ...
        int i22 = MathHelper.clamp((int)((float)i2 + (float)(i1 - i2) * p_181553_3_), 0, 255);
        int j22 = MathHelper.clamp((int)((float)j2 + (float)(j1 - j2) * p_181553_3_), 0, 255);
        int k22 = MathHelper.clamp((int)((float)k2 + (float)(k1 - k2) * p_181553_3_), 0, 255);
        int l22 = MathHelper.clamp((int)((float)l2 + (float)(l1 - l2) * p_181553_3_), 0, 255);
