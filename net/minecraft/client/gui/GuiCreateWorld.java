...
extends GuiScreen {
    ...
    private void calcSaveDirName() {
        ...
        char[] arrc = ChatAllowedCharacters.ILLEGAL_FILE_CHARACTERS;
        int n2 = ChatAllowedCharacters.ILLEGAL_FILE_CHARACTERS.length;
    ...
    public static String getUncollidingSaveDirName(ISaveFormat saveLoader, String name) {
        ...
        String[] arrstring = DISALLOWED_FILENAMES;
        int n2 = DISALLOWED_FILENAMES.length;
        for (int i2 = 0; i2 < n2; ++i2) {
            String s2 = arrstring[i2];
            if (!name.equalsIgnoreCase(s2)) continue;
            name = "_" + name + "_";
        }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == 1) {
                ...
                WorldSettings worldsettings = new WorldSettings(i2, GameType.getByName(this.gameMode), this.generateStructuresEnabled, this.hardCoreMode, WorldType.WORLD_TYPES[this.selectedIndex]);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        GuiCreateWorld.drawDefaultBackground();
