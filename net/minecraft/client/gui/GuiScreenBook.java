...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        int i2 = (width - 192) / 2;
        int j2 = 2;
        this.buttonNextPage = this.addButton(new NextPageButton(1, i2 + 120, 156, true));
        this.buttonPreviousPage = this.addButton(new NextPageButton(2, i2 + 38, 156, false));
        this.updateButtons();
    }
    ...
    private void pageInsertIntoCurrent(String p_146459_1_) {
        ...
        int i2 = this.fontRendererObj.splitStringWidth(String.valueOf(s1) + (Object)((Object)TextFormatting.BLACK) + "_", 118);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i2 = (width - 192) / 2;
        int j2 = 2;
        this.drawTexturedModalRect(i2, 2, 0, 0, 192, 192);
        if (this.bookGettingSigned) {
            String s2 = this.bookTitle;
            if (this.bookIsUnsigned) {
                s2 = this.updateCount / 6 % 2 == 0 ? String.valueOf(s2) + (Object)((Object)TextFormatting.BLACK) + "_" : String.valueOf(s2) + (Object)((Object)TextFormatting.GRAY) + "_";
            }
            String s1 = I18n.format("book.editTitle", new Object[0]);
            int k2 = this.fontRendererObj.getStringWidth(s1);
            this.fontRendererObj.drawString(s1, i2 + 36 + (116 - k2) / 2, 34, 0);
            int l2 = this.fontRendererObj.getStringWidth(s2);
            this.fontRendererObj.drawString(s2, i2 + 36 + (116 - l2) / 2, 50, 0);
            String s22 = I18n.format("book.byAuthor", this.editingPlayer.getName());
            int i1 = this.fontRendererObj.getStringWidth(s22);
            this.fontRendererObj.drawString((Object)((Object)TextFormatting.DARK_GRAY) + s22, i2 + 36 + (116 - i1) / 2, 60, 0);
            String s3 = I18n.format("book.finalizeWarning", new Object[0]);
            this.fontRendererObj.drawSplitString(s3, i2 + 36, 82, 116, 0);
        } else {
            ...
            this.fontRendererObj.drawString(s4, i2 - j1 + 192 - 44, 18, 0);
            if (this.cachedComponents == null) {
                this.fontRendererObj.drawSplitString(s5, i2 + 36, 34, 116, 0);
            } else {
                ...
                for (int l1 = 0; l1 < k1; ++l1) {
                    ...
                    this.fontRendererObj.drawString(itextcomponent2.getUnformattedText(), i2 + 36, 34 + l1 * this.fontRendererObj.FONT_HEIGHT, 0);
                }
    ...
    public ITextComponent getClickedComponentAt(int p_175385_1_, int p_175385_2_) {
        ...
        int i2 = p_175385_1_ - (width - 192) / 2 - 36;
        int j2 = p_175385_2_ - 2 - 16 - 16;
        if (i2 >= 0 && j2 >= 0) {
            int k2 = Math.min(128 / this.fontRendererObj.FONT_HEIGHT, this.cachedComponents.size());
            if (i2 <= 116 && j2 < this.mc.fontRendererObj.FONT_HEIGHT * k2 + k2) {
                int l2 = j2 / this.mc.fontRendererObj.FONT_HEIGHT;
                if (l2 >= 0 && l2 < this.cachedComponents.size()) {
                    ITextComponent itextcomponent = this.cachedComponents.get(l2);
                    int i1 = 0;
                    for (ITextComponent itextcomponent1 : itextcomponent) {
                        if (!(itextcomponent1 instanceof TextComponentString) || (i1 += this.mc.fontRendererObj.getStringWidth(((TextComponentString)itextcomponent1).getText())) <= i2) continue;
