...
extends GuiScreen {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        boolean bl2 = ((GuiButton)this.buttonList.get((int)2)).enabled = !this.nameEdit.getText().trim().isEmpty();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        GuiWorldEdit.drawDefaultBackground();
