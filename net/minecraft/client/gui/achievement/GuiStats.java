...
implements IProgressMeter {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            GuiStats.drawDefaultBackground();
    ...
    extends GuiSlot {
        ...
        protected void drawListHeader(int insideLeft, int insideTop, Tessellator tessellatorIn) {
            ...
            if (this.sortColumn != -1) {
                ...
                GuiStats.this.drawSprite(insideLeft + i2, insideTop + 1, j2, 0);
            }
        }
        ...
        protected void renderStat(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
            if (p_148209_1_ != null) {
                String s2 = p_148209_1_.format(GuiStats.this.stats.readStat(p_148209_1_));
        ...
        protected void renderDecorations(int mouseXIn, int mouseYIn) {
            if (mouseYIn >= this.top && mouseYIn <= this.bottom) {
                int i2 = this.getSlotIndexFromScreenCoords(mouseXIn, mouseYIn);
                int j2 = (this.width - this.getListWidth()) / 2;
                if (i2 >= 0) {
                    if (mouseXIn < j2 + 40 || mouseXIn > j2 + 40 + 20) {
                        return;
                    }
                    StatCrafting statcrafting = this.getSlotStat(i2);
                    this.renderMouseHoverToolTip(statcrafting, mouseXIn, mouseYIn);
                } else {
                    String s2;
                    if (mouseXIn >= j2 + 115 - 18 && mouseXIn <= j2 + 115) {
                        s2 = this.getHeaderDescriptionId(0);
                    } else if (mouseXIn >= j2 + 165 - 18 && mouseXIn <= j2 + 165) {
                        s2 = this.getHeaderDescriptionId(1);
                    } else if (mouseXIn >= j2 + 215 - 18 && mouseXIn <= j2 + 215) {
                        s2 = this.getHeaderDescriptionId(2);
                    } else if (mouseXIn >= j2 + 265 - 18 && mouseXIn <= j2 + 265) {
                        s2 = this.getHeaderDescriptionId(3);
                    } else {
                        if (mouseXIn < j2 + 315 - 18 || mouseXIn > j2 + 315) {
                            return;
                        }
                        s2 = this.getHeaderDescriptionId(4);
                    }
                    ...
                    if (!s2.isEmpty()) {
                        ...
                        GuiStats.drawGradientRect(k2 - 3, l2 - 3, k2 + i1 + 3, l2 + 8 + 3, -1073741824, -1073741824);
        ...
        protected void renderMouseHoverToolTip(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
            ...
            String s2;
            String s1;
            if (p_148213_1_ != null && !(s1 = I18n.format(String.valueOf(s2 = (itemstack = new ItemStack(item = p_148213_1_.getItem())).getUnlocalizedName()) + ".name", new Object[0]).trim()).isEmpty()) {
                int i2 = p_148213_2_ + 12;
                int j2 = p_148213_3_ - 12;
                int k2 = GuiStats.this.fontRendererObj.getStringWidth(s1);
                GuiStats.drawGradientRect(i2 - 3, j2 - 3, i2 + k2 + 3, j2 + 8 + 3, -1073741824, -1073741824);
            ...
            this.statSorter = new Comparator<StatCrafting>(){
                ...
                public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
                    ...
                    if (statbase != null || statbase1 != null) {
                        ...
                        int i2 = GuiStats.this.stats.readStat(statbase);
                        if (i2 != (j2 = GuiStats.this.stats.readStat(statbase1))) {
                            return (i2 - j2) * StatsBlock.this.sortOrder;
                        }
                    }
    ...
    extends GuiSlot {
        ...
        protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
            ...
            String s2 = statbase.format(GuiStats.this.stats.readStat(statbase));
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_192637_2_ + 2 + 213 - GuiStats.this.fontRendererObj.getStringWidth(s2), p_192637_3_ + 1, p_192637_1_ % 2 == 0 ? 0xFFFFFF : 0x909090);
        }
    }
        ...
        public StatsItem(Minecraft p_i47552_2_) {
            ...
            this.statSorter = new Comparator<StatCrafting>(){
                ...
                public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
                    Item item1 = p_compare_1_.getItem();
                    Item item2 = p_compare_2_.getItem();
                    int i2 = Item.getIdFromItem(item1);
                    int j2 = Item.getIdFromItem(item2);
                    StatBase statbase = null;
                    StatBase statbase1 = null;
                    ...
                    if (statbase != null || statbase1 != null) {
                        ...
                        int k2 = GuiStats.this.stats.readStat(statbase);
                        if (k2 != (l2 = GuiStats.this.stats.readStat(statbase1))) {
                            return (k2 - l2) * StatsItem.this.sortOrder;
                        }
                    }
                    return i2 - j2;
                }
    ...
    extends GuiSlot {
        ...
        protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
            ...
            String s2 = I18n.format("entity." + EntityList.func_191302_a(entitylist$entityegginfo.spawnedID) + ".name", new Object[0]);
            int i2 = GuiStats.this.stats.readStat(entitylist$entityegginfo.killEntityStat);
            int j2 = GuiStats.this.stats.readStat(entitylist$entityegginfo.entityKilledByStat);
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_192637_2_ + 2 - 10, p_192637_3_ + 1, 0xFFFFFF);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s1, p_192637_2_ + 2, p_192637_3_ + 1 + ((GuiStats)GuiStats.this).fontRendererObj.FONT_HEIGHT, i2 == 0 ? 0x606060 : 0x909090);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s22, p_192637_2_ + 2, p_192637_3_ + 1 + ((GuiStats)GuiStats.this).fontRendererObj.FONT_HEIGHT * 2, j2 == 0 ? 0x606060 : 0x909090);
        }
    }
}
