...
extends GuiListExtended {
    ...
    private void populateComponents() {
        GuiListEntry[][] arrguiListEntry = this.pages;
        int n2 = this.pages.length;
        for (int i2 = 0; i2 < n2; ++i2) {
            GuiListEntry[] aguipagebuttonlist$guilistentry = arrguiListEntry[i2];
            for (int i3 = 0; i3 < aguipagebuttonlist$guilistentry.length; i3 += 2) {
                GuiListEntry guipagebuttonlist$guilistentry = aguipagebuttonlist$guilistentry[i3];
                GuiListEntry guipagebuttonlist$guilistentry1 = i3 < aguipagebuttonlist$guilistentry.length - 1 ? aguipagebuttonlist$guilistentry[i3 + 1] : null;
    ...
    private void populateEntries() {
        this.entries.clear();
        for (int i2 = 0; i2 < this.pages[this.page].length; i2 += 2) {
            GuiListEntry guipagebuttonlist$guilistentry = this.pages[this.page][i2];
            GuiListEntry guipagebuttonlist$guilistentry1 = i2 < this.pages[this.page].length - 1 ? this.pages[this.page][i2 + 1] : null;
    ...
    public void setPage(int p_181156_1_) {
        if (p_181156_1_ != this.page) {
            ...
            this.populateEntries();
            this.markVisibility(i2, p_181156_1_);
    ...
    public boolean mouseClicked(int mouseX, int mouseY, int mouseEvent) {
        ...
        int i2 = this.getSlotIndexFromScreenCoords(mouseX, mouseY);
        if (i2 >= 0) {
            GuiEntry guipagebuttonlist$guientry = this.getListEntry(i2);
    ...
    public void onKeyPressed(char p_178062_1_, int p_178062_2_) {
        block1: {
            ...
            block2: {
                ...
                block3: {
                    ...
                    block4: {
                        ...
                        int k2 = this.editBoxes.indexOf(this.focusedControl);
                        k2 = GuiScreen.isShiftKeyDown() ? (k2 == 0 ? this.editBoxes.size() - 1 : --k2) : (k2 == this.editBoxes.size() - 1 ? 0 : ++k2);
                        this.focusedControl = this.editBoxes.get(k2);
                        guitextfield = (GuiTextField)this.focusedControl;
                        guitextfield.setFocused(true);
                        int l2 = guitextfield.yPosition + this.slotHeight;
                        i1 = guitextfield.yPosition;
                        if (l2 <= this.bottom) break block4;
                        this.amountScrolled += (float)(l2 - this.bottom);
                        break block1;
                    }
            ...
            int j2 = i2 = this.editBoxes.indexOf(this.focusedControl);
            String[] arrstring = astring;
            int n2 = astring.length;
            for (int i3 = 0; i3 < n2; ++i3) {
                String s1 = arrstring[i3];
                GuiTextField guitextfield1 = this.editBoxes.get(j2);
                guitextfield1.setText(s1);
                guitextfield1.func_190516_a(guitextfield1.getId(), s1);
                j2 = j2 == this.editBoxes.size() - 1 ? 0 : ++j2;
                if (j2 == i2) break;
            }
        }
    }
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        public void mouseReleased(int slotIndex, int x2, int y2, int mouseEvent, int relativeX, int relativeY) {
            this.releaseComponent(this.component1, x2, y2, mouseEvent);
            this.releaseComponent(this.component2, x2, y2, mouseEvent);
        }
