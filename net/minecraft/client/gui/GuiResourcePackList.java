...
extends GuiListExtended {
    ...
    protected void drawListHeader(int insideLeft, int insideTop, Tessellator tessellatorIn) {
        String s2 = (Object)((Object)TextFormatting.UNDERLINE) + (Object)((Object)TextFormatting.BOLD) + this.getListHeader();
        this.mc.fontRendererObj.drawString(s2, insideLeft + this.width / 2 - this.mc.fontRendererObj.getStringWidth(s2) / 2, Math.min(this.top + 3, insideTop), 0xFFFFFF);
    }
