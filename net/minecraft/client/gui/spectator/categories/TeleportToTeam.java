    ...
    implements ISpectatorMenuObject {
        ...
        public TeamSelectionObject(ScorePlayerTeam p_i45492_2_) {
            ...
            for (String s2 : p_i45492_2_.getMembershipCollection()) {
                NetworkPlayerInfo networkplayerinfo = Minecraft.getMinecraft().getConnection().getPlayerInfo(s2);
        ...
        public void renderIcon(float p_178663_1_, int alpha) {
            int i2 = -1;
            String s2 = FontRenderer.getFormatFromString(this.team.getColorPrefix());
            if (s2.length() >= 2) {
            ...
            if (i2 >= 0) {
                ...
                Gui.drawRect(1.0, 1.0, 15.0, 15.0, MathHelper.rgb(f2 * p_178663_1_, f1 * p_178663_1_, f22 * p_178663_1_) | alpha << 24);
            }
            ...
            Gui.drawScaledCustomSizeModalRect(2.0f, 2.0f, 8.0f, 8.0f, 8, 8, 12.0, 12.0, 64.0f, 64.0f);
            Gui.drawScaledCustomSizeModalRect(2.0f, 2.0f, 40.0f, 8.0f, 8, 8, 12.0, 12.0, 64.0f, 64.0f);
        }
