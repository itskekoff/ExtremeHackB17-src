...
extends GuiListExtended {
    ...
    public GuiOptionsRowList(Minecraft mcIn, int p_i45015_2_, int p_i45015_3_, int p_i45015_4_, int p_i45015_5_, int p_i45015_6_, GameSettings.Options ... p_i45015_7_) {
        ...
        for (int i2 = 0; i2 < p_i45015_7_.length; i2 += 2) {
    ...
    private GuiButton createButton(Minecraft mcIn, int p_148182_2_, int p_148182_3_, GameSettings.Options options) {
        ...
        int i2 = options.returnEnumOrdinal();
        return options.getEnumFloat() ? new GuiOptionSlider(i2, p_148182_2_, p_148182_3_, options) : new GuiOptionButton(i2, p_148182_2_, p_148182_3_, options, mcIn.gameSettings.getKeyBinding(options));
    }
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        public void mouseReleased(int slotIndex, int x2, int y2, int mouseEvent, int relativeX, int relativeY) {
            if (this.buttonA != null) {
                this.buttonA.mouseReleased(x2, y2);
            }
            if (this.buttonB != null) {
                this.buttonB.mouseReleased(x2, y2);
            }
        }
