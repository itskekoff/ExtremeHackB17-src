...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        int i2 = 0;
        GameSettings.Options[] arroptions = OPTIONS_ARR;
        int n2 = OPTIONS_ARR.length;
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 200) {
            ...
            KeyBinding[] arrkeyBinding = this.mc.gameSettings.keyBindings;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        boolean flag = false;
        KeyBinding[] arrkeyBinding = this.options.keyBindings;
