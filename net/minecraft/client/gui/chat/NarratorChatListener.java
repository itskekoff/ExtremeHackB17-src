...
implements IChatListener {
    ...
    public void func_192576_a(ChatType p_192576_1_, ITextComponent p_192576_2_) {
        int i2 = Minecraft.getMinecraft().gameSettings.field_192571_R;
        if (i2 != 0 && this.field_192580_a.active() && (i2 == 1 || i2 == 2 && p_192576_1_ == ChatType.CHAT || i2 == 3 && p_192576_1_ == ChatType.SYSTEM)) {
    ...
    public void func_193641_a(int p_193641_1_) {
        ...
        this.field_192580_a.say(String.valueOf(new TextComponentTranslation("options.narrator", new Object[0]).getUnformattedText()) + " : " + new TextComponentTranslation(GameSettings.field_193632_b[p_193641_1_], new Object[0]).getUnformattedText());
