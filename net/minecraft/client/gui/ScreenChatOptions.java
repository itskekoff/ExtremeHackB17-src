...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        int i2 = 0;
        GameSettings.Options[] arroptions = CHAT_OPTIONS;
        int n2 = CHAT_OPTIONS.length;
        for (int i3 = 0; i3 < n2; ++i3) {
            ...
            if (gamesettings$options.getEnumFloat()) {
                ...
                GuiOptionButton guioptionbutton = new GuiOptionButton(gamesettings$options.returnEnumOrdinal(), width / 2 - 155 + i2 % 2 * 160, height / 6 + 24 * (i2 >> 1), gamesettings$options, this.game_settings.getKeyBinding(gamesettings$options));
