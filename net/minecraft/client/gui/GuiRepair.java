...
implements IContainerListener {
        ...
        if (this.anvil.maximumCost > 0) {
            ...
            if (flag) {
                ...
                if (this.fontRendererObj.getUnicodeFlag()) {
                    GuiRepair.drawRect(k2 - 3, 65.0, this.xSize - 7, 77.0, -16777216);
                    GuiRepair.drawRect(k2 - 2, 66.0, this.xSize - 8, 76.0, -12895429);
                } else {
                    this.fontRendererObj.drawString(s2, k2, 68, j2);
                    this.fontRendererObj.drawString(s2, k2 + 1, 67, j2);
                    this.fontRendererObj.drawString(s2, k2 + 1, 68, j2);
                }
                this.fontRendererObj.drawString(s2, k2, 67, i2);
            }
        }
    ...
    private void renameItem() {
        ...
        this.mc.player.connection.sendPacket(new CPacketCustomPayload("MC|ItemName", new PacketBuffer(Unpooled.buffer()).writeString(s2)));
    }
