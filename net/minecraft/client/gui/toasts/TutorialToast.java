...
implements IToast {
    ...
    public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
        ...
        if (this.field_193678_j) {
            ...
            float f2 = (float)MathHelper.clampedLerp(this.field_193676_h, this.field_193677_i, (float)(p_193653_2_ - this.field_193675_g) / 100.0f);
            int i2 = this.field_193677_i >= this.field_193676_h ? -16755456 : -11206656;
            Gui.drawRect(3.0, 28.0, (int)(3.0f + 154.0f * f2), 29.0, i2);
            this.field_193676_h = f2;
