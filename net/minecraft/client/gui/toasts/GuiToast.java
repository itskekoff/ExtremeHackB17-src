...
extends Gui {
    ...
    public void func_191783_a(ScaledResolution p_191783_1_) {
        if (!this.field_191790_f.gameSettings.hideGUI) {
            ...
            for (int i2 = 0; i2 < this.field_191791_g.length; ++i2) {
                ToastInstance<?> toastinstance = this.field_191791_g[i2];
                if (toastinstance != null && toastinstance.func_193684_a(p_191783_1_.getScaledWidth(), i2)) {
                    this.field_191791_g[i2] = null;
                }
                if (this.field_191791_g[i2] != null || this.field_191792_h.isEmpty()) continue;
                this.field_191791_g[i2] = new ToastInstance(this, this.field_191792_h.removeFirst());
            }
        }
    }
    ...
    public <T extends IToast> T func_192990_a(Class<? extends T> p_192990_1_, Object p_192990_2_) {
        ToastInstance<?>[] arrtoastInstance = this.field_191791_g;
        int n2 = this.field_191791_g.length;
        for (int i2 = 0; i2 < n2; ++i2) {
            ToastInstance<?> toastinstance = arrtoastInstance[i2];
            if (toastinstance == null || !p_192990_1_.isAssignableFrom(toastinstance.func_193685_a().getClass()) || !((IToast)toastinstance.func_193685_a()).func_193652_b().equals(p_192990_2_)) continue;
    ...
    static class ToastInstance<T extends IToast> {
        ...
        private float func_193686_a(long p_193686_1_) {
            float f2 = MathHelper.clamp((float)(p_193686_1_ - this.field_193689_c) / 600.0f, 0.0f, 1.0f);
            f2 *= f2;
            return this.field_193691_e == IToast.Visibility.HIDE ? 1.0f - f2 : f2;
        }

        public boolean func_193684_a(int p_193684_1_, int p_193684_2_) {
            long i2 = Minecraft.getSystemTime();
            if (this.field_193689_c == -1L) {
                this.field_193689_c = i2;
                this.field_193691_e.func_194169_a(this.this$0.field_191790_f.getSoundHandler());
            }
            if (this.field_193691_e == IToast.Visibility.SHOW && i2 - this.field_193689_c <= 600L) {
                this.field_193690_d = i2;
            }
            GlStateManager.pushMatrix();
            GlStateManager.translate((float)p_193684_1_ - 160.0f * this.func_193686_a(i2), p_193684_2_ * 32, 500 + p_193684_2_);
            IToast.Visibility itoast$visibility = this.field_193688_b.func_193653_a(this.this$0, i2 - this.field_193690_d);
            GlStateManager.popMatrix();
            if (itoast$visibility != this.field_193691_e) {
                this.field_193689_c = i2 - (long)((int)((1.0f - this.func_193686_a(i2)) * 600.0f));
                this.field_193691_e = itoast$visibility;
                this.field_193691_e.func_194169_a(this.this$0.field_191790_f.getSoundHandler());
            }
            return this.field_193691_e == IToast.Visibility.HIDE && i2 - this.field_193689_c > 600L;
        }
    }
}
