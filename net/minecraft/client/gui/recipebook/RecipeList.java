...
public class RecipeList {
    ...
    public void func_194214_a(RecipeBook p_194214_1_) {
        for (int i2 = 0; i2 < this.field_192713_b.size(); ++i2) {
            this.field_194217_d.set(i2, p_194214_1_.func_193830_f(this.field_192713_b.get(i2)));
        }
    }

    public void func_194210_a(RecipeItemHelper p_194210_1_, int p_194210_2_, int p_194210_3_, RecipeBook p_194210_4_) {
        for (int i2 = 0; i2 < this.field_192713_b.size(); ++i2) {
            IRecipe irecipe = this.field_192713_b.get(i2);
            boolean flag = irecipe.func_194133_a(p_194210_2_, p_194210_3_) && p_194210_4_.func_193830_f(irecipe);
            this.field_194216_c.set(i2, flag);
            this.field_194215_b.set(i2, flag && p_194210_1_.func_194116_a(irecipe, null));
        }
    }
    ...
    public List<IRecipe> func_194208_a(boolean p_194208_1_) {
        ...
        int i2 = this.field_194217_d.nextSetBit(0);
        while (i2 >= 0) {
            if ((p_194208_1_ ? this.field_194215_b : this.field_194216_c).get(i2)) {
                list.add(this.field_192713_b.get(i2));
            }
            i2 = this.field_194217_d.nextSetBit(i2 + 1);
        }
        return list;
    }
    ...
    public List<IRecipe> func_194207_b(boolean p_194207_1_) {
        ...
        int i2 = this.field_194217_d.nextSetBit(0);
        while (i2 >= 0) {
            if (this.field_194216_c.get(i2) && this.field_194215_b.get(i2) == p_194207_1_) {
                list.add(this.field_192713_b.get(i2));
            }
            i2 = this.field_194217_d.nextSetBit(i2 + 1);
        }
