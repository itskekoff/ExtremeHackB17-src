...
extends Gui {
    ...
    public void func_191845_a(Minecraft p_191845_1_, RecipeList p_191845_2_, int p_191845_3_, int p_191845_4_, int p_191845_5_, int p_191845_6_, float p_191845_7_, RecipeBook p_191845_8_) {
        ...
        int i2 = list.size();
        int j2 = i2 + list1.size();
        int k2 = j2 <= 16 ? 4 : 5;
        int l2 = (int)Math.ceil((float)j2 / (float)k2);
        this.field_191851_i = p_191845_3_;
        this.field_191852_j = p_191845_4_;
        int i1 = 25;
        float f6 = this.field_191851_i + Math.min(j2, k2) * 25;
        if (f6 > (f1 = (float)(p_191845_5_ + 50))) {
            this.field_191851_i = (int)((float)this.field_191851_i - p_191845_7_ * (float)((int)((f6 - f1) / p_191845_7_)));
        }
        if ((f2 = (float)(this.field_191852_j + l2 * 25)) > (f3 = (float)(p_191845_6_ + 50))) {
        ...
        for (int j1 = 0; j1 < j2; ++j1) {
            boolean flag1 = j1 < i2;
            this.field_193972_f.add(new Button(this.field_191851_i + 4 + 25 * (j1 % k2), this.field_191852_j + 5 + 25 * (j1 / k2), flag1 ? list.get(j1) : (IRecipe)list1.get(j1 - i2), flag1));
        }
    ...
    public void func_191842_a(int p_191842_1_, int p_191842_2_, float p_191842_3_) {
        if (this.field_191850_h) {
            ...
            int i2 = this.field_193972_f.size() <= 16 ? 4 : 5;
            int j2 = Math.min(this.field_193972_f.size(), i2);
            int k2 = MathHelper.ceil((float)this.field_193972_f.size() / (float)i2);
            int l2 = 24;
            int i1 = 4;
            int j1 = 82;
            int k1 = 208;
            this.func_191846_c(j2, k2, 24, 4, 82, 208);
    ...
    private void func_191846_c(int p_191846_1_, int p_191846_2_, int p_191846_3_, int p_191846_4_, int p_191846_5_, int p_191846_6_) {
        ...
        for (int i2 = 0; i2 < p_191846_1_; ++i2) {
            this.drawTexturedModalRect(this.field_191851_i + p_191846_4_ + i2 * p_191846_3_, this.field_191852_j, p_191846_5_ + p_191846_4_, p_191846_6_, p_191846_3_, p_191846_4_);
            this.drawTexturedModalRect(this.field_191851_i + p_191846_4_ + (i2 + 1) * p_191846_3_, this.field_191852_j, p_191846_5_ + p_191846_4_, p_191846_6_, p_191846_4_, p_191846_4_);
            for (int j2 = 0; j2 < p_191846_2_; ++j2) {
                if (i2 == 0) {
                    this.drawTexturedModalRect(this.field_191851_i, this.field_191852_j + p_191846_4_ + j2 * p_191846_3_, p_191846_5_, p_191846_6_ + p_191846_4_, p_191846_4_, p_191846_3_);
                    this.drawTexturedModalRect(this.field_191851_i, this.field_191852_j + p_191846_4_ + (j2 + 1) * p_191846_3_, p_191846_5_, p_191846_6_ + p_191846_4_, p_191846_4_, p_191846_4_);
                }
                this.drawTexturedModalRect(this.field_191851_i + p_191846_4_ + i2 * p_191846_3_, this.field_191852_j + p_191846_4_ + j2 * p_191846_3_, p_191846_5_ + p_191846_4_, p_191846_6_ + p_191846_4_, p_191846_3_, p_191846_3_);
                this.drawTexturedModalRect(this.field_191851_i + p_191846_4_ + (i2 + 1) * p_191846_3_, this.field_191852_j + p_191846_4_ + j2 * p_191846_3_, p_191846_5_ + p_191846_4_, p_191846_6_ + p_191846_4_, p_191846_4_, p_191846_3_);
                this.drawTexturedModalRect(this.field_191851_i + p_191846_4_ + i2 * p_191846_3_, this.field_191852_j + p_191846_4_ + (j2 + 1) * p_191846_3_, p_191846_5_ + p_191846_4_, p_191846_6_ + p_191846_4_, p_191846_3_, p_191846_4_);
                this.drawTexturedModalRect(this.field_191851_i + p_191846_4_ + (i2 + 1) * p_191846_3_ - 1, this.field_191852_j + p_191846_4_ + (j2 + 1) * p_191846_3_ - 1, p_191846_5_ + p_191846_4_, p_191846_6_ + p_191846_4_, p_191846_4_ + 1, p_191846_4_ + 1);
                if (i2 != p_191846_1_ - 1) continue;
                this.drawTexturedModalRect(this.field_191851_i + p_191846_4_ * 2 + p_191846_1_ * p_191846_3_, this.field_191852_j + p_191846_4_ + j2 * p_191846_3_, p_191846_5_ + p_191846_3_ + p_191846_4_, p_191846_6_ + p_191846_4_, p_191846_4_, p_191846_3_);
                this.drawTexturedModalRect(this.field_191851_i + p_191846_4_ * 2 + p_191846_1_ * p_191846_3_, this.field_191852_j + p_191846_4_ + (j2 + 1) * p_191846_3_, p_191846_5_ + p_191846_3_ + p_191846_4_, p_191846_6_ + p_191846_4_, p_191846_4_, p_191846_4_);
            }
            this.drawTexturedModalRect(this.field_191851_i + p_191846_4_ + i2 * p_191846_3_, this.field_191852_j + p_191846_4_ * 2 + p_191846_2_ * p_191846_3_, p_191846_5_ + p_191846_4_, p_191846_6_ + p_191846_3_ + p_191846_4_, p_191846_3_, p_191846_4_);
            this.drawTexturedModalRect(this.field_191851_i + p_191846_4_ + (i2 + 1) * p_191846_3_, this.field_191852_j + p_191846_4_ * 2 + p_191846_2_ * p_191846_3_, p_191846_5_ + p_191846_4_, p_191846_6_ + p_191846_3_ + p_191846_4_, p_191846_4_, p_191846_4_);
        }
    }
    ...
    extends GuiButton {
        ...
        public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_) {
            ...
            if (this.field_193924_p instanceof ShapedRecipes) {
                ...
                k2 = shapedrecipes.func_192403_f();
                l2 = shapedrecipes.func_192404_g();
            }
            ...
            for (int i1 = 0; i1 < l2; ++i1) {
                ...
                for (int k1 = 0; k1 < k2; ++k1) {
                    ...
                    GlStateManager.pushMatrix();
                    float f2 = 0.42f;
                    int i22 = (int)((float)(this.xPosition + l1) / 0.42f - 3.0f);
                    int j22 = (int)((float)(this.yPosition + j1) / 0.42f - 3.0f);
                    GlStateManager.scale(0.42f, 0.42f, 1.0f);
                    GlStateManager.enableLighting();
                    p_191745_1_.getRenderItem().renderItemAndEffectIntoGUI(aitemstack[MathHelper.floor(GuiRecipeOverlay.this.field_193974_m / 30.0f) % aitemstack.length], i22, j22);
