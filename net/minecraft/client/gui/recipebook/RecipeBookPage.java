...
public class RecipeBookPage {
    ...
    public void func_194194_a(Minecraft p_194194_1_, int p_194194_2_, int p_194194_3_) {
        ...
        for (int i2 = 0; i2 < this.field_193743_h.size(); ++i2) {
            this.field_193743_h.get(i2).func_191770_c(p_194194_2_ + 11 + 25 * (i2 % 5), p_194194_3_ + 31 + 25 * (i2 / 5));
        }
    ...
    private void func_194198_d() {
        int i2 = 20 * this.field_193738_c;
        for (int j2 = 0; j2 < this.field_193743_h.size(); ++j2) {
            GuiButtonRecipe guibuttonrecipe = this.field_193743_h.get(j2);
            if (i2 + j2 < this.field_194203_f.size()) {
                RecipeList recipelist = this.field_194203_f.get(i2 + j2);
    ...
    public void func_194191_a(int p_194191_1_, int p_194191_2_, int p_194191_3_, int p_194191_4_, float p_194191_5_) {
        if (this.field_193737_b > 1) {
            String s2 = String.valueOf(this.field_193738_c + 1) + "/" + this.field_193737_b;
            int i2 = this.field_193754_s.fontRendererObj.getStringWidth(s2);
            this.field_193754_s.fontRendererObj.drawString(s2, p_194191_1_ - i2 / 2 + 73, p_194191_2_ + 141, -1);
        }
