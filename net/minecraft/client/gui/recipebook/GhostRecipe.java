...
public class GhostRecipe {
    ...
    public void func_194188_a(Minecraft p_194188_1_, int p_194188_2_, int p_194188_3_, boolean p_194188_4_, float p_194188_5_) {
        ...
        for (int i2 = 0; i2 < this.field_192688_b.size(); ++i2) {
            GhostIngredient ghostrecipe$ghostingredient = this.field_192688_b.get(i2);
            int j2 = ghostrecipe$ghostingredient.func_193713_b() + p_194188_2_;
            int k2 = ghostrecipe$ghostingredient.func_193712_c() + p_194188_3_;
            if (i2 == 0 && p_194188_4_) {
                Gui.drawRect(j2 - 4, k2 - 4, j2 + 20, k2 + 20, 0x30FF0000);
            } else {
                Gui.drawRect(j2, k2, j2 + 16, k2 + 16, 0x30FF0000);
            }
            GlStateManager.disableLighting();
            ItemStack itemstack = ghostrecipe$ghostingredient.func_194184_c();
            RenderItem renderitem = p_194188_1_.getRenderItem();
            renderitem.renderItemAndEffectIntoGUI(p_194188_1_.player, itemstack, j2, k2);
            GlStateManager.depthFunc(516);
            Gui.drawRect(j2, k2, j2 + 16, k2 + 16, 0x30FFFFFF);
            GlStateManager.depthFunc(515);
            if (i2 == 0) {
                renderitem.renderItemOverlays(p_194188_1_.fontRendererObj, itemstack, j2, k2);
            }
