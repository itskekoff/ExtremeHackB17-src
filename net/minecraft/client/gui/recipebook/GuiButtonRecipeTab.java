    ...
    public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_) {
        if (this.visible) {
            if (this.field_193922_v > 0.0f) {
                float f2 = 1.0f + 0.1f * (float)Math.sin(this.field_193922_v / 15.0f * (float)Math.PI);
            ...
            int k2 = this.field_191756_q;
            int i2 = this.field_191757_r;
            if (this.field_191755_p) {
                k2 += this.field_191758_s;
            }
            if (this.hovered) {
                i2 += this.field_191759_t;
            }
            int j2 = this.xPosition;
            if (this.field_191755_p) {
                j2 -= 2;
            }
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
            this.drawTexturedModalRect(j2, this.yPosition, k2, i2, this.width, this.height);
