...
implements IRecipeUpdateListener {
    ...
    public void func_193014_a(boolean p_193014_1_, InventoryCrafting p_193014_2_) {
        ...
        int i2 = (this.field_191904_o - 147) / 2 - this.field_191903_n;
        int j2 = (this.field_191905_p - 166) / 2;
        ...
        this.field_193962_q = new GuiTextField(0, this.field_191888_F.fontRendererObj, i2 + 25, j2 + 14, 80, this.field_191888_F.fontRendererObj.FONT_HEIGHT + 5);
        ...
        this.field_193022_s.func_194194_a(this.field_191888_F, i2, j2);
        this.field_193022_s.func_193732_a(this);
        this.field_193960_m = new GuiButtonToggle(0, i2 + 110, j2 + 12, 26, 16, this.field_193964_s.func_192815_c());
    ...
    public int func_193011_a(boolean p_193011_1_, int p_193011_2_, int p_193011_3_) {
        int i2 = this.func_191878_b() && !p_193011_1_ ? 177 + (p_193011_2_ - p_193011_3_ - 200) / 2 : (p_193011_2_ - p_193011_3_) / 2;
        return i2;
    }
    ...
    private void func_193003_g(boolean p_193003_1_) {
        ...
        String s2 = this.field_193962_q.getText();
        if (!s2.isEmpty()) {
            ObjectLinkedOpenHashSet<RecipeList> objectset = new ObjectLinkedOpenHashSet<RecipeList>(this.field_191888_F.func_193987_a(SearchTreeManager.field_194012_b).func_194038_a(s2.toLowerCase(Locale.ROOT)));
    ...
    private void func_193949_f() {
        int i2 = (this.field_191904_o - 147) / 2 - this.field_191903_n - 30;
        int j2 = (this.field_191905_p - 166) / 2 + 3;
        int k2 = 27;
        int l2 = 0;
        for (GuiButtonRecipeTab guibuttonrecipetab : this.field_193018_j) {
            ...
            if (creativetabs == CreativeTabs.SEARCH) {
                ...
                guibuttonrecipetab.func_191752_c(i2, j2 + 27 * l2++);
                continue;
            }
    ...
    public void func_191861_a(int p_191861_1_, int p_191861_2_, float p_191861_3_) {
        if (this.func_191878_b()) {
            ...
            int i2 = (this.field_191904_o - 147) / 2 - this.field_191903_n;
            int j2 = (this.field_191905_p - 166) / 2;
            this.drawTexturedModalRect(i2, j2, 1, 1, 147, 166);
            ...
            this.field_193022_s.func_194191_a(i2, j2, p_191861_1_, p_191861_2_, p_191861_3_);
    ...
    private void func_193015_d(int p_193015_1_, int p_193015_2_, int p_193015_3_, int p_193015_4_) {
        ...
        for (int i2 = 0; i2 < this.field_191915_z.func_192684_b(); ++i2) {
            GhostRecipe.GhostIngredient ghostrecipe$ghostingredient = this.field_191915_z.func_192681_a(i2);
            int j2 = ghostrecipe$ghostingredient.func_193713_b() + p_193015_1_;
            int k2 = ghostrecipe$ghostingredient.func_193712_c() + p_193015_2_;
    ...
    public boolean func_193955_c(int p_193955_1_, int p_193955_2_, int p_193955_3_, int p_193955_4_, int p_193955_5_, int p_193955_6_) {
        ...
        boolean bl2 = flag1 = p_193955_3_ - 147 < p_193955_1_ && p_193955_1_ < p_193955_3_ && p_193955_4_ < p_193955_2_ && p_193955_2_ < p_193955_4_ + p_193955_6_;
    ...
    public void func_193951_a(IRecipe p_193951_1_, List<Slot> p_193951_2_) {
        ...
        int i2 = this.field_193961_o.getWidth();
        int j2 = this.field_193961_o.getHeight();
        int k2 = p_193951_1_ instanceof ShapedRecipes ? ((ShapedRecipes)p_193951_1_).func_192403_f() : i2;
        int l2 = 1;
