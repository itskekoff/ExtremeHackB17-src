...
public class LanServerDetector {
    ...
    public static class LanServerList {
        ...
        public synchronized void addServer(String pingResponse, InetAddress ipAddress) {
            String s2 = ThreadLanServerPing.getMotdFromPingResponse(pingResponse);
            String s1 = ThreadLanServerPing.getAdFromPingResponse(pingResponse);
            if (s1 != null) {
                s1 = String.valueOf(ipAddress.getHostAddress()) + ":" + s1;
                boolean flag = false;
                ...
                if (!flag) {
                    this.listOfLanServers.add(new LanServerInfo(s2, s1));
    ...
    extends Thread {
        ...
        public void run() {
            ...
            while (!this.isInterrupted()) {
                ...
                String s2 = new String(datagrampacket.getData(), datagrampacket.getOffset(), datagrampacket.getLength(), StandardCharsets.UTF_8);
                LOGGER.debug("{}: {}", (Object)datagrampacket.getAddress(), (Object)s2);
                this.localServerList.addServer(s2, datagrampacket.getAddress());
            }
            try {
