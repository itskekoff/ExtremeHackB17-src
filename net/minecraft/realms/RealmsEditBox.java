...
public class RealmsEditBox {
    ...
    public RealmsEditBox(int id2, int x2, int y2, int width, int height) {
        this.editBox = new GuiTextField(id2, Minecraft.getMinecraft().fontRendererObj, x2, y2, width, height);
    }
