...
public class RealmsScreen {
    ...
    public void fillGradient(int p_fillGradient_1_, int p_fillGradient_2_, int p_fillGradient_3_, int p_fillGradient_4_, int p_fillGradient_5_, int p_fillGradient_6_) {
        GuiScreenRealmsProxy.drawGradientRect(p_fillGradient_1_, p_fillGradient_2_, p_fillGradient_3_, p_fillGradient_4_, p_fillGradient_5_, p_fillGradient_6_);
    }

    public void renderBackground() {
        GuiScreenRealmsProxy.drawDefaultBackground();
    }
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        for (int i2 = 0; i2 < this.proxy.buttons().size(); ++i2) {
            this.proxy.buttons().get(i2).render(p_render_1_, p_render_2_, p_render_3_);
        }
    }
