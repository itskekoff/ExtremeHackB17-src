...
public class RealmsButton {
    ...
    public RealmsButton(int buttonId, int x2, int y2, String text) {
        this.proxy = new GuiButtonRealmsProxy(this, buttonId, x2, y2, text);
    }

    public RealmsButton(int buttonId, int x2, int y2, int widthIn, int heightIn, String text) {
        this.proxy = new GuiButtonRealmsProxy(this, buttonId, x2, y2, text, widthIn, heightIn);
    }
