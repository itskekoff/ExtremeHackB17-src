...
extends RealmsButton {
    ...
    public RealmsSliderButton(int buttonId, int x2, int y2, int width, int maxValueIn, int p_i1056_6_) {
        this(buttonId, x2, y2, width, p_i1056_6_, 0, 1.0f, maxValueIn);
    }

    public RealmsSliderButton(int buttonId, int x2, int y2, int width, int p_i1057_5_, int valueIn, float minValueIn, float maxValueIn) {
        super(buttonId, x2, y2, width, 20, "");
