...
public class Explosion {
    ...
    public void doExplosionA() {
        ...
        for (int j2 = 0; j2 < 16; ++j2) {
            for (int k2 = 0; k2 < 16; ++k2) {
                for (int l2 = 0; l2 < 16; ++l2) {
                    ...
                    float f1 = 0.3f;
                    for (float f2 = this.explosionSize * (0.7f + this.worldObj.rand.nextFloat() * 0.6f); f2 > 0.0f; f2 -= 0.22500001f) {
        ...
        int i22 = MathHelper.floor(this.explosionY - (double)f3 - 1.0);
        ...
        List<Entity> list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder, new AxisAlignedBB(k1, i22, j2, l1, i1, j1));
