...
public class GameRules {
    ...
    public NBTTagCompound writeToNBT() {
        ...
        for (String s2 : this.theGameRules.keySet()) {
            Value gamerules$value = this.theGameRules.get(s2);
            nbttagcompound.setString(s2, gamerules$value.getString());
        }
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        for (String s2 : nbt.getKeySet()) {
            this.setOrCreateGameRule(s2, nbt.getString(s2));
        }
    }
