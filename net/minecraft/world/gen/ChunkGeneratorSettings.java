...
public class ChunkGeneratorSettings {
    ...
    /* synthetic */ ChunkGeneratorSettings(Factory factory, ChunkGeneratorSettings chunkGeneratorSettings) {
        this(factory);
    }
    ...
    public static class Factory {
        ...
        public int hashCode() {
            int i2 = this.coordinateScale == 0.0f ? 0 : Float.floatToIntBits(this.coordinateScale);
            i2 = 31 * i2 + (this.heightScale == 0.0f ? 0 : Float.floatToIntBits(this.heightScale));
            i2 = 31 * i2 + (this.upperLimitScale == 0.0f ? 0 : Float.floatToIntBits(this.upperLimitScale));
            i2 = 31 * i2 + (this.lowerLimitScale == 0.0f ? 0 : Float.floatToIntBits(this.lowerLimitScale));
            i2 = 31 * i2 + (this.depthNoiseScaleX == 0.0f ? 0 : Float.floatToIntBits(this.depthNoiseScaleX));
            i2 = 31 * i2 + (this.depthNoiseScaleZ == 0.0f ? 0 : Float.floatToIntBits(this.depthNoiseScaleZ));
            i2 = 31 * i2 + (this.depthNoiseScaleExponent == 0.0f ? 0 : Float.floatToIntBits(this.depthNoiseScaleExponent));
            i2 = 31 * i2 + (this.mainNoiseScaleX == 0.0f ? 0 : Float.floatToIntBits(this.mainNoiseScaleX));
            i2 = 31 * i2 + (this.mainNoiseScaleY == 0.0f ? 0 : Float.floatToIntBits(this.mainNoiseScaleY));
            i2 = 31 * i2 + (this.mainNoiseScaleZ == 0.0f ? 0 : Float.floatToIntBits(this.mainNoiseScaleZ));
            i2 = 31 * i2 + (this.baseSize == 0.0f ? 0 : Float.floatToIntBits(this.baseSize));
            i2 = 31 * i2 + (this.stretchY == 0.0f ? 0 : Float.floatToIntBits(this.stretchY));
            i2 = 31 * i2 + (this.biomeDepthWeight == 0.0f ? 0 : Float.floatToIntBits(this.biomeDepthWeight));
            i2 = 31 * i2 + (this.biomeDepthOffset == 0.0f ? 0 : Float.floatToIntBits(this.biomeDepthOffset));
            i2 = 31 * i2 + (this.biomeScaleWeight == 0.0f ? 0 : Float.floatToIntBits(this.biomeScaleWeight));
            i2 = 31 * i2 + (this.biomeScaleOffset == 0.0f ? 0 : Float.floatToIntBits(this.biomeScaleOffset));
            ...
            i2 = 31 * i2 + (this.field_191076_A ? 1 : 0);
