        ...
        while (p_180702_15_ < p_180702_16_) {
            ...
            if (flag2 || random.nextInt(4) != 0) {
                ...
                if (p_180702_6_ >= d0 - 16.0 - d2 * 2.0 && p_180702_10_ >= d1 - 16.0 - d2 * 2.0 && p_180702_6_ <= d0 + 16.0 + d2 * 2.0 && p_180702_10_ <= d1 + 16.0 + d2 * 2.0) {
                    ...
                    int k3 = MathHelper.floor(p_180702_6_ + d2) - p_180702_3_ * 16 + 1;
                    int l2 = MathHelper.floor(p_180702_8_ - d3) - 1;
                    int l3 = MathHelper.floor(p_180702_8_ + d3) + 1;
                        ...
                        for (int j3 = k2; j3 < k3; ++j3) {
                            ...
                            for (int i2 = i3; i2 < i1; ++i2) {
                                ...
                                for (int j22 = l3; j22 > l2; --j22) {
                                    ...
                                    IBlockState iblockstate2 = MoreObjects.firstNonNull(p_180702_5_.getBlockState(j3, j22 + 1, i2), BLK_AIR);
                                    ...
                                    if (j22 - 1 < 10) {
                                        p_180702_5_.setBlockState(j3, j22, i2, BLK_LAVA);
                                        continue;
                                    }
                                    p_180702_5_.setBlockState(j3, j22, i2, BLK_AIR);
                                    ...
                                    p_180702_5_.setBlockState(j3, j22 - 1, i2, this.worldObj.getBiome((BlockPos)blockpos$mutableblockpos).topBlock.getBlock().getDefaultState());
                                }
                            }
                        }
                        if (flag2) break;
    ...
    protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_, ChunkPrimer chunkPrimerIn) {
        ...
        for (int j2 = 0; j2 < i2; ++j2) {
            ...
            for (int l2 = 0; l2 < k2; ++l2) {
                ...
                this.addTunnel(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2, f22, f2, f1, 0, 0, 1.0);
            }
        }
    }
}
