...
public abstract class GenLayer {
    ...
    public static GenLayer[] initializeAllBiomeGenerators(long seed, WorldType p_180781_2_, ChunkGeneratorSettings p_180781_3_) {
        ...
        int j2 = i2 = 4;
        if (p_180781_3_ != null) {
            i2 = p_180781_3_.biomeSize;
            j2 = p_180781_3_.riverSize;
        }
        ...
        genlayer5 = GenLayerZoom.magnify(1000L, genlayer5, j2);
        GenLayerRiver genlayerriver = new GenLayerRiver(1L, genlayer5);
        GenLayerSmooth genlayersmooth = new GenLayerSmooth(1000L, genlayerriver);
        genlayerhills = new GenLayerRareBiome(1001L, genlayerhills);
        for (int k2 = 0; k2 < i2; ++k2) {
            genlayerhills = new GenLayerZoom(1000 + k2, genlayerhills);
            if (k2 == 0) {
                genlayerhills = new GenLayerAddIsland(3L, genlayerhills);
            }
            if (k2 != 1 && i2 != 1) continue;
    ...
    protected int nextInt(int p_75902_1_) {
        int i2 = (int)((this.chunkSeed >> 24) % (long)p_75902_1_);
        if (i2 < 0) {
            i2 += p_75902_1_;
        }
        this.chunkSeed *= this.chunkSeed * 6364136223846793005L + 1442695040888963407L;
