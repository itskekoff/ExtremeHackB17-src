...
public class PlacementSettings {
    ...
    public Random getRandom(@Nullable BlockPos p_189947_1_) {
        ...
        int i2 = p_189947_1_.getX();
        int j2 = p_189947_1_.getZ();
        return new Random((long)(i2 * i2 * 4987142 + i2 * 5947611) + (long)(j2 * j2) * 4392871L + (long)(j2 * 389711) ^ 0x3AD8025FL);
    }
    ...
    private StructureBoundingBox getBoundingBoxFromChunk(@Nullable ChunkPos pos) {
        ...
        int i2 = pos.chunkXPos * 16;
        int j2 = pos.chunkZPos * 16;
        return new StructureBoundingBox(i2, 0, j2, i2 + 16 - 1, 255, j2 + 16 - 1);
    }
}
