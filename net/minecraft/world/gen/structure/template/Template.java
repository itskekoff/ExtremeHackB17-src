...
public class Template {
    ...
    private void addEntitiesToWorld(World worldIn, BlockPos pos, Mirror mirrorIn, Rotation rotationIn, @Nullable StructureBoundingBox aabb) {
        for (EntityInfo template$entityinfo : this.entities) {
            ...
            float f2 = entity.getMirroredYaw(mirrorIn);
            entity.setLocationAndAngles(vec3d1.xCoord, vec3d1.yCoord, vec3d1.zCoord, f2 += entity.rotationYaw - entity.getRotatedYaw(rotationIn), entity.rotationPitch);
    ...
    private static BlockPos transformedBlockPos(BlockPos pos, Mirror mirrorIn, Rotation rotationIn) {
        ...
        return flag ? new BlockPos(i2, j2, k2) : pos;
    }
    ...
    public static BlockPos func_191157_a(BlockPos p_191157_0_, Mirror p_191157_1_, Rotation p_191157_2_, int p_191157_3_, int p_191157_4_) {
        int i2 = p_191157_1_ == Mirror.FRONT_BACK ? --p_191157_3_ : 0;
        int j2 = p_191157_1_ == Mirror.LEFT_RIGHT ? --p_191157_4_ : 0;
        BlockPos blockpos = p_191157_0_;
        switch (p_191157_2_) {
            case COUNTERCLOCKWISE_90: {
                blockpos = p_191157_0_.add(j2, 0, p_191157_3_ - i2);
                break;
            }
            case CLOCKWISE_90: {
                blockpos = p_191157_0_.add(p_191157_4_ - j2, 0, i2);
                break;
            }
            case CLOCKWISE_180: {
                blockpos = p_191157_0_.add(p_191157_3_ - i2, 0, p_191157_4_ - j2);
                break;
            }
            case NONE: {
                blockpos = p_191157_0_.add(i2, 0, j2);
            }
        }
        return blockpos;
    }
            ...
            public NBTTagCompound process(IDataFixer fixer, NBTTagCompound compound, int versionIn) {
                if (compound.hasKey("entities", 9)) {
                    ...
                    for (int i2 = 0; i2 < nbttaglist.tagCount(); ++i2) {
                        NBTTagCompound nbttagcompound = (NBTTagCompound)nbttaglist.get(i2);
                ...
                if (compound.hasKey("blocks", 9)) {
                    ...
                    for (int j2 = 0; j2 < nbttaglist1.tagCount(); ++j2) {
                        NBTTagCompound nbttagcompound1 = (NBTTagCompound)nbttaglist1.get(j2);
    ...
    public void read(NBTTagCompound compound) {
        ...
        for (int i2 = 0; i2 < nbttaglist1.tagCount(); ++i2) {
            template$basicpalette.addMapping(NBTUtil.readBlockState(nbttaglist1.getCompoundTagAt(i2)), i2);
        }
        NBTTagList nbttaglist3 = compound.getTagList("blocks", 10);
        for (int j2 = 0; j2 < nbttaglist3.tagCount(); ++j2) {
            NBTTagCompound nbttagcompound = nbttaglist3.getCompoundTagAt(j2);
        ...
        for (int k2 = 0; k2 < nbttaglist4.tagCount(); ++k2) {
            NBTTagCompound nbttagcompound3 = nbttaglist4.getCompoundTagAt(k2);
    ...
    private NBTTagList writeInts(int ... values) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            int i3 = arrn[i2];
            nbttaglist.appendTag(new NBTTagInt(i3));
        }
        return nbttaglist;
    }
    ...
    implements Iterable<IBlockState> {
        ...
        public int idFor(IBlockState p_189954_1_) {
            int i2 = this.ids.get(p_189954_1_);
            if (i2 == -1) {
                i2 = this.lastId++;
                this.ids.put(p_189954_1_, i2);
            }
            return i2;
        }
