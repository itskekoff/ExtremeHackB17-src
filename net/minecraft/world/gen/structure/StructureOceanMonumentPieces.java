...
public class StructureOceanMonumentPieces {
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 1; i2 <= 5; i2 += 4) {
                int j2 = 0;
                if (structureoceanmonumentpieces$roomdefinition1.hasOpening[EnumFacing.SOUTH.getIndex()]) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, i2, j2, 2, i2 + 2, j2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, i2, j2, 5, i2 + 2, j2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, i2 + 2, j2, 4, i2 + 2, j2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                } else {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, i2, j2, 7, i2 + 2, j2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, i2 + 1, j2, 7, i2 + 1, j2, ROUGH_PRISMARINE, ROUGH_PRISMARINE, false);
                }
                j2 = 7;
                if (structureoceanmonumentpieces$roomdefinition1.hasOpening[EnumFacing.NORTH.getIndex()]) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, i2, j2, 2, i2 + 2, j2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                ...
                int k2 = 0;
                if (structureoceanmonumentpieces$roomdefinition1.hasOpening[EnumFacing.WEST.getIndex()]) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, k2, i2, 2, k2, i2 + 2, 2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, k2, i2, 5, k2, i2 + 2, 5, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, k2, i2 + 2, 3, k2, i2 + 2, 4, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                } else {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, k2, i2, 0, k2, i2 + 2, 7, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, k2, i2 + 1, 0, k2, i2 + 1, 7, ROUGH_PRISMARINE, ROUGH_PRISMARINE, false);
                }
                k2 = 7;
    ...
    extends Piece {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
            ...
            this.childPieces.add(new WingRoom(enumfacing, structureboundingbox1, i2++));
            this.childPieces.add(new WingRoom(enumfacing, structureboundingbox2, i2++));
        ...
        private List<RoomDefinition> generateRoomGraph(Random p_175836_1_) {
            ...
            for (int i2 = 0; i2 < 5; ++i2) {
                for (int j2 = 0; j2 < 4; ++j2) {
                    boolean k2 = false;
                    int l2 = MonumentBuilding.getRoomIndex(i2, 0, j2);
            ...
            Object[] arrobject = astructureoceanmonumentpieces$roomdefinition;
            int n2 = astructureoceanmonumentpieces$roomdefinition.length;
            for (int i3 = 0; i3 < n2; ++i3) {
                Object structureoceanmonumentpieces$roomdefinition4 = arrobject[i3];
                if (structureoceanmonumentpieces$roomdefinition4 == null) continue;
                ((RoomDefinition)structureoceanmonumentpieces$roomdefinition4).updateOpenings();
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            this.generateWaterBox(worldIn, structureBoundingBoxIn, 0, 0, 0, 58, i2, 58, false);
                ...
                while (k2 < 7) {
                    ...
                    for (int j1 = 0; j1 < 4; ++j1) {
                        for (int k1 = 0; k1 < 4; ++k1) {
                            this.setBlockState(worldIn, BRICKS_PRISMARINE, l2 + j1, 0, i1 + k1, structureBoundingBoxIn);
                            this.replaceAirAndLiquidDownwards(worldIn, BRICKS_PRISMARINE, l2 + j1, -1, i1 + k1, structureBoundingBoxIn);
                        }
                    }
                    if (j2 != 0 && j2 != 6) {
                        k2 += 6;
        ...
        private void generateWing(boolean p_175840_1_, int p_175840_2_, World worldIn, Random p_175840_4_, StructureBoundingBox p_175840_5_) {
            ...
            if (this.doesChunkIntersect(p_175840_5_, p_175840_2_, 0, p_175840_2_ + 23, 20)) {
                ...
                for (int j2 = 0; j2 < 4; ++j2) {
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + j2, j2 + 1, j2, p_175840_2_ + j2, j2 + 1, 20, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + j2 + 7, j2 + 5, j2 + 7, p_175840_2_ + j2 + 7, j2 + 5, 20, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + 17 - j2, j2 + 5, j2 + 7, p_175840_2_ + 17 - j2, j2 + 5, 20, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + 24 - j2, j2 + 1, j2, p_175840_2_ + 24 - j2, j2 + 1, 20, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + j2 + 1, j2 + 1, j2, p_175840_2_ + 23 - j2, j2 + 1, j2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + j2 + 8, j2 + 5, j2 + 7, p_175840_2_ + 16 - j2, j2 + 5, j2 + 7, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
                ...
                int k2 = p_175840_2_ + (p_175840_1_ ? 5 : 19);
                for (int l2 = 20; l2 >= 5; l2 -= 3) {
                    this.setBlockState(worldIn, DOT_DECO_DATA, j1, 5, l2, p_175840_5_);
                }
                for (int k1 = 19; k1 >= 7; k1 -= 3) {
                    this.setBlockState(worldIn, DOT_DECO_DATA, k2, 5, k1, p_175840_5_);
                }
                ...
                this.setBlockState(worldIn, DOT_DECO_DATA, k2, 5, 5, p_175840_5_);
        ...
        private void generateEntranceArchs(World worldIn, Random p_175839_2_, StructureBoundingBox p_175839_3_) {
            if (this.doesChunkIntersect(p_175839_3_, 22, 5, 35, 17)) {
                ...
                for (int i2 = 0; i2 < 4; ++i2) {
                    this.fillWithBlocks(worldIn, p_175839_3_, 24, 2, 5 + i2 * 4, 24, 4, 5 + i2 * 4, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, p_175839_3_, 22, 4, 5 + i2 * 4, 23, 4, 5 + i2 * 4, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.setBlockState(worldIn, BRICKS_PRISMARINE, 25, 5, 5 + i2 * 4, p_175839_3_);
                    this.setBlockState(worldIn, BRICKS_PRISMARINE, 26, 6, 5 + i2 * 4, p_175839_3_);
                    this.setBlockState(worldIn, SEA_LANTERN, 26, 5, 5 + i2 * 4, p_175839_3_);
                    this.fillWithBlocks(worldIn, p_175839_3_, 33, 2, 5 + i2 * 4, 33, 4, 5 + i2 * 4, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, p_175839_3_, 34, 4, 5 + i2 * 4, 35, 4, 5 + i2 * 4, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.setBlockState(worldIn, BRICKS_PRISMARINE, 32, 5, 5 + i2 * 4, p_175839_3_);
                    this.setBlockState(worldIn, BRICKS_PRISMARINE, 31, 6, 5 + i2 * 4, p_175839_3_);
                    this.setBlockState(worldIn, SEA_LANTERN, 31, 5, 5 + i2 * 4, p_175839_3_);
                    this.fillWithBlocks(worldIn, p_175839_3_, 27, 6, 5 + i2 * 4, 30, 6, 5 + i2 * 4, ROUGH_PRISMARINE, ROUGH_PRISMARINE, false);
                }
            }
        }
        ...
        private void generateEntranceWall(World worldIn, Random p_175837_2_, StructureBoundingBox p_175837_3_) {
            if (this.doesChunkIntersect(p_175837_3_, 15, 20, 42, 21)) {
                ...
                for (int i2 = 0; i2 < 7; ++i2) {
                    this.setBlockState(worldIn, DARK_PRISMARINE, 28 - i2, 6 + i2, 21, p_175837_3_);
                    this.setBlockState(worldIn, DARK_PRISMARINE, 29 + i2, 6 + i2, 21, p_175837_3_);
                }
                for (int j2 = 0; j2 < 4; ++j2) {
                    this.setBlockState(worldIn, DARK_PRISMARINE, 28 - j2, 9 + j2, 21, p_175837_3_);
                    this.setBlockState(worldIn, DARK_PRISMARINE, 29 + j2, 9 + j2, 21, p_175837_3_);
                }
                ...
                for (int k2 = 0; k2 < 3; ++k2) {
                    this.setBlockState(worldIn, DARK_PRISMARINE, 22 - k2 * 2, 8, 21, p_175837_3_);
                    this.setBlockState(worldIn, DARK_PRISMARINE, 22 - k2 * 2, 9, 21, p_175837_3_);
                    this.setBlockState(worldIn, DARK_PRISMARINE, 35 + k2 * 2, 8, 21, p_175837_3_);
                    this.setBlockState(worldIn, DARK_PRISMARINE, 35 + k2 * 2, 9, 21, p_175837_3_);
                }
        ...
        private void generateRoofPiece(World worldIn, Random p_175841_2_, StructureBoundingBox p_175841_3_) {
            if (this.doesChunkIntersect(p_175841_3_, 21, 21, 36, 36)) {
                ...
                for (int i2 = 0; i2 < 4; ++i2) {
                    this.fillWithBlocks(worldIn, p_175841_3_, 21 + i2, 13 + i2, 21 + i2, 36 - i2, 13 + i2, 21 + i2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, p_175841_3_, 21 + i2, 13 + i2, 36 - i2, 36 - i2, 13 + i2, 36 - i2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, p_175841_3_, 21 + i2, 13 + i2, 22 + i2, 21 + i2, 13 + i2, 35 - i2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                    this.fillWithBlocks(worldIn, p_175841_3_, 36 - i2, 13 + i2, 22 + i2, 36 - i2, 13 + i2, 35 - i2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
        ...
        private void generateLowerWall(World worldIn, Random p_175835_2_, StructureBoundingBox p_175835_3_) {
            if (this.doesChunkIntersect(p_175835_3_, 0, 21, 6, 58)) {
                ...
                for (int i2 = 0; i2 < 4; ++i2) {
                    this.fillWithBlocks(worldIn, p_175835_3_, i2, i2 + 1, 21, i2, i2 + 1, 57 - i2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
                for (int j2 = 23; j2 < 53; j2 += 3) {
                    this.setBlockState(worldIn, DOT_DECO_DATA, 5, 5, j2, p_175835_3_);
                }
                this.setBlockState(worldIn, DOT_DECO_DATA, 5, 5, 52, p_175835_3_);
                for (int k2 = 0; k2 < 4; ++k2) {
                    this.fillWithBlocks(worldIn, p_175835_3_, k2, k2 + 1, 21, k2, k2 + 1, 57 - k2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
            ...
            if (this.doesChunkIntersect(p_175835_3_, 51, 21, 58, 58)) {
                ...
                for (int l2 = 0; l2 < 4; ++l2) {
                    this.fillWithBlocks(worldIn, p_175835_3_, 57 - l2, l2 + 1, 21, 57 - l2, l2 + 1, 57 - l2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
        ...
        private void generateMiddleWall(World worldIn, Random p_175842_2_, StructureBoundingBox p_175842_3_) {
            if (this.doesChunkIntersect(p_175842_3_, 7, 21, 13, 50)) {
                ...
                for (int i2 = 0; i2 < 4; ++i2) {
                    this.fillWithBlocks(worldIn, p_175842_3_, i2 + 7, i2 + 5, 21, i2 + 7, i2 + 5, 54, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
                for (int j2 = 21; j2 <= 45; j2 += 3) {
                    this.setBlockState(worldIn, DOT_DECO_DATA, 12, 9, j2, p_175842_3_);
                }
            }
            if (this.doesChunkIntersect(p_175842_3_, 44, 21, 50, 54)) {
                ...
                for (int k2 = 0; k2 < 4; ++k2) {
                    this.fillWithBlocks(worldIn, p_175842_3_, 50 - k2, k2 + 5, 21, 50 - k2, k2 + 5, 54, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
                for (int l2 = 21; l2 <= 45; l2 += 3) {
                    this.setBlockState(worldIn, DOT_DECO_DATA, 45, 9, l2, p_175842_3_);
                }
            }
        ...
        private void generateUpperWall(World worldIn, Random p_175838_2_, StructureBoundingBox p_175838_3_) {
            if (this.doesChunkIntersect(p_175838_3_, 14, 21, 20, 43)) {
                ...
                for (int i2 = 0; i2 < 4; ++i2) {
                    this.fillWithBlocks(worldIn, p_175838_3_, i2 + 14, i2 + 9, 21, i2 + 14, i2 + 9, 43 - i2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
                for (int j2 = 23; j2 <= 39; j2 += 3) {
                    this.setBlockState(worldIn, DOT_DECO_DATA, 19, 13, j2, p_175838_3_);
                }
            }
            if (this.doesChunkIntersect(p_175838_3_, 37, 21, 43, 43)) {
                ...
                for (int k2 = 0; k2 < 4; ++k2) {
                    this.fillWithBlocks(worldIn, p_175838_3_, 43 - k2, k2 + 9, 21, 43 - k2, k2 + 9, 43 - k2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
                for (int l2 = 23; l2 <= 39; l2 += 3) {
                    this.setBlockState(worldIn, DOT_DECO_DATA, 38, 13, l2, p_175838_3_);
                }
            }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int k2 = 1; k2 <= 6; ++k2) {
                ...
                for (int j2 = 0; j2 <= 15; j2 += 15) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, j2, k2, 0, j2, k2, 1, iblockstate, iblockstate, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, j2, k2, 6, j2, k2, 9, iblockstate, iblockstate, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, j2, k2, 14, j2, k2, 15, iblockstate, iblockstate, false);
                }
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, k2, 0, 1, k2, 0, iblockstate, iblockstate, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, k2, 0, 9, k2, 0, iblockstate, iblockstate, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 14, k2, 0, 14, k2, 0, iblockstate, iblockstate, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, k2, 15, 14, k2, 15, iblockstate, iblockstate, false);
            }
            ...
            for (int l2 = 3; l2 <= 6; l2 += 3) {
                for (int i1 = 6; i1 <= 9; i1 += 3) {
                    this.setBlockState(worldIn, SEA_LANTERN, i1, l2, 6, structureBoundingBoxIn);
                    this.setBlockState(worldIn, SEA_LANTERN, i1, l2, 9, structureBoundingBoxIn);
                }
            }
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 2; i2 <= 11; i2 += 3) {
                this.setBlockState(worldIn, SEA_LANTERN, 0, 0, i2, structureBoundingBoxIn);
                this.setBlockState(worldIn, SEA_LANTERN, 13, 0, i2, structureBoundingBoxIn);
                this.setBlockState(worldIn, SEA_LANTERN, i2, 0, 0, structureBoundingBoxIn);
            }
            ...
            for (int j2 = 0; j2 < 2; ++j2) {
                for (int k2 = 2; k2 <= 8; k2 += 3) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, l2, 0, k2, l2, 2, k2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
                l2 = 10;
            }
    ...
    extends StructureComponent {
            ...
            for (int i2 = p_181655_4_; i2 <= p_181655_7_; ++i2) {
                for (int j2 = p_181655_3_; j2 <= p_181655_6_; ++j2) {
                    for (int k2 = p_181655_5_; k2 <= p_181655_8_; ++k2) {
                        if (p_181655_9_ && this.getBlockStateFromPos(p_181655_1_, j2, i2, k2, p_181655_2_).getMaterial() == Material.AIR) continue;
                        ...
                        this.setBlockState(p_181655_1_, WATER, j2, i2, k2, p_181655_2_);
                    }
                }
            }
        }
            ...
            for (int i2 = p_175819_4_; i2 <= p_175819_7_; ++i2) {
                for (int j2 = p_175819_3_; j2 <= p_175819_6_; ++j2) {
                    for (int k2 = p_175819_5_; k2 <= p_175819_8_; ++k2) {
                        if (this.getBlockStateFromPos(worldIn, j2, i2, k2, p_175819_2_) != WATER) continue;
        ...
        protected boolean spawnElder(World worldIn, StructureBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_) {
            ...
            if (p_175817_2_.isVecInside(new BlockPos(i2, j2 = this.getYWithOffset(p_175817_4_), k2 = this.getZWithOffset(p_175817_3_, p_175817_5_)))) {
                ...
                entityelderguardian.setLocationAndAngles((double)i2 + 0.5, j2, (double)k2 + 0.5, 0.0f, 0.0f);
    ...
    static class RoomDefinition {
        ...
        public void updateOpenings() {
            for (int i2 = 0; i2 < 6; ++i2) {
                this.hasOpening[i2] = this.connections[i2] != null;
            }
        }
        ...
        public boolean findSource(int p_175959_1_) {
            ...
            for (int i2 = 0; i2 < 6; ++i2) {
                if (this.connections[i2] == null || !this.hasOpening[i2] || this.connections[i2].scanIndex == p_175959_1_ || !this.connections[i2].findSource(p_175959_1_)) continue;
                return true;
            }
            return false;
        }
        ...
        public int countOpenings() {
            ...
            for (int j2 = 0; j2 < 6; ++j2) {
                if (!this.hasOpening[j2]) continue;
                ++i2;
            }
            return i2;
        }
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            boolean bl2 = flag = this.mainDesign != 0 && randomIn.nextBoolean() && !this.roomDefinition.hasOpening[EnumFacing.DOWN.getIndex()] && !this.roomDefinition.hasOpening[EnumFacing.UP.getIndex()] && this.roomDefinition.countOpenings() > 1;
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            if (this.mainDesign == 0) {
                for (int i2 = 0; i2 < 4; ++i2) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 10 - i2, 3 - i2, 20 - i2, 12 + i2, 3 - i2, 20, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
                }
