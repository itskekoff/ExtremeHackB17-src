...
public class StructureMineshaftPieces {
    ...
    private static Peice func_189940_a(List<StructureComponent> p_189940_0_, Random p_189940_1_, int p_189940_2_, int p_189940_3_, int p_189940_4_, @Nullable EnumFacing p_189940_5_, int p_189940_6_, MapGenMineshaft.Type p_189940_7_) {
        int i2 = p_189940_1_.nextInt(100);
        if (i2 >= 80) {
    ...
    extends Peice {
        ...
        public static StructureBoundingBox findCorridorSize(List<StructureComponent> p_175814_0_, Random rand, int x2, int y2, int z2, EnumFacing facing) {
            int i2;
            StructureBoundingBox structureboundingbox = new StructureBoundingBox(x2, y2, z2, x2, y2 + 2, z2);
            for (i2 = rand.nextInt(3) + 2; i2 > 0; --i2) {
                int j2 = i2 * 5;
                switch (facing) {
                    default: {
            ...
            block24: {
                ...
                if (enumfacing != null) {
                    switch (enumfacing) {
                        default: {
                            if (j2 <= 1) {
                                StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, enumfacing, i2);
                                break;
                            }
                            if (j2 == 2) {
                                StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, EnumFacing.WEST, i2);
                                break;
                            }
                            StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, EnumFacing.EAST, i2);
                            break;
                        }
                        case SOUTH: {
                            if (j2 <= 1) {
                                StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, enumfacing, i2);
                                break;
                            }
                            if (j2 == 2) {
                                StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, EnumFacing.WEST, i2);
                                break;
                            }
                            StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, EnumFacing.EAST, i2);
                            break;
                        }
                        case WEST: {
                            if (j2 <= 1) {
                                StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, enumfacing, i2);
                                break;
                            }
                            if (j2 == 2) {
                                StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, EnumFacing.NORTH, i2);
                                break;
                            }
                            StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i2);
                            break;
                        }
                        case EAST: {
                            if (j2 <= 1) {
                                StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, enumfacing, i2);
                                break;
                            }
                            if (j2 == 2) {
                                StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, EnumFacing.NORTH, i2);
                                break;
                            }
                            StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i2);
                        }
                    }
                }
                ...
                if (enumfacing != EnumFacing.NORTH && enumfacing != EnumFacing.SOUTH) {
                    ...
                    while (i1 + 3 <= this.boundingBox.maxX) {
                        ...
                        if (j1 == 0) {
                            StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, i1, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i2 + 1);
                        } else if (j1 == 1) {
                            StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, i1, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i2 + 1);
                        }
                        i1 += 5;
                    }
                } else {
                    ...
                    while (k2 + 3 <= this.boundingBox.maxZ) {
                        ...
                        if (l2 == 0) {
                            StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, k2, EnumFacing.WEST, i2 + 1);
                        } else if (l2 == 1) {
                            StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, k2, EnumFacing.EAST, i2 + 1);
                        }
                        k2 += 5;
                    }
                }
        ...
        protected boolean generateChest(World worldIn, StructureBoundingBox structurebb, Random randomIn, int x2, int y2, int z2, ResourceLocation loot) {
            ...
            if (structurebb.isVecInside(blockpos) && worldIn.getBlockState(blockpos).getMaterial() == Material.AIR && worldIn.getBlockState(blockpos.down()).getMaterial() != Material.AIR) {
                ...
                this.setBlockState(worldIn, iblockstate, x2, y2, z2, structurebb);
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int j1 = 0; j1 < this.sectionCount; ++j1) {
                ...
                BlockPos blockpos = new BlockPos(j22, l1, k22 = this.getZWithOffset(1, i22));
                if (!structureBoundingBoxIn.isVecInside(blockpos) || this.func_189916_b(worldIn, 1, 0, i22, structureBoundingBoxIn) >= 8) continue;
            ...
            for (int l22 = 0; l22 <= 2; ++l22) {
                for (int i3 = 0; i3 <= i1; ++i3) {
                    int k3 = -1;
                    IBlockState iblockstate3 = this.getBlockStateFromPos(worldIn, l22, -1, i3, structureBoundingBoxIn);
                    if (iblockstate3.getMaterial() != Material.AIR || this.func_189916_b(worldIn, l22, -1, i3, structureBoundingBoxIn) >= 8) continue;
                    int l3 = -1;
                    this.setBlockState(worldIn, iblockstate, l22, -1, i3, structureBoundingBoxIn);
                }
            }
            if (this.hasRails) {
                ...
                for (int j3 = 0; j3 <= i1; ++j3) {
                    ...
                    float f2 = this.func_189916_b(worldIn, 1, 0, j3, structureBoundingBoxIn) > 8 ? 0.9f : 0.7f;
                    this.randomlyPlaceBlock(worldIn, structureBoundingBoxIn, randomIn, f2, 1, 0, j3, iblockstate1);
                }
            }
            return true;
        }
    ...
    extends Peice {
        ...
        public static StructureBoundingBox findCrossing(List<StructureComponent> listIn, Random rand, int x2, int y2, int z2, EnumFacing facing) {
            StructureBoundingBox structureboundingbox = new StructureBoundingBox(x2, y2, z2, x2, y2 + 2, z2);
            if (rand.nextInt(4) == 0) {
            ...
            switch (facing) {
                ...
                case SOUTH: {
                    structureboundingbox.minX = x2 - 1;
                    structureboundingbox.maxX = x2 + 3;
                    structureboundingbox.maxZ = z2 + 3 + 1;
                    break;
                }
                case WEST: {
                ...
                case EAST: {
                    structureboundingbox.maxX = x2 + 3 + 1;
                    structureboundingbox.minZ = z2 - 1;
                    structureboundingbox.maxZ = z2 + 3;
                }
            }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            switch (this.corridorDirection) {
                default: {
                    StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i2);
                    StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.WEST, i2);
                    StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.EAST, i2);
                    break;
                }
                case SOUTH: {
                    StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i2);
                    StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.WEST, i2);
                    StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.EAST, i2);
                    break;
                }
            ...
            if (this.isMultipleFloors) {
                if (rand.nextBoolean()) {
                    StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i2);
                }
                if (rand.nextBoolean()) {
                    StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, EnumFacing.WEST, i2);
                }
                if (rand.nextBoolean()) {
                    StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, EnumFacing.EAST, i2);
                }
                if (rand.nextBoolean()) {
                    StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i2);
                }
            }
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = this.boundingBox.minX; i2 <= this.boundingBox.maxX; ++i2) {
                for (int j2 = this.boundingBox.minZ; j2 <= this.boundingBox.maxZ; ++j2) {
                    if (this.getBlockStateFromPos(worldIn, i2, this.boundingBox.minY - 1, j2, structureBoundingBoxIn).getMaterial() != Material.AIR || this.func_189916_b(worldIn, i2, this.boundingBox.minY - 1, j2, structureBoundingBoxIn) >= 8) continue;
                    this.setBlockState(worldIn, iblockstate, i2, this.boundingBox.minY - 1, j2, structureBoundingBoxIn);
                }
            }
            return true;
        }
    ...
    extends StructureComponent {
        ...
        protected boolean func_189918_a(World p_189918_1_, StructureBoundingBox p_189918_2_, int p_189918_3_, int p_189918_4_, int p_189918_5_, int p_189918_6_) {
            for (int i2 = p_189918_3_; i2 <= p_189918_4_; ++i2) {
                if (this.getBlockStateFromPos(p_189918_1_, i2, p_189918_5_ + 1, p_189918_6_, p_189918_2_).getMaterial() != Material.AIR) continue;
                return false;
            }
            return true;
        }
    ...
    extends Peice {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            for (k2 = 0; k2 < this.boundingBox.getXSize(); k2 += 4) {
                if ((k2 += rand.nextInt(this.boundingBox.getXSize())) + 3 > this.boundingBox.getXSize()) break;
                Peice structuremineshaftpieces$peice = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + k2, this.boundingBox.minY + rand.nextInt(j2) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i2);
            ...
            for (k2 = 0; k2 < this.boundingBox.getXSize(); k2 += 4) {
                if ((k2 += rand.nextInt(this.boundingBox.getXSize())) + 3 > this.boundingBox.getXSize()) break;
                Peice structuremineshaftpieces$peice1 = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + k2, this.boundingBox.minY + rand.nextInt(j2) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i2);
            ...
            for (k2 = 0; k2 < this.boundingBox.getZSize(); k2 += 4) {
                if ((k2 += rand.nextInt(this.boundingBox.getZSize())) + 3 > this.boundingBox.getZSize()) break;
                Peice structuremineshaftpieces$peice2 = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(j2) + 1, this.boundingBox.minZ + k2, EnumFacing.WEST, i2);
            ...
            for (k2 = 0; k2 < this.boundingBox.getZSize(); k2 += 4) {
                if ((k2 += rand.nextInt(this.boundingBox.getZSize())) + 3 > this.boundingBox.getZSize()) break;
                Peice structurecomponent = StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(j2) + 1, this.boundingBox.minZ + k2, EnumFacing.EAST, i2);
        ...
        public void offset(int x2, int y2, int z2) {
            super.offset(x2, y2, z2);
            for (StructureBoundingBox structureboundingbox : this.roomsLinkedToTheRoom) {
                structureboundingbox.offset(x2, y2, z2);
            }
        }
    ...
    extends Peice {
        ...
        public static StructureBoundingBox findStairs(List<StructureComponent> listIn, Random rand, int x2, int y2, int z2, EnumFacing facing) {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            if (enumfacing != null) {
                switch (enumfacing) {
                    default: {
                        StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i2);
                        break;
                    }
                    case SOUTH: {
                        StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i2);
                        break;
                    }
                    case WEST: {
                        StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, i2);
                        break;
                    }
                    case EAST: {
                        StructureMineshaftPieces.func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, i2);
                    }
                }
            }
        }
