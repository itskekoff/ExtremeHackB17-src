...
public class StructureNetherBridgePieces {
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 0; i2 <= 9; ++i2) {
                ...
                int l2 = i2;
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 0, i2, 4, j2, i2, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, j2 + 1, i2, 3, k2 - 1, i2, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
                if (i2 <= 6) {
                    this.setBlockState(worldIn, iblockstate, 1, j2 + 1, i2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, iblockstate, 2, j2 + 1, i2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, iblockstate, 3, j2 + 1, i2, structureBoundingBoxIn);
                }
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, k2, i2, 4, k2, i2, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, j2 + 1, i2, 0, k2 - 1, i2, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, j2 + 1, i2, 4, k2 - 1, i2, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
                if ((i2 & 1) == 0) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, j2 + 2, i2, 0, j2 + 3, i2, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, j2 + 2, i2, 4, j2 + 3, i2, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                }
                for (int i1 = 0; i1 <= 4; ++i1) {
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.NETHER_BRICK.getDefaultState(), i1, -1, l2, structureBoundingBoxIn);
                }
            }
            return true;
        }
    ...
    extends Piece {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            this.getNextComponentX((Start)componentIn, listIn, rand, 0, i2, rand.nextInt(8) > 0);
            this.getNextComponentZ((Start)componentIn, listIn, rand, 0, i2, rand.nextInt(8) > 0);
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 7; i2 <= 11; ++i2) {
                for (int j2 = 0; j2 <= 2; ++j2) {
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.NETHER_BRICK.getDefaultState(), i2, -1, j2, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.NETHER_BRICK.getDefaultState(), i2, -1, 18 - j2, structureBoundingBoxIn);
                }
            }
            ...
            for (int k2 = 0; k2 <= 2; ++k2) {
                for (int l2 = 7; l2 <= 11; ++l2) {
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.NETHER_BRICK.getDefaultState(), k2, -1, l2, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.NETHER_BRICK.getDefaultState(), 18 - k2, -1, l2, structureBoundingBoxIn);
                }
            }
            return true;
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 0; i2 <= 4; ++i2) {
                for (int j2 = 3; j2 <= 4; ++j2) {
                    int k2 = random.nextInt(8);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, i2, j2, 0, i2, j2, k2, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
                }
            }
            int l2 = random.nextInt(8);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 0, 0, 5, l2, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
            l2 = random.nextInt(8);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 5, 0, 4, 5, l2, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
            for (int i1 = 0; i1 <= 4; ++i1) {
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 1; i2 <= 11; i2 += 2) {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, i2, 10, 0, i2, 11, 0, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, i2, 10, 12, i2, 11, 12, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 10, i2, 0, 11, i2, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 12, 10, i2, 12, 11, i2, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), i2, 13, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), i2, 13, 12, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), 0, 13, i2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.NETHER_BRICK.getDefaultState(), 12, 13, i2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), i2 + 1, 13, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), i2 + 1, 13, 12, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), 0, 13, i2 + 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.NETHER_BRICK_FENCE.getDefaultState(), 12, 13, i2 + 1, structureBoundingBoxIn);
            }
            ...
            for (int k2 = 3; k2 <= 9; k2 += 2) {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 7, k2, 1, 8, k2, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 11, 7, k2, 11, 8, k2, Blocks.NETHER_BRICK_FENCE.getDefaultState(), Blocks.NETHER_BRICK_FENCE.getDefaultState(), false);
            }
            ...
            for (int l2 = 4; l2 <= 8; ++l2) {
                for (int j2 = 0; j2 <= 2; ++j2) {
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.NETHER_BRICK.getDefaultState(), l2, -1, j2, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.NETHER_BRICK.getDefaultState(), l2, -1, 12 - j2, structureBoundingBoxIn);
                }
            }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int j2 = 0; j2 <= 6; ++j2) {
                ...
                for (int l2 = 5; l2 <= 7; ++l2) {
                    this.setBlockState(worldIn, iblockstate, l2, 5 + j2, k2, structureBoundingBoxIn);
                }
                if (k2 >= 5 && k2 <= 8) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 5, k2, 7, j2 + 4, k2, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
                } else if (k2 >= 9 && k2 <= 10) {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 8, k2, 7, j2 + 4, k2, Blocks.NETHER_BRICK.getDefaultState(), Blocks.NETHER_BRICK.getDefaultState(), false);
                }
                if (j2 < 1) continue;
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 6 + j2, k2, 7, 9 + j2, k2, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
            }
    ...
    extends StructureComponent {
        ...
        private int getTotalWeight(List<PieceWeight> p_74960_1_) {
            ...
            for (PieceWeight structurenetherbridgepieces$pieceweight : p_74960_1_) {
                ...
                i2 += structurenetherbridgepieces$pieceweight.weight;
            }
            return flag ? i2 : -1;
        }
        ...
        private Piece generatePiece(Start p_175871_1_, List<PieceWeight> p_175871_2_, List<StructureComponent> p_175871_3_, Random p_175871_4_, int p_175871_5_, int p_175871_6_, int p_175871_7_, EnumFacing p_175871_8_, int p_175871_9_) {
            int i2 = this.getTotalWeight(p_175871_2_);
            boolean flag = i2 > 0 && p_175871_9_ <= 30;
            int j2 = 0;
            block0: while (j2 < 5 && flag) {
                ++j2;
                int k2 = p_175871_4_.nextInt(i2);
                for (PieceWeight structurenetherbridgepieces$pieceweight : p_175871_2_) {
                    if ((k2 -= structurenetherbridgepieces$pieceweight.weight) >= 0) continue;
