...
public class StructureVillagePieces {
    ...
    private static Village generateComponent(Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType) {
        int i2 = StructureVillagePieces.updatePieceWeight(start.structureVillageWeightedPieceList);
        if (i2 <= 0) {
            return null;
        }
        int j2 = 0;
    ...
    extends Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 1; i2 <= 9; ++i2) {
                this.setBlockState(worldIn, iblockstate4, 3, i2, 3, structureBoundingBoxIn);
            }
            ...
            for (int k2 = 0; k2 < 9; ++k2) {
                for (int j2 = 0; j2 < 5; ++j2) {
                    this.clearCurrentPositionBlocksUpwards(worldIn, j2, 12, k2, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, iblockstate, j2, -1, k2, structureBoundingBoxIn);
                }
            }
    ...
    extends Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 1; i2 <= 7; ++i2) {
                int j2 = ((BlockCrops)this.cropTypeA).getMaxAge();
                int k2 = j2 / 3;
                this.setBlockState(worldIn, this.cropTypeA.getStateFromMeta(MathHelper.getInt(randomIn, k2, j2)), 1, 1, i2, structureBoundingBoxIn);
                this.setBlockState(worldIn, this.cropTypeA.getStateFromMeta(MathHelper.getInt(randomIn, k2, j2)), 2, 1, i2, structureBoundingBoxIn);
                int l2 = ((BlockCrops)this.cropTypeB).getMaxAge();
                int i1 = l2 / 3;
                this.setBlockState(worldIn, this.cropTypeB.getStateFromMeta(MathHelper.getInt(randomIn, i1, l2)), 4, 1, i2, structureBoundingBoxIn);
                this.setBlockState(worldIn, this.cropTypeB.getStateFromMeta(MathHelper.getInt(randomIn, i1, l2)), 5, 1, i2, structureBoundingBoxIn);
                int j1 = ((BlockCrops)this.cropTypeC).getMaxAge();
                int k1 = j1 / 3;
                this.setBlockState(worldIn, this.cropTypeC.getStateFromMeta(MathHelper.getInt(randomIn, k1, j1)), 7, 1, i2, structureBoundingBoxIn);
                this.setBlockState(worldIn, this.cropTypeC.getStateFromMeta(MathHelper.getInt(randomIn, k1, j1)), 8, 1, i2, structureBoundingBoxIn);
                int l1 = ((BlockCrops)this.cropTypeD).getMaxAge();
                int i22 = l1 / 3;
                this.setBlockState(worldIn, this.cropTypeD.getStateFromMeta(MathHelper.getInt(randomIn, i22, l1)), 10, 1, i2, structureBoundingBoxIn);
                this.setBlockState(worldIn, this.cropTypeD.getStateFromMeta(MathHelper.getInt(randomIn, i22, l1)), 11, 1, i2, structureBoundingBoxIn);
            }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = -1; i2 <= 2; ++i2) {
                for (int j2 = 0; j2 <= 8; ++j2) {
                    this.setBlockState(worldIn, iblockstate7, j2, 4 + i2, i2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, iblockstate8, j2, 4 + i2, 5 - i2, structureBoundingBoxIn);
                }
            }
            ...
            for (int k2 = 0; k2 < 5; ++k2) {
                for (int l2 = 0; l2 < 9; ++l2) {
                    this.clearCurrentPositionBlocksUpwards(worldIn, l2, 7, k2, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, iblockstate, l2, -1, k2, structureBoundingBoxIn);
                }
            }
    ...
    extends Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = -1; i2 <= 2; ++i2) {
                for (int j2 = 0; j2 <= 8; ++j2) {
                    this.setBlockState(worldIn, iblockstate1, j2, 6 + i2, i2, structureBoundingBoxIn);
                    this.setBlockState(worldIn, iblockstate2, j2, 6 + i2, 5 - i2, structureBoundingBoxIn);
                }
            }
            ...
            for (int l2 = 0; l2 < 6; ++l2) {
                for (int k2 = 0; k2 < 9; ++k2) {
                    this.clearCurrentPositionBlocksUpwards(worldIn, k2, 9, l2, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, iblockstate, k2, -1, l2, structureBoundingBoxIn);
                }
            }
            this.spawnVillagers(worldIn, structureBoundingBoxIn, 2, 1, 2, 1);
            return true;
    ...
    extends Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 6; i2 <= 8; ++i2) {
                if (this.getBlockStateFromPos(worldIn, i2, 0, -1, structureBoundingBoxIn).getMaterial() != Material.AIR || this.getBlockStateFromPos(worldIn, i2, -1, -1, structureBoundingBoxIn).getMaterial() == Material.AIR) continue;
                this.setBlockState(worldIn, iblockstate4, i2, 0, -1, structureBoundingBoxIn);
                if (this.getBlockStateFromPos(worldIn, i2, -1, -1, structureBoundingBoxIn).getBlock() != Blocks.GRASS_PATH) continue;
                this.setBlockState(worldIn, Blocks.GRASS.getDefaultState(), i2, -1, -1, structureBoundingBoxIn);
            }
    ...
    extends Village {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = -1; i2 <= 2; ++i2) {
                for (int j2 = 0; j2 <= 8; ++j2) {
                    this.setBlockState(worldIn, iblockstate7, j2, 4 + i2, i2, structureBoundingBoxIn);
                    if (i2 <= -1 && j2 > 1 || i2 <= 0 && j2 > 3 || i2 <= 1 && j2 > 4 && j2 < 6) continue;
                    this.setBlockState(worldIn, iblockstate8, j2, 4 + i2, 5 - i2, structureBoundingBoxIn);
                }
            }
            ...
            for (int k2 = 4; k2 >= 1; --k2) {
                this.setBlockState(worldIn, iblockstate5, k2, 2 + k2, 7 - k2, structureBoundingBoxIn);
                for (int k1 = 8 - k2; k1 <= 10; ++k1) {
                    this.setBlockState(worldIn, iblockstate10, k2, 2 + k2, k1, structureBoundingBoxIn);
                }
            }
            ...
            for (int l2 = 6; l2 <= 8; ++l2) {
                for (int l1 = 5; l1 <= 10; ++l1) {
                    this.setBlockState(worldIn, iblockstate9, l2, 12 - l2, l1, structureBoundingBoxIn);
                }
            }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int j2 = 0; j2 < 5; ++j2) {
                for (int i2 = 0; i2 < 5; ++i2) {
                    this.clearCurrentPositionBlocksUpwards(worldIn, i2, 6, j2, structureBoundingBoxIn);
                    this.replaceAirAndLiquidDownwards(worldIn, iblockstate, i2, -1, j2, structureBoundingBoxIn);
                }
            }
    ...
    extends Road {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            boolean flag = false;
            for (int i2 = rand.nextInt(5); i2 < this.length - 8; i2 += 2 + rand.nextInt(5)) {
            ...
            for (int j2 = rand.nextInt(5); j2 < this.length - 8; j2 += 2 + rand.nextInt(5)) {
        ...
        public static StructureBoundingBox findPieceBox(Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing) {
            for (int i2 = 7 * MathHelper.getInt(rand, 3, 5); i2 >= 7; i2 -= 7) {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = this.boundingBox.minX; i2 <= this.boundingBox.maxX; ++i2) {
                block1: for (int j2 = this.boundingBox.minZ; j2 <= this.boundingBox.maxZ; ++j2) {
    ...
    extends StructureComponent {
        ...
        protected int getAverageGroundLevel(World worldIn, StructureBoundingBox structurebb) {
            ...
            for (int k2 = this.boundingBox.minZ; k2 <= this.boundingBox.maxZ; ++k2) {
                for (int l2 = this.boundingBox.minX; l2 <= this.boundingBox.maxX; ++l2) {
                    ...
                    i2 += Math.max(worldIn.getTopSolidOrLiquidBlock(blockpos$mutableblockpos).getY(), worldIn.provider.getAverageGroundLevel() - 1);
                    ++j2;
                }
            }
            if (j2 == 0) {
        ...
        protected void spawnVillagers(World worldIn, StructureBoundingBox structurebb, int x2, int y2, int z2, int count) {
            if (this.villagersSpawned < count) {
                for (int i2 = this.villagersSpawned; i2 < count; ++i2) {
                    int l2;
                    int k2;
                    int j2 = this.getXWithOffset(x2 + i2, z2);
                    if (!structurebb.isVecInside(new BlockPos(j2, k2 = this.getYWithOffset(y2), l2 = this.getZWithOffset(x2 + i2, z2)))) break;
                    ++this.villagersSpawned;
                    if (this.isZombieInfested) {
                        EntityZombieVillager entityzombievillager = new EntityZombieVillager(worldIn);
                        entityzombievillager.setLocationAndAngles((double)j2 + 0.5, k2, (double)l2 + 0.5, 0.0f, 0.0f);
                        entityzombievillager.onInitialSpawn(worldIn.getDifficultyForLocation(new BlockPos(entityzombievillager)), null);
                        entityzombievillager.func_190733_a(this.chooseProfession(i2, 0));
                    ...
                    entityvillager.setProfession(this.chooseProfession(i2, worldIn.rand.nextInt(6)));
    ...
    extends Village {
        ...
        public Well(Start start, int type, Random rand, int x2, int z2) {
            super(start, type);
            this.setCoordBaseMode(EnumFacing.Plane.HORIZONTAL.random(rand));
            this.boundingBox = this.getCoordBaseMode().getAxis() == EnumFacing.Axis.Z ? new StructureBoundingBox(x2, 64, z2, x2 + 6 - 1, 78, z2 + 6 - 1) : new StructureBoundingBox(x2, 64, z2, x2 + 6 - 1, 78, z2 + 6 - 1);
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 0; i2 <= 5; ++i2) {
                for (int j2 = 0; j2 <= 5; ++j2) {
                    if (j2 != 0 && j2 != 5 && i2 != 0 && i2 != 5) continue;
                    this.setBlockState(worldIn, iblockstate, j2, 11, i2, structureBoundingBoxIn);
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 0; i2 < 5; ++i2) {
                for (int j2 = 0; j2 < 4; ++j2) {
                    ...
                    this.replaceAirAndLiquidDownwards(worldIn, iblockstate, j2, -1, i2, structureBoundingBoxIn);
                }
            }
            this.spawnVillagers(worldIn, structureBoundingBoxIn, 1, 1, 2, 1);
            return true;
