...
public class StructureEndCityPieces {
    ...
    private static final IGenerator TOWER_GENERATOR = new IGenerator(){
        ...
        public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_) {
            ...
            int i2 = 1 + p_191086_6_.nextInt(3);
            for (int j2 = 0; j2 < i2; ++j2) {
                ...
                if (j2 >= i2 - 1 || !p_191086_6_.nextBoolean()) continue;
    ...
    private static final IGenerator TOWER_BRIDGE_GENERATOR = new IGenerator(){
        ...
        public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_) {
            Rotation rotation = p_191086_3_.placeSettings.getRotation();
            int i2 = p_191086_6_.nextInt(4) + 1;
            ...
            for (int k2 = 0; k2 < i2; ++k2) {
                if (p_191086_6_.nextBoolean()) {
                    structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_191086_5_, StructureEndCityPieces.func_191090_b(p_191086_1_, structureendcitypieces$citytemplate, new BlockPos(0, j2, -4), "bridge_piece", rotation, true));
                    j2 = 0;
                    continue;
                }
                structureendcitypieces$citytemplate = p_191086_6_.nextBoolean() ? StructureEndCityPieces.func_189935_b(p_191086_5_, StructureEndCityPieces.func_191090_b(p_191086_1_, structureendcitypieces$citytemplate, new BlockPos(0, j2, -4), "bridge_steep_stairs", rotation, true)) : StructureEndCityPieces.func_189935_b(p_191086_5_, StructureEndCityPieces.func_191090_b(p_191086_1_, structureendcitypieces$citytemplate, new BlockPos(0, j2, -8), "bridge_gentle_stairs", rotation, true));
                j2 = 4;
            }
            if (!this.shipCreated && p_191086_6_.nextInt(10 - p_191086_2_) == 0) {
                StructureEndCityPieces.func_189935_b(p_191086_5_, StructureEndCityPieces.func_191090_b(p_191086_1_, structureendcitypieces$citytemplate, new BlockPos(-8 + p_191086_6_.nextInt(8), j2, -70 + p_191086_6_.nextInt(10)), "ship", rotation, true));
                this.shipCreated = true;
            } else if (!StructureEndCityPieces.func_191088_b(p_191086_1_, HOUSE_TOWER_GENERATOR, p_191086_2_ + 1, structureendcitypieces$citytemplate, new BlockPos(-3, j2 + 1, -11), p_191086_5_, p_191086_6_)) {
                return false;
            }
            structureendcitypieces$citytemplate = StructureEndCityPieces.func_189935_b(p_191086_5_, StructureEndCityPieces.func_191090_b(p_191086_1_, structureendcitypieces$citytemplate, new BlockPos(4, j2, 0), "bridge_end", rotation.add(Rotation.CLOCKWISE_180), true));
            structureendcitypieces$citytemplate.componentType = -1;
            return true;
        }
    };
    ...
    private static final IGenerator FAT_TOWER_GENERATOR = new IGenerator(){
        ...
        public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_) {
            ...
            for (int i2 = 0; i2 < 2 && p_191086_6_.nextInt(3) != 0; ++i2) {
    ...
    private static boolean func_191088_b(TemplateManager p_191088_0_, IGenerator p_191088_1_, int p_191088_2_, CityTemplate p_191088_3_, BlockPos p_191088_4_, List<StructureComponent> p_191088_5_, Random p_191088_6_) {
        ...
        if (p_191088_1_.func_191086_a(p_191088_0_, p_191088_2_, p_191088_3_, p_191088_4_, list, p_191088_6_)) {
            boolean flag = false;
            int i2 = p_191088_6_.nextInt();
            for (StructureComponent structurecomponent : list) {
                structurecomponent.componentType = i2;
