...
extends MapGenBase {
    ...
    public synchronized boolean generateStructure(World worldIn, Random randomIn, ChunkPos chunkCoord) {
        ...
        for (StructureStart structurestart : this.structureMap.values()) {
            if (!structurestart.isSizeableStructure() || !structurestart.isValidForPostProcess(chunkCoord) || !structurestart.getBoundingBox().intersectsWith(i2, j2, i2 + 15, j2 + 15)) continue;
        ...
        if (this.structureData == null && worldIn != null) {
            ...
            if (this.structureData == null) {
                ...
                for (String s2 : nbttagcompound.getKeySet()) {
                    ...
                    int i2 = nbttagcompound1.getInteger("ChunkX");
                    int j2 = nbttagcompound1.getInteger("ChunkZ");
                    StructureStart structurestart = MapGenStructureIO.getStructureStart(nbttagcompound1, worldIn);
                    if (structurestart == null) continue;
                    this.structureMap.put(ChunkPos.asLong(i2, j2), structurestart);
                }
            }
        }
    }
    ...
    protected static BlockPos func_191069_a(World p_191069_0_, MapGenStructure p_191069_1_, BlockPos p_191069_2_, int p_191069_3_, int p_191069_4_, int p_191069_5_, boolean p_191069_6_, int p_191069_7_, boolean p_191069_8_) {
        int i2 = p_191069_2_.getX() >> 4;
        int j2 = p_191069_2_.getZ() >> 4;
        Random random = new Random();
        block0: for (int k2 = 0; k2 <= p_191069_7_; ++k2) {
            for (int l2 = -k2; l2 <= k2; ++l2) {
                boolean flag = l2 == -k2 || l2 == k2;
                for (int i1 = -k2; i1 <= k2; ++i1) {
                    boolean flag1;
                    boolean bl2 = flag1 = i1 == -k2 || i1 == k2;
                    if (!flag && !flag1) continue;
                    int j1 = i2 + p_191069_3_ * l2;
                    int k1 = j2 + p_191069_3_ * i1;
                    if (j1 < 0) {
                        j1 -= p_191069_3_ - 1;
                    }
                    if (k1 < 0) {
                    ...
                    int i22 = k1 / p_191069_3_;
                    Random random1 = p_191069_0_.setRandomSeed(l1, i22, p_191069_5_);
                    l1 *= p_191069_3_;
                    i22 *= p_191069_3_;
                    if (p_191069_6_) {
                        l1 += (random1.nextInt(p_191069_3_ - p_191069_4_) + random1.nextInt(p_191069_3_ - p_191069_4_)) / 2;
                        i22 += (random1.nextInt(p_191069_3_ - p_191069_4_) + random1.nextInt(p_191069_3_ - p_191069_4_)) / 2;
                    } else {
                        l1 += random1.nextInt(p_191069_3_ - p_191069_4_);
                        i22 += random1.nextInt(p_191069_3_ - p_191069_4_);
                    }
                    MapGenBase.func_191068_a(p_191069_0_.getSeed(), random, l1, i22);
                    random.nextInt();
                    if (p_191069_1_.canSpawnStructureAtCoords(l1, i22)) {
                        if (p_191069_8_ && p_191069_0_.func_190526_b(l1, i22)) continue;
                        return new BlockPos((l1 << 4) + 8, 64, (i22 << 4) + 8);
                    }
                    if (k2 == 0) break;
                }
                if (k2 == 0) continue block0;
            }
        }
        return null;
    }
