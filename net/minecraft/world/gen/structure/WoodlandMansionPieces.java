...
public class WoodlandMansionPieces {
    ...
    static class Grid {
        ...
        public static boolean func_191109_a(SimpleGrid p_191109_0_, int p_191109_1_, int p_191109_2_) {
            int i2 = p_191109_0_.func_191145_a(p_191109_1_, p_191109_2_);
        ...
        private void func_191110_a(SimpleGrid p_191110_1_, int p_191110_2_, int p_191110_3_, EnumFacing p_191110_4_, int p_191110_5_) {
            if (p_191110_5_ > 0) {
                ...
                for (int i2 = 0; i2 < 8; ++i2) {
                    ...
                    int j2 = p_191110_2_ + p_191110_4_.getFrontOffsetX();
                    int k2 = p_191110_3_ + p_191110_4_.getFrontOffsetZ();
                    if (p_191110_1_.func_191145_a(j2 + enumfacing.getFrontOffsetX(), k2 + enumfacing.getFrontOffsetZ()) != 0 || p_191110_1_.func_191145_a(j2 + enumfacing.getFrontOffsetX() * 2, k2 + enumfacing.getFrontOffsetZ() * 2) != 0) continue;
        ...
        private boolean func_191111_a(SimpleGrid p_191111_1_) {
            boolean flag = false;
            for (int i2 = 0; i2 < p_191111_1_.field_191150_c; ++i2) {
                for (int j2 = 0; j2 < p_191111_1_.field_191149_b; ++j2) {
                    if (p_191111_1_.func_191145_a(j2, i2) != 0) continue;
                    int k2 = 0;
                    k2 += Grid.func_191109_a(p_191111_1_, j2 + 1, i2) ? 1 : 0;
                    k2 += Grid.func_191109_a(p_191111_1_, j2 - 1, i2) ? 1 : 0;
                    k2 += Grid.func_191109_a(p_191111_1_, j2, i2 + 1) ? 1 : 0;
                    if ((k2 += Grid.func_191109_a(p_191111_1_, j2, i2 - 1) ? 1 : 0) >= 3) {
                        p_191111_1_.func_191144_a(j2, i2, 2);
                        flag = true;
                        continue;
                    }
                    if (k2 != 2) continue;
                    int l2 = 0;
                    l2 += Grid.func_191109_a(p_191111_1_, j2 + 1, i2 + 1) ? 1 : 0;
                    l2 += Grid.func_191109_a(p_191111_1_, j2 - 1, i2 + 1) ? 1 : 0;
                    l2 += Grid.func_191109_a(p_191111_1_, j2 + 1, i2 - 1) ? 1 : 0;
                    if ((l2 += Grid.func_191109_a(p_191111_1_, j2 - 1, i2 - 1) ? 1 : 0) > 1) continue;
                    p_191111_1_.func_191144_a(j2, i2, 2);
                    flag = true;
                }
            }
        ...
        private void func_191115_b() {
            ...
            for (int i2 = 0; i2 < this.field_191119_c.field_191150_c; ++i2) {
                for (int j2 = 0; j2 < this.field_191119_c.field_191149_b; ++j2) {
                    int k2 = woodlandmansionpieces$simplegrid.func_191145_a(j2, i2);
                    int l2 = k2 & 0xF0000;
                    if (l2 != 131072 || (k2 & 0x200000) != 0x200000) continue;
                    list.add(new Tuple<Integer, Integer>(j2, i2));
                }
            }
            if (list.isEmpty()) {
        ...
        private void func_191116_a(SimpleGrid p_191116_1_, SimpleGrid p_191116_2_) {
            ArrayList<Tuple<Integer, Integer>> list = Lists.newArrayList();
            for (int i2 = 0; i2 < p_191116_1_.field_191150_c; ++i2) {
                for (int i3 = 0; i3 < p_191116_1_.field_191149_b; ++i3) {
                    if (p_191116_1_.func_191145_a(i3, i2) != 2) continue;
                    list.add(new Tuple<Integer, Integer>(i3, i2));
                }
            }
            ...
            for (Tuple tuple : list) {
                int l2;
                int k2 = (Integer)tuple.getFirst();
                if (p_191116_2_.func_191145_a(k2, l2 = ((Integer)tuple.getSecond()).intValue()) != 0) continue;
                int i1 = k2;
                int j1 = k2;
                int k1 = l2;
                int l1 = l2;
                int i2 = 65536;
                if (p_191116_2_.func_191145_a(k2 + 1, l2) == 0 && p_191116_2_.func_191145_a(k2, l2 + 1) == 0 && p_191116_2_.func_191145_a(k2 + 1, l2 + 1) == 0 && p_191116_1_.func_191145_a(k2 + 1, l2) == 2 && p_191116_1_.func_191145_a(k2, l2 + 1) == 2 && p_191116_1_.func_191145_a(k2 + 1, l2 + 1) == 2) {
                    j1 = k2 + 1;
                    l1 = l2 + 1;
                    i2 = 262144;
                } else if (p_191116_2_.func_191145_a(k2 - 1, l2) == 0 && p_191116_2_.func_191145_a(k2, l2 + 1) == 0 && p_191116_2_.func_191145_a(k2 - 1, l2 + 1) == 0 && p_191116_1_.func_191145_a(k2 - 1, l2) == 2 && p_191116_1_.func_191145_a(k2, l2 + 1) == 2 && p_191116_1_.func_191145_a(k2 - 1, l2 + 1) == 2) {
                    i1 = k2 - 1;
                    l1 = l2 + 1;
                    i2 = 262144;
                } else if (p_191116_2_.func_191145_a(k2 - 1, l2) == 0 && p_191116_2_.func_191145_a(k2, l2 - 1) == 0 && p_191116_2_.func_191145_a(k2 - 1, l2 - 1) == 0 && p_191116_1_.func_191145_a(k2 - 1, l2) == 2 && p_191116_1_.func_191145_a(k2, l2 - 1) == 2 && p_191116_1_.func_191145_a(k2 - 1, l2 - 1) == 2) {
                    ...
                    k1 = l2 - 1;
                    i2 = 262144;
                } else if (p_191116_2_.func_191145_a(k2 + 1, l2) == 0 && p_191116_1_.func_191145_a(k2 + 1, l2) == 2) {
                    j1 = k2 + 1;
                    i2 = 131072;
                } else if (p_191116_2_.func_191145_a(k2, l2 + 1) == 0 && p_191116_1_.func_191145_a(k2, l2 + 1) == 2) {
                    l1 = l2 + 1;
                    i2 = 131072;
                } else if (p_191116_2_.func_191145_a(k2 - 1, l2) == 0 && p_191116_1_.func_191145_a(k2 - 1, l2) == 2) {
                    i1 = k2 - 1;
                ...
                int k22 = this.field_191117_a.nextBoolean() ? k1 : l1;
                int l22 = 0x200000;
                if (!p_191116_1_.func_191147_b(j2, k22, 1)) {
                    j2 = j2 == i1 ? j1 : i1;
                    int n2 = k22 = k22 == k1 ? l1 : k1;
                    if (!p_191116_1_.func_191147_b(j2, k22, 1)) {
                        int n3 = k22 = k22 == k1 ? l1 : k1;
                        if (!p_191116_1_.func_191147_b(j2, k22, 1)) {
                            j2 = j2 == i1 ? j1 : i1;
                            int n4 = k22 = k22 == k1 ? l1 : k1;
                            if (!p_191116_1_.func_191147_b(j2, k22, 1)) {
                                l22 = 0;
                                j2 = i1;
                                k22 = k1;
                ...
                for (int i3 = k1; i3 <= l1; ++i3) {
                    for (int j3 = i1; j3 <= j1; ++j3) {
                        if (j3 == j2 && i3 == k22) {
                            p_191116_2_.func_191144_a(j3, i3, 0x100000 | l22 | i2 | k3);
                            continue;
                        }
    ...
    static class Placer {
        ...
        public void func_191125_a(BlockPos p_191125_1_, Rotation p_191125_2_, List<MansionTemplate> p_191125_3_, Grid p_191125_4_) {
            ...
            int i2 = p_191125_4_.field_191121_e + 1;
            int j2 = p_191125_4_.field_191122_f;
            this.func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata, woodlandmansionpieces$simplegrid, EnumFacing.SOUTH, this.field_191136_c, this.field_191137_d, i2, j2);
            this.func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata1, woodlandmansionpieces$simplegrid, EnumFacing.SOUTH, this.field_191136_c, this.field_191137_d, i2, j2);
            ...
            boolean flag = false;
            for (int k2 = 0; k2 < woodlandmansionpieces$simplegrid1.field_191150_c && !flag; ++k2) {
                for (int l2 = woodlandmansionpieces$simplegrid1.field_191149_b - 1; l2 >= 0 && !flag; --l2) {
                    if (!Grid.func_191109_a(woodlandmansionpieces$simplegrid1, l2, k2)) continue;
                    woodlandmansionpieces$placementdata2.field_191139_b = woodlandmansionpieces$placementdata2.field_191139_b.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 8 + (k2 - this.field_191137_d) * 8);
                    ...
                    this.func_191130_a(p_191125_3_, woodlandmansionpieces$placementdata2, woodlandmansionpieces$simplegrid1, EnumFacing.SOUTH, l2, k2, l2, k2);
                    flag = true;
                }
            }
            ...
            for (int l2 = 0; l2 < 3; ++l2) {
                ...
                String s2 = l2 == 0 ? "carpet_south" : "carpet_south_2";
                ...
                for (int i1 = 0; i1 < woodlandmansionpieces$simplegrid3.field_191150_c; ++i1) {
                    for (int j1 = 0; j1 < woodlandmansionpieces$simplegrid3.field_191149_b; ++j1) {
                        ...
                        if (woodlandmansionpieces$simplegrid3.func_191145_a(j1, i1 + 1) == 1 || (woodlandmansionpieces$simplegrid2.func_191145_a(j1, i1 + 1) & 0x800000) == 0x800000) {
                            p_191125_3_.add(new MansionTemplate(this.field_191134_a, s2, blockpos1.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 5).offset(p_191125_2_.rotate(EnumFacing.WEST), 1), p_191125_2_));
                        }
                ...
                String s22 = l2 == 0 ? "indoors_wall" : "indoors_wall_2";
                ...
                for (int k1 = 0; k1 < woodlandmansionpieces$simplegrid3.field_191150_c; ++k1) {
                    for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.field_191149_b; ++l1) {
                        boolean flag1;
                        boolean bl2 = flag1 = l2 == 2 && woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1) == 3;
                        if (woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1) != 2 && !flag1) continue;
                        int i22 = woodlandmansionpieces$simplegrid2.func_191145_a(l1, k1);
                        int j22 = i22 & 0xF0000;
                        int k2 = i22 & 0xFFFF;
                        flag1 = flag1 && (i22 & 0x800000) == 0x800000;
                        list.clear();
                        if ((i22 & 0x200000) == 0x200000) {
                            for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
                        ...
                        if (Grid.func_191109_a(woodlandmansionpieces$simplegrid3, l1 - 1, k1) && !p_191125_4_.func_191114_a(woodlandmansionpieces$simplegrid3, l1 - 1, k1, l2, k2)) {
                            p_191125_3_.add(new MansionTemplate(this.field_191134_a, enumfacing1 == EnumFacing.WEST ? s3 : s22, blockpos2, p_191125_2_));
                        }
                        if (woodlandmansionpieces$simplegrid3.func_191145_a(l1 + 1, k1) == 1 && !flag1) {
                            ...
                            p_191125_3_.add(new MansionTemplate(this.field_191134_a, enumfacing1 == EnumFacing.EAST ? s3 : s22, blockpos3, p_191125_2_));
                        }
                        if (Grid.func_191109_a(woodlandmansionpieces$simplegrid3, l1, k1 + 1) && !p_191125_4_.func_191114_a(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2, k2)) {
                            ...
                            p_191125_3_.add(new MansionTemplate(this.field_191134_a, enumfacing1 == EnumFacing.SOUTH ? s3 : s22, blockpos4, p_191125_2_.add(Rotation.CLOCKWISE_90)));
                        }
                        if (woodlandmansionpieces$simplegrid3.func_191145_a(l1, k1 - 1) == 1 && !flag1) {
                            ...
                            p_191125_3_.add(new MansionTemplate(this.field_191134_a, enumfacing1 == EnumFacing.NORTH ? s3 : s22, blockpos5, p_191125_2_.add(Rotation.CLOCKWISE_90)));
                        }
                        if (j22 == 65536) {
                            this.func_191129_a(p_191125_3_, blockpos2, p_191125_2_, enumfacing1, awoodlandmansionpieces$roomcollection[l2]);
                            continue;
                        }
                        if (j22 == 131072 && enumfacing1 != null) {
                            EnumFacing enumfacing3 = p_191125_4_.func_191113_b(woodlandmansionpieces$simplegrid3, l1, k1, l2, k2);
                            boolean flag2 = (i22 & 0x400000) == 0x400000;
                        ...
                        if (j22 == 262144 && enumfacing1 != null && enumfacing1 != EnumFacing.UP) {
                        ...
                        if (j22 != 262144 || enumfacing1 != EnumFacing.UP) continue;
        ...
        private void func_191130_a(List<MansionTemplate> p_191130_1_, PlacementData p_191130_2_, SimpleGrid p_191130_3_, EnumFacing p_191130_4_, int p_191130_5_, int p_191130_6_, int p_191130_7_, int p_191130_8_) {
            ...
            do {
                if (!Grid.func_191109_a(p_191130_3_, i2 + p_191130_4_.getFrontOffsetX(), j2 + p_191130_4_.getFrontOffsetZ())) {
                    this.func_191124_c(p_191130_1_, p_191130_2_);
                    p_191130_4_ = p_191130_4_.rotateY();
                    if (i2 == p_191130_7_ && j2 == p_191130_8_ && enumfacing == p_191130_4_) continue;
                    this.func_191131_b(p_191130_1_, p_191130_2_);
                    continue;
                }
                if (Grid.func_191109_a(p_191130_3_, i2 + p_191130_4_.getFrontOffsetX(), j2 + p_191130_4_.getFrontOffsetZ()) && Grid.func_191109_a(p_191130_3_, i2 + p_191130_4_.getFrontOffsetX() + p_191130_4_.rotateYCCW().getFrontOffsetX(), j2 + p_191130_4_.getFrontOffsetZ() + p_191130_4_.rotateYCCW().getFrontOffsetZ())) {
                    this.func_191126_d(p_191130_1_, p_191130_2_);
                    i2 += p_191130_4_.getFrontOffsetX();
                    j2 += p_191130_4_.getFrontOffsetZ();
                    p_191130_4_ = p_191130_4_.rotateYCCW();
                    continue;
                }
                if ((i2 += p_191130_4_.getFrontOffsetX()) == p_191130_7_ && (j2 += p_191130_4_.getFrontOffsetZ()) == p_191130_8_ && enumfacing == p_191130_4_) continue;
                this.func_191131_b(p_191130_1_, p_191130_2_);
            } while (i2 != p_191130_7_ || j2 != p_191130_8_ || enumfacing != p_191130_4_);
        }
        ...
        private void func_191123_a(List<MansionTemplate> p_191123_1_, BlockPos p_191123_2_, Rotation p_191123_3_, SimpleGrid p_191123_4_, @Nullable SimpleGrid p_191123_5_) {
            for (int i2 = 0; i2 < p_191123_4_.field_191150_c; ++i2) {
                for (int j2 = 0; j2 < p_191123_4_.field_191149_b; ++j2) {
                    boolean flag;
                    BlockPos lvt_8_3_ = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (i2 - this.field_191137_d) * 8);
                    lvt_8_3_ = lvt_8_3_.offset(p_191123_3_.rotate(EnumFacing.EAST), (j2 - this.field_191136_c) * 8);
                    boolean bl2 = flag = p_191123_5_ != null && Grid.func_191109_a(p_191123_5_, j2, i2);
                    if (!Grid.func_191109_a(p_191123_4_, j2, i2) || flag) continue;
                    p_191123_1_.add(new MansionTemplate(this.field_191134_a, "roof", lvt_8_3_.up(3), p_191123_3_));
                    if (!Grid.func_191109_a(p_191123_4_, j2 + 1, i2)) {
                    ...
                    if (!Grid.func_191109_a(p_191123_4_, j2, i2 - 1)) {
                    ...
                    if (Grid.func_191109_a(p_191123_4_, j2, i2 + 1)) continue;
            ...
            if (p_191123_5_ != null) {
                for (int k2 = 0; k2 < p_191123_4_.field_191150_c; ++k2) {
                    for (int i1 = 0; i1 < p_191123_4_.field_191149_b; ++i1) {
                        BlockPos blockpos3 = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (k2 - this.field_191137_d) * 8);
                        blockpos3 = blockpos3.offset(p_191123_3_.rotate(EnumFacing.EAST), (i1 - this.field_191136_c) * 8);
                        boolean flag1 = Grid.func_191109_a(p_191123_5_, i1, k2);
                        if (!Grid.func_191109_a(p_191123_4_, i1, k2) || !flag1) continue;
                        if (!Grid.func_191109_a(p_191123_4_, i1 + 1, k2)) {
                        ...
                        if (!Grid.func_191109_a(p_191123_4_, i1, k2 - 1)) {
                        ...
                        if (Grid.func_191109_a(p_191123_4_, i1 - 1, k2)) continue;
                        if (!Grid.func_191109_a(p_191123_4_, i1, k2 - 1)) {
                        ...
                        if (Grid.func_191109_a(p_191123_4_, i1, k2 + 1)) continue;
            ...
            for (int l2 = 0; l2 < p_191123_4_.field_191150_c; ++l2) {
                for (int j1 = 0; j1 < p_191123_4_.field_191149_b; ++j1) {
                    boolean flag2;
                    BlockPos blockpos4 = p_191123_2_.offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (l2 - this.field_191137_d) * 8);
                    blockpos4 = blockpos4.offset(p_191123_3_.rotate(EnumFacing.EAST), (j1 - this.field_191136_c) * 8);
                    boolean bl3 = flag2 = p_191123_5_ != null && Grid.func_191109_a(p_191123_5_, j1, l2);
                    if (!Grid.func_191109_a(p_191123_4_, j1, l2) || flag2) continue;
                    if (!Grid.func_191109_a(p_191123_4_, j1 + 1, l2)) {
                        BlockPos blockpos16 = blockpos4.offset(p_191123_3_.rotate(EnumFacing.EAST), 6);
                        if (!Grid.func_191109_a(p_191123_4_, j1, l2 + 1)) {
                        ...
                        } else if (Grid.func_191109_a(p_191123_4_, j1 + 1, l2 + 1)) {
                    ...
                    if (Grid.func_191109_a(p_191123_4_, j1 - 1, l2)) continue;
                    ...
                    if (!Grid.func_191109_a(p_191123_4_, j1 - 1, l2 - 1)) continue;
        ...
        private void func_191129_a(List<MansionTemplate> p_191129_1_, BlockPos p_191129_2_, Rotation p_191129_3_, EnumFacing p_191129_4_, RoomCollection p_191129_5_) {
            ...
            String s2 = p_191129_5_.func_191104_a(this.field_191135_b);
            if (p_191129_4_ != EnumFacing.EAST) {
                if (p_191129_4_ == EnumFacing.NORTH) {
                    ...
                    s2 = p_191129_5_.func_191099_b(this.field_191135_b);
                }
            }
            ...
            p_191129_1_.add(new MansionTemplate(this.field_191134_a, s2, blockpos1, rotation));
        }
        ...
        private void func_191127_a(List<MansionTemplate> p_191127_1_, BlockPos p_191127_2_, Rotation p_191127_3_, EnumFacing p_191127_4_, EnumFacing p_191127_5_, RoomCollection p_191127_6_) {
            ...
            BlockPos blockpos = p_191127_2_.offset(p_191127_3_.rotate(EnumFacing.EAST), i2);
            blockpos = blockpos.offset(p_191127_3_.rotate(EnumFacing.SOUTH), j2);
    ...
    extends RoomCollection {
        ...
        /* synthetic */ SecondFloor(SecondFloor secondFloor, SecondFloor secondFloor2) {
            this();
        }
    }
    ...
    static class SimpleGrid {
        ...
        public void func_191142_a(int p_191142_1_, int p_191142_2_, int p_191142_3_, int p_191142_4_, int p_191142_5_) {
            for (int i2 = p_191142_2_; i2 <= p_191142_4_; ++i2) {
                for (int j2 = p_191142_1_; j2 <= p_191142_3_; ++j2) {
                    this.func_191144_a(j2, i2, p_191142_5_);
                }
            }
        }
