...
public class ComponentScatteredFeaturePieces {
    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 0; i2 < this.scatteredFeatureSizeX; ++i2) {
                for (int j2 = 0; j2 < this.scatteredFeatureSizeZ; ++j2) {
                    int k2 = -5;
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.SANDSTONE.getDefaultState(), i2, -5, j2, structureBoundingBoxIn);
                }
            }
            ...
            int l2 = ~EnumDyeColor.ORANGE.getDyeDamage() & 0xF;
            ...
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 10, 0, 7, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 10, 0, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 9, 0, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 11, 0, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 8, 0, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 12, 0, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 7, 0, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 13, 0, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 9, 0, 11, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 11, 0, 11, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 10, 0, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 10, 0, 13, structureBoundingBoxIn);
            ...
            for (int j2 = 0; j2 <= this.scatteredFeatureSizeX - 1; j2 += this.scatteredFeatureSizeX - 1) {
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), j2, 2, 2, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), j2, 3, 2, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), j2, 4, 1, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), j2, 4, 3, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), j2, 5, 2, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), j2, 6, 1, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), j2, 6, 3, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), j2, 7, 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), j2, 7, 2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), j2, 7, 3, structureBoundingBoxIn);
            ...
            for (int k2 = 2; k2 <= this.scatteredFeatureSizeX - 3; k2 += this.scatteredFeatureSizeX - 3 - 2) {
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), k2, 2, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2 + 1, 2, 0, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), k2, 3, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2 + 1, 3, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), k2 - 1, 4, 0, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), k2, 5, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.SANDSTONE.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k2 + 1, 5, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), k2 - 1, 6, 0, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), k2 + 1, 6, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), k2 - 1, 7, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), k2, 7, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), k2 + 1, 7, 0, structureBoundingBoxIn);
            ...
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 9, 5, 0, structureBoundingBoxIn);
            ...
            this.setBlockState(worldIn, Blocks.STAINED_HARDENED_CLAY.getStateFromMeta(l2), 11, 5, 0, structureBoundingBoxIn);
    ...
    extends StructureComponent {
        ...
        protected Feature(Random rand, int x2, int y2, int z2, int sizeX, int sizeY, int sizeZ) {
            super(0);
            this.scatteredFeatureSizeX = sizeX;
            this.scatteredFeatureSizeY = sizeY;
            this.scatteredFeatureSizeZ = sizeZ;
            this.setCoordBaseMode(EnumFacing.Plane.HORIZONTAL.random(rand));
            this.boundingBox = this.getCoordBaseMode().getAxis() == EnumFacing.Axis.Z ? new StructureBoundingBox(x2, y2, z2, x2 + sizeX - 1, y2 + sizeY - 1, z2 + sizeZ - 1) : new StructureBoundingBox(x2, y2, z2, x2 + sizeZ - 1, y2 + sizeY - 1, z2 + sizeX - 1);
        }
        ...
        protected boolean offsetToAverageGroundLevel(World worldIn, StructureBoundingBox structurebb, int yOffset) {
            ...
            for (int k2 = this.boundingBox.minZ; k2 <= this.boundingBox.maxZ; ++k2) {
                for (int l2 = this.boundingBox.minX; l2 <= this.boundingBox.maxX; ++l2) {
                    blockpos$mutableblockpos.setPos(l2, 64, k2);
    ...
    extends Feature {
        ...
        public Igloo(Random rand, int x2, int z2) {
            super(rand, x2, 64, z2, 7, 5, 8);
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (randomIn.nextDouble() < 0.5) {
                ...
                int i2 = randomIn.nextInt(8) + 4;
                for (int j2 = 0; j2 < i2; ++j2) {
                    BlockPos blockpos1 = template.calculateConnectedPos(placementsettings, new BlockPos(3, -1 - j2 * 3, 5), placementsettings, new BlockPos(1, 2, 1));
                    template1.addBlocksToWorldChunk(worldIn, blockpos.add(blockpos1), placementsettings);
                }
                BlockPos blockpos4 = blockpos.add(template.calculateConnectedPos(placementsettings, new BlockPos(3, -1 - i2 * 3, 5), placementsettings, new BlockPos(3, 5, 7)));
    ...
    extends Feature {
        ...
        public JunglePyramid(Random rand, int x2, int z2) {
            super(rand, x2, 64, z2, 12, 10, 15);
        }
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            for (int i2 = 0; i2 <= 14; i2 += 14) {
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 4, i2, 2, 5, i2, false, randomIn, junglePyramidsRandomScatteredStones);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 4, i2, 4, 5, i2, false, randomIn, junglePyramidsRandomScatteredStones);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 7, 4, i2, 7, 5, i2, false, randomIn, junglePyramidsRandomScatteredStones);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, 4, i2, 9, 5, i2, false, randomIn, junglePyramidsRandomScatteredStones);
            }
            ...
            for (int l2 = 0; l2 <= 11; l2 += 11) {
                for (int j2 = 2; j2 <= 12; j2 += 2) {
                    this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, l2, 4, j2, l2, 5, j2, false, randomIn, junglePyramidsRandomScatteredStones);
                }
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, l2, 6, 5, l2, 6, 5, false, randomIn, junglePyramidsRandomScatteredStones);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, l2, 6, 9, l2, 6, 9, false, randomIn, junglePyramidsRandomScatteredStones);
            }
            ...
            for (int k2 = 0; k2 < 4; ++k2) {
                this.setBlockState(worldIn, iblockstate, 5, 0 - k2, 6 + k2, structureBoundingBoxIn);
                this.setBlockState(worldIn, iblockstate, 6, 0 - k2, 6 + k2, structureBoundingBoxIn);
                this.fillWithAir(worldIn, structureBoundingBoxIn, 5, 0 - k2, 7 + k2, 6, 0 - k2, 9 + k2);
            }
    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (!this.hasWitch && structureBoundingBoxIn.isVecInside(new BlockPos(l2 = this.getXWithOffset(2, 5), i1 = this.getYWithOffset(2), k2 = this.getZWithOffset(2, 5)))) {
                this.hasWitch = true;
                EntityWitch entitywitch = new EntityWitch(worldIn);
                entitywitch.enablePersistence();
                entitywitch.setLocationAndAngles((double)l2 + 0.5, i1, (double)k2 + 0.5, 0.0f, 0.0f);
                entitywitch.onInitialSpawn(worldIn.getDifficultyForLocation(new BlockPos(l2, i1, k2)), null);
