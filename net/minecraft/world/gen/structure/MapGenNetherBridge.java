...
extends MapGenStructure {
    ...
    protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
        int i2 = chunkX >> 4;
        int j2 = chunkZ >> 4;
        this.rand.setSeed((long)(i2 ^ j2 << 4) ^ this.worldObj.getSeed());
        this.rand.nextInt();
        if (this.rand.nextInt(3) != 0) {
            return false;
        }
        if (chunkX != (i2 << 4) + 4 + this.rand.nextInt(8)) {
            return false;
        }
        return chunkZ == (j2 << 4) + 4 + this.rand.nextInt(8);
    }
        ...
        for (int l2 = 0; l2 <= 1000; ++l2) {
            for (int i1 = -l2; i1 <= l2; ++i1) {
                ...
                for (int j1 = -l2; j1 <= l2; ++j1) {
                    ...
                    if (!flag && !flag1 || !this.canSpawnStructureAtCoords(k1 = j2 + i1, l1 = k2 + j1) || p_180706_3_ && worldIn.func_190526_b(k1, l1)) continue;
