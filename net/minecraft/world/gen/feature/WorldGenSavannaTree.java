        ...
        if (position.getY() >= 1 && position.getY() + i2 + 1 <= 256) {
            ...
            if ((block == Blocks.GRASS || block == Blocks.DIRT) && position.getY() < 256 - i2 - 1) {
                ...
                for (int l1 = 0; l1 < i2; ++l1) {
                    ...
                    if ((material = worldIn.getBlockState(blockpos = new BlockPos(i3, i22, j1)).getMaterial()) != Material.AIR && material != Material.LEAVES) continue;
                ...
                if (enumfacing1 != enumfacing) {
                    ...
                    k1 = 0;
                    for (int l4 = l3; l4 < i2 && k4 > 0; ++l4, --k4) {
                        if (l4 < 1) continue;
