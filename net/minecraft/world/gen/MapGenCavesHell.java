        ...
        while (p_180704_15_ < p_180704_16_) {
            ...
            if (flag1 || random.nextInt(4) != 0) {
                ...
                if (p_180704_6_ >= d0 - 16.0 - d2 * 2.0 && p_180704_10_ >= d1 - 16.0 - d2 * 2.0 && p_180704_6_ <= d0 + 16.0 + d2 * 2.0 && p_180704_10_ <= d1 + 16.0 + d2 * 2.0) {
                    int j22 = MathHelper.floor(p_180704_6_ - d2) - p_180704_3_ * 16 - 1;
                    int k2 = MathHelper.floor(p_180704_6_ + d2) - p_180704_3_ * 16 + 1;
                    int k22 = MathHelper.floor(p_180704_8_ - d3) - 1;
                    int l2 = MathHelper.floor(p_180704_8_ + d3) + 1;
                    int l22 = MathHelper.floor(p_180704_10_ - d2) - p_180704_4_ * 16 - 1;
    ...
    protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_, ChunkPrimer chunkPrimerIn) {
        ...
        for (int j2 = 0; j2 < i2; ++j2) {
            ...
            for (int l2 = 0; l2 < k2; ++l2) {
                ...
                this.addTunnel(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2, f22 * 2.0f, f2, f1, 0, 0, 0.5);
            }
        }
    }
}
