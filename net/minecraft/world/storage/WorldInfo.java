...
public class WorldInfo {
    ...
    public WorldInfo(NBTTagCompound nbt) {
        ...
        worldTime = nbt.hasKey("DayTime", 99) ? nbt.getLong("DayTime") : this.totalTime;
        ...
        if (nbt.hasKey("allowCommands", 99)) {
            ...
            boolean bl2 = this.allowCommands = this.theGameType == GameType.CREATIVE;
        }
        ...
        if (nbt.hasKey("DimensionData", 10)) {
            ...
            for (String s2 : nbttagcompound1.getKeySet()) {
                this.dimensionData.put(DimensionType.getById(Integer.parseInt(s2)), nbttagcompound1.getCompoundTag(s2));
            }
        }
    }
    ...
    public void addToCrashReport(CrashReportCategory category) {
        ...
        category.setDetail("Level time", new ICrashReportDetail<String>(){
            ...
            @Override
            public String call() throws Exception {
                return String.format("%d game time, %d day time", WorldInfo.this.totalTime, worldTime);
            }
        });
