...
public class LootTableList {
    ...
    private static ResourceLocation register(String id2) {
        return LootTableList.register(new ResourceLocation("minecraft", id2));
    }

    public static ResourceLocation register(ResourceLocation id2) {
        if (LOOT_TABLES.add(id2)) {
            return id2;
        }
        throw new IllegalArgumentException(id2 + " is already a registered built-in loot table");
    }
