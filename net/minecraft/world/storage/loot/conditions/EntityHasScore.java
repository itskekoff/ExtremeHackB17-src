...
implements LootCondition {
    ...
    protected boolean entityScoreMatch(Entity entityIn, Scoreboard scoreboardIn, String objectiveStr, RandomValueRange rand) {
        ...
        String s2 = entityIn instanceof EntityPlayerMP ? entityIn.getName() : entityIn.getCachedUniqueIdString();
        return !scoreboardIn.entityHasObjective(s2, scoreobjective) ? false : rand.isInRange(scoreboardIn.getOrCreateScore(s2, scoreobjective).getScorePoints());
    }
