...
IPlayerFileData {
    ...
    public void writePlayerData(EntityPlayer player) {
        try {
            ...
            File file1 = new File(this.playersDirectory, String.valueOf(player.getCachedUniqueIdString()) + ".dat.tmp");
            File file2 = new File(this.playersDirectory, String.valueOf(player.getCachedUniqueIdString()) + ".dat");
    ...
    public NBTTagCompound readPlayerData(EntityPlayer player) {
        ...
        try {
            File file1 = new File(this.playersDirectory, String.valueOf(player.getCachedUniqueIdString()) + ".dat");
