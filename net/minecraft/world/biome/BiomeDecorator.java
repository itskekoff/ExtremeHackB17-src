...
public class BiomeDecorator {
    ...
    protected void genDecorations(Biome biomeIn, World worldIn, Random random) {
        ...
        for (int i2 = 0; i2 < this.sandPerChunk2; ++i2) {
            int j2 = random.nextInt(16) + 8;
            int k2 = random.nextInt(16) + 8;
            this.sandGen.generate(worldIn, random, worldIn.getTopSolidOrLiquidBlock(this.chunkPos.add(j2, 0, k2)));
        }
        ...
        for (int j2 = 0; j2 < k1; ++j2) {
            ...
            BlockPos blockpos = worldIn.getHeight(this.chunkPos.add(k6, 0, l2));
