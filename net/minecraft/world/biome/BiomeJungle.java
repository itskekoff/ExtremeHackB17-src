...
extends Biome {
    ...
    public void decorate(World worldIn, Random rand, BlockPos pos) {
        ...
        int k2 = rand.nextInt(worldIn.getHeight(pos.add(i2, 0, j2)).getY() * 2);
        new WorldGenMelon().generate(worldIn, rand, pos.add(i2, k2, j2));
        WorldGenVines worldgenvines = new WorldGenVines();
        for (int j1 = 0; j1 < 50; ++j1) {
            k2 = rand.nextInt(16) + 8;
            int l2 = 128;
            int i1 = rand.nextInt(16) + 8;
            worldgenvines.generate(worldIn, rand, pos.add(k2, 128, i1));
        }
    }
}
