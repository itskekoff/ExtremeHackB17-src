...
public enum EnumEnchantmentType {
    ...
    WEARABLE{
        ...
        public boolean canEnchantItem(Item itemIn) {
            boolean flag;
            boolean bl2 = flag = itemIn instanceof ItemBlock && ((ItemBlock)itemIn).getBlock() instanceof BlockPumpkin;
    ...
    /* synthetic */ EnumEnchantmentType(String string, int n2, EnumEnchantmentType enumEnchantmentType) {
        this();
    }
}
