...
public abstract class Enchantment {
    ...
    @Nullable
    public static Enchantment getEnchantmentByID(int id2) {
    ...
    public List<ItemStack> getEntityEquipment(EntityLivingBase entityIn) {
        ...
        EntityEquipmentSlot[] arrentityEquipmentSlot = this.applicableEquipmentTypes;
        int n2 = this.applicableEquipmentTypes.length;
    ...
    public String getTranslatedName(int level) {
        String s2 = I18n.translateToLocal(this.getName());
        if (this.func_190936_d()) {
            s2 = (Object)((Object)TextFormatting.RED) + s2;
        }
        return level == 1 && this.getMaxLevel() == 1 ? s2 : String.valueOf(s2) + " " + I18n.translateToLocal("enchantment.level." + level);
    }
