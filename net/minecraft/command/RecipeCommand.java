    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        for (EntityPlayerMP entityplayermp : RecipeCommand.func_193513_a(server, sender, args[1])) {
            ...
            if (flag == entityplayermp.func_192037_E().func_193830_f(irecipe)) {
                String s2 = flag ? "commands.recipe.alreadyHave" : "commands.recipe.dontHave";
                throw new CommandException(s2, entityplayermp.getName(), irecipe.getRecipeOutput().getDisplayName());
            }
            if (flag) {
