...
extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if ("clear".equals(args[1])) {
            ...
            int k2 = 0;
            if (args.length >= 3) {
                j2 = CommandEffect.parseInt(args[2], 0, 1000000);
                i2 = potion.isInstant() ? j2 : j2 * 20;
            ...
            if (j2 > 0) {
                PotionEffect potioneffect = new PotionEffect(potion, i2, k2, false, flag);
                entitylivingbase.addPotionEffect(potioneffect);
                CommandEffect.notifyCommandListener(sender, (ICommand)this, "commands.effect.success", new TextComponentTranslation(potioneffect.getEffectName(), new Object[0]), Potion.getIdFromPotion(potion), k2, entitylivingbase.getName(), j2);
