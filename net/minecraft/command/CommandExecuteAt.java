...
extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        String s2 = CommandExecuteAt.buildString(args, i2);
        ...
        try {
            int j2 = icommandmanager.executeCommand(icommandsender, s2);
            if (j2 < 1) {
                throw new CommandException("commands.execute.allInvocationsFailed", s2);
            }
        }
        catch (Throwable var23) {
            throw new CommandException("commands.execute.failed", s2, entity.getName());
        }
    }
