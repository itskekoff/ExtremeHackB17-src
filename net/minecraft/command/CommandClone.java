...
extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        LinkedList<Iterator<Object>> deque = Lists.newLinkedList();
        ...
        while (++var20_21 <= structureboundingbox.maxZ) {
            for (int k2 = structureboundingbox.minY; k2 <= structureboundingbox.maxY; ++k2) {
                for (int l2 = structureboundingbox.minX; l2 <= structureboundingbox.maxX; ++l2) {
                    Iterator<Object> blockpos4 = new BlockPos(l2, k2, (int)var20_21);
        ...
        CommandClone.notifyCommandListener(sender, (ICommand)this, "commands.clone.success", i2);
    }
