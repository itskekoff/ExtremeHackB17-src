...
extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        String s2 = args[0];
        BlockPos blockpos = sender.getEntityWorld().func_190528_a(s2, sender.getPosition(), false);
        if (blockpos == null) {
            throw new CommandException("commands.locate.failure", s2);
        }
        sender.addChatMessage(new TextComponentTranslation("commands.locate.success", s2, blockpos.getX(), blockpos.getZ()));
    }
