...
extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        for (int j2 = structureboundingbox.minZ; j2 <= structureboundingbox.maxZ; ++j2) {
            for (int k2 = structureboundingbox.minY; k2 <= structureboundingbox.maxY; ++k2) {
                for (int l2 = structureboundingbox.minX; l2 <= structureboundingbox.maxX; ++l2) {
                    blockpos$mutableblockpos.setPos(l2, k2, j2);
                    blockpos$mutableblockpos1.setPos(l2 + blockpos3.getX(), k2 + blockpos3.getY(), j2 + blockpos3.getZ());
                    boolean flag1 = false;
        ...
        CommandCompare.notifyCommandListener(sender, (ICommand)this, "commands.compare.success", i2);
    }
