...
public class FunctionObject {
    ...
    public static FunctionObject func_193527_a(FunctionManager p_193527_0_, List<String> p_193527_1_) {
        ...
        for (String s2 : p_193527_1_) {
            if ((s2 = s2.trim()).startsWith("#") || s2.isEmpty()) continue;
            ...
            list.add(new CommandEntry(s2));
        }
        return new FunctionObject(list.toArray(new Entry[list.size()]));
    }

    public static class CacheableFunction {
        public static final CacheableFunction field_193519_a = new CacheableFunction(null);
        @Nullable
    ...
    implements Entry {
        ...
        public void func_194145_a(FunctionManager p_194145_1_, ICommandSender p_194145_2_, ArrayDeque<FunctionManager.QueuedCommand> p_194145_3_, int p_194145_4_) {
            ...
            if (functionobject != null) {
                ...
                int i2 = p_194145_4_ - p_194145_3_.size();
                int j2 = Math.min(afunctionobject$entry.length, i2);
                for (int k2 = j2 - 1; k2 >= 0; --k2) {
                    p_194145_3_.addFirst(new FunctionManager.QueuedCommand(p_194145_1_, p_194145_2_, afunctionobject$entry[k2]));
                }
            }
        }
