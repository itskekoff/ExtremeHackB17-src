...
extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        int i2 = args.length >= 3 ? CommandGive.parseInt(args[2], 1, item.getItemStackLimit()) : 1;
        int j2 = args.length >= 4 ? CommandGive.parseInt(args[3]) : 0;
        ItemStack itemstack = new ItemStack(item, i2, j2);
        if (args.length >= 5) {
            String s2 = CommandGive.buildString(args, 4);
            try {
        ...
        if (flag && itemstack.func_190926_b()) {
            ...
            sender.setCommandStat(CommandResultStats.Type.AFFECTED_ITEMS, i2 - itemstack.func_190916_E());
        ...
        CommandGive.notifyCommandListener(sender, (ICommand)this, "commands.give.success", itemstack.getTextComponent(), i2, entityplayer.getName());
    }
