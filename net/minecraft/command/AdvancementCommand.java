...
extends CommandBase {
    ...
    private void func_193516_a(MinecraftServer p_193516_1_, ICommandSender p_193516_2_, String[] p_193516_3_, EntityPlayerMP p_193516_4_, ActionType p_193516_5_, Mode p_193516_6_) throws CommandException {
        if (p_193516_6_ == Mode.EVERYTHING) {
            ...
            int j2 = p_193516_5_.func_193532_a(p_193516_4_, p_193516_1_.func_191949_aK().func_192780_b());
            if (j2 == 0) {
                throw p_193516_6_.func_193543_a(p_193516_5_, p_193516_4_.getName());
            }
            p_193516_6_.func_193546_a(p_193516_2_, this, p_193516_5_, p_193516_4_.getName(), j2);
            return;
        } else {
            ...
            if (p_193516_6_ == Mode.ONLY && p_193516_3_.length == 5) {
                String s2 = p_193516_3_[4];
                if (!advancement.func_192073_f().keySet().contains(s2)) {
                    throw new CommandException("commands.advancement.criterionNotFound", advancement.func_192067_g(), p_193516_3_[4]);
                }
                if (!p_193516_5_.func_193535_a(p_193516_4_, advancement, s2)) {
                    throw new CommandException(String.valueOf(p_193516_5_.field_193541_d) + ".criterion.failed", advancement.func_192067_g(), p_193516_4_.getName(), s2);
                }
                AdvancementCommand.notifyCommandListener(p_193516_2_, (ICommand)this, String.valueOf(p_193516_5_.field_193541_d) + ".criterion.success", advancement.func_192067_g(), p_193516_4_.getName(), s2);
                return;
            } else {
                if (p_193516_3_.length != 4) {
                    throw p_193516_6_.func_193544_a(p_193516_5_);
                ...
                int i2 = p_193516_5_.func_193532_a(p_193516_4_, list);
                if (i2 == 0) {
                    throw p_193516_6_.func_193543_a(p_193516_5_, advancement.func_192067_g(), p_193516_4_.getName());
                }
                p_193516_6_.func_193546_a(p_193516_2_, this, p_193516_5_, advancement.func_192067_g(), p_193516_4_.getName(), i2);
            }
        }
    }
    ...
    static enum ActionType {
        GRANT("grant"){
            ...
            protected boolean func_193537_a(EntityPlayerMP p_193537_1_, Advancement p_193537_2_) {
                ...
                for (String s2 : advancementprogress.func_192107_d()) {
                    p_193537_1_.func_192039_O().func_192750_a(p_193537_2_, s2);
                }
                return true;
            }
        ...
        REVOKE("revoke"){
            ...
            protected boolean func_193537_a(EntityPlayerMP p_193537_1_, Advancement p_193537_2_) {
                ...
                for (String s2 : advancementprogress.func_192102_e()) {
                    p_193537_1_.func_192039_O().func_192744_b(p_193537_2_, s2);
                }
                return true;
            }
    ...
    static enum Mode {
        ...
        static {
            ...
            for (int i2 = 0; i2 < Mode.values().length; ++i2) {
                Mode.field_193553_f[i2] = Mode.values()[i2].field_193554_g;
            }
        }
