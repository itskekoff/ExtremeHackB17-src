...
extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args.length != 1 && args.length != 2) {
            ...
            if (entity.world != null) {
                int j2 = 4096;
                int k2 = i2 + 1;
                CommandBase.CoordinateArg commandbase$coordinatearg = CommandTP.parseCoordinate(entity.posX, args[i2], true);
                CommandBase.CoordinateArg commandbase$coordinatearg1 = CommandTP.parseCoordinate(entity.posY, args[k2++], -4096, 4096, false);
                CommandBase.CoordinateArg commandbase$coordinatearg2 = CommandTP.parseCoordinate(entity.posZ, args[k2++], true);
                CommandBase.CoordinateArg commandbase$coordinatearg3 = CommandTP.parseCoordinate(entity.rotationYaw, args.length > k2 ? args[k2++] : "~", false);
                CommandBase.CoordinateArg commandbase$coordinatearg4 = CommandTP.parseCoordinate(entity.rotationPitch, args.length > k2 ? args[k2] : "~", false);
    ...
    private static void teleportEntityToCoordinates(Entity p_189863_0_, CommandBase.CoordinateArg p_189863_1_, CommandBase.CoordinateArg p_189863_2_, CommandBase.CoordinateArg p_189863_3_, CommandBase.CoordinateArg p_189863_4_, CommandBase.CoordinateArg p_189863_5_) {
        if (p_189863_0_ instanceof EntityPlayerMP) {
            ...
            float f2 = (float)p_189863_4_.getAmount();
            if (!p_189863_4_.isRelative()) {
            ...
            ((EntityPlayerMP)p_189863_0_).connection.setPlayerLocation(p_189863_1_.getAmount(), p_189863_2_.getAmount(), p_189863_3_.getAmount(), f2, f1, set);
