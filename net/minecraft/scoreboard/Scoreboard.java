...
public class Scoreboard {
    ...
    public void removeObjective(ScoreObjective objective) {
        ...
        for (int i2 = 0; i2 < 19; ++i2) {
            if (this.getObjectiveInDisplaySlot(i2) != objective) continue;
    ...
    public void removeTeam(ScorePlayerTeam playerTeam) {
        ...
        for (String s2 : playerTeam.getMembershipCollection()) {
    ...
    public static String getObjectiveDisplaySlot(int id2) {
        ...
        if (id2 >= 3 && id2 <= 18 && (textformatting = TextFormatting.fromColorIndex(id2 - 3)) != null && textformatting != TextFormatting.RESET) {
    ...
    public static int getObjectiveDisplaySlotNumber(String name) {
        ...
        if (name.startsWith("sidebar.team.") && (textformatting = TextFormatting.getValueByName(s2 = name.substring("sidebar.team.".length()))) != null && textformatting.getColorIndex() >= 0) {
    ...
    public static String[] getDisplaySlotStrings() {
        if (displaySlots == null) {
            ...
            for (int i2 = 0; i2 < 19; ++i2) {
                Scoreboard.displaySlots[i2] = Scoreboard.getObjectiveDisplaySlot(i2);
            }
        }
        return displaySlots;
    }
    ...
    public void removeEntity(Entity entityIn) {
        if (entityIn != null && !(entityIn instanceof EntityPlayer) && !entityIn.isEntityAlive()) {
            String s2 = entityIn.getCachedUniqueIdString();
