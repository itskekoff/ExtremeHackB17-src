...
extends Scoreboard {
    ...
    protected void markSaveDataDirty() {
        Runnable[] arrrunnable = this.dirtyRunnables;
        int n2 = this.dirtyRunnables.length;
    ...
    public List<Packet<?>> getCreatePackets(ScoreObjective objective) {
        ...
        for (int i2 = 0; i2 < 19; ++i2) {
            ...
            list.add(new SPacketDisplayObjective(i2, objective));
        }
    ...
    public List<Packet<?>> getDestroyPackets(ScoreObjective p_96548_1_) {
        ...
        for (int i2 = 0; i2 < 19; ++i2) {
            ...
            list.add(new SPacketDisplayObjective(i2, p_96548_1_));
        }
        return list;
    }
