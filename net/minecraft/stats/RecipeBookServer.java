...
extends RecipeBook {
    ...
    public void func_192825_a(NBTTagCompound p_192825_1_) {
        ...
        for (int i2 = 0; i2 < nbttaglist.tagCount(); ++i2) {
            ResourceLocation resourcelocation = new ResourceLocation(nbttaglist.getStringTagAt(i2));
        ...
        for (int j2 = 0; j2 < nbttaglist1.tagCount(); ++j2) {
            ResourceLocation resourcelocation1 = new ResourceLocation(nbttaglist1.getStringTagAt(j2));
    ...
    private List<IRecipe> func_194079_d() {
        ArrayList<IRecipe> list = Lists.newArrayList();
        int i2 = this.field_194077_a.nextSetBit(0);
        while (i2 >= 0) {
            list.add(CraftingManager.field_193380_a.getObjectById(i2));
            i2 = this.field_194077_a.nextSetBit(i2 + 1);
        }
        return list;
    }
    ...
    private List<IRecipe> func_194080_e() {
        ArrayList<IRecipe> list = Lists.newArrayList();
        int i2 = this.field_194078_b.nextSetBit(0);
        while (i2 >= 0) {
            list.add(CraftingManager.field_193380_a.getObjectById(i2));
            i2 = this.field_194078_b.nextSetBit(i2 + 1);
        }
        return list;
    }
