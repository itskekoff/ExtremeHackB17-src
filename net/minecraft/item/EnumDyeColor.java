...
public enum EnumDyeColor implements IStringSerializable
{
    ...
    static {
        ...
        int n2 = arrenumDyeColor.length;
        for (int i2 = 0; i2 < n2; ++i2) {
            EnumDyeColor enumdyecolor;
            EnumDyeColor.META_LOOKUP[enumdyecolor.getMetadata()] = enumdyecolor = arrenumDyeColor[i2];
    ...
    private EnumDyeColor(int p_i47505_3_, int p_i47505_4_, String p_i47505_5_, String p_i47505_6_, int p_i47505_7_, TextFormatting p_i47505_8_) {
        ...
        int i2 = (p_i47505_7_ & 0xFF0000) >> 16;
        int j2 = (p_i47505_7_ & 0xFF00) >> 8;
        int k2 = (p_i47505_7_ & 0xFF) >> 0;
        this.field_193352_x = new float[]{(float)i2 / 255.0f, (float)j2 / 255.0f, (float)k2 / 255.0f};
    }
