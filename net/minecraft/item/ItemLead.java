...
extends Item {
    ...
    public static boolean attachToFence(EntityPlayer player, World worldIn, BlockPos fence) {
        ...
        int j2 = fence.getY();
        int k2 = fence.getZ();
        for (EntityLiving entityliving : worldIn.getEntitiesWithinAABB(EntityLiving.class, new AxisAlignedBB((double)i2 - 7.0, (double)j2 - 7.0, (double)k2 - 7.0, (double)i2 + 7.0, (double)j2 + 7.0, (double)k2 + 7.0))) {
