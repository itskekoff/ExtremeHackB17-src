...
extends Item {
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        String s2 = I18n.translateToLocal(String.valueOf(this.getUnlocalizedName()) + ".name").trim();
        String s1 = EntityList.func_191302_a(ItemMonsterPlacer.func_190908_h(stack));
        if (s1 != null) {
            s2 = String.valueOf(s2) + " " + I18n.translateToLocal("entity." + s1 + ".name");
        }
        return s2;
    }
    ...
    @Nullable
    public static Entity spawnCreature(World worldIn, @Nullable ResourceLocation entityID, double x2, double y2, double z2) {
        if (entityID != null && EntityList.ENTITY_EGGS.containsKey(entityID)) {
            ...
            for (int i2 = 0; i2 < 1; ++i2) {
                ...
                entity.setLocationAndAngles(x2, y2, z2, MathHelper.wrapDegrees(worldIn.rand.nextFloat() * 360.0f), 0.0f);
