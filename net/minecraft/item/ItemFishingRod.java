...
extends Item {
    public ItemFishingRod() {
        ...
        this.addPropertyOverride(new ResourceLocation("cast"), new IItemPropertyGetter(){
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
                ...
                boolean bl2 = flag1 = entityIn.getHeldItemOffhand() == stack;
    ...
    public ActionResult<ItemStack> onItemRightClick(World itemStackIn, EntityPlayer worldIn, EnumHand playerIn) {
        ...
        if (worldIn.fishEntity != null) {
            int i2 = worldIn.fishEntity.handleHookRetraction();
            itemstack.damageItem(i2, worldIn);
            ...
            if (!itemStackIn.isRemote) {
                ...
                int j2 = EnchantmentHelper.func_191528_c(itemstack);
                if (j2 > 0) {
                    entityfishhook.func_191516_a(j2);
                }
                if ((k2 = EnchantmentHelper.func_191529_b(itemstack)) > 0) {
                    entityfishhook.func_191517_b(k2);
                }
