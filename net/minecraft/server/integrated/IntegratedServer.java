...
extends MinecraftServer {
    ...
    public void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, String generatorOptions) {
        ...
        if (Reflector.DimensionManager.exists()) {
            ...
            for (int l2 = 0; l2 < this.worldServers.length; ++l2) {
                ...
                if (l2 == 0) {
                    this.worldServers[l2] = this.isDemo() ? (WorldServer)new WorldServerDemo(this, isavehandler, worldinfo, i1, this.theProfiler).init() : (WorldServer)new WorldServerOF(this, isavehandler, worldinfo, i1, this.theProfiler).init();
                ...
                this.worldServers[l2].addEventListener(new ServerWorldEventHandler(this, this.worldServers[l2]));
            }
    ...
    public void tick() {
        ...
        boolean bl2 = this.isGamePaused = Minecraft.getMinecraft().getConnection() != null && Minecraft.getMinecraft().isGamePaused();
        ...
        report.getCategory().setDetail("Is Modded", new ICrashReportDetail<String>(){
            ...
            public String call() throws Exception {
                ...
                if (!"vanilla".equals(s2)) {
                    return "Definitely; Server brand changed to '" + s2 + "'";
                }
    ...
    public String shareToLAN(GameType type, boolean allowCheats) {
        try {
            ...
            LOGGER.info("Started on {}", (Object)i2);
            this.isPublic = true;
