...
public class PlayerProfileCache {
    ...
    private void addEntry(GameProfile gameProfile, Date expirationDate) {
        ...
        String s2 = gameProfile.getName().toLowerCase(Locale.ROOT);
    ...
    public GameProfile getGameProfileForUsername(String username) {
        String s2 = username.toLowerCase(Locale.ROOT);
        ProfileEntry playerprofilecache$profileentry = this.usernameToProfileEntryMap.get(s2);
        ...
        if (playerprofilecache$profileentry != null) {
            ...
            GameProfile gameprofile1 = PlayerProfileCache.lookupProfile(this.profileRepo, s2);
            if (gameprofile1 != null) {
                this.addEntry(gameprofile1);
                playerprofilecache$profileentry = this.usernameToProfileEntryMap.get(s2);
            }
        }
        this.save();
     ...
     */
    public void save() {
        String s2 = this.gson.toJson(this.getEntriesWithLimit(1000));
        ...
        public ProfileEntry deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            if (p_deserialize_1_.isJsonObject()) {
                ...
                if (jsonelement != null && jsonelement1 != null) {
                    String s2 = jsonelement1.getAsString();
