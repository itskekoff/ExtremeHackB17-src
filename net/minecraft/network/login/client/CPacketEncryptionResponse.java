...
implements Packet<INetHandlerLoginServer> {
    ...
    public void readPacketData(PacketBuffer buf2) throws IOException {
        this.secretKeyEncrypted = buf2.readByteArray();
        this.verifyTokenEncrypted = buf2.readByteArray();
    }

    @Override
    public void writePacketData(PacketBuffer buf2) throws IOException {
        buf2.writeByteArray(this.secretKeyEncrypted);
        buf2.writeByteArray(this.verifyTokenEncrypted);
    }
