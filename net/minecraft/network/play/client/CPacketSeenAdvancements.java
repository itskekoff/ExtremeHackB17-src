...
implements Packet<INetHandlerPlayServer> {
    ...
    public void readPacketData(PacketBuffer buf2) throws IOException {
        this.field_194166_a = buf2.readEnumValue(Action.class);
        if (this.field_194166_a == Action.OPENED_TAB) {
            this.field_194167_b = buf2.func_192575_l();
        }
    }

    @Override
    public void writePacketData(PacketBuffer buf2) throws IOException {
        buf2.writeEnumValue(this.field_194166_a);
        if (this.field_194166_a == Action.OPENED_TAB) {
            buf2.func_192572_a(this.field_194167_b);
        }
    }
