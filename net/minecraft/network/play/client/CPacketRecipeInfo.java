...
implements Packet<INetHandlerPlayServer> {
    ...
    public void readPacketData(PacketBuffer buf2) throws IOException {
        this.field_194157_a = buf2.readEnumValue(Purpose.class);
        if (this.field_194157_a == Purpose.SHOWN) {
            this.field_193649_d = CraftingManager.func_193374_a(buf2.readInt());
        } else if (this.field_194157_a == Purpose.SETTINGS) {
            this.field_192631_e = buf2.readBoolean();
            this.field_192632_f = buf2.readBoolean();
        }
    }

    @Override
    public void writePacketData(PacketBuffer buf2) throws IOException {
        buf2.writeEnumValue(this.field_194157_a);
        if (this.field_194157_a == Purpose.SHOWN) {
            buf2.writeInt(CraftingManager.func_193375_a(this.field_193649_d));
        } else if (this.field_194157_a == Purpose.SETTINGS) {
            buf2.writeBoolean(this.field_192631_e);
            buf2.writeBoolean(this.field_192632_f);
        }
    }
