...
implements Packet<INetHandlerPlayClient> {
    ...
    public void readPacketData(PacketBuffer buf2) throws IOException {
        this.sound = SoundEvent.REGISTRY.getObjectById(buf2.readVarIntFromBuffer());
        this.category = buf2.readEnumValue(SoundCategory.class);
        this.posX = buf2.readInt();
        this.posY = buf2.readInt();
        this.posZ = buf2.readInt();
        this.soundVolume = buf2.readFloat();
        this.soundPitch = buf2.readFloat();
    }

    @Override
    public void writePacketData(PacketBuffer buf2) throws IOException {
        buf2.writeVarIntToBuffer(SoundEvent.REGISTRY.getIDForObject(this.sound));
        buf2.writeEnumValue(this.category);
        buf2.writeInt(this.posX);
        buf2.writeInt(this.posY);
        buf2.writeInt(this.posZ);
        buf2.writeFloat(this.soundVolume);
        buf2.writeFloat(this.soundPitch);
    }
