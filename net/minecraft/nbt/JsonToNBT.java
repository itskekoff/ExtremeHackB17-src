...
public class JsonToNBT {
    ...
    protected NBTBase func_193611_c() throws NBTException {
        ...
        String s2 = this.func_193614_i();
        if (s2.isEmpty()) {
            throw this.func_193602_b("Expected value");
        }
        return this.func_193596_c(s2);
    }
        ...
        while (this.func_193612_g()) {
            ...
            if (flag) {
                ...
                if (c0 == '\\') {
                    ...
                    stringbuilder = new StringBuilder(this.field_193622_h.substring(i2, this.field_193623_i - 1));
                    continue;
                }
                if (c0 == '\"') {
                    return stringbuilder == null ? this.field_193622_h.substring(i2, this.field_193623_i - 1) : stringbuilder.toString();
                }
            }
            if (stringbuilder == null) continue;
    ...
    private String func_193614_i() {
        ...
        return this.field_193622_h.substring(i2, this.field_193623_i);
    }
    ...
    protected NBTTagCompound func_193593_f() throws NBTException {
        ...
        while (this.func_193612_g() && this.func_193598_n() != '}') {
            String s2 = this.func_193601_b();
            if (s2.isEmpty()) {
                throw this.func_193602_b("Expected non-empty key");
            }
            this.func_193604_b(':');
            nbttagcompound.setTag(s2, this.func_193610_d());
    ...
    private NBTBase func_193600_j() throws NBTException {
        ...
        while (this.func_193598_n() != ']') {
            ...
            byte j2 = nbtbase.getId();
            if (i2 < 0) {
                i2 = j2;
            } else if (j2 != i2) {
                throw this.func_193602_b("Unable to insert " + NBTBase.func_193581_j(j2) + " into ListTag of type " + NBTBase.func_193581_j(i2));
            }
    ...
    private <T extends Number> List<T> func_193603_a(byte p_193603_1_, byte p_193603_2_) throws NBTException {
        ...
        while (this.func_193598_n() != ']') {
            NBTBase nbtbase = this.func_193610_d();
            byte i2 = nbtbase.getId();
            if (i2 != p_193603_2_) {
                throw this.func_193602_b("Unable to insert " + NBTBase.func_193581_j(i2) + " into " + NBTBase.func_193581_j(p_193603_1_));
            }
            if (p_193603_2_ == 1) {
