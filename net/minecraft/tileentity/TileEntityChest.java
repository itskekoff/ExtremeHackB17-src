...
implements ITickable {
    ...
    public void update() {
        ...
        ++this.ticksSinceSync;
        if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + i2 + j2 + k2) % 200 == 0) {
            this.numPlayersUsing = 0;
            float f2 = 5.0f;
            for (EntityPlayer entityplayer : this.world.getEntitiesWithinAABB(EntityPlayer.class, new AxisAlignedBB((float)i2 - 5.0f, (float)j2 - 5.0f, (float)k2 - 5.0f, (float)(i2 + 1) + 5.0f, (float)(j2 + 1) + 5.0f, (float)(k2 + 1) + 5.0f))) {
        ...
        if (this.numPlayersUsing > 0 && this.lidAngle == 0.0f && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null) {
            ...
            this.world.playSound(null, d1, (double)j2 + 0.5, d2, SoundEvents.BLOCK_CHEST_OPEN, SoundCategory.BLOCKS, 0.5f, this.world.rand.nextFloat() * 0.1f + 0.9f);
        }
        if (this.numPlayersUsing == 0 && this.lidAngle > 0.0f || this.numPlayersUsing > 0 && this.lidAngle < 1.0f) {
            ...
            if (this.lidAngle < 0.5f && f2 >= 0.5f && this.adjacentChestZNeg == null && this.adjacentChestXNeg == null) {
                ...
                this.world.playSound(null, d3, (double)j2 + 0.5, d0, SoundEvents.BLOCK_CHEST_CLOSE, SoundCategory.BLOCKS, 0.5f, this.world.rand.nextFloat() * 0.1f + 0.9f);
            }
