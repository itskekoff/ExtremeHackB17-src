...
implements ITickable {
    ...
    public void update() {
        ...
        if (this.numPlayersUsing > 0 && this.lidAngle == 0.0f) {
            ...
            this.world.playSound(null, d0, (double)j2 + 0.5, d1, SoundEvents.BLOCK_ENDERCHEST_OPEN, SoundCategory.BLOCKS, 0.5f, this.world.rand.nextFloat() * 0.1f + 0.9f);
        }
        if (this.numPlayersUsing == 0 && this.lidAngle > 0.0f || this.numPlayersUsing > 0 && this.lidAngle < 1.0f) {
            ...
            float f1 = 0.5f;
            if (this.lidAngle < 0.5f && f22 >= 0.5f) {
                double d3 = (double)i2 + 0.5;
                double d2 = (double)k2 + 0.5;
                this.world.playSound(null, d3, (double)j2 + 0.5, d2, SoundEvents.BLOCK_ENDERCHEST_CLOSE, SoundCategory.BLOCKS, 0.5f, this.world.rand.nextFloat() * 0.1f + 0.9f);
            }
