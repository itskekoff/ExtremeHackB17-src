...
implements ITickable {
    private final MobSpawnerBaseLogic spawnerLogic = new MobSpawnerBaseLogic(){
        ...
        public void broadcastEvent(int id2) {
            TileEntityMobSpawner.this.world.addBlockEvent(TileEntityMobSpawner.this.pos, Blocks.MOB_SPAWNER, id2, 0);
        }
    ...
    public boolean receiveClientEvent(int id2, int type) {
        return this.spawnerLogic.setDelayToMin(id2) ? true : super.receiveClientEvent(id2, type);
    }
