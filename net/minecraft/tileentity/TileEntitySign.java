...
extends TileEntity {
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound compound) {
        ...
        for (int i2 = 0; i2 < 4; ++i2) {
            String s2 = ITextComponent.Serializer.componentToJson(this.signText[i2]);
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        for (int i2 = 0; i2 < 4; ++i2) {
            ...
            ITextComponent itextcomponent = ITextComponent.Serializer.jsonToComponent(s2);
            try {
                this.signText[i2] = TextComponentUtils.processComponent(icommandsender, itextcomponent, null);
                continue;
            }
            catch (CommandException var7) {
                this.signText[i2] = itextcomponent;
            }
        }
    ...
    public boolean executeCommand(final EntityPlayer playerIn) {
        ...
        ITextComponent[] arriTextComponent = this.signText;
        int n2 = this.signText.length;
        for (int i2 = 0; i2 < n2; ++i2) {
            ClickEvent clickevent;
            Style style;
            ITextComponent itextcomponent = arriTextComponent[i2];
