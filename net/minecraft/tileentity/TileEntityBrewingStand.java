...
ISidedInventory {
    ...
    public boolean[] createFilledSlotsArray() {
        ...
        for (int i2 = 0; i2 < 3; ++i2) {
            if (this.brewingItemStacks.get(i2).func_190926_b()) continue;
            aboolean[i2] = true;
        }
        return aboolean;
    }
    ...
    private boolean canBrew() {
        ...
        for (int i2 = 0; i2 < 3; ++i2) {
            ItemStack itemstack1 = this.brewingItemStacks.get(i2);
    ...
    private void brewPotions() {
        ItemStack itemstack = this.brewingItemStacks.get(3);
        for (int i2 = 0; i2 < 3; ++i2) {
            this.brewingItemStacks.set(i2, PotionHelper.doReaction(itemstack, this.brewingItemStacks.get(i2)));
        }
        itemstack.func_190918_g(1);
