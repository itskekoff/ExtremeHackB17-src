...
extends TileEntity {
    ...
    private final CommandBlockBaseLogic commandBlockLogic = new CommandBlockBaseLogic(){
        ...
        @Override
        public void fillInInfo(ByteBuf buf2) {
            buf2.writeInt(TileEntityCommandBlock.this.pos.getX());
            buf2.writeInt(TileEntityCommandBlock.this.pos.getY());
            buf2.writeInt(TileEntityCommandBlock.this.pos.getZ());
        }
