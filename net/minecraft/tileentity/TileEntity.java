...
public abstract class TileEntity {
    ...
    public static TileEntity create(World worldIn, NBTTagCompound compound) {
        ...
        try {
            Class<? extends TileEntity> oclass = field_190562_f.getObject(new ResourceLocation(s2));
            if (oclass != null) {
                tileentity = oclass.newInstance();
            }
        }
        catch (Throwable throwable1) {
            LOGGER.error("Failed to create block entity {}", (Object)s2, (Object)throwable1);
        }
        if (tileentity != null) {
            try {
    ...
    public void addInfoToCrashReport(CrashReportCategory reportCategory) {
        ...
        if (this.world != null) {
            ...
            reportCategory.setDetail("Actual block type", new ICrashReportDetail<String>(){
                ...
                @Override
                public String call() throws Exception {
                    int i2 = Block.getIdFromBlock(TileEntity.this.world.getBlockState(TileEntity.this.pos).getBlock());
                    try {
