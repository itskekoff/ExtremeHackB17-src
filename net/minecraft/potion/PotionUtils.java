...
public class PotionUtils {
    ...
    public static int getPotionColorFromEffectList(Collection<PotionEffect> effects) {
        ...
        for (PotionEffect potioneffect : effects) {
            ...
            int k2 = potioneffect.getPotion().getLiquidColor();
            if (Config.isCustomColors()) {
                k2 = CustomColors.getPotionColor(potioneffect.getPotion(), k2);
            }
            int l2 = potioneffect.getAmplifier() + 1;
    ...
    public static void addPotionTooltip(ItemStack itemIn, List<String> lores, float durationFactor) {
        ...
        if (list.isEmpty()) {
            String string = I18n.translateToLocal("effect.none").trim();
            lores.add((Object)((Object)TextFormatting.GRAY) + string);
        } else {
