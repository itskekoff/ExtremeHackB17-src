...
implements Comparable<PotionEffect> {
    ...
    public String toString() {
        String s2 = this.amplifier > 0 ? String.valueOf(this.getEffectName()) + " x " + (this.amplifier + 1) + ", Duration: " + this.duration : String.valueOf(this.getEffectName()) + ", Duration: " + this.duration;
        if (this.isSplashPotion) {
            s2 = String.valueOf(s2) + ", Splash: true";
        }
        if (!this.showParticles) {
            s2 = String.valueOf(s2) + ", Particles: false";
        }
        return s2;
    }
    ...
    public int hashCode() {
        int i2 = this.potion.hashCode();
        i2 = 31 * i2 + this.duration;
        i2 = 31 * i2 + this.amplifier;
        i2 = 31 * i2 + (this.isSplashPotion ? 1 : 0);
        i2 = 31 * i2 + (this.isAmbient ? 1 : 0);
        return i2;
    }
    ...
    public static PotionEffect readCustomPotionEffectFromNBT(NBTTagCompound nbt) {
        ...
        Potion potion = Potion.getPotionById(i2);
        if (potion == null) {
            return null;
        }
        ...
        return new PotionEffect(potion, k2, j2 < 0 ? (byte)0 : j2, flag, flag1);
    }
