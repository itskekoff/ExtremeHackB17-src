...
public class AdvancementTreeNode {
    ...
    private void func_192320_a() {
        if (this.field_192332_e.isEmpty()) {
            ...
            this.func_192325_b();
            float f2 = (this.field_192332_e.get((int)0).field_192336_i + this.field_192332_e.get((int)(this.field_192332_e.size() - 1)).field_192336_i) / 2.0f;
            if (this.field_192330_c != null) {
                this.field_192336_i = this.field_192330_c.field_192336_i + 1.0f;
                this.field_192337_j = this.field_192336_i - f2;
            } else {
                this.field_192336_i = f2;
            }
        }
    }
    ...
    private void func_192325_b() {
        float f2 = 0.0f;
        float f1 = 0.0f;
        for (int i2 = this.field_192332_e.size() - 1; i2 >= 0; --i2) {
            AdvancementTreeNode advancementtreenode = this.field_192332_e.get(i2);
            advancementtreenode.field_192336_i += f2;
            advancementtreenode.field_192337_j += f2;
            f2 += advancementtreenode.field_192339_l + (f1 += advancementtreenode.field_192338_k);
        }
    }
    ...
    private AdvancementTreeNode func_192324_a(AdvancementTreeNode p_192324_1_) {
        ...
        float f22 = advancementtreenode2.field_192337_j;
        ...
        while (advancementtreenode2.func_192317_d() != null && advancementtreenode.func_192321_c() != null) {
            ...
            float f4 = advancementtreenode2.field_192336_i + f22 - (advancementtreenode.field_192336_i + f2) + 1.0f;
            if (f4 > 0.0f) {
                advancementtreenode2.func_192326_a(this, p_192324_1_).func_192316_a(this, f4);
                f2 += f4;
                f1 += f4;
            }
            f22 += advancementtreenode2.field_192337_j;
            f2 += advancementtreenode.field_192337_j;
        ...
        if (advancementtreenode2.func_192317_d() != null && advancementtreenode1.func_192317_d() == null) {
            ...
            advancementtreenode1.field_192337_j += f22 - f1;
        } else {
            if (advancementtreenode.func_192321_c() != null && advancementtreenode3.func_192321_c() == null) {
                ...
                advancementtreenode3.field_192337_j += f2 - f3;
            }
            p_192324_1_ = this;
        }
        return p_192324_1_;
    ...
    private void func_192316_a(AdvancementTreeNode p_192316_1_, float p_192316_2_) {
        float f2 = p_192316_1_.field_192331_d - this.field_192331_d;
        if (f2 != 0.0f) {
            p_192316_1_.field_192338_k -= p_192316_2_ / f2;
            this.field_192338_k += p_192316_2_ / f2;
        }
    ...
    public static void func_192323_a(Advancement p_192323_0_) {
        ...
        float f2 = advancementtreenode.func_192319_a(0.0f, 0, advancementtreenode.field_192336_i);
        if (f2 < 0.0f) {
            advancementtreenode.func_192318_a(-f2);
        }
        advancementtreenode.func_192327_e();
    }
}
