...
implements Comparable<AdvancementProgress> {
    ...
    public void func_192099_a(Map<String, Criterion> p_192099_1_, String[][] p_192099_2_) {
        ...
        for (String s2 : set) {
            if (this.field_192110_a.containsKey(s2)) continue;
            this.field_192110_a.put(s2, new CriterionProgress(this));
        }
    ...
    public boolean func_192105_a() {
        ...
        String[][] arrstring = this.field_192111_b;
        int n2 = this.field_192111_b.length;
        for (int i2 = 0; i2 < n2; ++i2) {
            ...
            for (int i3 = 0; i3 < n3; ++i3) {
                ...
                CriterionProgress criterionprogress = this.func_192106_c(s2);
    ...
    public static AdvancementProgress func_192100_b(PacketBuffer p_192100_0_) {
        ...
        int i2 = p_192100_0_.readVarIntFromBuffer();
    ...
    public float func_192103_c() {
        ...
        float f2 = this.field_192111_b.length;
    ...
    public String func_193126_d() {
        ...
        int i2 = this.field_192111_b.length;
        if (i2 <= 1) {
            return null;
        }
        int j2 = this.func_194032_h();
    ...
    private int func_194032_h() {
        ...
        for (int i3 = 0; i3 < n2; ++i3) {
            String[] astring = arrstring[i3];
            boolean flag = false;
            String[] arrstring2 = astring;
            int n3 = astring.length;
            for (int i4 = 0; i4 < n3; ++i4) {
                String s2 = arrstring2[i4];
                CriterionProgress criterionprogress = this.func_192106_c(s2);
                if (criterionprogress == null || !criterionprogress.func_192151_a()) continue;
                flag = true;
                break;
    ...
    JsonSerializer<AdvancementProgress> {
        ...
        public AdvancementProgress deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            for (Map.Entry<String, JsonElement> entry : jsonobject1.entrySet()) {
                ...
                advancementprogress.field_192110_a.put(s2, CriterionProgress.func_192152_a(advancementprogress, JsonUtils.getString(entry.getValue(), s2)));
            }
            return advancementprogress;
        }
    }
