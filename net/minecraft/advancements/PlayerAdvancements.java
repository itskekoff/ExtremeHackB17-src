...
public class PlayerAdvancements {
    ...
    private void func_192740_f() {
        if (this.field_192757_e.isFile()) {
            try {
                String s2 = Files.toString(this.field_192757_e, StandardCharsets.UTF_8);
                Map map = (Map)JsonUtils.func_193840_a(field_192754_b, s2, field_192755_c.getType());
                if (map == null) {
    ...
    private boolean func_192738_c(Advancement p_192738_1_) {
        for (int i2 = 0; p_192738_1_ != null && i2 <= 2; p_192738_1_ = p_192738_1_.func_192070_b(), ++i2) {
            if (i2 == 0 && this.func_192746_d(p_192738_1_)) {
                return true;
            }
