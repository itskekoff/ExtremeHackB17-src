...
public class AdvancementRewards {
    ...
    public void func_192113_a(final EntityPlayerMP p_192113_1_) {
        ...
        boolean flag = false;
        ResourceLocation[] arrresourceLocation = this.field_192116_c;
        int n2 = this.field_192116_c.length;
    ...
    implements JsonDeserializer<AdvancementRewards> {
        ...
        public AdvancementRewards deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            int i2 = JsonUtils.getInt(jsonobject, "experience", 0);
            ...
            for (int j2 = 0; j2 < aresourcelocation.length; ++j2) {
                aresourcelocation[j2] = new ResourceLocation(JsonUtils.getString(jsonarray.get(j2), "loot[" + j2 + "]"));
            }
            ...
            for (int k2 = 0; k2 < aresourcelocation1.length; ++k2) {
                aresourcelocation1[k2] = new ResourceLocation(JsonUtils.getString(jsonarray1.get(k2), "recipes[" + k2 + "]"));
                IRecipe irecipe = CraftingManager.func_193373_a(aresourcelocation1[k2]);
                if (irecipe != null) continue;
                throw new JsonSyntaxException("Unknown recipe '" + aresourcelocation1[k2] + "'");
            }
            ...
            return new AdvancementRewards(i2, aresourcelocation, aresourcelocation1, functionobject$cacheablefunction);
        }
    }
}
