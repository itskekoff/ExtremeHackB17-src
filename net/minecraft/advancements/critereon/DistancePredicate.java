...
public class DistancePredicate {
    ...
    public boolean func_193422_a(double p_193422_1_, double p_193422_3_, double p_193422_5_, double p_193422_7_, double p_193422_9_, double p_193422_11_) {
        float f2 = (float)(p_193422_1_ - p_193422_7_);
        float f1 = (float)(p_193422_3_ - p_193422_9_);
        float f22 = (float)(p_193422_5_ - p_193422_11_);
        if (this.field_193424_b.func_192514_a(MathHelper.abs(f2)) && this.field_193425_c.func_192514_a(MathHelper.abs(f1)) && this.field_193426_d.func_192514_a(MathHelper.abs(f22))) {
            if (!this.field_193427_e.func_192513_a(f2 * f2 + f22 * f22)) {
                return false;
            }
            return this.field_193428_f.func_192513_a(f2 * f2 + f1 * f1 + f22 * f22);
        }
        return false;
    }
