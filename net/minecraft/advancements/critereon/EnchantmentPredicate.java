...
public class EnchantmentPredicate {
    ...
    public boolean func_192463_a(Map<Enchantment, Integer> p_192463_1_) {
        if (this.field_192467_b != null) {
            ...
            int i2 = p_192463_1_.get(this.field_192467_b);
            if (this.field_192468_c != null && !this.field_192468_c.func_192514_a(i2)) {
                return false;
            }
    ...
    public static EnchantmentPredicate[] func_192465_b(@Nullable JsonElement p_192465_0_) {
        if (p_192465_0_ != null && !p_192465_0_.isJsonNull()) {
            ...
            for (int i2 = 0; i2 < aenchantmentpredicate.length; ++i2) {
                aenchantmentpredicate[i2] = EnchantmentPredicate.func_192464_a(jsonarray.get(i2));
            }
