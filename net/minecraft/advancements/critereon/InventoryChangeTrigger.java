...
implements ICriterionTrigger<Instance> {
    ...
    extends AbstractCriterionInstance {
        ...
        public boolean func_192265_a(InventoryPlayer p_192265_1_) {
            ...
            for (int l2 = 0; l2 < p_192265_1_.getSizeInventory(); ++l2) {
                ItemStack itemstack = p_192265_1_.getStackInSlot(l2);
            ...
            if (!this.field_192267_b.func_192514_a(i2)) {
                return false;
            }
            if (!this.field_192268_c.func_192514_a(j2)) {
                return false;
            }
            if (!this.field_192266_a.func_192514_a(k2)) {
                return false;
            }
            return list.isEmpty();
        }
