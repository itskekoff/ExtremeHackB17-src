...
public class ItemPredicate {
    ...
    public boolean func_192493_a(ItemStack p_192493_1_) {
        ...
        for (int i2 = 0; i2 < this.field_192499_e.length; ++i2) {
            if (this.field_192499_e[i2].func_192463_a(map)) continue;
            return false;
        }
    ...
    public static ItemPredicate[] func_192494_b(@Nullable JsonElement p_192494_0_) {
        if (p_192494_0_ != null && !p_192494_0_.isJsonNull()) {
            ...
            for (int i2 = 0; i2 < aitempredicate.length; ++i2) {
                aitempredicate[i2] = ItemPredicate.func_192492_a(jsonarray.get(i2));
            }
