...
public class LocationPredicate {
    ...
    public static LocationPredicate func_193454_a(@Nullable JsonElement p_193454_0_) {
        if (p_193454_0_ != null && !p_193454_0_.isJsonNull()) {
            ...
            String s2 = jsonobject.has("feature") ? JsonUtils.getString(jsonobject, "feature") : null;
            Biome biome = null;
            ...
            return new LocationPredicate(minmaxbounds, minmaxbounds1, minmaxbounds2, biome, s2, dimensiontype);
        }
