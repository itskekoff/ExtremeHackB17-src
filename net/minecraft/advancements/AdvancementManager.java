...
public class AdvancementManager {
    ...
    private Map<ResourceLocation, Advancement.Builder> func_192781_c() {
        ...
        for (File file1 : FileUtils.listFiles(this.field_192785_d, new String[]{"json"}, true)) {
            String s2 = FilenameUtils.removeExtension(this.field_192785_d.toURI().relativize(file1.toURI()).toString());
    ...
    private void func_192777_a(Map<ResourceLocation, Advancement.Builder> p_192777_1_) {
        block15: {
            block16: {
                block18: {
                    filesystem = null;
                    url = AdvancementManager.class.getResource("/assets/.mcassetsroot");
                    if (url == null) break block15;
                    uri = url.toURI();
                    if (!"file".equals(uri.getScheme())) break block18;
                    path = Paths.get(CraftingManager.class.getResource("/assets/minecraft/advancements").toURI());
                    ** GOTO lbl19
                }
                if ("jar".equals(uri.getScheme())) break block16;
...
lbl19:
            ...
            while (iterator.hasNext()) {
                ...
                try {
                    ...
                    advancement$builder = JsonUtils.func_193839_a(AdvancementManager.field_192783_b, bufferedreader, Advancement.Builder.class);
                    ...
                    try {
                        AdvancementManager.field_192782_a.error("Couldn't read advancement " + resourcelocation + " from " + path1, (Throwable)ioexception);
                        this.field_193768_e = true;
                        continue;
                    }
