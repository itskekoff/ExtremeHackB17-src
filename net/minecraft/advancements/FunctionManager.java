...
implements ITickable {
    ...
    @Override
    public void update() {
        String s2 = this.field_193069_c.worldServers[0].getGameRules().getString("gameLoopFunction");
        if (!s2.equals(this.field_193071_e)) {
            this.field_193071_e = s2;
            this.field_193072_f = this.func_193058_a(new ResourceLocation(s2));
        }
    ...
    public int func_194019_a(FunctionObject p_194019_1_, ICommandSender p_194019_2_) {
        int l2;
        int i2 = this.func_193065_c();
        if (this.field_194021_h) {
            if (this.field_194020_g.size() < i2) {
        ...
        try {
            ...
            for (int k2 = afunctionobject$entry.length - 1; k2 >= 0; --k2) {
                this.field_194020_g.push(new QueuedCommand(this, p_194019_2_, afunctionobject$entry[k2]));
            }
            do {
                ...
                this.field_194020_g.removeFirst().func_194222_a(this.field_194020_g, i2);
            } while (++j2 < i2);
            l2 = j2;
        }
        finally {
    ...
    private void func_193061_h() {
        if (this.field_193068_b != null) {
            ...
            for (File file1 : FileUtils.listFiles(this.field_193068_b, new String[]{"mcfunction"}, true)) {
                String s2 = FilenameUtils.removeExtension(this.field_193068_b.toURI().relativize(file1.toURI()).toString());
