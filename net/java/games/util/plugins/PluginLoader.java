...
extends URLClassLoader {
    ...
    public PluginLoader(File jf2) throws MalformedURLException {
        super(new URL[]{jf2.toURL()}, Thread.currentThread().getContextClassLoader());
        this.parentDir = jf2.getParentFile();
    ...
    public boolean attemptPluginDefine(Class pc2) {
        return !pc2.isInterface() && this.classImplementsPlugin(pc2);
    }
