...
extends WinTabComponent {
    ...
    protected WinTabCursorComponent(WinTabContext context, int parentDevice, String name, Component.Identifier id2, int index) {
        super(context, parentDevice, name, id2);
        this.index = index;
    }
