...
final class DIDeviceObject {
    ...
    public DIDeviceObject(IDirectInputDevice device, Component.Identifier id2, byte[] guid, int guid_type, int identifier, int type, int instance, int flags, String name, int format_offset) throws IOException {
        this.device = device;
        this.id = id2;
        this.guid = guid;
