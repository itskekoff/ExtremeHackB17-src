...
implements Controller {
    ...
    public final Component getComponent(Component.Identifier id2) {
        return (Component)this.id_to_components.get(id2);
    }
    ...
    public final void setEventQueueSize(int size) {
        try {
            ...
            ControllerEnvironment.logln("Failed to create new event queue of size " + size + ": " + e2);
        }
    }
    ...
    public synchronized boolean poll() {
        ...
        try {
            ...
            ControllerEnvironment.logln("Failed to poll device: " + e2.getMessage());
            return false;
        }
    }
}
