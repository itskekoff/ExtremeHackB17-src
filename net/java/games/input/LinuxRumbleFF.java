...
extends LinuxForceFeedbackEffect {
    ...
    protected final int upload(int id2, float intensity) throws IOException {
        int weak_magnitude;
        ...
        return this.getDevice().uploadRumbleEffect(id2, 0, 0, 0, -1, 0, strong_magnitude, weak_magnitude);
    }
}
