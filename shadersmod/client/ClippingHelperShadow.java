...
extends ClippingHelper {
    ...
    private void normalizePlane(float[] plane) {
        float f2 = MathHelper.sqrt(plane[0] * plane[0] + plane[1] * plane[1] + plane[2] * plane[2]);
        plane[0] = plane[0] / f2;
        plane[1] = plane[1] / f2;
        plane[2] = plane[2] / f2;
        plane[3] = plane[3] / f2;
    ...
    public void init() {
        ...
        float f2 = (float)this.dot3(this.frustum[0], afloat3);
        float f1 = (float)this.dot3(this.frustum[1], afloat3);
        float f22 = (float)this.dot3(this.frustum[2], afloat3);
