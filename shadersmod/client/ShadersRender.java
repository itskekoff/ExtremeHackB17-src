...
public class ShadersRender {
    ...
    public static void setFrustrumPosition(ICamera frustum, double x2, double y2, double z2) {
    ...
    public static void renderShadowMap(EntityRenderer entityRenderer, int pass, float partialTicks, long finishTimeNano) {
        if (Shaders.usedShadowDepthBuffers > 0 && --Shaders.shadowPassCounter <= 0) {
            ...
            int i2 = 0;
            i2 = entityRenderer.frameCount;
            entityRenderer.frameCount = i2 + 1;
            renderglobal.setupTerrain(entity, partialTicks, frustum, i2, minecraft.player.isSpectator());
    ...
    public static boolean renderEndPortal(TileEntityEndPortal te2, double x2, double y2, double z2, float partialTicks, int destroyStage, float offset) {
        ...
        int i2 = 240;
        if (te2.shouldRenderFace(EnumFacing.SOUTH)) {
            bufferbuilder.pos(x2, y2, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2 + 1.0, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2, y2 + 1.0, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i2, i2).endVertex();
        }
        if (te2.shouldRenderFace(EnumFacing.NORTH)) {
            bufferbuilder.pos(x2, y2 + 1.0, z2).color(f1, f22, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2 + 1.0, z2).color(f1, f22, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2, z2).color(f1, f22, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2, y2, z2).color(f1, f22, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i2, i2).endVertex();
        }
        if (te2.shouldRenderFace(EnumFacing.EAST)) {
            bufferbuilder.pos(x2 + 1.0, y2 + 1.0, z2).color(f1, f22, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2 + 1.0, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2, z2).color(f1, f22, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i2, i2).endVertex();
        }
        if (te2.shouldRenderFace(EnumFacing.WEST)) {
            bufferbuilder.pos(x2, y2, z2).color(f1, f22, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2, y2, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2, y2 + 1.0, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2, y2 + 1.0, z2).color(f1, f22, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i2, i2).endVertex();
        }
        if (te2.shouldRenderFace(EnumFacing.DOWN)) {
            bufferbuilder.pos(x2, y2, z2).color(f1, f22, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2, z2).color(f1, f22, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2, y2, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i2, i2).endVertex();
        }
        if (te2.shouldRenderFace(EnumFacing.UP)) {
            bufferbuilder.pos(x2, y2 + (double)offset, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f4 + f6, f4 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2 + (double)offset, z2 + 1.0).color(f1, f22, f3, 1.0f).tex(f4 + f6, f5 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2 + 1.0, y2 + (double)offset, z2).color(f1, f22, f3, 1.0f).tex(f5 + f6, f5 + f6).lightmap(i2, i2).endVertex();
            bufferbuilder.pos(x2, y2 + (double)offset, z2).color(f1, f22, f3, 1.0f).tex(f5 + f6, f4 + f6).lightmap(i2, i2).endVertex();
        }
        tessellator.draw();
