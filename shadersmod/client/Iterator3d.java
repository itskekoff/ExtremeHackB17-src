...
implements Iterator<BlockPos> {
    ...
    public Iterator3d(BlockPos posStart, BlockPos posEnd, int width, int height) {
        ...
        if (d5 >= d3 && d5 >= d1) {
            ...
            int k2 = posEnd.getZ() - posStart.getZ();
            double d9 = (double)(posEnd.getY() - posStart.getY()) / (1.0 * (double)k2);
            double d11 = (double)(posEnd.getX() - posStart.getX()) / (1.0 * (double)k2);
            ...
            int j2 = posEnd.getY() - posStart.getY();
            double d8 = (double)(posEnd.getX() - posStart.getX()) / (1.0 * (double)j2);
            double d10 = (double)(posEnd.getZ() - posStart.getZ()) / (1.0 * (double)j2);
            ...
            int i2 = posEnd.getX() - posStart.getX();
            double d6 = (double)(posEnd.getY() - posStart.getY()) / (1.0 * (double)i2);
            double d7 = (double)(posEnd.getZ() - posStart.getZ()) / (1.0 * (double)i2);
