...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(201, j1 / 4 - k1 / 2, height - 25, k1, j2, Lang.get("of.options.shaders.shadersFolder")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, String.valueOf(this.screenTitle) + " ", width / 2, 15, 0xFFFFFF);
        ...
        if (i2 < width - 5) {
            this.drawCenteredString(this.fontRendererObj, s2, width / 2, height - 40, 0x808080);
        } else {
