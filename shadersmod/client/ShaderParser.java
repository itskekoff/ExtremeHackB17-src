...
public class ShaderParser {
    ...
    public static int getIndex(String uniform, String prefix, int minIndex, int maxIndex) {
        ...
        int i2 = uniform.charAt(prefix.length()) - 48;
        return i2 >= minIndex && i2 <= maxIndex ? i2 : -1;
    }
    ...
    public static int getColorIndex(String uniform) {
        int i2 = ShaderParser.getIndex(uniform, "gaux", 1, 4);
        return i2 > 0 ? i2 + 3 : ShaderParser.getIndex(uniform, "colortex", 4, 7);
    }
