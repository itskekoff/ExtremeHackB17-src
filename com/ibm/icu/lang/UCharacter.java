...
UCharacterEnums.ECharacterDirection {
    ...
    public static int digit(int ch2, int radix) {
        if (2 <= radix && radix <= 36) {
            int value = UCharacter.digit(ch2);
            if (value < 0) {
                value = UCharacterProperty.getEuropeanDigit(ch2);
            }
    ...
    public static int digit(int ch2) {
        return UCharacterProperty.INSTANCE.digit(ch2);
    }

    public static int getNumericValue(int ch2) {
        return UCharacterProperty.INSTANCE.getNumericValue(ch2);
    }

    public static double getUnicodeNumericValue(int ch2) {
        return UCharacterProperty.INSTANCE.getUnicodeNumericValue(ch2);
    }

    public static boolean isSpace(int ch2) {
        return ch2 <= 32 && (ch2 == 32 || ch2 == 9 || ch2 == 10 || ch2 == 12 || ch2 == 13);
    }

    public static int getType(int ch2) {
        return UCharacterProperty.INSTANCE.getType(ch2);
    }

    public static boolean isDefined(int ch2) {
        return UCharacter.getType(ch2) != 0;
    }

    public static boolean isDigit(int ch2) {
        return UCharacter.getType(ch2) == 9;
    }

    public static boolean isISOControl(int ch2) {
        return ch2 >= 0 && ch2 <= 159 && (ch2 <= 31 || ch2 >= 127);
    }

    public static boolean isLetter(int ch2) {
        return (1 << UCharacter.getType(ch2) & 0x3E) != 0;
    }

    public static boolean isLetterOrDigit(int ch2) {
        return (1 << UCharacter.getType(ch2) & 0x23E) != 0;
    }
    ...
    public static boolean isLowerCase(int ch2) {
        return UCharacter.getType(ch2) == 2;
    }

    public static boolean isWhitespace(int ch2) {
        return (1 << UCharacter.getType(ch2) & 0x7000) != 0 && ch2 != 160 && ch2 != 8199 && ch2 != 8239 || ch2 >= 9 && ch2 <= 13 || ch2 >= 28 && ch2 <= 31;
    }

    public static boolean isSpaceChar(int ch2) {
        return (1 << UCharacter.getType(ch2) & 0x7000) != 0;
    }

    public static boolean isTitleCase(int ch2) {
        return UCharacter.getType(ch2) == 3;
    }

    public static boolean isUnicodeIdentifierPart(int ch2) {
        return (1 << UCharacter.getType(ch2) & 0x40077E) != 0 || UCharacter.isIdentifierIgnorable(ch2);
    }

    public static boolean isUnicodeIdentifierStart(int ch2) {
        return (1 << UCharacter.getType(ch2) & 0x43E) != 0;
    }

    public static boolean isIdentifierIgnorable(int ch2) {
        if (ch2 <= 159) {
            return !(!UCharacter.isISOControl(ch2) || ch2 >= 9 && ch2 <= 13 || ch2 >= 28 && ch2 <= 31);
        }
        return UCharacter.getType(ch2) == 16;
    }

    public static boolean isUpperCase(int ch2) {
        return UCharacter.getType(ch2) == 1;
    }

    public static int toLowerCase(int ch2) {
        return UCaseProps.INSTANCE.tolower(ch2);
    }

    public static String toString(int ch2) {
        if (ch2 < 0 || ch2 > 0x10FFFF) {
            return null;
        }
        if (ch2 < 65536) {
            return String.valueOf((char)ch2);
        }
        StringBuilder result = new StringBuilder();
        result.append(UTF16.getLeadSurrogate(ch2));
        result.append(UTF16.getTrailSurrogate(ch2));
        return result.toString();
    }

    public static int toTitleCase(int ch2) {
        return UCaseProps.INSTANCE.totitle(ch2);
    }

    public static int toUpperCase(int ch2) {
        return UCaseProps.INSTANCE.toupper(ch2);
    }

    public static boolean isSupplementary(int ch2) {
        return ch2 >= 65536 && ch2 <= 0x10FFFF;
    }

    public static boolean isBMP(int ch2) {
        return ch2 >= 0 && ch2 <= 65535;
    }

    public static boolean isPrintable(int ch2) {
        int cat2 = UCharacter.getType(ch2);
        return cat2 != 0 && cat2 != 15 && cat2 != 16 && cat2 != 17 && cat2 != 18 && cat2 != 0;
    }

    public static boolean isBaseForm(int ch2) {
        int cat2 = UCharacter.getType(ch2);
        return cat2 == 9 || cat2 == 11 || cat2 == 10 || cat2 == 1 || cat2 == 2 || cat2 == 3 || cat2 == 4 || cat2 == 5 || cat2 == 6 || cat2 == 7 || cat2 == 8;
    }

    public static int getDirection(int ch2) {
        return UBiDiProps.INSTANCE.getClass(ch2);
    }

    public static boolean isMirrored(int ch2) {
        return UBiDiProps.INSTANCE.isMirrored(ch2);
    }

    public static int getMirror(int ch2) {
        return UBiDiProps.INSTANCE.getMirror(ch2);
    }

    public static int getCombiningClass(int ch2) {
        return Norm2AllModes.getNFCInstance().decomp.getCombiningClass(ch2);
    }

    public static boolean isLegal(int ch2) {
        if (ch2 < 0) {
            return false;
        }
        if (ch2 < 55296) {
        ...
        if (UCharacterUtility.isNonCharacter(ch2)) {
            return false;
        }
        return ch2 <= 0x10FFFF;
    }
    ...
    public static String getName(int ch2) {
        return UCharacterName.INSTANCE.getName(ch2, 0);
    }
    ...
    public static String getName1_0(int ch2) {
        return null;
    }

    public static String getExtendedName(int ch2) {
        return UCharacterName.INSTANCE.getName(ch2, 2);
    }

    public static String getNameAlias(int ch2) {
        return UCharacterName.INSTANCE.getName(ch2, 3);
    }

    public static String getISOComment(int ch2) {
        return null;
    }
            ...
            if (prev < index) {
                ...
                if (titleStart < index) {
                    ...
                    while (true) {
                        ...
                        if (nc < 0) break;
                        if (isDutch && (nc == 74 || nc == 106) && c2 == 73 && FirstIJ) {
                            c2 = 74;
                            FirstIJ = false;
                            continue;
                        }
                        c2 = UCaseProps.INSTANCE.toFullLower(nc, iter, result, locale, locCache);
                    }
                }
            }
            prev = index;
    ...
    public static int foldCase(int ch2, boolean defaultmapping) {
        return UCharacter.foldCase(ch2, defaultmapping ? 0 : 1);
    }
    ...
    public static int foldCase(int ch2, int options) {
        return UCaseProps.INSTANCE.fold(ch2, options);
    }
    ...
    public static int getHanNumericValue(int ch2) {
        switch (ch2) {
            case 12295: 
            case 38646: {
                return 0;
    ...
    public static VersionInfo getAge(int ch2) {
        if (ch2 < 0 || ch2 > 0x10FFFF) {
            throw new IllegalArgumentException("Codepoint out of bounds");
        }
        return UCharacterProperty.INSTANCE.getAge(ch2);
    }

    public static boolean hasBinaryProperty(int ch2, int property) {
        return UCharacterProperty.INSTANCE.hasBinaryProperty(ch2, property);
    }

    public static boolean isUAlphabetic(int ch2) {
        return UCharacter.hasBinaryProperty(ch2, 0);
    }

    public static boolean isULowercase(int ch2) {
        return UCharacter.hasBinaryProperty(ch2, 22);
    }

    public static boolean isUUppercase(int ch2) {
        return UCharacter.hasBinaryProperty(ch2, 30);
    }

    public static boolean isUWhiteSpace(int ch2) {
        return UCharacter.hasBinaryProperty(ch2, 31);
    }

    public static int getIntPropertyValue(int ch2, int type) {
        return UCharacterProperty.INSTANCE.getIntPropertyValue(ch2, type);
    }
    ...
    public static int codePointCount(CharSequence text, int start, int limit) {
        ...
        block0: while (limit > start) {
            char ch2 = text.charAt(--limit);
            while (ch2 >= '\udc00' && ch2 <= '\udfff' && limit > start) {
                if ((ch2 = text.charAt(--limit)) < '\ud800' || ch2 > '\udbff') continue;
                --len;
                continue block0;
            }
        }
    ...
    public static int codePointCount(char[] text, int start, int limit) {
        ...
        block0: while (limit > start) {
            char ch2 = text[--limit];
            while (ch2 >= '\udc00' && ch2 <= '\udfff' && limit > start) {
                if ((ch2 = text[--limit]) < '\ud800' || ch2 > '\udbff') continue;
                --len;
                continue block0;
            }
        }
    ...
    public static int offsetByCodePoints(CharSequence text, int index, int codePointOffset) {
        ...
        if (codePointOffset < 0) {
            while (++codePointOffset <= 0) {
                ...
                while (ch2 >= '\udc00' && ch2 <= '\udfff' && index > 0) {
                    if ((ch2 = text.charAt(--index)) >= '\ud800' && ch2 <= '\udbff' || ++codePointOffset <= 0) continue;
                    return index + 1;
                }
            }
        } else {
            ...
            while (--codePointOffset >= 0) {
                char ch3 = text.charAt(index++);
                while (ch3 >= '\ud800' && ch3 <= '\udbff' && index < limit) {
                    if ((ch3 = text.charAt(index++)) >= '\udc00' && ch3 <= '\udfff' || --codePointOffset >= 0) continue;
                    return index - 1;
                }
            }
        }
    ...
    public static int offsetByCodePoints(char[] text, int start, int count, int index, int codePointOffset) {
        ...
        if (codePointOffset < 0) {
            while (++codePointOffset <= 0) {
                ...
                while (ch2 >= '\udc00' && ch2 <= '\udfff' && index > start) {
                    if ((ch2 = text[--index]) >= '\ud800' && ch2 <= '\udbff' || ++codePointOffset <= 0) continue;
                    return index + 1;
                }
            }
        } else {
            while (--codePointOffset >= 0) {
                ...
                while (ch3 >= '\ud800' && ch3 <= '\udbff' && index < limit) {
                    if ((ch3 = text[index++]) >= '\udc00' && ch3 <= '\udfff' || --codePointOffset >= 0) continue;
                    return index - 1;
                }
            }
        }
    ...
    extends Character.Subset {
        ...
        public static UnicodeBlock of(int ch2) {
            if (ch2 > 0x10FFFF) {
                return INVALID_CODE;
            }
            return UnicodeBlock.getInstance(UCharacterProperty.INSTANCE.getIntPropertyValue(ch2, 4097));
        }
