...
public abstract class Normalizer2 {
    ...
    public String normalize(CharSequence src) {
        if (src instanceof String) {
            ...
            StringBuilder sb2 = new StringBuilder(src.length()).append(src, 0, spanLength);
            return this.normalizeSecondAndAppend(sb2, src.subSequence(spanLength, src.length())).toString();
        }
