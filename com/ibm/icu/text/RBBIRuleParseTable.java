...
class RBBIRuleParseTable {
    ...
    static class RBBIRuleTableElement {
        ...
        RBBIRuleTableElement(short a2, int cc2, int ns2, int ps2, boolean nc, String sn2) {
            this.fAction = a2;
            this.fCharClass = (short)cc2;
            this.fNextState = (short)ns2;
            this.fPushState = (short)ps2;
            this.fNextChar = nc;
            this.fStateName = sn2;
        }
    }
