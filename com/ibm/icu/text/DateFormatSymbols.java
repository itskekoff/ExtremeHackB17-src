...
Cloneable {
    ...
    public DateFormatSymbols(Calendar cal2, Locale locale) {
        this.initializeData(ULocale.forLocale(locale), cal2.getType());
    }

    public DateFormatSymbols(Calendar cal2, ULocale locale) {
        this.initializeData(locale, cal2.getType());
    }
    ...
    public static ResourceBundle getDateFormatBundle(Calendar cal2, Locale locale) throws MissingResourceException {
        return null;
    }

    public static ResourceBundle getDateFormatBundle(Calendar cal2, ULocale locale) throws MissingResourceException {
        return null;
    }
