...
extends UFormat {
    ...
    private static DateFormat get(int dateStyle, int timeStyle, ULocale loc) {
        if (timeStyle != -1 && (timeStyle & 0x80) > 0 || dateStyle != -1 && (dateStyle & 0x80) > 0) {
            RelativeDateFormat r2 = new RelativeDateFormat(timeStyle, dateStyle, loc);
            return r2;
        }
        ...
        try {
            Calendar cal2 = Calendar.getInstance(loc);
            DateFormat result = cal2.getDateTimeFormat(dateStyle, timeStyle, loc);
            result.setLocale(cal2.getLocale(ULocale.VALID_LOCALE), cal2.getLocale(ULocale.ACTUAL_LOCALE));
            return result;
        }
    ...
    public static final DateFormat getDateInstance(Calendar cal2, int dateStyle, Locale locale) {
        return DateFormat.getDateTimeInstance(cal2, dateStyle, -1, ULocale.forLocale(locale));
    }

    public static final DateFormat getDateInstance(Calendar cal2, int dateStyle, ULocale locale) {
        return DateFormat.getDateTimeInstance(cal2, dateStyle, -1, locale);
    }

    public static final DateFormat getTimeInstance(Calendar cal2, int timeStyle, Locale locale) {
        return DateFormat.getDateTimeInstance(cal2, -1, timeStyle, ULocale.forLocale(locale));
    }

    public static final DateFormat getTimeInstance(Calendar cal2, int timeStyle, ULocale locale) {
        return DateFormat.getDateTimeInstance(cal2, -1, timeStyle, locale);
    }

    public static final DateFormat getDateTimeInstance(Calendar cal2, int dateStyle, int timeStyle, Locale locale) {
        return cal2.getDateTimeFormat(dateStyle, timeStyle, ULocale.forLocale(locale));
    }

    public static final DateFormat getDateTimeInstance(Calendar cal2, int dateStyle, int timeStyle, ULocale locale) {
        return cal2.getDateTimeFormat(dateStyle, timeStyle, locale);
    }

    public static final DateFormat getInstance(Calendar cal2, Locale locale) {
        return DateFormat.getDateTimeInstance(cal2, 3, 3, ULocale.forLocale(locale));
    }

    public static final DateFormat getInstance(Calendar cal2, ULocale locale) {
        return DateFormat.getDateTimeInstance(cal2, 3, 3, locale);
    }

    public static final DateFormat getInstance(Calendar cal2) {
        return DateFormat.getInstance(cal2, ULocale.getDefault(ULocale.Category.FORMAT));
    }

    public static final DateFormat getDateInstance(Calendar cal2, int dateStyle) {
        return DateFormat.getDateInstance(cal2, dateStyle, ULocale.getDefault(ULocale.Category.FORMAT));
    }

    public static final DateFormat getTimeInstance(Calendar cal2, int timeStyle) {
        return DateFormat.getTimeInstance(cal2, timeStyle, ULocale.getDefault(ULocale.Category.FORMAT));
    }

    public static final DateFormat getDateTimeInstance(Calendar cal2, int dateStyle, int timeStyle) {
        return DateFormat.getDateTimeInstance(cal2, dateStyle, timeStyle, ULocale.getDefault(ULocale.Category.FORMAT));
    }
    ...
    public static final DateFormat getPatternInstance(Calendar cal2, String skeleton, Locale locale) {
        return DateFormat.getPatternInstance(cal2, skeleton, ULocale.forLocale(locale));
    }

    public static final DateFormat getPatternInstance(Calendar cal2, String skeleton, ULocale locale) {
        DateTimePatternGenerator generator = DateTimePatternGenerator.getInstance(locale);
        String bestPattern = generator.getBestPattern(skeleton);
    ...
    extends Format.Field {
        ...
        static {
            ...
            CAL_FIELD_COUNT = cal2.getFieldCount();
