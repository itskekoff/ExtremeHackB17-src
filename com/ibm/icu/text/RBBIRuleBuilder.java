...
class RBBIRuleBuilder {
    ...
    void flattenData(OutputStream os2) throws IOException {
        int i2;
        ...
        this.fSetBuilder.serializeTrie(os2);
        outputPos += header[13];
        while (outputPos % 8 != 0) {
            dos.write(0);
            ++outputPos;
    ...
    static void compileRules(String rules, OutputStream os2) throws IOException {
