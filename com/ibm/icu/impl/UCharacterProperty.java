...
public final class UCharacterProperty {
    ...
    public final int getProperty(int ch2) {
        return this.m_trie_.get(ch2);
    }
    ...
    public static int getEuropeanDigit(int ch2) {
        if (ch2 > 122 && ch2 < 65313 || ch2 < 65 || ch2 > 90 && ch2 < 97 || ch2 > 65370 || ch2 > 65338 && ch2 < 65345) {
            return -1;
        }
        if (ch2 <= 122) {
            return ch2 + 10 - (ch2 <= 90 ? 65 : 97);
        }
        if (ch2 <= 65338) {
            return ch2 + 10 - 65313;
        }
