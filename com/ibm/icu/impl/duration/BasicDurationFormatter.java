...
implements DurationFormatter {
    ...
    public DurationFormatter withTimeZone(TimeZone tz2) {
        if (!tz2.equals(this.timeZone)) {
            PeriodBuilder newBuilder = this.builder.withTimeZone(tz2);
            DateFormatter newFallback = this.fallback == null ? null : this.fallback.withTimeZone(tz2);
            return new BasicDurationFormatter(this.formatter, newBuilder, newFallback, this.fallbackLimit, this.localeName, tz2);
        }
        return this;
    }
