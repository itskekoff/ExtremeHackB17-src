...
public class PeriodFormatterData {
    ...
    public boolean appendPrefix(int tl2, int td2, StringBuffer sb2) {
        String prefix;
        int ix2;
        DataRecord.ScopeData sd2;
        if (this.dr.scopeData != null && (sd2 = this.dr.scopeData[ix2 = tl2 * 3 + td2]) != null && (prefix = sd2.prefix) != null) {
            sb2.append(prefix);
    ...
    public void appendSuffix(int tl2, int td2, StringBuffer sb2) {
        String suffix;
        int ix2;
        DataRecord.ScopeData sd2;
        if (this.dr.scopeData != null && (sd2 = this.dr.scopeData[ix2 = tl2 * 3 + td2]) != null && (suffix = sd2.suffix) != null) {
            if (trace) {
    ...
    public boolean appendUnit(TimeUnit unit, int count, int cv2, int uv2, boolean useCountSep, boolean useDigitPrefix, boolean multiple, boolean last, boolean wasSkipped, StringBuffer sb2) {
        ...
        if (uv2 != 0) {
            ...
            String[] arrstring = names = useMedium ? this.dr.mediumNames : this.dr.shortNames;
            if (names == null || names[px2] == null) {
                String[] arrstring2 = names = useMedium ? this.dr.shortNames : this.dr.mediumNames;
            }
            if (names != null && names[px2] != null) {
    ...
    public void appendDigits(long num, int mindigits, int maxdigits, StringBuffer sb2) {
        char[] buf2 = new char[maxdigits];
        int ix2 = maxdigits;
        while (ix2 > 0 && num > 0L) {
            buf2[--ix2] = (char)((long)this.dr.zero + num % 10L);
            num /= 10L;
        }
        int e2 = maxdigits - mindigits;
        while (ix2 > e2) {
            buf2[--ix2] = this.dr.zero;
        }
        sb2.append(buf2, ix2, maxdigits - ix2);
    }
