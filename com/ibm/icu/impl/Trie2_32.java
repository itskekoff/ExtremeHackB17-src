...
extends Trie2 {
    ...
    public static Trie2_32 createFromSerialized(InputStream is2) throws IOException {
        return (Trie2_32)Trie2.createFromSerialized(is2);
    }
    ...
    int rangeEnd(int startingCP, int limit, int value) {
        ...
        block0: while (cp2 < limit) {
            ...
            for (int ix3 = startIx; ix3 < limitIx; ++ix3) {
                if (this.data32[ix3] == value) continue;
                cp2 += ix3 - startIx;
                break block0;
            }
            cp2 += limitIx - startIx;
