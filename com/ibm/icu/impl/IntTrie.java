...
extends Trie {
    ...
    public final int getCodePointValue(int ch2) {
        if (0 <= ch2 && ch2 < 55296) {
    ...
    public final int getLeadValue(char ch2) {
        return this.m_data_[this.getLeadOffset(ch2)];
    }

    public final int getBMPValue(char ch2) {
    ...
    public final int getLatin1LinearValue(char ch2) {
        return this.m_data_[32 + ch2];
    }
