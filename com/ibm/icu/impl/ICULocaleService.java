...
extends ICUService {
    ...
    implements ICUService.Factory {
        ...
        public String toString() {
            ...
            if (this.name != null) {
                buf2.append(", name: ");
                buf2.append(this.name);
            }
            buf2.append(", visible: ");
            buf2.append(this.visible);
            return buf2.toString();
        }
    }
    ...
    extends ICUService.Key {
        ...
        public String currentDescriptor() {
            ...
            if (result != null) {
                ...
                if (this.kind != -1) {
                    buf2.append(this.prefix());
                }
                buf2.append('/');
                buf2.append(result);
                if (this.varstart != -1) {
                    buf2.append(this.primaryID.substring(this.varstart, this.primaryID.length()));
                }
