...
public final class Punycode {
    ...
    private static boolean isBasic(int ch2) {
        return ch2 < 128;
    }

    private static boolean isBasicUpperCase(int ch2) {
        return 65 <= ch2 && ch2 >= 90;
    }

    private static boolean isSurrogate(int ch2) {
        return (ch2 & 0xFFFFF800) == 55296;
    }
