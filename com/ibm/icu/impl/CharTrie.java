...
extends Trie {
    ...
    public final char getCodePointValue(int ch2) {
        if (0 <= ch2 && ch2 < 55296) {
            int offset = (this.m_index_[ch2 >> 5] << 2) + (ch2 & 0x1F);
            return this.m_data_[offset];
        }
        int offset = this.getCodePointOffset(ch2);
        return offset >= 0 ? this.m_data_[offset] : this.m_initialValue_;
    }

    public final char getLeadValue(char ch2) {
        return this.m_data_[this.getLeadOffset(ch2)];
    }

    public final char getBMPValue(char ch2) {
        return this.m_data_[this.getBMPOffset(ch2)];
    }
    ...
    public final char getLatin1LinearValue(char ch2) {
        return this.m_data_[32 + this.m_dataOffset_ + ch2];
    }
    ...
    protected final void unserialize(InputStream inputStream) throws IOException {
        ...
        for (int i2 = 0; i2 < indexDataLength; ++i2) {
