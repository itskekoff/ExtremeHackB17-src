...
extends DateFormat {
    ...
    public StringBuffer format(Calendar cal2, StringBuffer toAppendTo, FieldPosition fieldPosition) {
        String relativeDayString = null;
        if (this.fDateStyle != -1) {
            int dayDiff = RelativeDateFormat.dayDifference(cal2);
        ...
        if (this.fDateTimeFormat != null && (this.fDatePattern != null || this.fTimePattern != null)) {
            if (this.fDatePattern == null) {
                ...
                this.fDateTimeFormat.format(cal2, toAppendTo, fieldPosition);
            ...
            if (relativeDayString != null) {
                ...
                this.fDateFormat.format(cal2, toAppendTo, fieldPosition);
            }
        }
        return toAppendTo;
    }

    public void parse(String text, Calendar cal2, ParsePosition pos) {
    ...
    private MessageFormat initializeCombinedFormat(Calendar cal2, ULocale locale) {
        String pattern = "{1} {0}";
        try {
            CalendarData calData = new CalendarData(locale, cal2.getType());
