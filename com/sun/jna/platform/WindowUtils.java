...
public class WindowUtils {
    ...
    extends NativeWindowUtils {
        ...
        extends NativeWindowUtils.TransparentContentPane {
            ...
            protected void paintDirect(BufferedImage buf2, Rectangle bounds) {
    ...
    extends NativeWindowUtils {
        ...
        private void setBackgroundTransparent(Window w2, boolean transparent, String context) {
            ...
            if (transparent) {
                ...
                Color bg = (Color)rp2.getClientProperty(WindowUtils.TRANSPARENT_OLD_BG);
                if (bg != null) {
            ...
            public void paint(Graphics gr2) {
                if (this.transparent) {
                    ...
                    if (this.getWidth() > 0 && this.getHeight() > 0) {
                        BufferedImage buf2 = new BufferedImage(w2, h2, 3);
