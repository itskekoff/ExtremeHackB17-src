...
implements TypeConverter {
    ...
    public NativeMapped defaultValue() {
        try {
            ...
            String msg = "Can't create an instance of " + this.type + ", requires a no-arg constructor: " + e2;
            throw new IllegalArgumentException(msg);
        }
        catch (IllegalAccessException e3) {
            String msg = "Not allowed to create an instance of " + this.type + ", requires a public, no-arg constructor: " + e3;
            throw new IllegalArgumentException(msg);
        }
    }
