...
public class StreamState {
    ...
    void lacing_expand(int needed) {
        if (this.lacing_storage <= this.lacing_fill + needed) {
            ...
            long[] bar2 = new long[this.lacing_storage];
            System.arraycopy(this.granule_vals, 0, bar2, 0, this.granule_vals.length);
            this.granule_vals = bar2;
        }
    }
    ...
    public int pagein(Page og) {
        ...
        if (lr2 != 0) {
            if (this.lacing_fill - lr2 != 0) {
                System.arraycopy(this.lacing_vals, lr2, this.lacing_vals, 0, this.lacing_fill - lr2);
                System.arraycopy(this.granule_vals, lr2, this.granule_vals, 0, this.lacing_fill - lr2);
            }
            this.lacing_fill -= lr2;
            this.lacing_packet -= lr2;
