...
extends FuncFloor {
    ...
    Object look(DspState vd2, InfoMode mi2, Object i2) {
        Info vi2 = vd2.vi;
        InfoFloor0 info = (InfoFloor0)i2;
        LookFloor0 look = new LookFloor0();
        look.m = info.order;
        look.n = vi2.blocksizes[mi2.blockflag] / 2;
    ...
    int inverse(Block vb2, Object i2, float[] out) {
        ...
        if (ampraw > 0) {
            ...
            float amp2 = (float)ampraw / (float)maxval * (float)info.ampdB;
            ...
            if (booknum != -1 && booknum < info.numbooks) {
                ...
                synchronized (floor0) {
                    ...
                    Lsp.lsp_to_curve(out, look.linearmap, look.n, look.ln, this.lsp, look.m, amp2, info.ampdB);
                    return 1;
                }
            }
        }
    ...
    int inverse2(Block vb2, Object i2, Object memo, float[] out) {
        ...
        if (memo != null) {
            ...
            float amp2 = lsp[look.m];
            Lsp.lsp_to_curve(out, look.linearmap, look.n, look.ln, lsp, look.m, amp2, info.ampdB);
            return 1;
        }
        for (int j2 = 0; j2 < look.n; ++j2) {
            out[j2] = 0.0f;
    ...
    static void lpc_to_curve(float[] curve, float[] lpc, float amp2, LookFloor0 l2, String name, int frameno) {
        ...
        l2.lpclook.lpc_to_curve(lcurve, lpc, amp2);
