...
extends FuncFloor {
    ...
    void pack(Object i2, Buffer opb) {
        ...
        k2 = 0;
        for (j2 = 0; j2 < info.partitions; ++j2) {
            while (k2 < (count += info.class_dim[info.partitionclass[j2]])) {
        ...
        if (vb2.opb.read(1) == 1) {
            ...
            for (i2 = 2; i2 < look.posts; ++i2) {
                ...
                if (val != 0) {
                    ...
                    fit_value[n2] = fit_value[n2] & 0x7FFF;
                    int n3 = look.hineighbor[i2 - 2];
                    fit_value[n3] = fit_value[n3] & 0x7FFF;
                    continue;
                }
    ...
    int inverse2(Block vb2, Object i2, Object memo, float[] out) {
        ...
        if (memo != null) {
            ...
            for (j2 = 1; j2 < look.posts; ++j2) {
                ...
                int hy2 = fit_value[current] & 0x7FFF;
