...
class Lsp {
    ...
    static void lsp_to_curve(float[] curve, int[] map, int n2, int ln2, float[] lsp, int m2, float amp2, float ampoffset) {
        int i2;
        ...
        while (i2 < n2) {
            ...
            q2 = Lookup.fromdBlook(amp2 * Lookup.invsqlook(q2) * Lookup.invsq2explook(qexp + m2) - ampoffset);
            do {
                int n3 = i2++;
