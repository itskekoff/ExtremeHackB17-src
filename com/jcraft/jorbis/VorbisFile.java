...
public class VorbisFile {
    ...
    int fetch_headers(Info vi2, Comment vc, int[] serialno, Page og_ptr) {
        Page og = new Page();
    ...
    extends InputStream {
        ...
        public int read(byte[] buf2) throws IOException {
            return this.raf.read(buf2);
        }

        public int read(byte[] buf2, int s2, int len) throws IOException {
            return this.raf.read(buf2, s2, len);
        }
