        ...
        if (localValue == null) {
            ...
            if (ATOMIC_HELPER.casValue(this, null, valueToSet)) {
                try {
                    ...
                    Failure failure;
                    try {
                        failure = new Failure(t2);
                    }
                    catch (Throwable oomMostLikely) {
                        failure = Failure.FALLBACK_INSTANCE;
                    }
                    boolean bl2 = ATOMIC_HELPER.casValue(this, valueToSet, failure);
                }
                return true;
            }
            localValue = this.value;
