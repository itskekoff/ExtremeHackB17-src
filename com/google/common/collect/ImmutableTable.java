...
implements Serializable {
    ...
    public static <T, R, C, V> Collector<T, ?, ImmutableTable<R, C, V>> toImmutableTable(Function<? super T, ? extends R> rowFunction, Function<? super T, ? extends C> columnFunction, Function<? super T, ? extends V> valueFunction) {
        ...
        return Collector.of(() -> new Builder(), (builder, t2) -> builder.put(rowFunction.apply(t2), columnFunction.apply(t2), valueFunction.apply(t2)), (b1, b2) -> b1.combine(b2), b2 -> b2.build(), new Collector.Characteristics[0]);
    }
    ...
    implements Serializable {
        ...
        Object readResolve() {
            ...
            for (int i2 = 0; i2 < this.cellValues.length; ++i2) {
                cellListBuilder.add(ImmutableTable.cellOf(this.rowKeys[this.cellRowIndices[i2]], this.columnKeys[this.cellColumnIndices[i2]], this.cellValues[i2]));
            }
