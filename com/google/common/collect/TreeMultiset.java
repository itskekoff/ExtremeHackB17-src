...
implements Serializable {
    ...
    extends Multisets.AbstractEntry<E> {
        ...
        private AvlNode<E> ceiling(Comparator<? super E> comparator, E e2) {
            int cmp = comparator.compare(e2, this.elem);
            if (cmp < 0) {
                return this.left == null ? this : MoreObjects.firstNonNull(super.ceiling(comparator, e2), this);
            }
            if (cmp == 0) {
                return this;
            }
        ...
        private AvlNode<E> floor(Comparator<? super E> comparator, E e2) {
            int cmp = comparator.compare(e2, this.elem);
            if (cmp > 0) {
                return this.right == null ? this : MoreObjects.firstNonNull(super.floor(comparator, e2), this);
            }
            if (cmp == 0) {
                return this;
            }
