...
Serializable {
    ...
    Serializable {
        ...
        public void forEach(BiConsumer<? super V, ? super K> action) {
            Preconditions.checkNotNull(action);
            HashBiMap.this.forEach((? super K k2, ? super V v2) -> action.accept((Object)v2, (Object)k2));
        }
        ...
        extends Maps.KeySet<V, K> {
            ...
            public boolean remove(@Nullable Object o2) {
                BiEntry entry = HashBiMap.this.seekByValue(o2, Hashing.smearedHash(o2));
                if (entry == null) {
                    return false;
                }
                HashBiMap.this.delete(entry);
    ...
    extends Maps.KeySet<K, V> {
        ...
        @Override
        public boolean remove(@Nullable Object o2) {
            BiEntry entry = HashBiMap.this.seekByKey(o2, Hashing.smearedHash(o2));
            if (entry == null) {
                return false;
            }
            HashBiMap.this.delete(entry);
