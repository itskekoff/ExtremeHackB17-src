...
implements ListMultimap<K, V> {
    ...
    public static <T, K, V> Collector<T, ?, ImmutableListMultimap<K, V>> toImmutableListMultimap(Function<? super T, ? extends K> keyFunction, Function<? super T, ? extends V> valueFunction) {
        ...
        return Collector.of(ImmutableListMultimap::builder, (builder, t2) -> builder.put(keyFunction.apply(t2), valueFunction.apply(t2)), Builder::combine, Builder::build, new Collector.Characteristics[0]);
    }
