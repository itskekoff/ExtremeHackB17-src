...
extends ImmutableSortedMultiset<E> {
    ...
    public void forEachEntry(ObjIntConsumer<? super E> action) {
        ...
        for (int i2 = 0; i2 < this.size(); ++i2) {
            action.accept(this.elementSet.asList().get(i2), this.getCount(i2));
        }
    }
    ...
    ImmutableSortedMultiset<E> getSubMultiset(int from, int to2) {
        ...
        RegularImmutableSortedSet<E> subElementSet = this.elementSet.getSubSet(from, to2);
        return new RegularImmutableSortedMultiset<E>(subElementSet, this.cumulativeCounts, this.offset + from, to2 - from);
    }
