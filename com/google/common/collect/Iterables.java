...
public final class Iterables {
    ...
    public static <T> Iterable<T> filter(final Iterable<T> unfiltered, final Predicate<? super T> retainIfTrue) {
        ...
        return new FluentIterable<T>(){
            ...
            public void forEach(Consumer<? super T> action) {
                ...
                unfiltered.forEach(a2 -> {
                    if (retainIfTrue.test(a2)) {
                        action.accept(a2);
                    }
                });
            }
    ...
    public static <T> Iterable<T> filter(final Iterable<?> unfiltered, final Class<T> desiredType) {
        ...
        return new FluentIterable<T>(){
            ...
            public void forEach(Consumer<? super T> action) {
                Preconditions.checkNotNull(action);
                unfiltered.forEach(o2 -> {
                    if (desiredType.isInstance(o2)) {
                        action.accept((Object)desiredType.cast(o2));
                    }
                });
            }
    ...
    public static <F, T> Iterable<T> transform(final Iterable<F> fromIterable, final Function<? super F, ? extends T> function) {
        ...
        return new FluentIterable<T>(){
            ...
            public void forEach(Consumer<? super T> action) {
                Preconditions.checkNotNull(action);
                fromIterable.forEach(f2 -> action.accept((Object)function.apply(f2)));
            }
