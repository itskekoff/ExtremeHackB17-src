...
implements Serializable {
    ...
    boolean tooLow(@Nullable T t2) {
        ...
        int cmp = this.comparator.compare(t2, lbound);
    ...
    boolean tooHigh(@Nullable T t2) {
        ...
        int cmp = this.comparator.compare(t2, ubound);
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj instanceof GeneralRange) {
            GeneralRange r2 = (GeneralRange)obj;
            return this.comparator.equals(r2.comparator) && this.hasLowerBound == r2.hasLowerBound && this.hasUpperBound == r2.hasUpperBound && this.getLowerBoundType().equals((Object)r2.getLowerBoundType()) && this.getUpperBoundType().equals((Object)r2.getUpperBoundType()) && Objects.equal(this.getLowerEndpoint(), r2.getLowerEndpoint()) && Objects.equal(this.getUpperEndpoint(), r2.getUpperEndpoint());
        }
        return false;
    }
