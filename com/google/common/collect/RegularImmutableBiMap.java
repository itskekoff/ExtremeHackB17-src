...
extends ImmutableBiMap<K, V> {
    ...
    static <K, V> RegularImmutableBiMap<K, V> fromEntryArray(int n2, Map.Entry<K, V>[] entryArray) {
        ...
        Map.Entry<K, V>[] entries = n2 == entryArray.length ? entryArray : ImmutableMapEntry.createEntryArray(n2);
        int hashCode = 0;
    ...
    extends ImmutableBiMap<V, K> {
        ...
        public void forEach(BiConsumer<? super V, ? super K> action) {
            Preconditions.checkNotNull(action);
            RegularImmutableBiMap.this.forEach((? super K k2, ? super V v2) -> action.accept((Object)v2, (Object)k2));
        }
