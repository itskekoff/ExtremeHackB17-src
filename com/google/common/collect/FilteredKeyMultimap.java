...
implements FilteredMultimap<K, V> {
    ...
    extends ForwardingCollection<Map.Entry<K, V>> {
        ...
        public boolean remove(@Nullable Object o2) {
            Map.Entry entry;
            if (o2 instanceof Map.Entry && FilteredKeyMultimap.this.unfiltered.containsKey((entry = (Map.Entry)o2).getKey()) && FilteredKeyMultimap.this.keyPredicate.apply(entry.getKey())) {
