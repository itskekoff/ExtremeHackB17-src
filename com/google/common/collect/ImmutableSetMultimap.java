...
implements SetMultimap<K, V> {
    ...
    public static <T, K, V> Collector<T, ?, ImmutableSetMultimap<K, V>> toImmutableSetMultimap(Function<? super T, ? extends K> keyFunction, Function<? super T, ? extends V> valueFunction) {
        ...
        return Collector.of(ImmutableSetMultimap::builder, (builder, t2) -> builder.put(keyFunction.apply(t2), valueFunction.apply(t2)), Builder::combine, Builder::build, new Collector.Characteristics[0]);
    }
