...
implements Multiset<E> {
    ...
    public static <E> Collector<E, ?, ImmutableMultiset<E>> toImmutableMultiset() {
        return ImmutableMultiset.toImmutableMultiset(Function.identity(), e2 -> 1);
    }
    ...
    private static <T, E> Collector<T, ?, ImmutableMultiset<E>> toImmutableMultiset(Function<? super T, ? extends E> elementFunction, ToIntFunction<? super T> countFunction) {
        ...
        return Collector.of(LinkedHashMultiset::create, (multiset, t2) -> multiset.add(elementFunction.apply(t2), countFunction.applyAsInt(t2)), (multiset1, multiset2) -> {
