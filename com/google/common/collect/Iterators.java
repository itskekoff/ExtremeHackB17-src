...
public final class Iterators {
    ...
    public static <T> T getOnlyElement(Iterator<T> iterator) {
        ...
        StringBuilder sb2 = new StringBuilder().append("expected one element but was: <").append(first);
        for (int i2 = 0; i2 < 4 && iterator.hasNext(); ++i2) {
            sb2.append(", ").append(iterator.next());
        }
        if (iterator.hasNext()) {
            sb2.append(", ...");
        }
    ...
    public static <T> Iterator<T> concat(Iterator<? extends T> a2, Iterator<? extends T> b2) {
        ...
        return Iterators.concat(new ConsumingQueueIterator<Iterator>(a2, b2));
    }
    ...
    public static <T> Iterator<T> concat(Iterator<? extends T> a2, Iterator<? extends T> b2, Iterator<? extends T> c2) {
        ...
        return Iterators.concat(new ConsumingQueueIterator<Iterator>(a2, b2, c2));
    }
    ...
    public static <T> Iterator<T> concat(Iterator<? extends T> a2, Iterator<? extends T> b2, Iterator<? extends T> c2, Iterator<? extends T> d2) {
        ...
        return Iterators.concat(new ConsumingQueueIterator<Iterator>(a2, b2, c2, d2));
    }
