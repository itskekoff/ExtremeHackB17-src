...
extends StandardRowSortedTable<R, C, V> {
    ...
    implements SortedMap<C, V> {
        ...
        boolean rangeContains(@Nullable Object o2) {
            return !(o2 == null || this.lowerBound != null && this.compare(this.lowerBound, o2) > 0 || this.upperBound != null && this.compare(this.upperBound, o2) <= 0);
        }
