...
Serializable {
    ...
    static int optimalNumOfHashFunctions(long n2, long m2) {
        return Math.max(1, (int)Math.round((double)m2 / (double)n2 * Math.log(2.0)));
    }
    ...
    public static <T> BloomFilter<T> readFrom(InputStream in2, Funnel<T> funnel) throws IOException {
