...
implements Predicate<Character> {
    ...
    public String replaceFrom(CharSequence sequence, CharSequence replacement) {
        ...
        StringBuilder buf2 = new StringBuilder(len * 3 / 2 + 16);
        int oldpos = 0;
        do {
            buf2.append(string, oldpos, pos);
            buf2.append(replacement);
        } while ((pos = this.indexIn(string, oldpos = pos + 1)) != -1);
        buf2.append(string, oldpos, len);
    ...
    public String collapseFrom(CharSequence sequence, char replacement) {
        ...
        for (int i2 = 0; i2 < len; ++i2) {
            ...
            StringBuilder builder = new StringBuilder(len).append(sequence, 0, i2).append(replacement);
