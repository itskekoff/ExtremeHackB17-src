...
implements Serializable {
    ...
    @Override
    CommonMatcher matcher(CharSequence t2) {
        return new JdkMatcher(this.pattern.matcher(t2));
    }
    ...
    public boolean equals(Object o2) {
        if (!(o2 instanceof JdkPattern)) {
            return false;
        }
        return this.pattern.equals(((JdkPattern)o2).pattern);
    }
