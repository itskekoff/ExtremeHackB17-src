    ...
    private static List<StackTraceElement> jlaStackTrace(final Throwable t2) {
        ...
        return new AbstractList<StackTraceElement>(){
            ...
            public StackTraceElement get(int n2) {
                return (StackTraceElement)Throwables.invokeAccessibleNonThrowingMethod(getStackTraceElementMethod, jla, new Object[]{t2, n2});
            }

            @Override
            public int size() {
                return (Integer)Throwables.invokeAccessibleNonThrowingMethod(getStackTraceDepthMethod, jla, new Object[]{t2});
            }
        };
    }
