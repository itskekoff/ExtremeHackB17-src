        ...
        try {
            ...
            while (it2.hasNext()) {
                try {
                    ...
                    Platform.logPatternCompilerError(e2);
                }
            }
        }
        catch (ServiceConfigurationError e3) {
            Platform.logPatternCompilerError(e3);
        }
        return new JdkPatternCompiler();
    }

    private static void logPatternCompilerError(ServiceConfigurationError e2) {
        logger.log(Level.WARNING, "Error loading regex compiler, falling back to next option", e2);
    }
