...
final class SubscriberRegistry {
    ...
    SubscriberRegistry(EventBus bus2) {
        this.bus = Preconditions.checkNotNull(bus2);
    }
    ...
    Iterator<Subscriber> getSubscribers(Object event) {
        ...
        for (Class class_ : eventTypes) {
            CopyOnWriteArraySet eventSubscribers = (CopyOnWriteArraySet)this.subscribers.get(class_);
