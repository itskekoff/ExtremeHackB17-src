...
public final class InetAddresses {
    ...
    private static byte[] textToNumericFormatV4(String ipString) {
        ...
        try {
            for (String octet : IPV4_SPLITTER.split(ipString)) {
                bytes[i2++] = InetAddresses.parseOctet(octet);
            }
        }
        catch (NumberFormatException ex2) {
            return null;
        }
        return (byte[])(i2 == 4 ? bytes : null);
    }
    ...
    private static String hextetsToIPv6String(int[] hextets) {
        StringBuilder buf2 = new StringBuilder(39);
        ...
        for (int i2 = 0; i2 < hextets.length; ++i2) {
            ...
            if (thisIsNumber) {
                ...
                buf2.append(Integer.toHexString(hextets[i2]));
    ...
    public static InetAddress decrement(InetAddress address) {
        ...
        for (i2 = addr.length - 1; i2 >= 0 && addr[i2] == 0; --i2) {
            addr[i2] = -1;
        }
        Preconditions.checkArgument(i2 >= 0, "Decrementing %s would wrap.", (Object)address);
        int n2 = i2;
    ...
    public static InetAddress increment(InetAddress address) {
        ...
        Preconditions.checkArgument(i2 >= 0, "Incrementing %s would wrap.", (Object)address);
        int n2 = i2;
        addr[n2] = (byte)(addr[n2] + 1);
        return InetAddresses.bytesToInetAddress(addr);
    }
