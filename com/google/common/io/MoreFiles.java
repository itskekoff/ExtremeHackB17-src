...
public final class MoreFiles {
    ...
    private static Collection<IOException> deleteRecursivelySecure(SecureDirectoryStream<Path> dir, Path path) {
        ...
        try {
            ...
            return MoreFiles.addException(exceptions, e2);
        }
    }
    ...
    private static Collection<IOException> deleteDirectoryContentsSecure(SecureDirectoryStream<Path> dir) {
        ...
        try {
            ...
            return MoreFiles.addException(exceptions, e2.getCause());
        }
    }
    ...
    private static Collection<IOException> addException(@Nullable Collection<IOException> exceptions, IOException e2) {
        if (exceptions == null) {
