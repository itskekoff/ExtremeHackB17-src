...
implements Constant<Signal> {
    ...
    private static final ConstantPool<Signal> pool = new ConstantPool<Signal>(){
        ...
        @Override
        protected Signal newConstant(int id2, String name) {
            return new Signal(id2, name);
        }
    };
    ...
    private Signal(int id2, String name) {
        this.constant = new SignalConstant(id2, name);
    }
    ...
    extends AbstractConstant<SignalConstant> {
        SignalConstant(int id2, String name) {
            super(id2, name);
        }
    }
}
