...
implements ShortObjectMap<V> {
    ...
    public String toString() {
        ...
        StringBuilder sb2 = new StringBuilder(4 * this.size);
        sb2.append('{');
        boolean first = true;
        for (int i2 = 0; i2 < this.values.length; ++i2) {
            V value = this.values[i2];
            ...
            sb2.append(this.keyToString(this.keys[i2])).append('=').append((Object)(value == this ? "(this Map)" : ShortObjectHashMap.toExternal(value)));
            first = false;
        }
    ...
    extends AbstractSet<Short> {
        ...
        public boolean contains(Object o2) {
            return ShortObjectHashMap.this.containsKey(o2);
        }

        @Override
        public boolean remove(Object o2) {
            return ShortObjectHashMap.this.remove(o2) != null;
        }
