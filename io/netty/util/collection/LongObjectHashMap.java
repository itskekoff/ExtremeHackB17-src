...
implements LongObjectMap<V> {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.values.length; ++i2) {
            ...
            sb2.append(this.keyToString(this.keys[i2])).append('=').append((Object)(value == this ? "(this Map)" : LongObjectHashMap.toExternal(value)));
            first = false;
        }
    ...
    extends AbstractSet<Long> {
        ...
        public boolean contains(Object o2) {
            return LongObjectHashMap.this.containsKey(o2);
        }

        @Override
        public boolean remove(Object o2) {
            return LongObjectHashMap.this.remove(o2) != null;
        }
