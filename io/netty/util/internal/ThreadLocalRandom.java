...
extends Random {
    ...
    private static long mix64(long z2) {
        z2 = (z2 ^ z2 >>> 33) * -49064778989728563L;
        z2 = (z2 ^ z2 >>> 33) * -4265267296055464877L;
        return z2 ^ z2 >>> 33;
    }
            ...
            if (secureRandom) {
                ...
                seedGeneratorThread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler(){
                    ...
                    public void uncaughtException(Thread t2, Throwable e2) {
                        logger.debug("An exception has been raised by {}", (Object)t2.getName(), (Object)e2);
                    }
                });
