...
final class PlatformDependent0 {
    ...
    static boolean equals(byte[] bytes1, int startPos1, byte[] bytes2, int startPos2, int length) {
        ...
        long i2 = baseOffset1 - 8L + (long)length;
        long j2 = baseOffset2 - 8L + (long)length;
        while (i2 >= end) {
            if (UNSAFE.getLong((Object)bytes1, i2) != UNSAFE.getLong((Object)bytes2, j2)) {
                return false;
            }
            i2 -= 8L;
            j2 -= 8L;
    ...
    static int equalsConstantTime(byte[] bytes1, int startPos1, byte[] bytes2, int startPos2, int length) {
        ...
        long j2 = baseOffset2 - 8L + (long)length;
        while (i2 >= end) {
            result |= UNSAFE.getLong((Object)bytes1, i2) ^ UNSAFE.getLong((Object)bytes2, j2);
            i2 -= 8L;
            j2 -= 8L;
        }
