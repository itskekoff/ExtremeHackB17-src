    ...
    private static Class<?> find0(Object object, Class<?> parameterizedSuperclass, String typeParamName) {
        ...
        while (true) {
            ...
            for (int i2 = 0; i2 < typeParams.length; ++i2) {
                if (!typeParamName.equals(typeParams[i2].getName())) continue;
                typeParamIndex = i2;
                break;
            }
            if (typeParamIndex < 0) {
            ...
            TypeVariable v2 = (TypeVariable)actualTypeParam;
            currentClass = thisClass;
            if (!(v2.getGenericDeclaration() instanceof Class)) {
                return Object.class;
            }
            parameterizedSuperclass = (Class)v2.getGenericDeclaration();
            typeParamName = v2.getName();
