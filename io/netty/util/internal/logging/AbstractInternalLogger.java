...
Serializable {
    ...
    @Override
    public void trace(Throwable t2) {
        this.trace(EXCEPTION_MESSAGE, t2);
    }

    @Override
    public void debug(Throwable t2) {
        this.debug(EXCEPTION_MESSAGE, t2);
    }

    @Override
    public void info(Throwable t2) {
        this.info(EXCEPTION_MESSAGE, t2);
    }

    @Override
    public void warn(Throwable t2) {
        this.warn(EXCEPTION_MESSAGE, t2);
    }

    @Override
    public void error(Throwable t2) {
        this.error(EXCEPTION_MESSAGE, t2);
    }
    ...
    @Override
    public void log(InternalLogLevel level, String format, Object arg2) {
        switch (level) {
            case TRACE: {
