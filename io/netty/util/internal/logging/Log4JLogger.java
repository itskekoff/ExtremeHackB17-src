...
extends AbstractInternalLogger {
    ...
    public void trace(String format, Object arg2) {
        if (this.isTraceEnabled()) {
            ...
            this.logger.log(FQCN, (Priority)(this.traceCapable ? Level.TRACE : Level.DEBUG), (Object)ft2.getMessage(), ft2.getThrowable());
        }
    }
    ...
    public void debug(String format, Object arg2) {
        if (this.logger.isDebugEnabled()) {
            FormattingTuple ft2 = MessageFormatter.format(format, arg2);
            this.logger.log(FQCN, (Priority)Level.DEBUG, (Object)ft2.getMessage(), ft2.getThrowable());
        }
    }
    ...
    public void info(String format, Object arg2) {
        if (this.logger.isInfoEnabled()) {
            FormattingTuple ft2 = MessageFormatter.format(format, arg2);
            this.logger.log(FQCN, (Priority)Level.INFO, (Object)ft2.getMessage(), ft2.getThrowable());
        }
    }
    ...
    public void warn(String format, Object arg2) {
        if (this.logger.isEnabledFor((Priority)Level.WARN)) {
            FormattingTuple ft2 = MessageFormatter.format(format, arg2);
            this.logger.log(FQCN, (Priority)Level.WARN, (Object)ft2.getMessage(), ft2.getThrowable());
        }
    }
    ...
    public void error(String format, Object arg2) {
        if (this.logger.isEnabledFor((Priority)Level.ERROR)) {
            FormattingTuple ft2 = MessageFormatter.format(format, arg2);
            this.logger.log(FQCN, (Priority)Level.ERROR, (Object)ft2.getMessage(), ft2.getThrowable());
        }
    }
