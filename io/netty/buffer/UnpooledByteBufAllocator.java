...
implements ByteBufAllocatorMetricProvider {
    ...
    protected ByteBuf newDirectBuffer(int initialCapacity, int maxCapacity) {
        AbstractReferenceCountedByteBuf buf2 = PlatformDependent.hasUnsafe() ? (PlatformDependent.useDirectBufferNoCleaner() ? new InstrumentedUnpooledUnsafeNoCleanerDirectByteBuf(this, initialCapacity, maxCapacity) : new InstrumentedUnpooledUnsafeDirectByteBuf(this, initialCapacity, maxCapacity)) : new InstrumentedUnpooledDirectByteBuf(this, initialCapacity, maxCapacity);
        return this.disableLeakDetector ? buf2 : UnpooledByteBufAllocator.toLeakAwareBuffer(buf2);
    }

    @Override
    public CompositeByteBuf compositeHeapBuffer(int maxNumComponents) {
        CompositeByteBuf buf2 = new CompositeByteBuf(this, false, maxNumComponents);
        return this.disableLeakDetector ? buf2 : UnpooledByteBufAllocator.toLeakAwareBuffer(buf2);
    }

    @Override
    public CompositeByteBuf compositeDirectBuffer(int maxNumComponents) {
        CompositeByteBuf buf2 = new CompositeByteBuf(this, true, maxNumComponents);
        return this.disableLeakDetector ? buf2 : UnpooledByteBufAllocator.toLeakAwareBuffer(buf2);
    }
