...
extends ByteBuf {
    ...
    public SwappedByteBuf(ByteBuf buf2) {
        ...
        this.buf = buf2;
        this.order = buf2.order() == ByteOrder.BIG_ENDIAN ? ByteOrder.LITTLE_ENDIAN : ByteOrder.BIG_ENDIAN;
    }
    ...
    public int setBytes(int index, InputStream in2, int length) throws IOException {
        return this.buf.setBytes(index, in2, length);
    }
    ...
    public int setBytes(int index, FileChannel in2, long position, int length) throws IOException {
        return this.buf.setBytes(index, in2, position, length);
    }
    ...
    public int writeBytes(InputStream in2, int length) throws IOException {
        return this.buf.writeBytes(in2, length);
    }
    ...
    public int writeBytes(FileChannel in2, long position, int length) throws IOException {
        return this.buf.writeBytes(in2, position, length);
    }
