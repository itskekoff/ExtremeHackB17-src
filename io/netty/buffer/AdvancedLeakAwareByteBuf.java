...
extends SimpleLeakAwareByteBuf {
    ...
    AdvancedLeakAwareByteBuf(ByteBuf buf2, ResourceLeakTracker<ByteBuf> leak) {
        super(buf2, leak);
    }
    ...
    public int setBytes(int index, InputStream in2, int length) throws IOException {
        AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation(this.leak);
        return super.setBytes(index, in2, length);
    }
    ...
    public int setBytes(int index, FileChannel in2, long position, int length) throws IOException {
        AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation(this.leak);
        return super.setBytes(index, in2, position, length);
    }
    ...
    public int writeBytes(FileChannel in2, long position, int length) throws IOException {
        AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation(this.leak);
        return super.writeBytes(in2, position, length);
    }
    ...
    @Override
    protected AdvancedLeakAwareByteBuf newLeakAwareByteBuf(ByteBuf buf2, ByteBuf trackedByteBuf, ResourceLeakTracker<ByteBuf> leakTracker) {
        return new AdvancedLeakAwareByteBuf(buf2, trackedByteBuf, leakTracker);
    }
