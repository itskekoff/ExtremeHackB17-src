...
extends ByteBuf {
    ...
    @Override
    public int writeBytes(InputStream in2, int length) {
        this.checkLength(length);
        return 0;
    }

    @Override
    public int writeBytes(ScatteringByteChannel in2, int length) {
        this.checkLength(length);
        return 0;
    }

    @Override
    public int writeBytes(FileChannel in2, long position, int length) {
        this.checkLength(length);
        return 0;
    }
