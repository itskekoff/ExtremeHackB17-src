    ...
    public void addContent(ByteBuf buffer, boolean last) throws IOException {
        if (buffer != null) {
            ...
            if (this.byteBuf == null) {
                ...
                CompositeByteBuf cbb2 = (CompositeByteBuf)this.byteBuf;
                cbb2.addComponent(true, buffer);
            } else {
                CompositeByteBuf cbb3 = Unpooled.compositeBuffer(Integer.MAX_VALUE);
                cbb3.addComponents(true, this.byteBuf, buffer);
                this.byteBuf = cbb3;
            }
        }
        if (last) {
