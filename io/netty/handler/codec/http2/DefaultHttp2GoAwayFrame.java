...
implements Http2GoAwayFrame {
    ...
    public boolean equals(Object o2) {
        if (!(o2 instanceof DefaultHttp2GoAwayFrame)) {
            return false;
        }
        DefaultHttp2GoAwayFrame other = (DefaultHttp2GoAwayFrame)o2;
        return super.equals(o2) && this.errorCode == other.errorCode && this.content().equals(other.content()) && this.extraStreamIds == other.extraStreamIds;
    }
