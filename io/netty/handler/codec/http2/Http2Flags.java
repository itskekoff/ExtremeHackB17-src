...
public final class Http2Flags {
    ...
    public Http2Flags ack(boolean ack2) {
        return this.setFlag(ack2, (short)1);
    }

    public Http2Flags setFlag(boolean on2, short mask) {
        this.value = on2 ? (short)(this.value | mask) : (short)(this.value & ~mask);
        return this;
    }
