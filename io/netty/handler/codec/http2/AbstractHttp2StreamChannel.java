...
extends AbstractChannel {
    ...
    protected void doBeginRead() {
        ...
        while ((m2 = this.inboundBuffer.poll()) != null) {
            if (!this.doRead0(m2, allocHandle)) {
                return;
            }
    ...
    @Override
    protected final void doWrite(ChannelOutboundBuffer in2) throws Exception {
        if (this.closed) {
        ...
        if (preferredExecutor.inEventLoop()) {
            ...
            while ((msg = in2.current()) != null) {
                try {
                    ...
                    this.pipeline().fireExceptionCaught(t2);
                }
                in2.remove();
            }
                ...
                public void run() {
                    for (Object msg : msgsCopy) {
                        try {
                            ...
                            AbstractHttp2StreamChannel.this.pipeline().fireExceptionCaught(t2);
                        }
                    }
