...
implements StreamByteDistributor {
    ...
    void notifyParentChanged(List<ParentChangedEvent> events) {
        for (int i2 = 0; i2 < events.size(); ++i2) {
            ParentChangedEvent event = events.get(i2);
    ...
    implements PriorityQueueNode {
        ...
        void write(int numBytes, StreamByteDistributor.Writer writer) throws Http2Exception {
            ...
            try {
                ...
                throw Http2Exception.connectionError(Http2Error.INTERNAL_ERROR, t2, "byte distribution write error", new Object[0]);
            }
        }
        ...
        @Override
        public void priorityQueueIndex(DefaultPriorityQueue<?> queue, int i2) {
    ...
    implements Comparator<State> {
        ...
        public int compare(State o1, State o2) {
            ...
            int x2 = o2.dependencyTreeDepth - o1.dependencyTreeDepth;
            return x2 != 0 ? x2 : o1.streamId - o2.streamId;
        }
    }
}
