...
extends DecoratingHttp2ConnectionEncoder {
    ...
    public void close() {
        try {
            if (!this.closed) {
                this.closed = true;
                Http2ChannelClosedException e2 = new Http2ChannelClosedException();
    ...
    private void cancelGoAwayStreams(int lastStreamId, long errorCode, ByteBuf debugData) {
        ...
        Http2GoAwayException e2 = new Http2GoAwayException(lastStreamId, errorCode, ByteBufUtil.getBytes(debugData));
        while (iter.hasNext()) {
