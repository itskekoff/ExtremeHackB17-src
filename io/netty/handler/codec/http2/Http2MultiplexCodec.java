...
extends ChannelDuplexHandler {
    ...
    public void channelReadComplete(ChannelHandlerContext ctx) {
        for (int i2 = 0; i2 < this.channelsToFireChildReadComplete.size(); ++i2) {
            Http2StreamChannel childChannel = this.channelsToFireChildReadComplete.get(i2);
    ...
    private static void initOpts(Channel channel, Map<ChannelOption<?>, Object> opts) {
        if (opts != null) {
            for (Map.Entry<ChannelOption<?>, Object> e2 : opts.entrySet()) {
                try {
