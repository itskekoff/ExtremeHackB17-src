...
extends ChannelHandlerAdapter {
    ...
    private String toString(ByteBuf buf2) {
        if (this.level == InternalLogLevel.TRACE || buf2.readableBytes() <= 64) {
            return ByteBufUtil.hexDump(buf2);
        }
        int length = Math.min(buf2.readableBytes(), 64);
        return ByteBufUtil.hexDump(buf2, buf2.readerIndex(), length) + "...";
    }
    ...
    private void log(Direction direction, String format, Object ... args) {
        ...
        this.logger.log(this.level, b2.toString());
    }
