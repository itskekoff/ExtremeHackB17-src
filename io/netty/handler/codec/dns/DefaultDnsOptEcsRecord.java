...
implements DnsOptEcsRecord {
    ...
    public String toString() {
        StringBuilder sb2 = this.toStringBuilder();
        sb2.setLength(sb2.length() - 1);
        return sb2.append(" address:").append(Arrays.toString(this.address)).append(" sourcePrefixLength:").append(this.sourcePrefixLength()).append(" scopePrefixLength:").append(this.scopePrefixLength()).append(')').toString();
    }
}
