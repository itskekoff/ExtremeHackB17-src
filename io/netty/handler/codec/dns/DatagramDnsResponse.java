...
implements AddressedEnvelope<DatagramDnsResponse, InetSocketAddress> {
    ...
    public DatagramDnsResponse(InetSocketAddress sender, InetSocketAddress recipient, int id2) {
        this(sender, recipient, id2, DnsOpCode.QUERY, DnsResponseCode.NOERROR);
    }

    public DatagramDnsResponse(InetSocketAddress sender, InetSocketAddress recipient, int id2, DnsOpCode opCode) {
        this(sender, recipient, id2, opCode, DnsResponseCode.NOERROR);
    }

    public DatagramDnsResponse(InetSocketAddress sender, InetSocketAddress recipient, int id2, DnsOpCode opCode, DnsResponseCode responseCode) {
        super(id2, opCode, responseCode);
    ...
    @Override
    public DatagramDnsResponse setId(int id2) {
        return (DatagramDnsResponse)super.setId(id2);
    }
    ...
    @Override
    public DatagramDnsResponse setZ(int z2) {
        return (DatagramDnsResponse)super.setZ(z2);
    }
