...
implements Comparable<DnsRecordType> {
    ...
    public boolean equals(Object o2) {
        return o2 instanceof DnsRecordType && ((DnsRecordType)o2).intValue == this.intValue;
    }

    @Override
    public int compareTo(DnsRecordType o2) {
        return this.intValue() - o2.intValue();
    }
    ...
    static {
        DnsRecordType[] all2 = new DnsRecordType[]{A, NS, CNAME, SOA, PTR, MX, TXT, RP, AFSDB, SIG, KEY, AAAA, LOC, SRV, NAPTR, KX, CERT, DNAME, OPT, APL, DS, SSHFP, IPSECKEY, RRSIG, NSEC, DNSKEY, DHCID, NSEC3, NSEC3PARAM, TLSA, HIP, SPF, TKEY, TSIG, IXFR, AXFR, ANY, CAA, TA, DLV};
        StringBuilder expected = new StringBuilder(512);
        expected.append(" (expected: ");
        for (DnsRecordType type : all2) {
