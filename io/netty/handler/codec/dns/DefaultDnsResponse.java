...
implements DnsResponse {
    ...
    public DefaultDnsResponse(int id2) {
        this(id2, DnsOpCode.QUERY, DnsResponseCode.NOERROR);
    }

    public DefaultDnsResponse(int id2, DnsOpCode opCode) {
        this(id2, opCode, DnsResponseCode.NOERROR);
    }

    public DefaultDnsResponse(int id2, DnsOpCode opCode, DnsResponseCode code) {
        super(id2, opCode);
        this.setCode(code);
    }
    ...
    @Override
    public DnsResponse setId(int id2) {
        return (DnsResponse)super.setId(id2);
    }
    ...
    @Override
    public DnsResponse setZ(int z2) {
        return (DnsResponse)super.setZ(z2);
    }
