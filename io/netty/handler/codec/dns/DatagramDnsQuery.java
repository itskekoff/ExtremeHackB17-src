...
implements AddressedEnvelope<DatagramDnsQuery, InetSocketAddress> {
    ...
    public DatagramDnsQuery(InetSocketAddress sender, InetSocketAddress recipient, int id2) {
        this(sender, recipient, id2, DnsOpCode.QUERY);
    }

    public DatagramDnsQuery(InetSocketAddress sender, InetSocketAddress recipient, int id2, DnsOpCode opCode) {
        super(id2, opCode);
    ...
    @Override
    public DatagramDnsQuery setId(int id2) {
        return (DatagramDnsQuery)super.setId(id2);
    }
    ...
    @Override
    public DatagramDnsQuery setZ(int z2) {
        return (DatagramDnsQuery)super.setZ(z2);
    }
