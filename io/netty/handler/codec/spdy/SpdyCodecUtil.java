...
final class SpdyCodecUtil {
    ...
    static int getUnsignedShort(ByteBuf buf2, int offset) {
        return (buf2.getByte(offset) & 0xFF) << 8 | buf2.getByte(offset + 1) & 0xFF;
    }

    static int getUnsignedMedium(ByteBuf buf2, int offset) {
        return (buf2.getByte(offset) & 0xFF) << 16 | (buf2.getByte(offset + 1) & 0xFF) << 8 | buf2.getByte(offset + 2) & 0xFF;
    }

    static int getUnsignedInt(ByteBuf buf2, int offset) {
        return (buf2.getByte(offset) & 0x7F) << 24 | (buf2.getByte(offset + 1) & 0xFF) << 16 | (buf2.getByte(offset + 2) & 0xFF) << 8 | buf2.getByte(offset + 3) & 0xFF;
    }

    static int getSignedInt(ByteBuf buf2, int offset) {
        return (buf2.getByte(offset) & 0xFF) << 24 | (buf2.getByte(offset + 1) & 0xFF) << 16 | (buf2.getByte(offset + 2) & 0xFF) << 8 | buf2.getByte(offset + 3) & 0xFF;
    }

    static boolean isServerId(int id2) {
        return id2 % 2 == 0;
    }
