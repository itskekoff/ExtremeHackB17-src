        ...
        block16: while (true) {
            switch (this.state) {
                case READ_COMMON_HEADER: {
                    ...
                    buffer.skipBytes(8);
                    boolean bl2 = control = (buffer.getByte(frameOffset) & 0x80) != 0;
                    if (control) {
                ...
                case READ_SETTING: {
                    ...
                    int id2 = SpdyCodecUtil.getUnsignedMedium(buffer, buffer.readerIndex() + 1);
                    ...
                    buffer.skipBytes(8);
                    --this.numSettings;
                    this.delegate.readSetting(id2, value, persistValue, persisted);
                    continue block16;
                }
