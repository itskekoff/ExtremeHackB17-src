...
ChannelOutboundHandler {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in2, List<Object> out) throws Exception {
        this.spdyFrameDecoder.decode(in2);
    }
    ...
    @Override
    public void readSetting(int id2, int value, boolean persistValue, boolean persisted) {
        this.spdySettingsFrame.setValue(id2, value, persistValue, persisted);
    }
    ...
    @Override
    public void readPingFrame(int id2) {
        this.read = true;
        DefaultSpdyPingFrame spdyPingFrame = new DefaultSpdyPingFrame(id2);
