...
extends SSLEngine {
    ...
    @Override
    public SSLEngineResult wrap(ByteBuffer[] byteBuffers, int i2, int i22, ByteBuffer byteBuffer) throws SSLException {
        return this.engine.wrap(byteBuffers, i2, i22, byteBuffer);
    }
    ...
    @Override
    public SSLEngineResult unwrap(ByteBuffer byteBuffer, ByteBuffer[] byteBuffers, int i2, int i22) throws SSLException {
        return this.engine.unwrap(byteBuffer, byteBuffers, i2, i22);
    }
    ...
    @Override
    public void setUseClientMode(boolean b2) {
        this.engine.setUseClientMode(b2);
    }
    ...
    public void setNeedClientAuth(boolean b2) {
        this.engine.setNeedClientAuth(b2);
    }
    ...
    public void setWantClientAuth(boolean b2) {
        this.engine.setWantClientAuth(b2);
    }
    ...
    public void setEnableSessionCreation(boolean b2) {
        this.engine.setEnableSessionCreation(b2);
    }
