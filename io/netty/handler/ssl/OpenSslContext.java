...
extends ReferenceCountedOpenSslContext {
    ...
    OpenSslContext(Iterable<String> ciphers, CipherSuiteFilter cipherFilter, OpenSslApplicationProtocolNegotiator apn2, long sessionCacheSize, long sessionTimeout, int mode, Certificate[] keyCertChain, ClientAuth clientAuth, String[] protocols, boolean startTls) throws SSLException {
        super(ciphers, cipherFilter, apn2, sessionCacheSize, sessionTimeout, mode, keyCertChain, clientAuth, protocols, startTls, false);
    }
