...
implements DatagramChannel {
    ...
    protected int doReadMessages(List<Object> buf2) throws Exception {
        ...
        try {
            ...
            buf2.add(new DatagramPacket(data.writerIndex(data.writerIndex() + allocHandle.lastBytesRead()), this.localAddress(), remoteAddress));
            free = false;
            int n3 = 1;
            return n3;
        }
    ...
    protected Object filterOutboundMessage(Object msg) {
        ...
        if (msg instanceof ByteBuf) {
            ...
            if (NioDatagramChannel.isSingleDirectBuffer(buf2)) {
                return buf2;
            }
            return this.newDirectBuffer(buf2);
        }
    ...
    private static boolean isSingleDirectBuffer(ByteBuf buf2) {
        return buf2.isDirect() && buf2.nioBufferCount() == 1;
    }
