...
implements ServerDomainSocketChannel {
    ...
    public EpollServerDomainSocketChannel(FileDescriptor fd2) {
        super(fd2);
    }

    public EpollServerDomainSocketChannel(Socket fd2) {
        super(fd2);
    }

    public EpollServerDomainSocketChannel(Socket fd2, boolean active) {
        super(fd2, active);
    }

    @Override
    protected Channel newChildChannel(int fd2, byte[] addr, int offset, int len) throws Exception {
        return new EpollDomainSocketChannel((Channel)this, new Socket(fd2));
    }
