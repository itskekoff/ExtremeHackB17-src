...
implements ChannelConfig {
    ...
    protected Map<ChannelOption<?>, Object> getOptions(Map<ChannelOption<?>, Object> result, ChannelOption<?> ... options) {
        ...
        for (ChannelOption<?> o2 : options) {
            result.put(o2, this.getOption(o2));
        }
        return result;
    }
    ...
    public boolean setOptions(Map<ChannelOption<?>, ?> options) {
        ...
        for (Map.Entry<ChannelOption<?>, ?> e2 : options.entrySet()) {
            if (this.setOption(e2.getKey(), e2.getValue())) continue;
            setAllOptions = false;
        }
    ...
    public ChannelConfig setAutoRead(boolean autoRead) {
        boolean oldAutoRead;
        boolean bl2 = oldAutoRead = AUTOREAD_UPDATER.getAndSet(this, autoRead ? 1 : 0) == 1;
