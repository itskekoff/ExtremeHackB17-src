...
public class FileDescriptor {
    ...
    public final int write(ByteBuffer buf2, int pos, int limit) throws IOException {
        int res = FileDescriptor.write(this.fd, buf2, pos, limit);
        if (res >= 0) {
            return res;
        }
    ...
    public final int read(ByteBuffer buf2, int pos, int limit) throws IOException {
        int res = FileDescriptor.read(this.fd, buf2, pos, limit);
        if (res > 0) {
            return res;
        }
        if (res == 0) {
    ...
    public boolean equals(Object o2) {
        ...
        if (!(o2 instanceof FileDescriptor)) {
            return false;
        }
        return this.fd == ((FileDescriptor)o2).fd;
    }
