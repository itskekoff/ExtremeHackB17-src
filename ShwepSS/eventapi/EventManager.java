package ShwepSS.eventapi;

import ShwepSS.eventapi.EventTarget;
import ShwepSS.eventapi.events.Event;
import ShwepSS.eventapi.events.EventStoppable;
import ShwepSS.eventapi.types.Priority;
...
public final class EventManager {
    ...
    private static void sortListValue(Class<? extends Event> indexClass) {
        ...
        int n2 = Priority.VALUE_ARRAY.length;
        for (int i2 = 0; i2 < n2; ++i2) {
            byte priority = arrby[i2];
