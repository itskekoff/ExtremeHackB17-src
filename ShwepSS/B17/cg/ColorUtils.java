...
public class ColorUtils {
    ...
    public static int color(int n2, int n22, int n3, int n4) {
        n4 = 255;
        return new Color(n2, n22, n3, n4).getRGB();
    }
    ...
    public static int getRandomColor() {
        ...
        for (int i2 = 0; i2 < 6; ++i2) {
            color = String.valueOf(color) + letters[new Random().nextInt(letters.length)];
        }
