...
public class ViaMCP {
    ...
    public AsyncVersionSlider asyncSlider = new AsyncVersionSlider(-1, -1073741824, -1073741824, 0, 0);
    ...
    public void initAsyncSlider(int x2, int y2, int width, int height) {
        this.asyncSlider = new AsyncVersionSlider(-1, x2, y2, Math.max(width, 110), height);
    }
