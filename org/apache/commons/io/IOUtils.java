...
public class IOUtils {
    ...
    public static void copy(InputStream input, Writer output, Charset inputEncoding) throws IOException {
        InputStreamReader in2 = new InputStreamReader(input, Charsets.toCharset(inputEncoding));
    ...
    static {
        StringBuilderWriter buf2 = new StringBuilderWriter(4);
        PrintWriter out = new PrintWriter(buf2);
        out.println();
        LINE_SEPARATOR = buf2.toString();
        out.close();
    }
}
