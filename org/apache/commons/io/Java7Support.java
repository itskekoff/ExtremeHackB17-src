...
class Java7Support {
    ...
    static {
        ...
        try {
            ...
            Class<?> files = cl2.loadClass("java.nio.file.Files");
            Class<?> path = cl2.loadClass("java.nio.file.Path");
            Class<?> fa2 = cl2.loadClass("java.nio.file.attribute.FileAttribute");
            Class<?> linkOption = cl2.loadClass("java.nio.file.LinkOption");
            ...
            emptyFileAttributes = Array.newInstance(fa2, 0);
