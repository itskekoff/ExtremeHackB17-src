...
extends InputStream {
    ...
    public CharSequenceInputStream(CharSequence cs2, Charset charset, int bufferSize) {
        ...
        this.bbuf.flip();
        this.cbuf = CharBuffer.wrap(cs2);
        this.mark_cbuf = -1;
        this.mark_bbuf = -1;
    }

    public CharSequenceInputStream(CharSequence cs2, String charset, int bufferSize) {
        this(cs2, Charset.forName(charset), bufferSize);
    }

    public CharSequenceInputStream(CharSequence cs2, Charset charset) {
        this(cs2, charset, 2048);
    }

    public CharSequenceInputStream(CharSequence cs2, String charset) {
        this(cs2, charset, 2048);
    }
