            ...
            try {
                ...
                Rule r2 = new Rule(pat, lCon, rCon, ph2){
                    ...
                    public String toString() {
                        ...
                        sb2.append(", pat='").append(pat).append('\'');
                        sb2.append(", lcon='").append(lCon).append('\'');
                        sb2.append(", rcon='").append(rCon).append('\'');
                        sb2.append('}');
                        return sb2.toString();
                    }
                };
        ...
        for (NameType s2 : NameType.values()) {
            ...
            for (RuleType rt : RuleType.values()) {
                ...
                for (String l2 : ls2.getLanguages()) {
                    try {
                        rs2.put(l2, Rule.parseRules(Rule.createScanner(s2, rt, l2), Rule.createResourceName(s2, rt, l2)));
                    }
                ...
                if (!rt.equals((Object)RuleType.RULES)) {
                    rs2.put("common", Rule.parseRules(Rule.createScanner(s2, rt, "common"), Rule.createResourceName(s2, rt, "common")));
                }
                rts.put(rt, Collections.unmodifiableMap(rs2));
            }
