...
implements StringEncoder {
    ...
    String removeAccents(String accentedWord) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            ...
            if (pos > -1) {
                sb2.append(PLAIN_ASCII.charAt(pos));
                continue;
            }
            sb2.append(c2);
        }
    ...
    String removeDoubleConsonants(String name) {
        ...
        for (String dc2 : DOUBLE_CONSONANT) {
            if (!replacedName.contains(dc2)) continue;
            String singleLetter = dc2.substring(0, 1);
            replacedName = replacedName.replace(dc2, singleLetter);
        }
        return replacedName;
    }
