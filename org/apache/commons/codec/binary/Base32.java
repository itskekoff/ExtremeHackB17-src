...
extends BaseNCodec {
    ...
    @Override
    void decode(byte[] in2, int inPos, int inAvail, BaseNCodec.Context context) {
        if (context.eof) {
            return;
        }
        if (inAvail < 0) {
    ...
    @Override
    void encode(byte[] in2, int inPos, int inAvail, BaseNCodec.Context context) {
        if (context.eof) {
            return;
        }
        if (inAvail < 0) {
