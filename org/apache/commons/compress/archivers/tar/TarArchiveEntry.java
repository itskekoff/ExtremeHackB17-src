...
ArchiveEntry {
    ...
    public boolean equals(TarArchiveEntry it2) {
        return this.getName().equals(it2.getName());
    }

    public boolean equals(Object it2) {
        if (it2 == null || this.getClass() != it2.getClass()) {
            return false;
        }
        return this.equals((TarArchiveEntry)it2);
    }
    ...
    public TarArchiveEntry[] getDirectoryEntries() {
        ...
        for (int i2 = 0; i2 < list.length; ++i2) {
            result[i2] = new TarArchiveEntry(new File(this.file, list[i2]));
        }
        return result;
    }
