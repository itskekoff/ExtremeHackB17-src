...
Serializable {
    ...
    public String toString() {
        ...
        buf2.append("0x5455 Zip Extra Field: Flags=");
        buf2.append(Integer.toBinaryString(ZipUtil.unsignedIntToSignedByte(this.flags))).append(" ");
        if (this.bit0_modifyTimePresent && this.modifyTime != null) {
            Date m2 = this.getModifyJavaTime();
            buf2.append(" Modify:[").append(m2).append("] ");
        }
        if (this.bit1_accessTimePresent && this.accessTime != null) {
            Date a2 = this.getAccessJavaTime();
            buf2.append(" Access:[").append(a2).append("] ");
        }
        if (this.bit2_createTimePresent && this.createTime != null) {
            Date c2 = this.getCreateJavaTime();
            buf2.append(" Create:[").append(c2).append("] ");
        }
    ...
    public boolean equals(Object o2) {
        if (o2 instanceof X5455_ExtendedTimestamp) {
            X5455_ExtendedTimestamp xf2 = (X5455_ExtendedTimestamp)o2;
            return (this.flags & 7) == (xf2.flags & 7) && (this.modifyTime == xf2.modifyTime || this.modifyTime != null && this.modifyTime.equals(xf2.modifyTime)) && (this.accessTime == xf2.accessTime || this.accessTime != null && this.accessTime.equals(xf2.accessTime)) && (this.createTime == xf2.createTime || this.createTime != null && this.createTime.equals(xf2.createTime));
        }
        return false;
    }
