...
implements ZipExtraField {
    ...
    public byte[] getUnicodeName() {
        byte[] b2 = null;
        if (this.unicodeName != null) {
            b2 = new byte[this.unicodeName.length];
            System.arraycopy(this.unicodeName, 0, b2, 0, b2.length);
        }
        return b2;
    }
    ...
    public byte[] getCentralDirectoryData() {
        ...
        byte[] b2 = null;
        if (this.data != null) {
            b2 = new byte[this.data.length];
            System.arraycopy(this.data, 0, b2, 0, b2.length);
        }
        return b2;
    }
