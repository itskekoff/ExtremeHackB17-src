        ...
        try {
            ...
            block16: {
                ...
                if (ZipArchiveInputStream.matches(signature, signatureLength)) {
                    if (this.entryEncoding == null) return new ZipArchiveInputStream(in2);
                    return new ZipArchiveInputStream(in2, this.entryEncoding);
                }
                ...
                if (TarArchiveInputStream.matches(tarheader, signatureLength)) {
                    if (this.entryEncoding == null) return new TarArchiveInputStream(in2);
                    return new TarArchiveInputStream(in2, this.entryEncoding);
                }
                ...
                try {
                    ...
                    if (!tais.getNextTarEntry().isCheckSumOK()) break block16;
                    tarArchiveInputStream = new TarArchiveInputStream(in2);
                }
                catch (Exception e2) {
