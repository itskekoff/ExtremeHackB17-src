...
implements ArchiveEntry {
    ...
    public void setCreationDate(Date creationDate) {
        boolean bl2 = this.hasCreationDate = creationDate != null;
        if (this.hasCreationDate) {
    ...
    public void setLastModifiedDate(Date lastModifiedDate) {
        boolean bl2 = this.hasLastModifiedDate = lastModifiedDate != null;
        if (this.hasLastModifiedDate) {
    ...
    public void setAccessDate(Date accessDate) {
        boolean bl2 = this.hasAccessDate = accessDate != null;
        if (this.hasAccessDate) {
