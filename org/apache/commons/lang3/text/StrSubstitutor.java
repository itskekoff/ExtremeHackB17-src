...
public class StrSubstitutor {
    ...
    public String replace(String source) {
        ...
        StrBuilder buf2 = new StrBuilder(source);
        if (!this.substitute(buf2, 0, source.length())) {
            return source;
        }
    ...
    public String replace(String source, int offset, int length) {
        ...
        StrBuilder buf2 = new StrBuilder(length).append(source, offset, length);
        if (!this.substitute(buf2, 0, length)) {
    ...
    public String replace(char[] source) {
        ...
        StrBuilder buf2 = new StrBuilder(source.length).append(source);
        this.substitute(buf2, 0, source.length);
        return buf2.toString();
    }
    ...
    public String replace(StringBuffer source) {
        ...
        StrBuilder buf2 = new StrBuilder(source.length()).append(source);
        this.substitute(buf2, 0, buf2.length());
        return buf2.toString();
    }
    ...
    public String replace(Object source) {
        ...
        StrBuilder buf2 = new StrBuilder().append(source);
        this.substitute(buf2, 0, buf2.length());
        return buf2.toString();
    }
    ...
    public boolean replaceIn(StringBuffer source, int offset, int length) {
        ...
        source.replace(offset, offset + length, buf2.toString());
        return true;
    }
    ...
    protected boolean substitute(StrBuilder buf2, int offset, int length) {
        return this.substitute(buf2, offset, length, null) > 0;
    }

    private int substitute(StrBuilder buf2, int offset, int length, List<String> priorVariables) {
        ...
        block0: while (pos < bufEnd) {
            ...
            while (pos < bufEnd) {
                ...
                if (nestedVarCount == 0) {
                    ...
                    String varValue = this.resolveVariable(varName, buf2, startPos, endPos);
                    if (varValue == null) {
                        varValue = varDefaultValue;
                    }
                    if (varValue != null) {
                        int varLen = varValue.length();
                        buf2.replace(startPos, endPos, varValue);
                        altered = true;
                        int change = this.substitute(buf2, startPos, varLen, priorVariables);
    ...
    private void checkCyclicSubstitution(String varName, List<String> priorVariables) {
        ...
        StrBuilder buf2 = new StrBuilder(256);
        buf2.append("Infinite loop in property interpolation of ");
        buf2.append(priorVariables.remove(0));
        buf2.append(": ");
        buf2.appendWithSeparators(priorVariables, "->");
        throw new IllegalStateException(buf2.toString());
    }

    protected String resolveVariable(String variableName, StrBuilder buf2, int startPos, int endPos) {
