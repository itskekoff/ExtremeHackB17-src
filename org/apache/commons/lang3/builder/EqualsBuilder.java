    ...
    private static void reflectionAppend(Object lhs, Object rhs, Class<?> clazz, EqualsBuilder builder, boolean useTransients, String[] excludeFields) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < fields.length && builder.isEquals; ++i2) {
                ...
                if (ArrayUtils.contains(excludeFields, ((Field)f2).getName()) || ((Field)f2).getName().contains("$") || !useTransients && Modifier.isTransient(((Field)f2).getModifiers()) || Modifier.isStatic(((Field)f2).getModifiers()) || f2.isAnnotationPresent(EqualsExclude.class)) continue;
                try {
