...
public class DateUtils {
    ...
    private static Date parseDateWithLeniency(String str, Locale locale, String[] parsePatterns, boolean lenient) throws ParseException {
        ...
        Calendar calendar = Calendar.getInstance(tz2, lcl);
        calendar.setLenient(lenient);
        for (String parsePattern : parsePatterns) {
            FastDateParser fdp = new FastDateParser(parsePattern, tz2, lcl);
            calendar.clear();
            try {
    ...
    public static Calendar toCalendar(Date date, TimeZone tz2) {
    ...
    private static void modify(Calendar val, int field, ModifyType modType) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            int[] aField;
            for (int element : aField = arrn[i2]) {
            ...
            if (!offsetSet) {
                ...
                boolean bl2 = roundUp = offset > (max - min) / 2;
            }
