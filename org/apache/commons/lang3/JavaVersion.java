...
public enum JavaVersion {
    ...
    static JavaVersion get(String nom) {
        ...
        if ((double)v2 - 1.0 < 1.0 && Float.parseFloat(nom.substring((firstComma = Math.max(nom.indexOf(46), nom.indexOf(44))) + 1, end = Math.max(nom.length(), nom.indexOf(44, firstComma)))) > 0.9f) {
            return JAVA_RECENT;
        }
        return null;
    }
