...
public abstract class PoolEntry<T, C> {
    ...
    public PoolEntry(String id2, T route, C conn, long timeToLive, TimeUnit tunit) {
    ...
    public PoolEntry(String id2, T route, C conn) {
        this(id2, route, conn, 0L, TimeUnit.MILLISECONDS);
    }
