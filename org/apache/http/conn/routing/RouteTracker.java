...
Cloneable {
    ...
    public final boolean equals(Object o2) {
        ...
        if (!(o2 instanceof RouteTracker)) {
            return false;
        }
        RouteTracker that = (RouteTracker)o2;
    ...
    public final String toString() {
        StringBuilder cab2 = new StringBuilder(50 + this.getHopCount() * 30);
        cab2.append("RouteTracker[");
        if (this.localAddress != null) {
            cab2.append(this.localAddress);
            cab2.append("->");
        }
        cab2.append('{');
        if (this.connected) {
        ...
        cab2.append(this.targetHost);
        cab2.append(']');
        return cab2.toString();
    }
