...
ConnPoolControl<HttpRoute> {
    ...
    private String format(HttpRoute route, Object state) {
        ...
        buf2.append("[route: ").append(route).append("]");
        if (state != null) {
            buf2.append("[state: ").append(state).append("]");
        }
    ...
    private String formatStats(HttpRoute route) {
        ...
        buf2.append("[total kept alive: ").append(totals.getAvailable()).append("; ");
        buf2.append("route allocated: ").append(stats.getLeased() + stats.getAvailable());
        buf2.append(" of ").append(stats.getMax()).append("; ");
        buf2.append("total allocated: ").append(totals.getLeased() + totals.getAvailable());
        buf2.append(" of ").append(totals.getMax()).append("]");
        return buf2.toString();
    }

    private String format(HttpPoolEntry entry) {
        StringBuilder buf2 = new StringBuilder();
        buf2.append("[id: ").append(entry.getId()).append("]");
        buf2.append("[route: ").append(entry.getRoute()).append("]");
