...
class HttpClientConnectionOperator {
    ...
    public void connect(ManagedHttpClientConnection conn, HttpHost host, InetSocketAddress localAddress, int connectTimeout, SocketConfig socketConfig, HttpContext context) throws IOException {
        ...
        ConnectionSocketFactory sf2 = registry.lookup(host.getSchemeName());
        if (sf2 == null) {
        ...
        for (int i2 = 0; i2 < addresses.length; ++i2) {
            ...
            block10: {
                ...
                Socket sock = sf2.createSocket(context);
                ...
                try {
                    ...
                    sock = sf2.connectSocket(connectTimeout, sock, host, remoteAddress, localAddress, context);
                    ...
                    if ("Connection timed out".equals(msg)) {
                        throw new ConnectTimeoutException(ex3, host, addresses);
                    }
                    throw new HttpHostConnectException(ex3, host, addresses);
                }
            }
    ...
    public void upgrade(ManagedHttpClientConnection conn, HttpHost host, HttpContext context) throws IOException {
        ...
        if (!(sf2 instanceof LayeredConnectionSocketFactory)) {
            throw new UnsupportedSchemeException(host.getSchemeName() + " protocol does not support connection upgrade");
        }
        LayeredConnectionSocketFactory lsf = (LayeredConnectionSocketFactory)sf2;
