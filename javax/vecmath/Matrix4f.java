...
Cloneable {
    ...
    public final void setRotation(AxisAngle4f a1) {
        ...
        if (mag < 1.0E-8) {
            ...
            this.m02 = (float)((t2 * xz2 + sinTheta * ay2) * tmp_scale[2]);
            ...
            this.m20 = (float)((t2 * xz2 - sinTheta * ay2) * tmp_scale[0]);
