        ...
        for (int i2 = 0; i2 < this.nRow; ++i2) {
            for (int j2 = 0; j2 < this.nCol; ++j2) {
                ...
                for (int k2 = 0; k2 < this.nCol; ++k2) {
                    double[] arrd = tmp[i2];
                    int n2 = j2;
                    arrd[n2] = arrd[n2] + this.values[i2][k2] * m1.values[k2][j2];
                }
            }
        }
        this.values = tmp;
        ...
        for (int i2 = 0; i2 < m1.nRow; ++i2) {
            for (int j2 = 0; j2 < m2.nCol; ++j2) {
                ...
                for (int k2 = 0; k2 < m1.nCol; ++k2) {
                    double[] arrd = tmp[i2];
                    int n2 = j2;
                    arrd[n2] = arrd[n2] + m1.values[i2][k2] * m2.values[k2][j2];
                }
            }
        }
        this.values = tmp;
            ...
            for (int i2 = 0; i2 < this.nRow; ++i2) {
                for (int j2 = 0; j2 < this.nCol; ++j2) {
                    ...
                    for (int k2 = 0; k2 < m1.nRow; ++k2) {
                        double[] arrd = tmp[i2];
                        int n2 = j2;
                        arrd[n2] = arrd[n2] + m1.values[k2][i2] * m2.values[j2][k2];
                    }
                }
            }
            this.values = tmp;
            ...
            for (int i3 = 0; i3 < this.nRow; ++i3) {
                for (int j3 = 0; j3 < this.nCol; ++j3) {
                    ...
                    for (int k3 = 0; k3 < m1.nRow; ++k3) {
                        double[] arrd = this.values[i3];
                        int n3 = j3;
                        arrd[n3] = arrd[n3] + m1.values[k3][i3] * m2.values[j3][k3];
                    }
                }
            }
        }
            ...
            for (int i2 = 0; i2 < this.nRow; ++i2) {
                for (int j2 = 0; j2 < this.nCol; ++j2) {
                    ...
                    for (int k2 = 0; k2 < m1.nCol; ++k2) {
                        double[] arrd = tmp[i2];
                        int n2 = j2;
                        arrd[n2] = arrd[n2] + m1.values[i2][k2] * m2.values[j2][k2];
                    }
                }
            }
            this.values = tmp;
            ...
            for (int i3 = 0; i3 < this.nRow; ++i3) {
                for (int j3 = 0; j3 < this.nCol; ++j3) {
                    ...
                    for (int k3 = 0; k3 < m1.nCol; ++k3) {
                        double[] arrd = this.values[i3];
                        int n3 = j3;
                        arrd[n3] = arrd[n3] + m1.values[i3][k3] * m2.values[j3][k3];
                    }
                }
            }
        }
            ...
            for (int i2 = 0; i2 < this.nRow; ++i2) {
                for (int j2 = 0; j2 < this.nCol; ++j2) {
                    ...
                    for (int k2 = 0; k2 < m1.nRow; ++k2) {
                        double[] arrd = tmp[i2];
                        int n2 = j2;
                        arrd[n2] = arrd[n2] + m1.values[k2][i2] * m2.values[k2][j2];
                    }
                }
            }
            this.values = tmp;
            ...
            for (int i3 = 0; i3 < this.nRow; ++i3) {
                for (int j3 = 0; j3 < this.nCol; ++j3) {
                    ...
                    for (int k3 = 0; k3 < m1.nRow; ++k3) {
                        double[] arrd = this.values[i3];
                        int n3 = j3;
                        arrd[n3] = arrd[n3] + m1.values[k3][i3] * m2.values[k3][j3];
                    }
                }
            }
        }
    ...
    static void luBacksubstitution(int dim, double[] matrix1, int[] row_perm, double[] matrix2) {
        ...
        for (int k2 = 0; k2 < dim; ++k2) {
            ...
            for (i2 = 0; i2 < dim; ++i2) {
                ...
                matrix2[cv2 + dim * ri] = (matrix2[cv2 + dim * ri] - tt2) / matrix1[rv2 + ri];
            }
        }
    }
                ...
                for (j2 = si2; j2 < m2.nRow; ++j2) {
                    for (k2 = si2 + 1; k2 < m2.nCol; ++k2) {
                        ...
                        for (i2 = si2; i2 < m2.nCol; ++i2) {
                            double[] arrd = tmp.values[j2];
                            int n3 = k2;
                            arrd[n3] = arrd[n3] + u2.values[j2][i2] * m2.values[i2][k2];
                        }
                    }
                }
                for (j2 = si2; j2 < m2.nRow; ++j2) {
                ...
                for (j2 = si2; j2 < m2.nRow; ++j2) {
                    for (k2 = 0; k2 < m2.nCol; ++k2) {
                        ...
                        for (i2 = si2; i2 < m2.nCol; ++i2) {
                            double[] arrd = tmp.values[j2];
                            int n4 = k2;
                            arrd[n4] = arrd[n4] + u2.values[j2][i2] * U.values[i2][k2];
                        }
                    }
                }
                for (j2 = si2; j2 < m2.nRow; ++j2) {
            ...
            for (j2 = si2 + 1; j2 < m2.nRow; ++j2) {
                for (k2 = si2 + 1; k2 < m2.nCol; ++k2) {
                    ...
                    for (i2 = si2 + 1; i2 < m2.nCol; ++i2) {
                        double[] arrd = tmp.values[j2];
                        int n6 = k2;
                        arrd[n6] = arrd[n6] + v2.values[i2][k2] * m2.values[j2][i2];
                    }
                }
            }
            for (j2 = si2 + 1; j2 < m2.nRow; ++j2) {
            ...
            for (j2 = 0; j2 < m2.nRow; ++j2) {
                for (k2 = si2 + 1; k2 < m2.nCol; ++k2) {
                    ...
                    for (i2 = si2 + 1; i2 < m2.nCol; ++i2) {
                        double[] arrd = tmp.values[j2];
                        int n7 = k2;
                        arrd[n7] = arrd[n7] + v2.values[i2][k2] * V.values[j2][i2];
                    }
                }
            }
            for (j2 = 0; j2 < m2.nRow; ++j2) {
    ...
    static int compute_2X2(double f2, double g2, double h2, double[] single_values, double[] snl, double[] csl, double[] snr, double[] csr, int index) {
        ...
        if ((ga2 = Math.abs(gt2 = g2)) == 0.0) {
            ...
            if (gasmal) {
                ...
                double mm2 = m2 * m2;
                double tt2 = t2 * t2;
                double s2 = Math.sqrt(tt2 + mm2);
                double r2 = l2 == 0.0 ? Math.abs(m2) : Math.sqrt(l2 * l2 + mm2);
                double a2 = (s2 + r2) * 0.5;
                if (ga2 > fa2) {
                    pmax = 2;
                    if (fa2 / ga2 < 1.0E-10) {
                ...
                if (gasmal) {
                    ...
                    mm2 = m2 * m2;
                    tt2 = t2 * t2;
                    s2 = Math.sqrt(tt2 + mm2);
                    r2 = l2 == 0.0 ? Math.abs(m2) : Math.sqrt(l2 * l2 + mm2);
                    a2 = (s2 + r2) * 0.5;
                    ssmin = ha2 / a2;
                    ssmax = fa2 * a2;
                    t2 = mm2 == 0.0 ? (l2 == 0.0 ? GMatrix.d_sign(c_b3, ft2) * GMatrix.d_sign(c_b4, gt2) : gt2 / GMatrix.d_sign(d2, ft2) + m2 / t2) : (m2 / (s2 + t2) + m2 / (r2 + l2)) * (a2 + 1.0);
